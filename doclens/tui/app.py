...
from doclens.tui.theme import APP_CSS
from doclens.tui.commands import parse_input, build_builtin_registry
from doclens.tui.command_registry import Command
from doclens.tui.widgets.header_bar import HeaderBar
from doclens.tui.widgets.content_area import ContentArea
from doclens.tui.widgets.input_box import InputBox
from doclens.tui.widgets.status_bar import StatusBar
from doclens.tui.widgets.thinking_indicator import ThinkingIndicator
from doclens.tui.widgets.autocomplete import AutoComplete
from doclens.tui.renderers.search import render_search_results
...
class CortexApp(App):
    ...
    def action_show_tool_details(self) -> None:
        ...
        if not details:
            ...
            return
        from doclens.tui.widgets.tool_detail_screen import ToolDetailScreen
