...
`,e=e.substring(x.length+1),n=!0),!n){let K=this.rules.other.nextBulletRegex(m),O=this.rules.other.hrRegex(m),Pt=this.rules.other.fencesBeginRegex(m),ve=this.rules.other.headingBeginRegex(m),cr=this.rules.other.htmlBeginRegex(m),Li=this.rules.other.blockquoteBeginRegex(m);for(;e;){let dr=e.split(`
`,1)[0],Je;if(x=dr,this.options.pedantic?(x=x.replace(this.rules.other.listReplaceNesting,"  "),Je=x):Je=x.replace(this.rules.other.tabCharGlobal,"    "),Pt.test(x)||ve.test(x)||cr.test(x)||Li.test(x)||K.test(x)||O.test(x))break;if(Je.search(this.rules.other.nonSpaceChar)>=m||!x.trim())h+=`
...
`)?"":`
`)+n.raw,h.text+=`
`+n.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=h.text):r.push(n);continue}if(t){this.infiniteLoopError(t.charCodeAt(0));break}}return this.state.top=!0,r}inline(t,r=[]){return this.inlineQueue.push({src:t,tokens:r}),r}inlineTokens(t,r=[]){var u,h,b,x,S;this.tokenizer.lexer=this;let i=t,s=null;if(this.tokens.links){let m=Object.keys(this.tokens.links);if(m.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(i))!==null;)m.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(i=i.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(i))!==null;)i=i.slice(0,s.index)+"++"+i.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let o;for(;(s=this.tokenizer.rules.inline.blockSkip.exec(i))!==null;)o=s[2]?s[2].length:0,i=i.slice(0,s.index+o)+"["+"a".repeat(s[0].length-o-2)+"]"+i.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);i=((h=(u=this.options.hooks)==null?void 0:u.emStrongMask)==null?void 0:h.call({lexer:this},i))??i;let a=!1,l="",n=1/0;for(;t;){if(t.length<n)n=t.length;else{this.infiniteLoopError(t.charCodeAt(0));break}a||(l=""),a=!1;let m;if((x=(b=this.options.extensions)==null?void 0:b.inline)!=null&&x.some(O=>(m=O.call({lexer:this},t,r))?(t=t.substring(m.raw.length),r.push(m),!0):!1))continue;if(m=this.tokenizer.escape(t)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.tag(t)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.link(t)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(m.raw.length);let O=r.at(-1);m.type==="text"&&(O==null?void 0:O.type)==="text"?(O.raw+=m.raw,O.text+=m.text):r.push(m);continue}if(m=this.tokenizer.emStrong(t,i,l)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.codespan(t)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.br(t)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.del(t,i,l)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.autolink(t)){t=t.substring(m.raw.length),r.push(m);continue}if(!this.state.inLink&&(m=this.tokenizer.url(t))){t=t.substring(m.raw.length),r.push(m);continue}let K=t;if((S=this.options.extensions)!=null&&S.startInline){let O=1/0,Pt=t.slice(1),ve;this.options.extensions.startInline.forEach(cr=>{ve=cr.call({lexer:this},Pt),typeof ve=="number"&&ve>=0&&(O=Math.min(O,ve))}),O<1/0&&O>=0&&(K=t.substring(0,O+1))}if(m=this.tokenizer.inlineText(K)){t=t.substring(m.raw.length),m.raw.slice(-1)!=="_"&&(l=m.raw.slice(-1)),a=!0;let O=r.at(-1);(O==null?void 0:O.type)==="text"?(O.raw+=m.raw,O.text+=m.text):r.push(m);continue}if(t){this.infiniteLoopError(t.charCodeAt(0));break}}return r}infiniteLoopError(t){let r="Infinite loop on byte: "+t;if(this.options.silent)console.error(r);else throw new Error(r)}},Vt=class{constructor(e){z(this,"options");z(this,"parser");this.options=e||Re}space(e){return""}code({text:e,lang:t,escaped:r}){var o;let i=(o=(t||"").match(M.notSpaceStart))==null?void 0:o[0],s=e.replace(M.endingNewline,"")+`
...
Please report this to https://github.com/markedjs/marked.`,e){let i="<p>An error occurred:</p><pre>"+oe(r.message+"",!0)+"</pre>";return t?Promise.resolve(i):i}if(t)return Promise.reject(r);throw r}}},Ae=new vn;function T(e,t){return Ae.parse(e,t)}T.options=T.setOptions=function(e){return Ae.setOptions(e),T.defaults=Ae.defaults,vi(T.defaults),T};T.getDefaults=qr;T.defaults=Re;T.use=function(...e){return Ae.use(...e),T.defaults=Ae.defaults,vi(T.defaults),T};T.walkTokens=function(e,t){return Ae.walkTokens(e,t)};T.parseInline=Ae.parseInline;T.Parser=ee;T.parser=ee.parse;T.Renderer=Vt;T.TextRenderer=Jr;T.Lexer=J;T.lexer=J.lex;T.Tokenizer=qt;T.Hooks=lt;T.parse=T;T.options;T.setOptions;T.use;T.walkTokens;T.parseInline;ee.parse;J.lex;var gn=Object.defineProperty,xn=Object.getOwnPropertyDescriptor,es=(e,t,r,i)=>{for(var s=i>1?void 0:i?xn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&gn(t,r,s),s};let mt=class extends ${constructor(){super(...arguments),this.result=null,this.active=!1}_select(){this.result&&this.dispatchEvent(new CustomEvent("select",{detail:{result:this.result},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._select)}disconnectedCallback(){this.removeEventListener("click",this._select),super.disconnectedCallback()}_renderSnippet(){var r;const e=((r=this.result)==null?void 0:r.snippet)??"";if(!e)return null;const t=T.parse(e,{async:!1});return c`<div class="snippet" .innerHTML=${t}></div>`}render(){if(!this.result)return null;const e=Math.round(this.result.score*100);return c`
  ...
  `;es([d({attribute:!1})],mt.prototype,"result",2);es([d({type:Boolean,reflect:!0})],mt.prototype,"active",2);mt=es([A("result-card")],mt);var _n=Object.defineProperty,yn=Object.getOwnPropertyDescriptor,rr=(e,t,r,i)=>{for(var s=i>1?void 0:i?yn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&_n(t,r,s),s};let Ue=class extends ${constructor(){super(...arguments),this.results=[],this.activeResult=null,this.loading=!1}render(){return c`
      <div class="list-pane">
  ...
  `;rr([d({attribute:!1})],Ue.prototype,"results",2);rr([d({attribute:!1})],Ue.prototype,"activeResult",2);rr([d({type:Boolean})],Ue.prototype,"loading",2);Ue=rr([A("search-results")],Ue);var wn=Object.defineProperty,kn=Object.getOwnPropertyDescriptor,St=(e,t,r,i)=>{for(var s=i>1?void 0:i?kn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&wn(t,r,s),s};let ct="",Tr=0,Xt=0;function nt(e){if(!e)return 0;const t=ct.indexOf(e,Tr);if(t===-1){const i=ct.indexOf(e);return i===-1?0:(ct.slice(0,i).match(/\n/g)??[]).length+1+Xt}const r=(ct.slice(0,t).match(/\n/g)??[]).length+1;return Tr=t+e.length,r+Xt}function Ms(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const $n={heading(e){const t=this.parser.parseInline(e.tokens),r=nt(e.raw);return`<h${e.depth} data-source-line="${r}">${t}</h${e.depth}>
...
`);return c`
  ...
  `;sr([d({reflect:!0})],je.prototype,"role",2);sr([d({attribute:!1})],je.prototype,"message",2);sr([d()],je.prototype,"error",2);je=sr([A("chat-message")],je);var Ln=Object.defineProperty,Mn=Object.getOwnPropertyDescriptor,Ai=(e,t,r,i)=>{for(var s=i>1?void 0:i?Mn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&Ln(t,r,s),s};let Gt=class extends ${constructor(){super(...arguments),this.messages=[]}updated(){this.scrollTop=this.scrollHeight}render(){return this.messages.length===0?c`<div class="empty">开始与 Doclens 对话</div>`:c`
  ...
  `;Et([d({type:Number})],De.prototype,"total",2);Et([d({type:Number})],De.prototype,"offset",2);Et([d({type:Number})],De.prototype,"limit",2);Et([d({type:Boolean})],De.prototype,"disabled",2);De=Et([A("pagination-bar")],De);var jn=Object.defineProperty,qn=Object.getOwnPropertyDescriptor,Oi=(e,t,r,i)=>{for(var s=i>1?void 0:i?qn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&jn(t,r,s),s};let Yt=class extends ${constructor(){super(...arguments),this._toasts=[],this._nextId=1,this._timers=new Map}pushToast(e,t="info",r=2500){const i=this._nextId++;if(this._toasts=[...this._toasts,{id:i,message:e,level:t,duration:r}],r>0){const s=window.setTimeout(()=>this.dismiss(i),r);this._timers.set(i,s)}}dismiss(e){const t=this._timers.get(e);t!==void 0&&(window.clearTimeout(t),this._timers.delete(e)),this._toasts=this._toasts.filter(r=>r.id!==e)}disconnectedCallback(){super.disconnectedCallback();for(const e of this._timers.values())window.clearTimeout(e);this._timers.clear()}render(){return c`
