 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const hi=Symbol.for(""),Bo=e=>{if((e==null?void 0:e.r)===hi)return e==null?void 0:e._$litStatic$},Bt=(e,...t)=>({_$litStatic$:t.reduce((r,i,s)=>r+(o=>{if(o._$litStatic$!==void 0)return o._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${o}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(i)+e[s+1],e[0]),r:hi}),ks=new Map,Ho=e=>(t,...r)=>{const i=r.length;let s,o;const a=[],l=[];let n,h=0,u=!1;for(;h<i;){for(n=t[h];h<i&&(o=r[h],(s=Bo(o))!==void 0);)n+=s+t[++h],u=!0;h!==i&&l.push(o),a.push(n),h++}if(h===i&&a.push(t[i]),u){const b=a.join("$$lit$$");(t=ks.get(b))===void 0&&(a.raw=a,ks.set(b,t=a)),r=l}return e(t,...r)},Ft=Ho(c);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const C=e=>e??w;var O=class extends N{constructor(){super(...arguments),this.formControlController=new ci(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new kt(this,"[default]","prefix","suffix"),this.localize=new Re(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:jr}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){const e=this.isLink(),t=e?Bt`a`:Bt`button`;return Ft`
      <${t}
        part="base"
...
`,Uo=(e="value")=>(t,r)=>{const i=t.constructor,s=i.prototype.attributeChangedCallback;i.prototype.attributeChangedCallback=function(o,a,l){var n;const h=i.getPropertyOptions(e),u=typeof h.attribute=="string"?h.attribute:e;if(o===u){const b=h.converter||Ue,S=(typeof b=="function"?b:(n=b==null?void 0:b.fromAttribute)!=null?n:Ue.fromAttribute)(l,h.type);this[e]!==S&&(this[r]=S)}s.call(this,o,a,l)}},jo=_`
...
`,F=class extends N{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){const e=!!this.href,t=e?Bt`a`:Bt`button`;return Ft`
      <${t}
        part="base"
...
`,K=class _e extends N{constructor(){super(...arguments),this.hasSlotController=new kt(this,"icon","suffix"),this.localize=new Re(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"sl-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var t;(t=this.countdownAnimation)==null||t.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var t;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(t=this.countdownAnimation)==null||t.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:t}=this,r="100%",i="0";this.countdownAnimation=t.animate([{width:r},{width:i}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await We(this.base),this.base.hidden=!1;const{keyframes:t,options:r}=we(this,"alert.show",{dir:this.localize.dir()});await ke(this.base,t,r),this.emit("sl-after-show")}else{bi(this),this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await We(this.base);const{keyframes:t,options:r}=we(this,"alert.hide",{dir:this.localize.dir()});await ke(this.base,t,r),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,Ht(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Ht(this,"sl-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),_e.toastStack.parentElement===null&&document.body.append(_e.toastStack),_e.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{_e.toastStack.removeChild(this),t(),_e.toastStack.querySelector("sl-alert")===null&&_e.toastStack.remove()},{once:!0})})}render(){return c`
  ...
  `;gi([d()],jt.prototype,"active",2);jt=gi([E("activity-bar")],jt);var wa=Object.defineProperty,ka=Object.getOwnPropertyDescriptor,xi=(e,t,r,i)=>{for(var s=i>1?void 0:i?ka(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&wa(t,r,s),s};let Vt=class extends k{constructor(){super(...arguments),this.active="search",this._items=[{id:"search",icon:"🔍",label:"搜索"},{id:"chat",icon:"💬",label:"对话"},{id:"files",icon:"📁",label:"文件"}]}_select(e){this.dispatchEvent(new CustomEvent("navigate",{detail:{view:e},bubbles:!0,composed:!0}))}render(){return c`
      ${this._items.map(e=>c`
        <button
  ...
  `;xi([d()],Vt.prototype,"active",2);Vt=xi([E("tab-bar")],Vt);var $a=Object.defineProperty,Sa=Object.getOwnPropertyDescriptor,qr=(e,t,r,i)=>{for(var s=i>1?void 0:i?Sa(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&$a(t,r,s),s};let mt=class extends k{constructor(){super(...arguments),this.heading="Doclens",this.subheading=""}render(){return c`
  ...
  `;_i([d({attribute:!1})],qt.prototype,"session",2);qt=_i([E("history-item")],qt);var Da=Object.defineProperty,za=Object.getOwnPropertyDescriptor,ie=(e,t,r,i)=>{for(var s=i>1?void 0:i?za(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&Da(t,r,s),s};let j=class extends k{constructor(){super(...arguments),this.value="",this.placeholder="",this.buttonLabel="搜索",this.buttonIcon="",this.multiline=!1,this.disabled=!1,this.mode="keyword",this.modes=null,this._menuOpen=!1,this._onDocClick=()=>{this._menuOpen=!1,document.removeEventListener("click",this._onDocClick)}}focus(){var e;(e=this.inputEl)==null||e.focus()}updated(e){var t;(t=super.updated)==null||t.call(this,e),(e.has("value")||e.has("multiline"))&&this._autoResize()}_autoResize(){const e=this.renderRoot.querySelector("textarea");e&&(e.style.height="auto",e.style.height=`${e.scrollHeight}px`)}get trimmed(){return this.value.trim()}_onInput(e){const t=e.target;this.value=t.value,this.dispatchEvent(new CustomEvent("input-change",{detail:{value:this.value}}));const r=this.renderRoot.querySelector("button");r&&(r.disabled=!this.trimmed||this.disabled),this._autoResize()}_onKeydown(e){e.key==="Enter"&&(e.shiftKey&&this.multiline||(e.preventDefault(),this._submit()))}_submit(){!this.trimmed||this.disabled||this.dispatchEvent(new CustomEvent("submit",{detail:{value:this.trimmed}}))}get _hasModes(){return!!this.modes&&this.mode in this.modes}_toggleMenu(e){e.stopPropagation(),this._menuOpen=!this._menuOpen,this._menuOpen&&document.addEventListener("click",this._onDocClick)}_selectMode(e){this._menuOpen=!1,document.removeEventListener("click",this._onDocClick),this.dispatchEvent(new CustomEvent("mode-change",{detail:{mode:e}}))}_renderButton(){if(!this._hasModes)return c`
...
`,e=e.substring(x.length+1),n=!0),!n){let Y=this.rules.other.nextBulletRegex(m),z=this.rules.other.hrRegex(m),Ot=this.rules.other.fencesBeginRegex(m),ve=this.rules.other.headingBeginRegex(m),ur=this.rules.other.htmlBeginRegex(m),Bi=this.rules.other.blockquoteBeginRegex(m);for(;e;){let hr=e.split(`
`,1)[0],et;if(x=hr,this.options.pedantic?(x=x.replace(this.rules.other.listReplaceNesting,"  "),et=x):et=x.replace(this.rules.other.tabCharGlobal,"    "),Ot.test(x)||ve.test(x)||ur.test(x)||Bi.test(x)||Y.test(x)||z.test(x))break;if(et.search(this.rules.other.nonSpaceChar)>=m||!x.trim())u+=`
`+et.slice(m);else{if(S||b.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||Ot.test(b)||ve.test(b)||z.test(b))break;u+=`
`+x}S=!x.trim(),h+=hr+`
...
`)?"":`
`)+n.raw,u.text+=`
`+n.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=u.text):r.push(n);continue}if(t){this.infiniteLoopError(t.charCodeAt(0));break}}return this.state.top=!0,r}inline(t,r=[]){return this.inlineQueue.push({src:t,tokens:r}),r}inlineTokens(t,r=[]){var h,u,b,x,S;this.tokenizer.lexer=this;let i=t,s=null;if(this.tokens.links){let m=Object.keys(this.tokens.links);if(m.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(i))!==null;)m.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(i=i.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(i))!==null;)i=i.slice(0,s.index)+"++"+i.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let o;for(;(s=this.tokenizer.rules.inline.blockSkip.exec(i))!==null;)o=s[2]?s[2].length:0,i=i.slice(0,s.index+o)+"["+"a".repeat(s[0].length-o-2)+"]"+i.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);i=((u=(h=this.options.hooks)==null?void 0:h.emStrongMask)==null?void 0:u.call({lexer:this},i))??i;let a=!1,l="",n=1/0;for(;t;){if(t.length<n)n=t.length;else{this.infiniteLoopError(t.charCodeAt(0));break}a||(l=""),a=!1;let m;if((x=(b=this.options.extensions)==null?void 0:b.inline)!=null&&x.some(z=>(m=z.call({lexer:this},t,r))?(t=t.substring(m.raw.length),r.push(m),!0):!1))continue;if(m=this.tokenizer.escape(t)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.tag(t)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.link(t)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(m.raw.length);let z=r.at(-1);m.type==="text"&&(z==null?void 0:z.type)==="text"?(z.raw+=m.raw,z.text+=m.text):r.push(m);continue}if(m=this.tokenizer.emStrong(t,i,l)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.codespan(t)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.br(t)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.del(t,i,l)){t=t.substring(m.raw.length),r.push(m);continue}if(m=this.tokenizer.autolink(t)){t=t.substring(m.raw.length),r.push(m);continue}if(!this.state.inLink&&(m=this.tokenizer.url(t))){t=t.substring(m.raw.length),r.push(m);continue}let Y=t;if((S=this.options.extensions)!=null&&S.startInline){let z=1/0,Ot=t.slice(1),ve;this.options.extensions.startInline.forEach(ur=>{ve=ur.call({lexer:this},Ot),typeof ve=="number"&&ve>=0&&(z=Math.min(z,ve))}),z<1/0&&z>=0&&(Y=t.substring(0,z+1))}if(m=this.tokenizer.inlineText(Y)){t=t.substring(m.raw.length),m.raw.slice(-1)!=="_"&&(l=m.raw.slice(-1)),a=!0;let z=r.at(-1);(z==null?void 0:z.type)==="text"?(z.raw+=m.raw,z.text+=m.text):r.push(m);continue}if(t){this.infiniteLoopError(t.charCodeAt(0));break}}return r}infiniteLoopError(t){let r="Infinite loop on byte: "+t;if(this.options.silent)console.error(r);else throw new Error(r)}},Yt=class{constructor(e){D(this,"options");D(this,"parser");this.options=e||Me}space(e){return""}code({text:e,lang:t,escaped:r}){var o;let i=(o=(t||"").match(M.notSpaceStart))==null?void 0:o[0],s=e.replace(M.endingNewline,"")+`
...
Please report this to https://github.com/markedjs/marked.`,e){let i="<p>An error occurred:</p><pre>"+ae(r.message+"",!0)+"</pre>";return t?Promise.resolve(i):i}if(t)return Promise.reject(r);throw r}}},Ae=new yn;function T(e,t){return Ae.parse(e,t)}T.options=T.setOptions=function(e){return Ae.setOptions(e),T.defaults=Ae.defaults,yi(T.defaults),T};T.getDefaults=Xr;T.defaults=Me;T.use=function(...e){return Ae.use(...e),T.defaults=Ae.defaults,yi(T.defaults),T};T.walkTokens=function(e,t){return Ae.walkTokens(e,t)};T.parseInline=Ae.parseInline;T.Parser=ee;T.parser=ee.parse;T.Renderer=Yt;T.TextRenderer=ts;T.Lexer=J;T.lexer=J.lex;T.Tokenizer=Kt;T.Hooks=ct;T.parse=T;T.options;T.setOptions;T.use;T.walkTokens;T.parseInline;ee.parse;J.lex;var wn=Object.defineProperty,kn=Object.getOwnPropertyDescriptor,rs=(e,t,r,i)=>{for(var s=i>1?void 0:i?kn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&wn(t,r,s),s};let vt=class extends k{constructor(){super(...arguments),this.result=null,this.active=!1}_select(){this.result&&this.dispatchEvent(new CustomEvent("select",{detail:{result:this.result},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._select)}disconnectedCallback(){this.removeEventListener("click",this._select),super.disconnectedCallback()}_renderSnippet(){var r;const e=((r=this.result)==null?void 0:r.snippet)??"";if(!e)return null;const t=T.parse(e,{async:!1});return c`<div class="snippet" .innerHTML=${t}></div>`}render(){if(!this.result)return null;const e=Math.round(this.result.score*100);return c`
  ...
  `;rs([d({attribute:!1})],vt.prototype,"result",2);rs([d({type:Boolean,reflect:!0})],vt.prototype,"active",2);vt=rs([E("result-card")],vt);var $n=Object.defineProperty,Sn=Object.getOwnPropertyDescriptor,or=(e,t,r,i)=>{for(var s=i>1?void 0:i?Sn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&$n(t,r,s),s};let Ve=class extends k{constructor(){super(...arguments),this.results=[],this.activeResult=null,this.loading=!1}render(){return c`
      <div class="list-pane">
  ...
  `;or([d({attribute:!1})],Ve.prototype,"results",2);or([d({attribute:!1})],Ve.prototype,"activeResult",2);or([d({type:Boolean})],Ve.prototype,"loading",2);Ve=or([E("search-results")],Ve);var En=Object.defineProperty,Cn=Object.getOwnPropertyDescriptor,Et=(e,t,r,i)=>{for(var s=i>1?void 0:i?Cn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&En(t,r,s),s};let dt="",Dr=0,Gt=0;function lt(e){if(!e)return 0;const t=dt.indexOf(e,Dr);if(t===-1){const i=dt.indexOf(e);return i===-1?0:(dt.slice(0,i).match(/\n/g)??[]).length+1+Gt}const r=(dt.slice(0,t).match(/\n/g)??[]).length+1;return Dr=t+e.length,r+Gt}function Ns(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const Pn={heading(e){const t=this.parser.parseInline(e.tokens),r=lt(e.raw);return`<h${e.depth} data-source-line="${r}">${t}</h${e.depth}>
...
`);i.push({label:t[s].label,md:l,offset:o})}return i}render(){if(An(),!this.content)return c`<div class="empty">无内容</div>`;if(this.pages&&this.pages.length>0){const t=this._splitByPages(this.content,this.pages);return c`<div class="md-body md-body-paged">
        ${t.map(r=>{Gt=r.offset;const i=T.parse(r.md,{async:!1});return c`
            <section class="page-card">
              <header class="page-card-header">${r.label}</header>
              <div .innerHTML=${i}></div>
            </section>
          `})}
      </div>`}Gt=0;const e=T.parse(this.content,{async:!1});return c`<div class="md-body" .innerHTML=${e}></div>`}};Te.styles=_`
    :host {
      display: block;
      padding: 12px 16px;
      font-family: var(--cortex-font);
...
`);return c`
  ...
  `;ar([d({reflect:!0})],qe.prototype,"role",2);ar([d({attribute:!1})],qe.prototype,"message",2);ar([d()],qe.prototype,"error",2);qe=ar([E("chat-message")],qe);var Bn=Object.defineProperty,Hn=Object.getOwnPropertyDescriptor,Ct=(e,t,r,i)=>{for(var s=i>1?void 0:i?Hn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&Bn(t,r,s),s};const Wn={search:"🔍",read_document:"📄",grep:"🔎"},Un={search:"正在搜索",read_document:"正在读取",grep:"正在检索"};function jn(e){const t=[`思考过程（${e.length} 步）`];return e.forEach((r,i)=>{t.push(""),t.push(`[${i+1}] ${r.name}`),Object.keys(r.input).length&&(t.push("参数："),t.push(JSON.stringify(r.input,null,2))),r.output!=null&&r.output!==""?(t.push("结果："),t.push(r.output)):t.push("结果：（无输出）")}),t.join(`
...
`):e.output??"",n=e.output!=null&&e.output!=="";return c`
  ...
  `;Pt([d({type:Number})],De.prototype,"total",2);Pt([d({type:Number})],De.prototype,"offset",2);Pt([d({type:Number})],De.prototype,"limit",2);Pt([d({type:Boolean})],De.prototype,"disabled",2);De=Pt([E("pagination-bar")],De);var Jn=Object.defineProperty,el=Object.getOwnPropertyDescriptor,Mi=(e,t,r,i)=>{for(var s=i>1?void 0:i?el(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&Jn(t,r,s),s};let Jt=class extends k{constructor(){super(...arguments),this._toasts=[],this._nextId=1,this._timers=new Map}pushToast(e,t="info",r=2500){const i=this._nextId++;if(this._toasts=[...this._toasts,{id:i,message:e,level:t,duration:r}],r>0){const s=window.setTimeout(()=>this.dismiss(i),r);this._timers.set(i,s)}}dismiss(e){const t=this._timers.get(e);t!==void 0&&(window.clearTimeout(t),this._timers.delete(e)),this._toasts=this._toasts.filter(r=>r.id!==e)}disconnectedCallback(){super.disconnectedCallback();for(const e of this._timers.values())window.clearTimeout(e);this._timers.clear()}render(){return c`
...
⚠️ ${a.detail}`}),g.setChatState({messages:s})):a.type==="context_compact"?(this._compactToast="上下文已压缩",this._compactTimer&&clearTimeout(this._compactTimer),this._compactTimer=window.setTimeout(()=>{this._compactToast=null},3e3)):a.type!=="done"&&(s=Us(s,a),g.setChatState({messages:s}));const o=s[s.length-1];await Gn(r,[{kind:"message_user",payload:JSON.stringify({content:t})},{kind:"message_ai",payload:JSON.stringify({content:o.content,tool_calls:o.tool_steps??[]})}],s.length),this._loadHistory()}catch(o){s=al(s),g.setChatState({messages:s}),g.setError(`对话失败: ${o.message}`)}finally{g.setChatState({streaming:!1})}}_backToInitial(){g.setChatState({state:"initial",currentSession:null,messages:[]}),this._loadHistory()}async _loadSession(e){g.setChatState({state:"focus",currentSession:e,messages:[]});try{const t=await fetch(`/api/sessions/${e.id}`);if(t.ok){const r=await t.json(),i=nl(r.items||[]);g.setChatState({messages:i})}}catch(t){console.warn("load session failed",t)}}_onHistorySelect(e){this._loadSession(e.detail.session)}render(){var t;const e=this.viewState;return e.state==="initial"?c`
      ...
      <div class="focus-body">
        ...
        ${this._compactToast?c`<div class="compact-toast">${this._compactToast}</div>`:""}
        <div class="input-bar">
          <input-box
            placeholder="继续对话..."
            button-label="→"
...
确定要丢弃吗？`))return;this._discardPreviewEdits()}await this._fetchPreview(e)}async _fetchPreview(e){const t=await Zt(e);t.ok?(this._previewError=null,this._previewPath=t.path,this._previewContent=t.content,this._previewLanguage=t.language,this._previewWritable=t.writable,this._previewPages=t.pages):t.notIndexed?(this._previewError="NOT_INDEXED",this._previewPath=e,this._previewContent="",this._previewWritable=!1,this._previewPages=null):this._showToast(t.message||"预览失败")}async _reloadPreview(){if(!this._previewPath)return;const e=await Zt(this._previewPath);e.ok&&(this._previewContent=e.content,this._previewLanguage=e.language,this._previewWritable=e.writable,this._previewPages=e.pages)}_discardPreviewEdits(){var t,r;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("preview-pane");(r=e==null?void 0:e.discard)==null||r.call(e),this._previewDirty=!1}_renderNotIndexedHint(){return c`<div class="preview-placeholder">
      该文件未索引，无法预览。<br>
