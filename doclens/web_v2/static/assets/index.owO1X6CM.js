var Zo=Object.defineProperty;var Jo=(e,t,r)=>t in e?Zo(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var O=(e,t,r)=>Jo(e,typeof t!="symbol"?t+"":t,r);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function r(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(o){if(o.ep)return;o.ep=!0;const i=r(o);fetch(o.href,i)}})();/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Wt=globalThis,Hr=Wt.ShadowRoot&&(Wt.ShadyCSS===void 0||Wt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ur=Symbol(),hs=new WeakMap;let ro=class{constructor(t,r,s){if(this._$cssResult$=!0,s!==Ur)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=r}get styleSheet(){let t=this.o;const r=this.t;if(Hr&&t===void 0){const s=r!==void 0&&r.length===1;s&&(t=hs.get(r)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&hs.set(r,t))}return t}toString(){return this.cssText}};const Qo=e=>new ro(typeof e=="string"?e:e+"",void 0,Ur),_=(e,...t)=>{const r=e.length===1?e[0]:t.reduce((s,o,i)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+e[i+1],e[0]);return new ro(r,e,Ur)},ei=(e,t)=>{if(Hr)e.adoptedStyleSheets=t.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet);else for(const r of t){const s=document.createElement("style"),o=Wt.litNonce;o!==void 0&&s.setAttribute("nonce",o),s.textContent=r.cssText,e.appendChild(s)}},ps=Hr?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let r="";for(const s of t.cssRules)r+=s.cssText;return Qo(r)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:ti,defineProperty:ri,getOwnPropertyDescriptor:si,getOwnPropertyNames:oi,getOwnPropertySymbols:ii,getPrototypeOf:ai}=Object,be=globalThis,fs=be.trustedTypes,ni=fs?fs.emptyScript:"",gr=be.reactiveElementPolyfillSupport,ft=(e,t)=>e,Ve={toAttribute(e,t){switch(t){case Boolean:e=e?ni:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let r=e;switch(t){case Boolean:r=e!==null;break;case Number:r=e===null?null:Number(e);break;case Object:case Array:try{r=JSON.parse(e)}catch{r=null}}return r}},jr=(e,t)=>!ti(e,t),bs={attribute:!0,type:String,converter:Ve,reflect:!1,useDefault:!1,hasChanged:jr};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),be.litPropertyMetadata??(be.litPropertyMetadata=new WeakMap);let He=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,r=bs){if(r.state&&(r.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((r=Object.create(r)).wrapped=!0),this.elementProperties.set(t,r),!r.noAccessor){const s=Symbol(),o=this.getPropertyDescriptor(t,s,r);o!==void 0&&ri(this.prototype,t,o)}}static getPropertyDescriptor(t,r,s){const{get:o,set:i}=si(this.prototype,t)??{get(){return this[r]},set(a){this[r]=a}};return{get:o,set(a){const l=o==null?void 0:o.call(this);i==null||i.call(this,a),this.requestUpdate(t,l,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??bs}static _$Ei(){if(this.hasOwnProperty(ft("elementProperties")))return;const t=ai(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(ft("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(ft("properties"))){const r=this.properties,s=[...oi(r),...ii(r)];for(const o of s)this.createProperty(o,r[o])}const t=this[Symbol.metadata];if(t!==null){const r=litPropertyMetadata.get(t);if(r!==void 0)for(const[s,o]of r)this.elementProperties.set(s,o)}this._$Eh=new Map;for(const[r,s]of this.elementProperties){const o=this._$Eu(r,s);o!==void 0&&this._$Eh.set(o,r)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const r=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const o of s)r.unshift(ps(o))}else t!==void 0&&r.push(ps(t));return r}static _$Eu(t,r){const s=r.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(r=>this.enableUpdating=r),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(r=>r(this))}addController(t){var r;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((r=t.hostConnected)==null||r.call(t))}removeController(t){var r;(r=this._$EO)==null||r.delete(t)}_$E_(){const t=new Map,r=this.constructor.elementProperties;for(const s of r.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ei(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(r=>{var s;return(s=r.hostConnected)==null?void 0:s.call(r)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(r=>{var s;return(s=r.hostDisconnected)==null?void 0:s.call(r)})}attributeChangedCallback(t,r,s){this._$AK(t,s)}_$ET(t,r){var i;const s=this.constructor.elementProperties.get(t),o=this.constructor._$Eu(t,s);if(o!==void 0&&s.reflect===!0){const a=(((i=s.converter)==null?void 0:i.toAttribute)!==void 0?s.converter:Ve).toAttribute(r,s.type);this._$Em=t,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._$Em=null}}_$AK(t,r){var i,a;const s=this.constructor,o=s._$Eh.get(t);if(o!==void 0&&this._$Em!==o){const l=s.getPropertyOptions(o),n=typeof l.converter=="function"?{fromAttribute:l.converter}:((i=l.converter)==null?void 0:i.fromAttribute)!==void 0?l.converter:Ve;this._$Em=o;const h=n.fromAttribute(r,l.type);this[o]=h??((a=this._$Ej)==null?void 0:a.get(o))??h,this._$Em=null}}requestUpdate(t,r,s,o=!1,i){var a;if(t!==void 0){const l=this.constructor;if(o===!1&&(i=this[t]),s??(s=l.getPropertyOptions(t)),!((s.hasChanged??jr)(i,r)||s.useDefault&&s.reflect&&i===((a=this._$Ej)==null?void 0:a.get(t))&&!this.hasAttribute(l._$Eu(t,s))))return;this.C(t,r,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,r,{useDefault:s,reflect:o,wrapped:i},a){s&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,a??r??this[t]),i!==!0||a!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(r=void 0),this._$AL.set(t,r)),o===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(r){Promise.reject(r)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var s;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[i,a]of this._$Ep)this[i]=a;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[i,a]of o){const{wrapped:l}=a,n=this[i];l!==!0||this._$AL.has(i)||n===void 0||this.C(i,void 0,a,n)}}let t=!1;const r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),(s=this._$EO)==null||s.forEach(o=>{var i;return(i=o.hostUpdate)==null?void 0:i.call(o)}),this.update(r)):this._$EM()}catch(o){throw t=!1,this._$EM(),o}t&&this._$AE(r)}willUpdate(t){}_$AE(t){var r;(r=this._$EO)==null||r.forEach(s=>{var o;return(o=s.hostUpdated)==null?void 0:o.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(r=>this._$ET(r,this[r]))),this._$EM()}updated(t){}firstUpdated(t){}};He.elementStyles=[],He.shadowRootOptions={mode:"open"},He[ft("elementProperties")]=new Map,He[ft("finalized")]=new Map,gr==null||gr({ReactiveElement:He}),(be.reactiveElementVersions??(be.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bt=globalThis,vs=e=>e,jt=bt.trustedTypes,ms=jt?jt.createPolicy("lit-html",{createHTML:e=>e}):void 0,so="$lit$",fe=`lit$${Math.random().toFixed(9).slice(2)}$`,oo="?"+fe,li=`<${oo}>`,Ae=document,mt=()=>Ae.createComment(""),gt=e=>e===null||typeof e!="object"&&typeof e!="function",Vr=Array.isArray,ci=e=>Vr(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",xr=`[ 	
\f\r]`,ot=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,gs=/-->/g,xs=/>/g,_e=RegExp(`>|${xr}(?:([^\\s"'>=/]+)(${xr}*=${xr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),_s=/'/g,ys=/"/g,io=/^(?:script|style|textarea|title)$/i,di=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),c=di(1),se=Symbol.for("lit-noChange"),w=Symbol.for("lit-nothing"),ws=new WeakMap,Ce=Ae.createTreeWalker(Ae,129);function ao(e,t){if(!Vr(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return ms!==void 0?ms.createHTML(t):t}const ui=(e,t)=>{const r=e.length-1,s=[];let o,i=t===2?"<svg>":t===3?"<math>":"",a=ot;for(let l=0;l<r;l++){const n=e[l];let h,u,b=-1,x=0;for(;x<n.length&&(a.lastIndex=x,u=a.exec(n),u!==null);)x=a.lastIndex,a===ot?u[1]==="!--"?a=gs:u[1]!==void 0?a=xs:u[2]!==void 0?(io.test(u[2])&&(o=RegExp("</"+u[2],"g")),a=_e):u[3]!==void 0&&(a=_e):a===_e?u[0]===">"?(a=o??ot,b=-1):u[1]===void 0?b=-2:(b=a.lastIndex-u[2].length,h=u[1],a=u[3]===void 0?_e:u[3]==='"'?ys:_s):a===ys||a===_s?a=_e:a===gs||a===xs?a=ot:(a=_e,o=void 0);const S=a===_e&&e[l+1].startsWith("/>")?" ":"";i+=a===ot?n+li:b>=0?(s.push(h),n.slice(0,b)+so+n.slice(b)+fe+S):n+fe+(b===-2?l:S)}return[ao(e,i+(e[r]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]};class xt{constructor({strings:t,_$litType$:r},s){let o;this.parts=[];let i=0,a=0;const l=t.length-1,n=this.parts,[h,u]=ui(t,r);if(this.el=xt.createElement(h,s),Ce.currentNode=this.el.content,r===2||r===3){const b=this.el.content.firstChild;b.replaceWith(...b.childNodes)}for(;(o=Ce.nextNode())!==null&&n.length<l;){if(o.nodeType===1){if(o.hasAttributes())for(const b of o.getAttributeNames())if(b.endsWith(so)){const x=u[a++],S=o.getAttribute(b).split(fe),g=/([.?@])?(.*)/.exec(x);n.push({type:1,index:i,name:g[2],strings:S,ctor:g[1]==="."?pi:g[1]==="?"?fi:g[1]==="@"?bi:ar}),o.removeAttribute(b)}else b.startsWith(fe)&&(n.push({type:6,index:i}),o.removeAttribute(b));if(io.test(o.tagName)){const b=o.textContent.split(fe),x=b.length-1;if(x>0){o.textContent=jt?jt.emptyScript:"";for(let S=0;S<x;S++)o.append(b[S],mt()),Ce.nextNode(),n.push({type:2,index:++i});o.append(b[x],mt())}}}else if(o.nodeType===8)if(o.data===oo)n.push({type:2,index:i});else{let b=-1;for(;(b=o.data.indexOf(fe,b+1))!==-1;)n.push({type:7,index:i}),b+=fe.length-1}i++}}static createElement(t,r){const s=Ae.createElement("template");return s.innerHTML=t,s}}function qe(e,t,r=e,s){var a,l;if(t===se)return t;let o=s!==void 0?(a=r._$Co)==null?void 0:a[s]:r._$Cl;const i=gt(t)?void 0:t._$litDirective$;return(o==null?void 0:o.constructor)!==i&&((l=o==null?void 0:o._$AO)==null||l.call(o,!1),i===void 0?o=void 0:(o=new i(e),o._$AT(e,r,s)),s!==void 0?(r._$Co??(r._$Co=[]))[s]=o:r._$Cl=o),o!==void 0&&(t=qe(e,o._$AS(e,t.values),o,s)),t}class hi{constructor(t,r){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:r},parts:s}=this._$AD,o=((t==null?void 0:t.creationScope)??Ae).importNode(r,!0);Ce.currentNode=o;let i=Ce.nextNode(),a=0,l=0,n=s[0];for(;n!==void 0;){if(a===n.index){let h;n.type===2?h=new St(i,i.nextSibling,this,t):n.type===1?h=new n.ctor(i,n.name,n.strings,this,t):n.type===6&&(h=new vi(i,this,t)),this._$AV.push(h),n=s[++l]}a!==(n==null?void 0:n.index)&&(i=Ce.nextNode(),a++)}return Ce.currentNode=Ae,o}p(t){let r=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,r),r+=s.strings.length-2):s._$AI(t[r])),r++}}class St{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,r,s,o){this.type=2,this._$AH=w,this._$AN=void 0,this._$AA=t,this._$AB=r,this._$AM=s,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const r=this._$AM;return r!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=r.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,r=this){t=qe(this,t,r),gt(t)?t===w||t==null||t===""?(this._$AH!==w&&this._$AR(),this._$AH=w):t!==this._$AH&&t!==se&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ci(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==w&&gt(this._$AH)?this._$AA.nextSibling.data=t:this.T(Ae.createTextNode(t)),this._$AH=t}$(t){var i;const{values:r,_$litType$:s}=t,o=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=xt.createElement(ao(s.h,s.h[0]),this.options)),s);if(((i=this._$AH)==null?void 0:i._$AD)===o)this._$AH.p(r);else{const a=new hi(o,this),l=a.u(this.options);a.p(r),this.T(l),this._$AH=a}}_$AC(t){let r=ws.get(t.strings);return r===void 0&&ws.set(t.strings,r=new xt(t)),r}k(t){Vr(this._$AH)||(this._$AH=[],this._$AR());const r=this._$AH;let s,o=0;for(const i of t)o===r.length?r.push(s=new St(this.O(mt()),this.O(mt()),this,this.options)):s=r[o],s._$AI(i),o++;o<r.length&&(this._$AR(s&&s._$AB.nextSibling,o),r.length=o)}_$AR(t=this._$AA.nextSibling,r){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,r);t!==this._$AB;){const o=vs(t).nextSibling;vs(t).remove(),t=o}}setConnected(t){var r;this._$AM===void 0&&(this._$Cv=t,(r=this._$AP)==null||r.call(this,t))}}let ar=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,r,s,o,i){this.type=1,this._$AH=w,this._$AN=void 0,this.element=t,this.name=r,this._$AM=o,this.options=i,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=w}_$AI(t,r=this,s,o){const i=this.strings;let a=!1;if(i===void 0)t=qe(this,t,r,0),a=!gt(t)||t!==this._$AH&&t!==se,a&&(this._$AH=t);else{const l=t;let n,h;for(t=i[0],n=0;n<i.length-1;n++)h=qe(this,l[s+n],r,n),h===se&&(h=this._$AH[n]),a||(a=!gt(h)||h!==this._$AH[n]),h===w?t=w:t!==w&&(t+=(h??"")+i[n+1]),this._$AH[n]=h}a&&!o&&this.j(t)}j(t){t===w?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},pi=class extends ar{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===w?void 0:t}},fi=class extends ar{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==w)}},bi=class extends ar{constructor(t,r,s,o,i){super(t,r,s,o,i),this.type=5}_$AI(t,r=this){if((t=qe(this,t,r,0)??w)===se)return;const s=this._$AH,o=t===w&&s!==w||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,i=t!==w&&(s===w||o);o&&this.element.removeEventListener(this.name,this,s),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var r;typeof this._$AH=="function"?this._$AH.call(((r=this.options)==null?void 0:r.host)??this.element,t):this._$AH.handleEvent(t)}},vi=class{constructor(t,r,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=r,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){qe(this,t)}};const _r=bt.litHtmlPolyfillSupport;_r==null||_r(xt,St),(bt.litHtmlVersions??(bt.litHtmlVersions=[])).push("3.3.3");const mi=(e,t,r)=>{const s=(r==null?void 0:r.renderBefore)??t;let o=s._$litPart$;if(o===void 0){const i=(r==null?void 0:r.renderBefore)??null;s._$litPart$=o=new St(t.insertBefore(mt(),i),i,void 0,r??{})}return o._$AI(e),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pe=globalThis;let k=class extends He{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var r;const t=super.createRenderRoot();return(r=this.renderOptions).renderBefore??(r.renderBefore=t.firstChild),t}update(t){const r=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=mi(r,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return se}};var to;k._$litElement$=!0,k.finalized=!0,(to=Pe.litElementHydrateSupport)==null||to.call(Pe,{LitElement:k});const yr=Pe.litElementPolyfillSupport;yr==null||yr({LitElement:k});(Pe.litElementVersions??(Pe.litElementVersions=[])).push("4.2.2");var gi=_`
  :host {
    --track-width: 2px;
...
`,ho=Object.defineProperty,yi=Object.defineProperties,wi=Object.getOwnPropertyDescriptor,ki=Object.getOwnPropertyDescriptors,ks=Object.getOwnPropertySymbols,$i=Object.prototype.hasOwnProperty,Si=Object.prototype.propertyIsEnumerable,wr=(e,t)=>(t=Symbol[e])?t:Symbol.for("Symbol."+e),Kr=e=>{throw TypeError(e)},$s=(e,t,r)=>t in e?ho(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Fe=(e,t)=>{for(var r in t||(t={}))$i.call(t,r)&&$s(e,r,t[r]);if(ks)for(var r of ks(t))Si.call(t,r)&&$s(e,r,t[r]);return e},Yr=(e,t)=>yi(e,ki(t)),p=(e,t,r,s)=>{for(var o=s>1?void 0:s?wi(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&ho(t,r,o),o},po=(e,t,r)=>t.has(e)||Kr("Cannot "+r),Ei=(e,t,r)=>(po(e,t,"read from private field"),t.get(e)),Ci=(e,t,r)=>t.has(e)?Kr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),Pi=(e,t,r,s)=>(po(e,t,"write to private field"),t.set(e,r),r),Ai=function(e,t){this[0]=e,this[1]=t},Ti=e=>{var t=e[wr("asyncIterator")],r=!1,s,o={};return t==null?(t=e[wr("iterator")](),s=i=>o[i]=a=>t[i](a)):(t=t.call(e),s=i=>o[i]=a=>{if(r){if(r=!1,i==="throw")throw a;return a}return r=!0,{done:!1,value:new Ai(new Promise(l=>{var n=t[i](a);n instanceof Object||Kr("Object expected"),l(n)}),1)}}),o[wr("iterator")]=()=>o,s("next"),"throw"in t?s("throw"):o.throw=i=>{throw i},"return"in t&&s("return"),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Et=class{constructor(e,...t){this.slotNames=[],this.handleSlotChange=r=>{const s=r.target;(this.slotNames.includes("[default]")&&!s.name||s.name&&this.slotNames.includes(s.name))&&this.host.requestUpdate()},(this.host=e).addController(this),this.slotNames=t}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!=="")return!0;if(e.nodeType===e.ELEMENT_NODE){const t=e;if(t.tagName.toLowerCase()==="sl-visually-hidden")return!1;if(!t.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}},Tr="";function Ss(e){Tr=e}function Li(e=""){if(!Tr){const t=[...document.getElementsByTagName("script")],r=t.find(s=>s.hasAttribute("data-shoelace"));if(r)Ss(r.getAttribute("data-shoelace"));else{const s=t.find(i=>/shoelace(\.min)?\.js($|\?)/.test(i.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(i.src));let o="";s&&(o=s.getAttribute("src")),Ss(o.split("/").slice(0,-1).join("/"))}}return Tr.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}var Mi={name:"default",resolver:e=>Li(`assets/icons/${e}.svg`)},Fi=Mi,Es={caret:`
  ...
  `},Ni={name:"system",resolver:e=>e in Es?`data:image/svg+xml,${encodeURIComponent(Es[e])}`:""},Wi=Ni,Bi=[Fi,Wi],Dr=[];function Hi(e){Dr.push(e)}function Ui(e){Dr=Dr.filter(t=>t!==e)}function Cs(e){return Bi.find(t=>t.name===e)}var ji=_`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Vi=(e,t)=>(e==null?void 0:e._$litType$)!==void 0,qi=e=>e.strings===void 0,Xi={},Ki=(e,t=Xi)=>e._$AH=t;var lt=Symbol(),Mt=Symbol(),$r,Sr=new Map,Q=class extends B{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var r;let s;if(t!=null&&t.spriteSheet)return this.svg=c`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,this.svg;try{if(s=await fetch(e,{mode:"cors"}),!s.ok)return s.status===410?lt:Mt}catch{return Mt}try{const o=document.createElement("div");o.innerHTML=await s.text();const i=o.firstElementChild;if(((r=i==null?void 0:i.tagName)==null?void 0:r.toLowerCase())!=="svg")return lt;$r||($r=new DOMParser);const l=$r.parseFromString(i.outerHTML,"text/html").body.querySelector("svg");return l?(l.part.add("svg"),document.adoptNode(l)):lt}catch{return lt}}connectedCallback(){super.connectedCallback(),Hi(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),Ui(this)}getIconSource(){const e=Cs(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;const{url:t,fromLibrary:r}=this.getIconSource(),s=r?Cs(this.library):void 0;if(!t){this.svg=null;return}let o=Sr.get(t);if(o||(o=this.resolveIcon(t,s),Sr.set(t,o)),!this.initialRender)return;const i=await o;if(i===Mt&&Sr.delete(t),t===this.getIconSource().url){if(Vi(i)){if(this.svg=i,s){await this.updateComplete;const a=this.shadowRoot.querySelector("[part='svg']");typeof s.mutator=="function"&&a&&s.mutator(a)}return}switch(i){case Mt:case lt:this.svg=null,this.emit("sl-error");break;default:this.svg=i.cloneNode(!0),(e=s==null?void 0:s.mutator)==null||e.call(s,this.svg),this.emit("sl-load")}}}render(){return this.svg}};Q.styles=[oe,ji];p([v()],Q.prototype,"svg",2);p([d({reflect:!0})],Q.prototype,"name",2);p([d()],Q.prototype,"src",2);p([d()],Q.prototype,"label",2);p([d({reflect:!0})],Q.prototype,"library",2);p([H("label")],Q.prototype,"handleLabelChange",1);p([H(["name","src","library"])],Q.prototype,"setIcon",1);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ye={ATTRIBUTE:1,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},vo=e=>(...t)=>({_$litDirective$:e,values:t});let mo=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,s){this._$Ct=t,this._$AM=r,this._$Ci=s}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const J=vo(class extends mo{constructor(e){var t;if(super(e),e.type!==ye.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var s,o;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!((s=this.nt)!=null&&s.has(i))&&this.st.add(i);return this.render(t)}const r=e.element.classList;for(const i of this.st)i in t||(r.remove(i),this.st.delete(i));for(const i in t){const a=!!t[i];a===this.st.has(i)||(o=this.nt)!=null&&o.has(i)||(a?(r.add(i),this.st.add(i)):(r.remove(i),this.st.delete(i)))}return se}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const go=Symbol.for(""),Yi=e=>{if((e==null?void 0:e.r)===go)return e==null?void 0:e._$litStatic$},Vt=(e,...t)=>({_$litStatic$:t.reduce((r,s,o)=>r+(i=>{if(i._$litStatic$!==void 0)return i._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${i}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(s)+e[o+1],e[0]),r:go}),Ps=new Map,Gi=e=>(t,...r)=>{const s=r.length;let o,i;const a=[],l=[];let n,h=0,u=!1;for(;h<s;){for(n=t[h];h<s&&(i=r[h],(o=Yi(i))!==void 0);)n+=o+t[++h],u=!0;h!==s&&l.push(i),a.push(n),h++}if(h===s&&a.push(t[s]),u){const b=a.join("$$lit$$");(t=Ps.get(b))===void 0&&(a.raw=a,Ps.set(b,t=a)),r=l}return e(t,...r)},Ht=Gi(c);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const C=e=>e??w;var D=class extends B{constructor(){super(...arguments),this.formControlController=new bo(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new Et(this,"[default]","prefix","suffix"),this.localize=new Me(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Gr}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){const e=this.isLink(),t=e?Vt`a`:Vt`button`;return Ht`
    ...
    `}};D.styles=[oe,Ii];D.dependencies={"sl-icon":Q,"sl-spinner":fo};p([V(".button")],D.prototype,"button",2);p([v()],D.prototype,"hasFocus",2);p([v()],D.prototype,"invalid",2);p([d()],D.prototype,"title",2);p([d({reflect:!0})],D.prototype,"variant",2);p([d({reflect:!0})],D.prototype,"size",2);p([d({type:Boolean,reflect:!0})],D.prototype,"caret",2);p([d({type:Boolean,reflect:!0})],D.prototype,"disabled",2);p([d({type:Boolean,reflect:!0})],D.prototype,"loading",2);p([d({type:Boolean,reflect:!0})],D.prototype,"outline",2);p([d({type:Boolean,reflect:!0})],D.prototype,"pill",2);p([d({type:Boolean,reflect:!0})],D.prototype,"circle",2);p([d()],D.prototype,"type",2);p([d()],D.prototype,"name",2);p([d()],D.prototype,"value",2);p([d()],D.prototype,"href",2);p([d()],D.prototype,"target",2);p([d()],D.prototype,"rel",2);p([d()],D.prototype,"download",2);p([d()],D.prototype,"form",2);p([d({attribute:"formaction"})],D.prototype,"formAction",2);p([d({attribute:"formenctype"})],D.prototype,"formEnctype",2);p([d({attribute:"formmethod"})],D.prototype,"formMethod",2);p([d({attribute:"formnovalidate",type:Boolean})],D.prototype,"formNoValidate",2);p([d({attribute:"formtarget"})],D.prototype,"formTarget",2);p([H("disabled",{waitUntilFirstUpdate:!0})],D.prototype,"handleDisabledChange",1);D.define("sl-button");Q.define("sl-icon");var Zi=_`
  :host {
    display: block;
  }
...
`,Ji=(e="value")=>(t,r)=>{const s=t.constructor,o=s.prototype.attributeChangedCallback;s.prototype.attributeChangedCallback=function(i,a,l){var n;const h=s.getPropertyOptions(e),u=typeof h.attribute=="string"?h.attribute:e;if(i===u){const b=h.converter||Ve,S=(typeof b=="function"?b:(n=b==null?void 0:b.fromAttribute)!=null?n:Ve.fromAttribute)(l,h.type);this[e]!==S&&(this[r]=S)}o.call(this,i,a,l)}},Qi=_`
...
`,xo=class extends B{constructor(){super(...arguments),this.hasSlotController=new Et(this,"footer","header","image")}render(){return c`
    ...
    `}};xo.styles=[oe,ta];xo.define("sl-card");var ra=_`
  :host {
    display: inline-block;
  }
...
`,W=class extends B{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){const e=!!this.href,t=e?Vt`a`:Vt`button`;return Ht`
    ...
    `}};W.styles=[oe,sa];W.dependencies={"sl-icon":Q};p([V(".icon-button")],W.prototype,"button",2);p([v()],W.prototype,"hasFocus",2);p([d()],W.prototype,"name",2);p([d()],W.prototype,"library",2);p([d()],W.prototype,"src",2);p([d()],W.prototype,"href",2);p([d()],W.prototype,"target",2);p([d()],W.prototype,"download",2);p([d()],W.prototype,"label",2);p([d({type:Boolean,reflect:!0})],W.prototype,"disabled",2);var oa=0,ie=class extends B{constructor(){super(...arguments),this.localize=new Me(this),this.attrId=++oa,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("sl-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,c`
      <div
        part="base"
    ...
    `}};ie.styles=[oe,ra];ie.dependencies={"sl-icon-button":W};p([V(".tab")],ie.prototype,"tab",2);p([d({reflect:!0})],ie.prototype,"panel",2);p([d({type:Boolean,reflect:!0})],ie.prototype,"active",2);p([d({type:Boolean,reflect:!0})],ie.prototype,"closable",2);p([d({type:Boolean,reflect:!0})],ie.prototype,"disabled",2);p([d({type:Number,reflect:!0})],ie.prototype,"tabIndex",2);p([H("active")],ie.prototype,"handleActiveChange",1);p([H("disabled")],ie.prototype,"handleDisabledChange",1);ie.define("sl-tab");var ia=_`
  :host {
    --indicator-color: var(--sl-color-primary-600);
...
`,nr=class extends B{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit("sl-resize",{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){const e=this.shadowRoot.querySelector("slot");if(e!==null){const t=e.assignedElements({flatten:!0});this.observedElements.forEach(r=>this.resizeObserver.unobserve(r)),this.observedElements=[],t.forEach(r=>{this.resizeObserver.observe(r),this.observedElements.push(r)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return c` <slot @slotchange=${this.handleSlotChange}></slot> `}};nr.styles=[oe,aa];p([d({type:Boolean,reflect:!0})],nr.prototype,"disabled",2);p([H("disabled",{waitUntilFirstUpdate:!0})],nr.prototype,"handleDisabledChange",1);function na(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}var Or=new Set;function la(){const e=document.documentElement.clientWidth;return Math.abs(window.innerWidth-e)}function ca(){const e=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(e)||!e?0:e}function Er(e){if(Or.add(e),!document.documentElement.classList.contains("sl-scroll-lock")){const t=la()+ca();let r=getComputedStyle(document.documentElement).scrollbarGutter;(!r||r==="auto")&&(r="stable"),t<2&&(r=""),document.documentElement.style.setProperty("--sl-scroll-lock-gutter",r),document.documentElement.classList.add("sl-scroll-lock"),document.documentElement.style.setProperty("--sl-scroll-lock-size",`${t}px`)}}function Cr(e){Or.delete(e),Or.size===0&&(document.documentElement.classList.remove("sl-scroll-lock"),document.documentElement.style.removeProperty("--sl-scroll-lock-size"))}function As(e,t,r="vertical",s="smooth"){const o=na(e,t),i=o.top+t.scrollTop,a=o.left+t.scrollLeft,l=t.scrollLeft,n=t.scrollLeft+t.offsetWidth,h=t.scrollTop,u=t.scrollTop+t.offsetHeight;(r==="horizontal"||r==="both")&&(a<l?t.scrollTo({left:a,behavior:s}):a+e.clientWidth>n&&t.scrollTo({left:a-t.offsetWidth+e.clientWidth,behavior:s})),(r==="vertical"||r==="both")&&(i<h?t.scrollTo({top:i,behavior:s}):i+e.clientHeight>u&&t.scrollTo({top:i-t.offsetHeight+e.clientHeight,behavior:s}))}var M=class extends B{constructor(){super(...arguments),this.tabs=[],this.focusableTabs=[],this.panels=[],this.localize=new Me(this),this.hasScrollControls=!1,this.shouldHideScrollStartButton=!1,this.shouldHideScrollEndButton=!1,this.placement="top",this.activation="auto",this.noScrollControls=!1,this.fixedScrollControls=!1,this.scrollOffset=1}connectedCallback(){const e=Promise.all([customElements.whenDefined("sl-tab"),customElements.whenDefined("sl-tab-panel")]);super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.repositionIndicator(),this.updateScrollControls()}),this.mutationObserver=new MutationObserver(t=>{const r=t.filter(({target:s})=>{if(s===this)return!0;if(s.closest("sl-tab-group")!==this)return!1;const o=s.tagName.toLowerCase();return o==="sl-tab"||o==="sl-tab-panel"});if(r.length!==0){if(r.some(s=>!["aria-labelledby","aria-controls"].includes(s.attributeName))&&setTimeout(()=>this.setAriaLabels()),r.some(s=>s.attributeName==="disabled"))this.syncTabsAndPanels();else if(r.some(s=>s.attributeName==="active")){const o=r.filter(i=>i.attributeName==="active"&&i.target.tagName.toLowerCase()==="sl-tab").map(i=>i.target).find(i=>i.active);o&&this.setActiveTab(o)}}}),this.updateComplete.then(()=>{this.syncTabsAndPanels(),this.mutationObserver.observe(this,{attributes:!0,attributeFilter:["active","disabled","name","panel"],childList:!0,subtree:!0}),this.resizeObserver.observe(this.nav),e.then(()=>{new IntersectionObserver((r,s)=>{var o;r[0].intersectionRatio>0&&(this.setAriaLabels(),this.setActiveTab((o=this.getActiveTab())!=null?o:this.tabs[0],{emitEvents:!1}),s.unobserve(r[0].target))}).observe(this.tabGroup)})})}disconnectedCallback(){var e,t;super.disconnectedCallback(),(e=this.mutationObserver)==null||e.disconnect(),this.nav&&((t=this.resizeObserver)==null||t.unobserve(this.nav))}getAllTabs(){return this.shadowRoot.querySelector('slot[name="nav"]').assignedElements()}getAllPanels(){return[...this.body.assignedElements()].filter(e=>e.tagName.toLowerCase()==="sl-tab-panel")}getActiveTab(){return this.tabs.find(e=>e.active)}handleClick(e){const r=e.target.closest("sl-tab");(r==null?void 0:r.closest("sl-tab-group"))===this&&r!==null&&this.setActiveTab(r,{scrollBehavior:"smooth"})}handleKeyDown(e){const r=e.target.closest("sl-tab");if((r==null?void 0:r.closest("sl-tab-group"))===this&&(["Enter"," "].includes(e.key)&&r!==null&&(this.setActiveTab(r,{scrollBehavior:"smooth"}),e.preventDefault()),["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key))){const o=this.tabs.find(l=>l.matches(":focus")),i=this.localize.dir()==="rtl";let a=null;if((o==null?void 0:o.tagName.toLowerCase())==="sl-tab"){if(e.key==="Home")a=this.focusableTabs[0];else if(e.key==="End")a=this.focusableTabs[this.focusableTabs.length-1];else if(["top","bottom"].includes(this.placement)&&e.key===(i?"ArrowRight":"ArrowLeft")||["start","end"].includes(this.placement)&&e.key==="ArrowUp"){const l=this.tabs.findIndex(n=>n===o);a=this.findNextFocusableTab(l,"backward")}else if(["top","bottom"].includes(this.placement)&&e.key===(i?"ArrowLeft":"ArrowRight")||["start","end"].includes(this.placement)&&e.key==="ArrowDown"){const l=this.tabs.findIndex(n=>n===o);a=this.findNextFocusableTab(l,"forward")}if(!a)return;a.tabIndex=0,a.focus({preventScroll:!0}),this.activation==="auto"?this.setActiveTab(a,{scrollBehavior:"smooth"}):this.tabs.forEach(l=>{l.tabIndex=l===a?0:-1}),["top","bottom"].includes(this.placement)&&As(a,this.nav,"horizontal"),e.preventDefault()}}}handleScrollToStart(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft+this.nav.clientWidth:this.nav.scrollLeft-this.nav.clientWidth,behavior:"smooth"})}handleScrollToEnd(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft-this.nav.clientWidth:this.nav.scrollLeft+this.nav.clientWidth,behavior:"smooth"})}setActiveTab(e,t){if(t=Fe({emitEvents:!0,scrollBehavior:"auto"},t),e!==this.activeTab&&!e.disabled){const r=this.activeTab;this.activeTab=e,this.tabs.forEach(s=>{s.active=s===this.activeTab,s.tabIndex=s===this.activeTab?0:-1}),this.panels.forEach(s=>{var o;return s.active=s.name===((o=this.activeTab)==null?void 0:o.panel)}),this.syncIndicator(),["top","bottom"].includes(this.placement)&&As(this.activeTab,this.nav,"horizontal",t.scrollBehavior),t.emitEvents&&(r&&this.emit("sl-tab-hide",{detail:{name:r.panel}}),this.emit("sl-tab-show",{detail:{name:this.activeTab.panel}}))}}setAriaLabels(){this.tabs.forEach(e=>{const t=this.panels.find(r=>r.name===e.panel);t&&(e.setAttribute("aria-controls",t.getAttribute("id")),t.setAttribute("aria-labelledby",e.getAttribute("id")))})}repositionIndicator(){const e=this.getActiveTab();if(!e)return;const t=e.clientWidth,r=e.clientHeight,s=this.localize.dir()==="rtl",o=this.getAllTabs(),a=o.slice(0,o.indexOf(e)).reduce((l,n)=>({left:l.left+n.clientWidth,top:l.top+n.clientHeight}),{left:0,top:0});switch(this.placement){case"top":case"bottom":this.indicator.style.width=`${t}px`,this.indicator.style.height="auto",this.indicator.style.translate=s?`${-1*a.left}px`:`${a.left}px`;break;case"start":case"end":this.indicator.style.width="auto",this.indicator.style.height=`${r}px`,this.indicator.style.translate=`0 ${a.top}px`;break}}syncTabsAndPanels(){this.tabs=this.getAllTabs(),this.focusableTabs=this.tabs.filter(e=>!e.disabled),this.panels=this.getAllPanels(),this.syncIndicator(),this.updateComplete.then(()=>this.updateScrollControls())}findNextFocusableTab(e,t){let r=null;const s=t==="forward"?1:-1;let o=e+s;for(;e<this.tabs.length;){if(r=this.tabs[o]||null,r===null){t==="forward"?r=this.focusableTabs[0]:r=this.focusableTabs[this.focusableTabs.length-1];break}if(!r.disabled)break;o+=s}return r}updateScrollButtons(){this.hasScrollControls&&!this.fixedScrollControls&&(this.shouldHideScrollStartButton=this.scrollFromStart()<=this.scrollOffset,this.shouldHideScrollEndButton=this.isScrolledToEnd())}isScrolledToEnd(){return this.scrollFromStart()+this.nav.clientWidth>=this.nav.scrollWidth-this.scrollOffset}scrollFromStart(){return this.localize.dir()==="rtl"?-this.nav.scrollLeft:this.nav.scrollLeft}updateScrollControls(){this.noScrollControls?this.hasScrollControls=!1:this.hasScrollControls=["top","bottom"].includes(this.placement)&&this.nav.scrollWidth>this.nav.clientWidth+1,this.updateScrollButtons()}syncIndicator(){this.getActiveTab()?(this.indicator.style.display="block",this.repositionIndicator()):this.indicator.style.display="none"}show(e){const t=this.tabs.find(r=>r.panel===e);t&&this.setActiveTab(t,{scrollBehavior:"smooth"})}render(){const e=this.localize.dir()==="rtl";return c`
    ...
    `}};M.styles=[oe,ia];M.dependencies={"sl-icon-button":W,"sl-resize-observer":nr};p([V(".tab-group")],M.prototype,"tabGroup",2);p([V(".tab-group__body")],M.prototype,"body",2);p([V(".tab-group__nav")],M.prototype,"nav",2);p([V(".tab-group__indicator")],M.prototype,"indicator",2);p([v()],M.prototype,"hasScrollControls",2);p([v()],M.prototype,"shouldHideScrollStartButton",2);p([v()],M.prototype,"shouldHideScrollEndButton",2);p([d()],M.prototype,"placement",2);p([d()],M.prototype,"activation",2);p([d({attribute:"no-scroll-controls",type:Boolean})],M.prototype,"noScrollControls",2);p([d({attribute:"fixed-scroll-controls",type:Boolean})],M.prototype,"fixedScrollControls",2);p([zi({passive:!0})],M.prototype,"updateScrollButtons",1);p([H("noScrollControls",{waitUntilFirstUpdate:!0})],M.prototype,"updateScrollControls",1);p([H("placement",{waitUntilFirstUpdate:!0})],M.prototype,"syncIndicator",1);M.define("sl-tab-group");var da=(e,t)=>{let r=0;return function(...s){window.clearTimeout(r),r=window.setTimeout(()=>{e.call(this,...s)},t)}},Ts=(e,t,r)=>{const s=e[t];e[t]=function(...o){s.call(this,...o),r.call(this,s,...o)}};(()=>{if(typeof window>"u")return;if(!("onscrollend"in window)){const t=new Set,r=new WeakMap,s=i=>{for(const a of i.changedTouches)t.add(a.identifier)},o=i=>{for(const a of i.changedTouches)t.delete(a.identifier)};document.addEventListener("touchstart",s,!0),document.addEventListener("touchend",o,!0),document.addEventListener("touchcancel",o,!0),Ts(EventTarget.prototype,"addEventListener",function(i,a){if(a!=="scrollend")return;const l=da(()=>{t.size?l():this.dispatchEvent(new Event("scrollend"))},100);i.call(this,"scroll",l,{passive:!0}),r.set(this,l)}),Ts(EventTarget.prototype,"removeEventListener",function(i,a){if(a!=="scrollend")return;const l=r.get(this);l&&i.call(this,"scroll",l,{passive:!0})})}})();var ua=_`
  :host {
    --size: 25rem;
...
`;function*Zr(e=document.activeElement){e!=null&&(yield e,"shadowRoot"in e&&e.shadowRoot&&e.shadowRoot.mode!=="closed"&&(yield*Ti(Zr(e.shadowRoot.activeElement))))}function ha(){return[...Zr()].pop()}var Ds=new WeakMap;function _o(e){let t=Ds.get(e);return t||(t=window.getComputedStyle(e,null),Ds.set(e,t)),t}function pa(e){if(typeof e.checkVisibility=="function")return e.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const t=_o(e);return t.visibility!=="hidden"&&t.display!=="none"}function fa(e){const t=_o(e),{overflowY:r,overflowX:s}=t;return r==="scroll"||s==="scroll"?!0:r!=="auto"||s!=="auto"?!1:e.scrollHeight>e.clientHeight&&r==="auto"||e.scrollWidth>e.clientWidth&&s==="auto"}function ba(e){const t=e.tagName.toLowerCase(),r=Number(e.getAttribute("tabindex"));if(e.hasAttribute("tabindex")&&(isNaN(r)||r<=-1)||e.hasAttribute("disabled")||e.closest("[inert]"))return!1;if(t==="input"&&e.getAttribute("type")==="radio"){const i=e.getRootNode(),a=`input[type='radio'][name="${e.getAttribute("name")}"]`,l=i.querySelector(`${a}:checked`);return l?l===e:i.querySelector(a)===e}return pa(e)?(t==="audio"||t==="video")&&e.hasAttribute("controls")||e.hasAttribute("tabindex")||e.hasAttribute("contenteditable")&&e.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(t)?!0:fa(e):!1}function va(e,t){var r;return((r=e.getRootNode({composed:!0}))==null?void 0:r.host)!==t}function Os(e){const t=new WeakMap,r=[];function s(o){if(o instanceof Element){if(o.hasAttribute("inert")||o.closest("[inert]")||t.has(o))return;t.set(o,!0),!r.includes(o)&&ba(o)&&r.push(o),o instanceof HTMLSlotElement&&va(o,e)&&o.assignedElements({flatten:!0}).forEach(i=>{s(i)}),o.shadowRoot!==null&&o.shadowRoot.mode==="open"&&s(o.shadowRoot)}for(const i of o.children)s(i)}return s(e),r.sort((o,i)=>{const a=Number(o.getAttribute("tabindex"))||0;return(Number(i.getAttribute("tabindex"))||0)-a})}var ct=[],ma=class{constructor(e){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{var r;if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const s=ha();if(this.previousFocus=s,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const o=Os(this.element);let i=o.findIndex(l=>l===s);this.previousFocus=this.currentFocus;const a=this.tabDirection==="forward"?1:-1;for(;;){i+a>=o.length?i=0:i+a<0?i=o.length-1:i+=a,this.previousFocus=this.currentFocus;const l=o[i];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||l&&this.possiblyHasTabbableChildren(l))return;t.preventDefault(),this.currentFocus=l,(r=this.currentFocus)==null||r.focus({preventScroll:!1});const n=[...Zr()];if(n.includes(this.currentFocus)||!n.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){ct.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){ct=ct.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return ct[ct.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=Os(this.element);if(!this.element.matches(":focus-within")){const t=e[0],r=e[e.length-1],s=this.tabDirection==="forward"?t:r;typeof(s==null?void 0:s.focus)=="function"&&(this.currentFocus=s,s.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}},yo=e=>{var t;const{activeElement:r}=document;r&&e.contains(r)&&((t=document.activeElement)==null||t.blur())},wo=new Map,ga=new WeakMap;function xa(e){return e??{keyframes:[],options:{duration:0}}}function zs(e,t){return t.toLowerCase()==="rtl"?{keyframes:e.rtlKeyframes||e.keyframes,options:e.options}:e}function K(e,t){wo.set(e,xa(t))}function $e(e,t,r){const s=ga.get(e);if(s!=null&&s[t])return zs(s[t],r.dir);const o=wo.get(t);return o?zs(o,r.dir):{keyframes:[],options:{duration:0}}}function qt(e,t){return new Promise(r=>{function s(o){o.target===e&&(e.removeEventListener(t,s),r())}e.addEventListener(t,s)})}function Se(e,t,r){return new Promise(s=>{if((r==null?void 0:r.duration)===1/0)throw new Error("Promise-based animations must be finite.");const o=e.animate(t,Yr(Fe({},r),{duration:_a()?0:r.duration}));o.addEventListener("cancel",s,{once:!0}),o.addEventListener("finish",s,{once:!0})})}function _a(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function je(e){return Promise.all(e.getAnimations().map(t=>new Promise(r=>{t.cancel(),requestAnimationFrame(r)})))}function Rs(e){return e.charAt(0).toUpperCase()+e.slice(1)}var Y=class extends B{constructor(){super(...arguments),this.hasSlotController=new Et(this,"footer"),this.localize=new Me(this),this.modal=new ma(this),this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=e=>{this.contained||e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopImmediatePropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),Er(this)))}disconnectedCallback(){super.disconnectedCallback(),Cr(this),this.removeOpenListeners()}requestClose(e){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const r=$e(this,"drawer.denyClose",{dir:this.localize.dir()});Se(this.panel,r.keyframes,r.options);return}this.hide()}addOpenListeners(){var e;"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var e;document.removeEventListener("keydown",this.handleDocumentKeyDown),(e=this.closeWatcher)==null||e.destroy()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),Er(this));const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([je(this.drawer),je(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=$e(this,`drawer.show${Rs(this.placement)}`,{dir:this.localize.dir()}),r=$e(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([Se(this.panel,t.keyframes,t.options),Se(this.overlay,r.keyframes,r.options)]),this.emit("sl-after-show")}else{yo(this),this.emit("sl-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),Cr(this)),await Promise.all([je(this.drawer),je(this.overlay)]);const e=$e(this,`drawer.hide${Rs(this.placement)}`,{dir:this.localize.dir()}),t=$e(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([Se(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),Se(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;const r=this.originalTrigger;typeof(r==null?void 0:r.focus)=="function"&&setTimeout(()=>r.focus()),this.emit("sl-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),Er(this)),this.open&&this.contained&&(this.modal.deactivate(),Cr(this))}async show(){if(!this.open)return this.open=!0,qt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,qt(this,"sl-after-hide")}render(){return c`
      <div
        part="base"
...
`,G=class we extends B{constructor(){super(...arguments),this.hasSlotController=new Et(this,"icon","suffix"),this.localize=new Me(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"sl-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var t;(t=this.countdownAnimation)==null||t.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var t;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(t=this.countdownAnimation)==null||t.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:t}=this,r="100%",s="0";this.countdownAnimation=t.animate([{width:r},{width:s}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await je(this.base),this.base.hidden=!1;const{keyframes:t,options:r}=$e(this,"alert.show",{dir:this.localize.dir()});await Se(this.base,t,r),this.emit("sl-after-show")}else{yo(this),this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await je(this.base);const{keyframes:t,options:r}=$e(this,"alert.hide",{dir:this.localize.dir()});await Se(this.base,t,r),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,qt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,qt(this,"sl-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),we.toastStack.parentElement===null&&document.body.append(we.toastStack),we.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{we.toastStack.removeChild(this),t(),we.toastStack.querySelector("sl-alert")===null&&we.toastStack.remove()},{once:!0})})}render(){return c`
    ...
    :host {
      ...
      /* slate-200 淡灰底（比 main slate-1 深一档做区隔，同色系相容）+ 极淡点阵纹路 */
    ...
    button:hover { background: var(--cortex-surface); color: var(--cortex-text); box-shadow: var(--cortex-shadow-sm); }
    button.active { background: var(--cortex-surface); color: var(--cortex-text); box-shadow: var(--cortex-shadow-md); }
  `;$o([d()],Yt.prototype,"active",2);Yt=$o([E("activity-bar")],Yt);var Da=Object.defineProperty,Oa=Object.getOwnPropertyDescriptor,So=(e,t,r,s)=>{for(var o=s>1?void 0:s?Oa(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Da(t,r,o),o};let Gt=class extends k{constructor(){super(...arguments),this.active="search",this._items=[{id:"search",icon:"🔍",label:"搜索"},{id:"chat",icon:"💬",label:"对话"},{id:"files",icon:"📁",label:"文件"}]}_select(e){this.dispatchEvent(new CustomEvent("navigate",{detail:{view:e},bubbles:!0,composed:!0}))}render(){return c`
      ${this._items.map(e=>c`
        <button
    ...
    :host {
      ...
      box-shadow: var(--cortex-shadow-md-up);
    ...
    .tab:hover { background: var(--cortex-surface-muted); color: var(--cortex-text); }
  ...
  `;So([d()],Gt.prototype,"active",2);Gt=So([E("tab-bar")],Gt);function za(e){if(e==null)return null;const t=Date.now()/1e3-e;return t<60?"刚刚":t<3600?`${Math.floor(t/60)} 分钟前`:t<86400?`${Math.floor(t/3600)} 小时前`:t<604800?`${Math.floor(t/86400)} 天前`:new Date(e*1e3).toISOString().slice(0,10).replace(/-/g,"/")}function Ra(e,t=2){if(!e)return{text:"—",title:e};const r=e.split(/[/\\]+/).filter(o=>o.length>0);return r.length<=t?{text:r.join("/"),title:e}:{text:`…/${r.slice(-t).join("/")}`,title:e}}var Ia=Object.defineProperty,La=Object.getOwnPropertyDescriptor,lr=(e,t,r,s)=>{for(var o=s>1?void 0:s?La(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Ia(t,r,o),o};let Xe=class extends k{constructor(){super(...arguments),this.heading="Doclens",this.subheading="",this.suffix=""}connectedCallback(){super.connectedCallback(),this._unsub=f.subscribe(()=>this.requestUpdate())}disconnectedCallback(){var e;(e=this._unsub)==null||e.call(this),super.disconnectedCallback()}_monitorText(e){if(!e)return"—";let t;e.reindexing?t="⟳ 更新中":e.running&&e.changed_count>0?t=`● 监控 · 待更新 ${e.changed_count}`:e.running?t="● 监控中":t="○ 未启用";const r=za(e.last_reindex_at);return r?`${t} · 🕒 ${r}`:t}_renderStatus(e,t){const r=e?Ra(e.search_path):{text:"—",title:""},s=e?`📁 ${r.text}  ·  👁 ${this._monitorText(t)}  ·  📄 ${e.indexed_docs}`:"—";return c`
      <div class="status-area">
        <div class="status-row">
          <span class="status-value" data-kind="line1" title=${r.title}>${s}</span>
        </div>
      </div>
    `}render(){const{status:e,watcher:t}=f.getState();return c`
      <h1 class="title">
    ...
    :host {
      display: block;
      padding: var(--cortex-space-6) var(--cortex-space-4) var(--cortex-space-3);
      text-align: center;
  ...
  `;lr([d()],Xe.prototype,"heading",2);lr([d()],Xe.prototype,"subheading",2);lr([d()],Xe.prototype,"suffix",2);Xe=lr([E("welcome-pane")],Xe);var Ma=Object.defineProperty,Fa=Object.getOwnPropertyDescriptor,et=(e,t,r,s)=>{for(var o=s>1?void 0:s?Fa(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Ma(t,r,o),o};let ve=class extends k{constructor(){super(...arguments),this.backLabel="返回",this.title="",this.meta="",this.actions=[],this._menuOpen=!1,this._onDocClick=e=>{if(!this._menuOpen)return;e.composedPath().includes(this)||(this._menuOpen=!1)}}_back(){this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}_onMoreClick(e){e.stopPropagation(),this._menuOpen=!this._menuOpen}_onItemClick(e){e.disabled||(this._menuOpen=!1,e.onClick())}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick)}disconnectedCallback(){document.removeEventListener("click",this._onDocClick),super.disconnectedCallback()}render(){return c`
  ...
  `;et([d()],ve.prototype,"backLabel",2);et([d()],ve.prototype,"title",2);et([d()],ve.prototype,"meta",2);et([d({attribute:!1})],ve.prototype,"actions",2);et([v()],ve.prototype,"_menuOpen",2);ve=et([E("focus-header")],ve);var Na=Object.defineProperty,Wa=Object.getOwnPropertyDescriptor,Ct=(e,t,r,s)=>{for(var o=s>1?void 0:s?Wa(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Na(t,r,o),o};let Te=class extends k{constructor(){super(...arguments),this.title="历史会话",this.sessions=[],this.clearing=!1}_onClear(){this.clearing||this.dispatchEvent(new CustomEvent("clear",{bubbles:!0,composed:!0}))}render(){const e=this.sessions.length>0;return c`
      <div class="header">
        <div class="title">${this.title}</div>
        ${e?c`
          <button
    ...
    :host {
      ...
      /* 融入父 .hero-card（卡片外观由 hero-card 提供），这里只给底色 + 内边距 */
      background: var(--cortex-surface);
  ...
  `;Ct([d()],Te.prototype,"title",2);Ct([d({attribute:!1})],Te.prototype,"sessions",2);Ct([d()],Te.prototype,"type",2);Ct([d({type:Boolean})],Te.prototype,"clearing",2);Te=Ct([E("history-list")],Te);var Ba=Object.defineProperty,Ha=Object.getOwnPropertyDescriptor,Eo=(e,t,r,s)=>{for(var o=s>1?void 0:s?Ha(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Ba(t,r,o),o};let Zt=class extends k{constructor(){super(...arguments),this.session=null}_select(){this.session&&this.dispatchEvent(new CustomEvent("select",{detail:{session:this.session},bubbles:!0,composed:!0}))}render(){if(!this.session)return null;const e=[];return this.session.type==="chat"&&e.push(String(this.session.message_count)),e.push(new Date(this.session.updated_at).toLocaleDateString()),c`
      <div class="name">
  ...
  `;Eo([d({attribute:!1})],Zt.prototype,"session",2);Zt=Eo([E("history-item")],Zt);var Ua=Object.defineProperty,ja=Object.getOwnPropertyDescriptor,ae=(e,t,r,s)=>{for(var o=s>1?void 0:s?ja(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Ua(t,r,o),o};let q=class extends k{constructor(){super(...arguments),this.value="",this.placeholder="",this.buttonLabel="搜索",this.buttonIcon="",this.multiline=!1,this.disabled=!1,this.mode="keyword",this.modes=null,this._menuOpen=!1,this._onDocClick=()=>{this._menuOpen=!1,document.removeEventListener("click",this._onDocClick)}}focus(){var e;(e=this.inputEl)==null||e.focus()}updated(e){var t;(t=super.updated)==null||t.call(this,e),(e.has("value")||e.has("multiline"))&&this._autoResize()}_autoResize(){const e=this.renderRoot.querySelector("textarea");e&&(e.style.height="auto",e.style.height=`${e.scrollHeight}px`)}get trimmed(){return this.value.trim()}_onInput(e){const t=e.target;this.value=t.value,this.dispatchEvent(new CustomEvent("input-change",{detail:{value:this.value}}));const r=this.renderRoot.querySelector("button");r&&(r.disabled=!this.trimmed||this.disabled),this._autoResize()}_onKeydown(e){e.key==="Enter"&&(e.shiftKey&&this.multiline||(e.preventDefault(),this._submit()))}_submit(){!this.trimmed||this.disabled||this.dispatchEvent(new CustomEvent("submit",{detail:{value:this.trimmed}}))}get _hasModes(){return!!this.modes&&this.mode in this.modes}_toggleMenu(e){e.stopPropagation(),this._menuOpen=!this._menuOpen,this._menuOpen&&document.addEventListener("click",this._onDocClick)}_selectMode(e){this._menuOpen=!1,document.removeEventListener("click",this._onDocClick),this.dispatchEvent(new CustomEvent("mode-change",{detail:{mode:e}}))}_renderButton(){if(!this._hasModes)return c`
    ...
    .caret:hover:not(:disabled) { background: var(--cortex-surface-muted); }
  ...
  `;ae([d()],q.prototype,"value",2);ae([d()],q.prototype,"placeholder",2);ae([d()],q.prototype,"buttonLabel",2);ae([d()],q.prototype,"buttonIcon",2);ae([d({type:Boolean})],q.prototype,"multiline",2);ae([d({type:Boolean})],q.prototype,"disabled",2);ae([d()],q.prototype,"mode",2);ae([d({attribute:!1})],q.prototype,"modes",2);ae([v()],q.prototype,"_menuOpen",2);ae([V("input, textarea")],q.prototype,"inputEl",2);q=ae([E("input-box")],q);function Jr(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Ne=Jr();function Co(e){Ne=e}var Ee={exec:()=>null};function Be(e){let t=[];return r=>{let s=Math.max(0,Math.min(3,r-1)),o=t[s];return o||(o=e(s),t[s]=o),o}}function A(e,t=""){let r=typeof e=="string"?e:e.source,s={replace:(o,i)=>{let a=typeof i=="string"?i:i.source;return a=a.replace(N.caret,"$1"),r=r.replace(o,a),s},getRegex:()=>new RegExp(r,t)};return s}var Va=((e="")=>{try{return!!new RegExp("(?<=1)(?<!1)"+e)}catch{return!1}})(),N={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>new RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:Be(e=>new RegExp(`^ {0,${e}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`)),hrRegex:Be(e=>new RegExp(`^ {0,${e}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`)),fencesBeginRegex:Be(e=>new RegExp(`^ {0,${e}}(?:\`\`\`|~~~)`)),headingBeginRegex:Be(e=>new RegExp(`^ {0,${e}}#`)),htmlBeginRegex:Be(e=>new RegExp(`^ {0,${e}}<(?:[a-z].*>|!--)`,"i")),blockquoteBeginRegex:Be(e=>new RegExp(`^ {0,${e}}>`))},qa=/^(?:[ \t]*(?:\n|$))+/,Xa=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Ka=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Pt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Ya=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Qr=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,Po=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Ao=A(Po).replace(/bull/g,Qr).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Ga=A(Po).replace(/bull/g,Qr).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),es=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Za=/^[^\n]+/,ts=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Ja=A(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",ts).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Qa=A(/^(bull)([ \t][^\n]*?)?(?:\n|$)/).replace(/bull/g,Qr).getRegex(),cr="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",rs=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,en=A("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",rs).replace("tag",cr).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),To=A(es).replace("hr",Pt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]+[^ \\t\\n]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",cr).getRegex(),tn=A(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",To).getRegex(),ss={blockquote:tn,code:Xa,def:Ja,fences:Ka,heading:Ya,hr:Pt,html:en,lheading:Ao,list:Qa,newline:qa,paragraph:To,table:Ee,text:Za},Ms=A("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Pt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",cr).getRegex(),rn={...ss,lheading:Ga,table:Ms,paragraph:A(es).replace("hr",Pt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Ms).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]+[^ \\t\\n]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",cr).getRegex()},sn={...ss,html:A(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",rs).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ee,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:A(es).replace("hr",Pt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Ao).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},on=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,an=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Do=/^( {2,}|\\)\n(?!\s*$)/,nn=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,tt=/[\p{P}\p{S}]/u,dr=/[\s\p{P}\p{S}]/u,os=/[^\s\p{P}\p{S}]/u,ln=A(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,dr).getRegex(),Oo=/(?!~)[\p{P}\p{S}]/u,cn=/(?!~)[\s\p{P}\p{S}]/u,dn=/(?:[^\s\p{P}\p{S}]|~)/u,un=A(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Va?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),zo=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,hn=A(zo,"u").replace(/punct/g,tt).getRegex(),pn=A(zo,"u").replace(/punct/g,Oo).getRegex(),Ro="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",fn=A(Ro,"gu").replace(/notPunctSpace/g,os).replace(/punctSpace/g,dr).replace(/punct/g,tt).getRegex(),bn=A(Ro,"gu").replace(/notPunctSpace/g,dn).replace(/punctSpace/g,cn).replace(/punct/g,Oo).getRegex(),vn=A("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,os).replace(/punctSpace/g,dr).replace(/punct/g,tt).getRegex(),mn=A(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,tt).getRegex(),gn="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",xn=A(gn,"gu").replace(/notPunctSpace/g,os).replace(/punctSpace/g,dr).replace(/punct/g,tt).getRegex(),_n=A(/\\(punct)/,"gu").replace(/punct/g,tt).getRegex(),yn=A(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),wn=A(rs).replace("(?:-->|$)","-->").getRegex(),kn=A("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",wn).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Jt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,$n=A(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",Jt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Io=A(/^!?\[(label)\]\[(ref)\]/).replace("label",Jt).replace("ref",ts).getRegex(),Lo=A(/^!?\[(ref)\](?:\[\])?/).replace("ref",ts).getRegex(),Sn=A("reflink|nolink(?!\\()","g").replace("reflink",Io).replace("nolink",Lo).getRegex(),Fs=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,is={_backpedal:Ee,anyPunctuation:_n,autolink:yn,blockSkip:un,br:Do,code:an,del:Ee,delLDelim:Ee,delRDelim:Ee,emStrongLDelim:hn,emStrongRDelimAst:fn,emStrongRDelimUnd:vn,escape:on,link:$n,nolink:Lo,punctuation:ln,reflink:Io,reflinkSearch:Sn,tag:kn,text:nn,url:Ee},En={...is,link:A(/^!?\[(label)\]\((.*?)\)/).replace("label",Jt).getRegex(),reflink:A(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Jt).getRegex()},Rr={...is,emStrongRDelimAst:bn,emStrongLDelim:pn,delLDelim:mn,delRDelim:xn,url:A(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Fs).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:A(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Fs).getRegex()},Cn={...Rr,br:A(Do).replace("{2,}","*").getRegex(),text:A(Rr.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Ft={normal:ss,gfm:rn,pedantic:sn},dt={normal:is,gfm:Rr,breaks:Cn,pedantic:En},Pn={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ns=e=>Pn[e];function le(e,t){if(t){if(N.escapeTest.test(e))return e.replace(N.escapeReplace,Ns)}else if(N.escapeTestNoEncode.test(e))return e.replace(N.escapeReplaceNoEncode,Ns);return e}function Ws(e){try{e=encodeURI(e).replace(N.percentDecode,"%")}catch{return null}return e}function Bs(e,t){var i;let r=e.replace(N.findPipe,(a,l,n)=>{let h=!1,u=l;for(;--u>=0&&n[u]==="\\";)h=!h;return h?"|":" |"}),s=r.split(N.splitPipe),o=0;if(s[0].trim()||s.shift(),s.length>0&&!((i=s.at(-1))!=null&&i.trim())&&s.pop(),t)if(s.length>t)s.splice(t);else for(;s.length<t;)s.push("");for(;o<s.length;o++)s[o]=s[o].trim().replace(N.slashPipe,"|");return s}function ue(e,t,r){let s=e.length;if(s===0)return"";let o=0;for(;o<s&&e.charAt(s-o-1)===t;)o++;return e.slice(0,s-o)}function Hs(e){let t=e.split(`
`),r=t.length-1;for(;r>=0&&N.blankLine.test(t[r]);)r--;return t.length-r<=2?e:t.slice(0,r+1).join(`
`)}function An(e,t){if(e.indexOf(t[1])===-1)return-1;let r=0;for(let s=0;s<e.length;s++)if(e[s]==="\\")s++;else if(e[s]===t[0])r++;else if(e[s]===t[1]&&(r--,r<0))return s;return r>0?-2:-1}function Tn(e,t=0){let r=t,s="";for(let o of e)if(o==="	"){let i=4-r%4;s+=" ".repeat(i),r+=i}else s+=o,r++;return s}function Us(e,t,r,s,o){let i=t.href,a=t.title||null,l=e[1].replace(o.other.outputLinkReplace,"$1");s.state.inLink=!0;let n={type:e[0].charAt(0)==="!"?"image":"link",raw:r,href:i,title:a,text:l,tokens:s.inlineTokens(l)};return s.state.inLink=!1,n}function Dn(e,t,r){let s=e.match(r.other.indentCodeCompensation);if(s===null)return t;let o=s[1];return t.split(`
`).map(i=>{let a=i.match(r.other.beginningSpace);if(a===null)return i;let[l]=a;return l.length>=o.length?i.slice(o.length):i}).join(`
`)}var Qt=class{constructor(e){O(this,"options");O(this,"rules");O(this,"lexer");this.options=e||Ne}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let r=this.options.pedantic?t[0]:Hs(t[0]),s=r.replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:r,codeBlockStyle:"indented",text:s}}}fences(e){let t=this.rules.block.fences.exec(e);if(t){let r=t[0],s=Dn(r,t[3]||"",this.rules);return{type:"code",raw:r,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:s}}}heading(e){let t=this.rules.block.heading.exec(e);if(t){let r=t[2].trim();if(this.rules.other.endingHash.test(r)){let s=ue(r,"#");(this.options.pedantic||!s||this.rules.other.endingSpaceChar.test(s))&&(r=s.trim())}return{type:"heading",raw:ue(t[0],`
...
`,e=e.substring(x.length+1),n=!0),!n){let I=this.rules.other.nextBulletRegex(g),R=this.rules.other.hrRegex(g),It=this.rules.other.fencesBeginRegex(g),xe=this.rules.other.headingBeginRegex(g),vr=this.rules.other.htmlBeginRegex(g),Go=this.rules.other.blockquoteBeginRegex(g);for(;e;){let mr=e.split(`
`,1)[0],st;if(x=mr,this.options.pedantic?(x=x.replace(this.rules.other.listReplaceNesting,"  "),st=x):st=x.replace(this.rules.other.tabCharGlobal,"    "),It.test(x)||xe.test(x)||vr.test(x)||Go.test(x)||I.test(x)||R.test(x))break;if(st.search(this.rules.other.nonSpaceChar)>=g||!x.trim())u+=`
`+st.slice(g);else{if(S||b.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||It.test(b)||xe.test(b)||R.test(b))break;u+=`
`+x}S=!x.trim(),h+=mr+`
`,e=e.substring(mr.length+1),b=st.slice(g)}}o.loose||(a?o.loose=!0:this.rules.other.doubleBlankLine.test(h)&&(a=!0)),o.items.push({type:"list_item",raw:h,task:!!this.options.gfm&&this.rules.other.listIsTask.test(u),loose:!1,text:u,tokens:[]}),o.raw+=h}let l=o.items.at(-1);if(l)l.raw=l.raw.trimEnd(),l.text=l.text.trimEnd();else return;o.raw=o.raw.trimEnd();for(let n of o.items){this.lexer.state.top=!1,n.tokens=this.lexer.blockTokens(n.text,[]);let h=n.tokens[0];if(n.task&&((h==null?void 0:h.type)==="text"||(h==null?void 0:h.type)==="paragraph")){n.text=n.text.replace(this.rules.other.listReplaceTask,""),h.raw=h.raw.replace(this.rules.other.listReplaceTask,""),h.text=h.text.replace(this.rules.other.listReplaceTask,"");for(let b=this.lexer.inlineQueue.length-1;b>=0;b--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[b].src)){this.lexer.inlineQueue[b].src=this.lexer.inlineQueue[b].src.replace(this.rules.other.listReplaceTask,"");break}let u=this.rules.other.listTaskCheckbox.exec(n.raw);if(u){let b={type:"checkbox",raw:u[0]+" ",checked:u[0]!=="[ ]"};n.checked=b.checked,o.loose?n.tokens[0]&&["paragraph","text"].includes(n.tokens[0].type)&&"tokens"in n.tokens[0]&&n.tokens[0].tokens?(n.tokens[0].raw=b.raw+n.tokens[0].raw,n.tokens[0].text=b.raw+n.tokens[0].text,n.tokens[0].tokens.unshift(b)):n.tokens.unshift({type:"paragraph",raw:b.raw,text:b.raw,tokens:[b]}):n.tokens.unshift(b)}}else n.task&&(n.task=!1);if(!o.loose){let u=n.tokens.filter(x=>x.type==="space"),b=u.length>0&&u.some(x=>this.rules.other.anyLine.test(x.raw));o.loose=b}}if(o.loose)for(let n of o.items){n.loose=!0;for(let h of n.tokens)h.type==="text"&&(h.type="paragraph")}return o}}html(e){let t=this.rules.block.html.exec(e);if(t){let r=Hs(t[0]);return{type:"html",block:!0,raw:r,pre:t[1]==="pre"||t[1]==="script"||t[1]==="style",text:r}}}def(e){let t=this.rules.block.def.exec(e);if(t){let r=t[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),s=t[2]?t[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",o=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):t[3];return{type:"def",tag:r,raw:ue(t[0],`
`),href:s,title:o}}}table(e){var a;let t=this.rules.block.table.exec(e);if(!t||!this.rules.other.tableDelimiter.test(t[2]))return;let r=Bs(t[1]),s=t[2].replace(this.rules.other.tableAlignChars,"").split("|"),o=(a=t[3])!=null&&a.trim()?t[3].replace(this.rules.other.tableRowBlankLine,"").split(`
`):[],i={type:"table",raw:ue(t[0],`
`),header:[],align:[],rows:[]};if(r.length===s.length){for(let l of s)this.rules.other.tableAlignRight.test(l)?i.align.push("right"):this.rules.other.tableAlignCenter.test(l)?i.align.push("center"):this.rules.other.tableAlignLeft.test(l)?i.align.push("left"):i.align.push(null);for(let l=0;l<r.length;l++)i.header.push({text:r[l],tokens:this.lexer.inline(r[l]),header:!0,align:i.align[l]});for(let l of o)i.rows.push(Bs(l,i.header.length).map((n,h)=>({text:n,tokens:this.lexer.inline(n),header:!1,align:i.align[h]})));return i}}lheading(e){let t=this.rules.block.lheading.exec(e);if(t){let r=t[1].trim();return{type:"heading",raw:ue(t[0],`
...
`}strong({tokens:e}){return`<strong>${this.parser.parseInline(e)}</strong>`}em({tokens:e}){return`<em>${this.parser.parseInline(e)}</em>`}codespan({text:e}){return`<code>${le(e,!0)}</code>`}br(e){return"<br>"}del({tokens:e}){return`<del>${this.parser.parseInline(e)}</del>`}link({href:e,title:t,tokens:r}){let s=this.parser.parseInline(r),o=Ws(e);if(o===null)return s;e=o;let i='<a href="'+e+'"';return t&&(i+=' title="'+le(t)+'"'),i+=">"+s+"</a>",i}image({href:e,title:t,text:r,tokens:s}){s&&(r=this.parser.parseInline(s,this.parser.textRenderer));let o=Ws(e);if(o===null)return le(r);e=o;let i=`<img src="${e}" alt="${le(r)}"`;return t&&(i+=` title="${le(t)}"`),i+=">",i}text(e){return"tokens"in e&&e.tokens?this.parser.parseInline(e.tokens):"escaped"in e&&e.escaped?e.text:le(e.text)}},as=class{strong({text:e}){return e}em({text:e}){return e}codespan({text:e}){return e}del({text:e}){return e}html({text:e}){return e}text({text:e}){return e}link({text:e}){return""+e}image({text:e}){return""+e}br(){return""}checkbox({raw:e}){return e}},re=class Lr{constructor(t){O(this,"options");O(this,"renderer");O(this,"textRenderer");this.options=t||Ne,this.options.renderer=this.options.renderer||new er,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new as}static parse(t,r){return new Lr(r).parse(t)}static parseInline(t,r){return new Lr(r).parseInline(t)}parse(t){var s,o;this.renderer.parser=this;let r="";for(let i=0;i<t.length;i++){let a=t[i];if((o=(s=this.options.extensions)==null?void 0:s.renderers)!=null&&o[a.type]){let n=a,h=this.options.extensions.renderers[n.type].call({parser:this},n);if(h!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(n.type)){r+=h||"";continue}}let l=a;switch(l.type){case"space":{r+=this.renderer.space(l);break}case"hr":{r+=this.renderer.hr(l);break}case"heading":{r+=this.renderer.heading(l);break}case"code":{r+=this.renderer.code(l);break}case"table":{r+=this.renderer.table(l);break}case"blockquote":{r+=this.renderer.blockquote(l);break}case"list":{r+=this.renderer.list(l);break}case"checkbox":{r+=this.renderer.checkbox(l);break}case"html":{r+=this.renderer.html(l);break}case"def":{r+=this.renderer.def(l);break}case"paragraph":{r+=this.renderer.paragraph(l);break}case"text":{r+=this.renderer.text(l);break}default:{let n='Token with "'+l.type+'" type was not found.';if(this.options.silent)return console.error(n),"";throw new Error(n)}}}return r}parseInline(t,r=this.renderer){var o,i;this.renderer.parser=this;let s="";for(let a=0;a<t.length;a++){let l=t[a];if((i=(o=this.options.extensions)==null?void 0:o.renderers)!=null&&i[l.type]){let h=this.options.extensions.renderers[l.type].call({parser:this},l);if(h!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(l.type)){s+=h||"";continue}}let n=l;switch(n.type){case"escape":{s+=r.text(n);break}case"html":{s+=r.html(n);break}case"link":{s+=r.link(n);break}case"image":{s+=r.image(n);break}case"checkbox":{s+=r.checkbox(n);break}case"strong":{s+=r.strong(n);break}case"em":{s+=r.em(n);break}case"codespan":{s+=r.codespan(n);break}case"br":{s+=r.br(n);break}case"del":{s+=r.del(n);break}case"text":{s+=r.text(n);break}default:{let h='Token with "'+n.type+'" type was not found.';if(this.options.silent)return console.error(h),"";throw new Error(h)}}}return s}},Nt,ht=(Nt=class{constructor(e){O(this,"options");O(this,"block");this.options=e||Ne}preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}emStrongMask(e){return e}provideLexer(e=this.block){return e?te.lex:te.lexInline}provideParser(e=this.block){return e?re.parse:re.parseInline}},O(Nt,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens","emStrongMask"])),O(Nt,"passThroughHooksRespectAsync",new Set(["preprocess","postprocess","processAllTokens"])),Nt),On=class{constructor(...e){O(this,"defaults",Jr());O(this,"options",this.setOptions);O(this,"parse",this.parseMarkdown(!0));O(this,"parseInline",this.parseMarkdown(!1));O(this,"Parser",re);O(this,"Renderer",er);O(this,"TextRenderer",as);O(this,"Lexer",te);O(this,"Tokenizer",Qt);O(this,"Hooks",ht);this.use(...e)}walkTokens(e,t){var s,o;let r=[];for(let i of e)switch(r=r.concat(t.call(this,i)),i.type){case"table":{let a=i;for(let l of a.header)r=r.concat(this.walkTokens(l.tokens,t));for(let l of a.rows)for(let n of l)r=r.concat(this.walkTokens(n.tokens,t));break}case"list":{let a=i;r=r.concat(this.walkTokens(a.items,t));break}default:{let a=i;(o=(s=this.defaults.extensions)==null?void 0:s.childTokens)!=null&&o[a.type]?this.defaults.extensions.childTokens[a.type].forEach(l=>{let n=a[l].flat(1/0);r=r.concat(this.walkTokens(n,t))}):a.tokens&&(r=r.concat(this.walkTokens(a.tokens,t)))}}return r}use(...e){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(r=>{let s={...r};if(s.async=this.defaults.async||s.async||!1,r.extensions&&(r.extensions.forEach(o=>{if(!o.name)throw new Error("extension name required");if("renderer"in o){let i=t.renderers[o.name];i?t.renderers[o.name]=function(...a){let l=o.renderer.apply(this,a);return l===!1&&(l=i.apply(this,a)),l}:t.renderers[o.name]=o.renderer}if("tokenizer"in o){if(!o.level||o.level!=="block"&&o.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let i=t[o.level];i?i.unshift(o.tokenizer):t[o.level]=[o.tokenizer],o.start&&(o.level==="block"?t.startBlock?t.startBlock.push(o.start):t.startBlock=[o.start]:o.level==="inline"&&(t.startInline?t.startInline.push(o.start):t.startInline=[o.start]))}"childTokens"in o&&o.childTokens&&(t.childTokens[o.name]=o.childTokens)}),s.extensions=t),r.renderer){let o=this.defaults.renderer||new er(this.defaults);for(let i in r.renderer){if(!(i in o))throw new Error(`renderer '${i}' does not exist`);if(["options","parser"].includes(i))continue;let a=i,l=r.renderer[a],n=o[a];o[a]=(...h)=>{let u=l.apply(o,h);return u===!1&&(u=n.apply(o,h)),u||""}}s.renderer=o}if(r.tokenizer){let o=this.defaults.tokenizer||new Qt(this.defaults);for(let i in r.tokenizer){if(!(i in o))throw new Error(`tokenizer '${i}' does not exist`);if(["options","rules","lexer"].includes(i))continue;let a=i,l=r.tokenizer[a],n=o[a];o[a]=(...h)=>{let u=l.apply(o,h);return u===!1&&(u=n.apply(o,h)),u}}s.tokenizer=o}if(r.hooks){let o=this.defaults.hooks||new ht;for(let i in r.hooks){if(!(i in o))throw new Error(`hook '${i}' does not exist`);if(["options","block"].includes(i))continue;let a=i,l=r.hooks[a],n=o[a];ht.passThroughHooks.has(i)?o[a]=h=>{if(this.defaults.async&&ht.passThroughHooksRespectAsync.has(i))return(async()=>{let b=await l.call(o,h);return n.call(o,b)})();let u=l.call(o,h);return n.call(o,u)}:o[a]=(...h)=>{if(this.defaults.async)return(async()=>{let b=await l.apply(o,h);return b===!1&&(b=await n.apply(o,h)),b})();let u=l.apply(o,h);return u===!1&&(u=n.apply(o,h)),u}}s.hooks=o}if(r.walkTokens){let o=this.defaults.walkTokens,i=r.walkTokens;s.walkTokens=function(a){let l=[];return l.push(i.call(this,a)),o&&(l=l.concat(o.call(this,a))),l}}this.defaults={...this.defaults,...s}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return te.lex(e,t??this.defaults)}parser(e,t){return re.parse(e,t??this.defaults)}parseMarkdown(e){return(t,r)=>{let s={...r},o={...this.defaults,...s},i=this.onError(!!o.silent,!!o.async);if(this.defaults.async===!0&&s.async===!1)return i(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof t>"u"||t===null)return i(new Error("marked(): input parameter is undefined or null"));if(typeof t!="string")return i(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(t)+", string expected"));if(o.hooks&&(o.hooks.options=o,o.hooks.block=e),o.async)return(async()=>{let a=o.hooks?await o.hooks.preprocess(t):t,l=await(o.hooks?await o.hooks.provideLexer(e):e?te.lex:te.lexInline)(a,o),n=o.hooks?await o.hooks.processAllTokens(l):l;o.walkTokens&&await Promise.all(this.walkTokens(n,o.walkTokens));let h=await(o.hooks?await o.hooks.provideParser(e):e?re.parse:re.parseInline)(n,o);return o.hooks?await o.hooks.postprocess(h):h})().catch(i);try{o.hooks&&(t=o.hooks.preprocess(t));let a=(o.hooks?o.hooks.provideLexer(e):e?te.lex:te.lexInline)(t,o);o.hooks&&(a=o.hooks.processAllTokens(a)),o.walkTokens&&this.walkTokens(a,o.walkTokens);let l=(o.hooks?o.hooks.provideParser(e):e?re.parse:re.parseInline)(a,o);return o.hooks&&(l=o.hooks.postprocess(l)),l}catch(a){return i(a)}}}onError(e,t){return r=>{if(r.message+=`
Please report this to https://github.com/markedjs/marked.`,e){let s="<p>An error occurred:</p><pre>"+le(r.message+"",!0)+"</pre>";return t?Promise.resolve(s):s}if(t)return Promise.reject(r);throw r}}},De=new On;function T(e,t){return De.parse(e,t)}T.options=T.setOptions=function(e){return De.setOptions(e),T.defaults=De.defaults,Co(T.defaults),T};T.getDefaults=Jr;T.defaults=Ne;T.use=function(...e){return De.use(...e),T.defaults=De.defaults,Co(T.defaults),T};T.walkTokens=function(e,t){return De.walkTokens(e,t)};T.parseInline=De.parseInline;T.Parser=re;T.parser=re.parse;T.Renderer=er;T.TextRenderer=as;T.Lexer=te;T.lexer=te.lex;T.Tokenizer=Qt;T.Hooks=ht;T.parse=T;T.options;T.setOptions;T.use;T.walkTokens;T.parseInline;re.parse;te.lex;var zn=Object.defineProperty,Rn=Object.getOwnPropertyDescriptor,ns=(e,t,r,s)=>{for(var o=s>1?void 0:s?Rn(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&zn(t,r,o),o};let _t=class extends k{constructor(){super(...arguments),this.result=null,this.active=!1}_select(){this.result&&this.dispatchEvent(new CustomEvent("select",{detail:{result:this.result},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._select)}disconnectedCallback(){this.removeEventListener("click",this._select),super.disconnectedCallback()}_renderSnippet(){var r;const e=((r=this.result)==null?void 0:r.snippet)??"";if(!e)return null;const t=T.parse(e,{async:!1});return c`<div class="snippet" .innerHTML=${t}></div>`}render(){if(!this.result)return null;const e=Math.round(this.result.score*100);return c`
      <div class="path">
  ...
  `;ns([d({attribute:!1})],_t.prototype,"result",2);ns([d({type:Boolean,reflect:!0})],_t.prototype,"active",2);_t=ns([E("result-card")],_t);var In=Object.defineProperty,Ln=Object.getOwnPropertyDescriptor,ur=(e,t,r,s)=>{for(var o=s>1?void 0:s?Ln(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&In(t,r,o),o};let Ke=class extends k{constructor(){super(...arguments),this.results=[],this.activeResult=null,this.loading=!1}render(){return c`
      <div class="list-pane">
  ...
  `;ur([d({attribute:!1})],Ke.prototype,"results",2);ur([d({attribute:!1})],Ke.prototype,"activeResult",2);ur([d({type:Boolean})],Ke.prototype,"loading",2);Ke=ur([E("search-results")],Ke);var Mn=Object.defineProperty,Fn=Object.getOwnPropertyDescriptor,At=(e,t,r,s)=>{for(var o=s>1?void 0:s?Fn(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Mn(t,r,o),o};let pt="",Mr=0,tr=0;function ut(e){if(!e)return 0;const t=pt.indexOf(e,Mr);if(t===-1){const s=pt.indexOf(e);return s===-1?0:(pt.slice(0,s).match(/\n/g)??[]).length+1+tr}const r=(pt.slice(0,t).match(/\n/g)??[]).length+1;return Mr=t+e.length,r+tr}function rr(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const Mo={heading(e){const t=this.parser.parseInline(e.tokens),r=ut(e.raw);return`<h${e.depth} data-source-line="${r}">${t}</h${e.depth}>
...
`);s.push({label:t[o].label,md:l,offset:i})}return s}render(){if(Nn(),!this.content)return c`<div class="empty">无内容</div>`;if(this.pages&&this.pages.length>0){const t=this._splitByPages(this.content,this.pages);return c`<div class="md-body md-body-paged">
  ...
  `;We([d()],de.prototype,"path",2);We([d()],de.prototype,"originalContent",2);We([d({type:Boolean})],de.prototype,"mobile",2);We([v()],de.prototype,"_text",2);We([v()],de.prototype,"_dirty",2);We([v()],de.prototype,"_error",2);de=We([E("md-editor")],de);class Fo extends Error{constructor(t,r,s){super(r),this.code=t,this.status=s,this.name="PreviewSaveError"}}async function Hn(e,t){const r=await fetch(`/api/preview?path=${encodeURIComponent(e)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({content:t})});if(!r.ok){const s=await r.json().catch(()=>({code:"UNKNOWN",detail:r.statusText}));throw new Fo(s.code??"UNKNOWN",s.detail??"保存失败",r.status)}return r.json()}class No extends Error{constructor(t,r,s){super(r),this.code=t,this.status=s,this.name="PreviewUploadError"}}async function Un(e){const t=new FormData;t.append("file",e);const r=await fetch("/api/preview/upload",{method:"POST",body:t});if(!r.ok){const s=await r.json().catch(()=>({code:"UNKNOWN",detail:r.statusText}));throw new No(s.code??"UNKNOWN",s.detail??"上传失败",r.status)}return r.json()}const jn=[".md",".pdf",".docx",".xlsx",".xlsm",".xltx",".xltm",".csv"];function Vn(e){const t=e.toLowerCase();return jn.some(r=>t.endsWith(r))}async function Ye(e){const t=new URLSearchParams({path:e});try{const r=await fetch(`/api/preview?${t}`);if(r.ok){const i=await r.json();return{ok:!0,path:i.path,content:i.content,language:i.language,writable:i.writable??!1,pages:i.pages??null,lineMap:i.line_map??null}}const s=await r.json().catch(()=>({code:"UNKNOWN",detail:""}));return{ok:!1,notIndexed:s.code==="NOT_INDEXED",message:s.detail||s.code||`HTTP ${r.status}`}}catch(r){return{ok:!1,notIndexed:!1,message:r.message||"网络错误"}}}var qn=Object.defineProperty,Xn=Object.getOwnPropertyDescriptor,U=(e,t,r,s)=>{for(var o=s>1?void 0:s?Xn(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&qn(t,r,o),o};let L=class extends k{constructor(){super(...arguments),this.path="",this.language="text",this.content="",this.highlights=[],this.loading=!1,this.line=null,this.keyword="",this.writable=!1,this.noHeader=!1,this.mobile=!1,this.pages=null,this._mode="preview",this._content="",this._showMobileMenu=!1,this._onMobileBackClick=()=>{this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))},this._onMobileMoreClick=e=>{e.stopPropagation(),this._showMobileMenu=!this._showMobileMenu},this._onDocClick=e=>{var o,i;if(!this._showMobileMenu)return;const t=e.composedPath(),r=(o=this.shadowRoot)==null?void 0:o.querySelector(".mobile-menu"),s=(i=this.shadowRoot)==null?void 0:i.querySelector(".mobile-more");r&&t.includes(r)||s&&t.includes(s)||(this._showMobileMenu=!1)},this._onEditorCancel=()=>{this._mode="preview"},this._onEditorDirty=e=>{this.dispatchEvent(new CustomEvent("dirty-change",{detail:{dirty:e.detail.dirty}}))},this._onDownloadClick=()=>{if(!this.path)return;const e=`/api/preview/download?path=${encodeURIComponent(this.path)}`,t=document.createElement("a");t.href=e,t.rel="noopener",document.body.appendChild(t),t.click(),document.body.removeChild(t)},this._onUploadClick=()=>{var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector('input[type="file"]');e==null||e.click()}}willUpdate(e){e.has("content")&&(this._content=this.content,this._mode="preview")}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick,!0)}disconnectedCallback(){document.removeEventListener("click",this._onDocClick,!0),super.disconnectedCallback()}_basename(e){if(!e)return"";const t=e.lastIndexOf("/");return t>=0?e.slice(t+1):e}_renderMobileHeader(){return c`
    ...
    `}enterEdit(){this._mode="edit"}async _onEditorSave(e){const t=this.shadowRoot.querySelector("md-editor");try{await Hn(this.path,e.detail.content),this._content=e.detail.content,this._mode="preview",this.dispatchEvent(new CustomEvent("saved",{detail:{content:e.detail.content}}))}catch(r){const s=r instanceof Fo?`${r.code} ${r.message}`:r.message??"保存失败";t==null||t.setError(s),this.dispatchEvent(new CustomEvent("save-failed",{detail:{message:s}}))}}discard(){const e=this.shadowRoot.querySelector("md-editor");e==null||e.discard(),this._mode="preview"}_renderDownloadBtn(){return c`<button class="download-btn" @click=${this._onDownloadClick}>⬇️ 下载</button>`}async _onFileChange(e){var o;const t=e.target,r=(o=t.files)==null?void 0:o[0];if(t.value="",!(!r||!window.confirm(`即将上传 '${r.name}' 覆盖原文件，是否继续？`)))try{const i=await Un(r);this.dispatchEvent(new CustomEvent("upload-success",{detail:{path:i.path}}))}catch(i){const a=i instanceof No?`${i.code} ${i.message}`:i.message??"上传失败";this.dispatchEvent(new CustomEvent("upload-failed",{detail:{message:a}}))}}_renderUploadBtn(){return c`<button class="upload-btn" @click=${this._onUploadClick}>⬆️ 上传</button>`}render(){if(this.loading)return c`<div class="empty">加载中...</div>`;if(!this._content&&!this.content)return c`<div class="empty">点击左侧结果查看预览</div>`;const e=this.mobile?this._renderMobileHeader():null,t=!this.mobile&&!this.noHeader;if(this.language==="markdown"&&this._mode==="edit")return c`
...
`);return c`
  ...
  `;U([d()],L.prototype,"path",2);U([d()],L.prototype,"language",2);U([d()],L.prototype,"content",2);U([d({attribute:!1})],L.prototype,"highlights",2);U([d({type:Boolean})],L.prototype,"loading",2);U([d({type:Number})],L.prototype,"line",2);U([d()],L.prototype,"keyword",2);U([d({type:Boolean})],L.prototype,"writable",2);U([d({type:Boolean})],L.prototype,"noHeader",2);U([d({type:Boolean})],L.prototype,"mobile",2);U([d({attribute:!1})],L.prototype,"pages",2);U([v()],L.prototype,"_mode",2);U([v()],L.prototype,"_content",2);U([v()],L.prototype,"_showMobileMenu",2);L=U([E("preview-pane")],L);var Kn=Object.defineProperty,Yn=Object.getOwnPropertyDescriptor,hr=(e,t,r,s)=>{for(var o=s>1?void 0:s?Yn(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Kn(t,r,o),o};let Ge=class extends k{constructor(){super(...arguments),this.role="user",this.message=null,this.error=null,this._onClick=e=>{const t=e.composedPath().find(s=>s instanceof HTMLElement&&s.classList.contains("ref-link"));if(!t)return;e.preventDefault();const r=t.getAttribute("data-path")??"";this.dispatchEvent(new CustomEvent("reference-click",{detail:{path:r},bubbles:!0,composed:!0}))}}firstUpdated(){this.addEventListener("click",this._onClick)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this._onClick)}renderBubble(e){if(e==="")return c`<span class="thinking">思考中...</span>`;if(this.role==="assistant"){const t=T.parse(e,{async:!1});return c`<div class="md-body" .innerHTML=${this.linkifyReferences(t)}></div>`}return e}linkifyReferences(e){const t=/(<h2[^>]*>\s*参考资料\s*<\/h2>)\s*(<(?:ol|ul)[^>]*>[\s\S]*?<\/(?:ol|ul)>)/i;return e.replace(t,(r,s,o)=>{const i=o.replace(/<li>([^<]+?)<\/li>/g,(a,l)=>{const n=l.trim();return`<li><a class="ref-link" data-path="${n.replace(/&/g,"&amp;").replace(/"/g,"&quot;")}" href="#">${n}</a></li>`});return`${s}${i}`})}render(){if(!this.message)return null;const e=this.message.tool_steps,t=this.role==="assistant"&&e&&e.length>0;return this.role==="user"?c`<div class="bubble">${this.renderBubble(this.message.content)}${this.error?c`<div class="error">⚠️ ${this.error}</div>`:null}</div>`:c`
    ...
    :host([role="user"]) .bubble {
      ...
      border-bottom-right-radius: var(--cortex-radius-sm);
    ...
    :host([role="assistant"]) .bubble {
      ...
      border-bottom-left-radius: var(--cortex-radius-sm);
      box-shadow: var(--cortex-shadow-sm);
    }
  ...
  `;hr([d({reflect:!0})],Ge.prototype,"role",2);hr([d({attribute:!1})],Ge.prototype,"message",2);hr([d()],Ge.prototype,"error",2);Ge=hr([E("chat-message")],Ge);var Gn=Object.defineProperty,Zn=Object.getOwnPropertyDescriptor,Tt=(e,t,r,s)=>{for(var o=s>1?void 0:s?Zn(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Gn(t,r,o),o};const Jn={search:"🔍",read_document:"📄",grep:"🔎"},Qn={search:"正在搜索",read_document:"正在读取",grep:"正在检索"};function el(e){const t=[`思考过程（${e.length} 步）`];return e.forEach((r,s)=>{t.push(""),t.push(`[${s+1}] ${r.name}`),Object.keys(r.input).length&&(t.push("参数："),t.push(JSON.stringify(r.input,null,2))),r.output!=null&&r.output!==""?(t.push("结果："),t.push(r.output)):t.push("结果：（无输出）")}),t.join(`
`)}let ze=class extends k{constructor(){super(...arguments),this.steps=[],this._expanded=!1,this._fullResultIds=new Set,this._copied=!1}willUpdate(e){if(e.has("steps")){const r=(e.get("steps")??[]).some(o=>o.status==="running"),s=this.steps.some(o=>o.status==="running");!r&&s?this._expanded=!0:r&&!s&&(this._expanded=!1)}}_toggle(){this._expanded=!this._expanded}_toggleResult(e){const t=new Set(this._fullResultIds);t.has(e)?t.delete(e):t.add(e),this._fullResultIds=t}async _onCopy(e){e.stopPropagation();const t=el(this.steps);try{await navigator.clipboard.writeText(t),this._copied=!0,setTimeout(()=>{this._copied=!1},2e3)}catch{try{const s=document.createElement("textarea");s.value=t,s.style.position="fixed",s.style.opacity="0",document.body.appendChild(s),s.select(),document.execCommand("copy"),document.body.removeChild(s),this._copied=!0,setTimeout(()=>{this._copied=!1},2e3)}catch(s){console.warn("copy failed:",s)}}}_renderArgs(e){return Object.entries(e).map(([t,r])=>`${t}: ${typeof r=="string"?r:JSON.stringify(r)}`).join(`
`)}_renderStep(e){const t=e.status==="running",r=e.status==="error",s=Jn[e.name]??"🔧",o=this._fullResultIds.has(e.tool_use_id),i=(e.output??"").split(`
...
`):e.output??"",n=e.output!=null&&e.output!=="";return c`
    ...
    .head .meta { margin-left: auto; color: var(--cortex-text-muted); font-size: var(--cortex-fs-xs); font-family: var(--cortex-font-mono); }
  ...
  `;Tt([d({attribute:!1})],ze.prototype,"steps",2);Tt([v()],ze.prototype,"_expanded",2);Tt([v()],ze.prototype,"_fullResultIds",2);Tt([v()],ze.prototype,"_copied",2);ze=Tt([E("chat-tool-trace")],ze);var tl=Object.defineProperty,rl=Object.getOwnPropertyDescriptor,Wo=(e,t,r,s)=>{for(var o=s>1?void 0:s?rl(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&tl(t,r,o),o};let sr=class extends k{constructor(){super(...arguments),this.messages=[],this._scrollRafPending=!1}updated(){this._scrollRafPending||(this._scrollRafPending=!0,requestAnimationFrame(()=>{this._scrollRafPending=!1,this.scrollTop=this.scrollHeight}))}render(){return this.messages.length===0?c`<div class="empty">开始与 Doclens 对话</div>`:c`
  ...
  `;Dt([d({type:Number})],Re.prototype,"total",2);Dt([d({type:Number})],Re.prototype,"offset",2);Dt([d({type:Number})],Re.prototype,"limit",2);Dt([d({type:Boolean})],Re.prototype,"disabled",2);Re=Dt([E("pagination-bar")],Re);var ll=Object.defineProperty,cl=Object.getOwnPropertyDescriptor,Vo=(e,t,r,s)=>{for(var o=s>1?void 0:s?cl(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&ll(t,r,o),o};let or=class extends k{constructor(){super(...arguments),this._toasts=[],this._nextId=1,this._timers=new Map}pushToast(e,t="info",r=2500){const s=this._nextId++;if(this._toasts=[...this._toasts,{id:s,message:e,level:t,duration:r}],r>0){const o=window.setTimeout(()=>this.dismiss(s),r);this._timers.set(s,o)}}dismiss(e){const t=this._timers.get(e);t!==void 0&&(window.clearTimeout(t),this._timers.delete(e)),this._toasts=this._toasts.filter(r=>r.id!==e)}disconnectedCallback(){super.disconnectedCallback();for(const e of this._timers.values())window.clearTimeout(e);this._timers.clear()}render(){return c`
    ...
    :host {
      position: fixed;
      right: var(--cortex-space-4);
      bottom: var(--cortex-space-4);
      z-index: 1000;
      display: flex;
      flex-direction: column;
      gap: var(--cortex-space-2);
    ...
    .toast.success { background: var(--cortex-success); color: #fff; border-color: var(--cortex-success); }
    .toast.error { background: var(--cortex-danger); color: #fff; border-color: var(--cortex-danger); }
    .toast.info { color: var(--cortex-text); }
    .toast .msg { flex: 1; }
  `;Vo([v()],or.prototype,"_toasts",2);or=Vo([E("toast-stack")],or);const qo=_`
  .initial-stack {
    display: flex;
    flex-direction: column;
    flex: 1;
...
确定要丢弃吗？`))return;this._discardPreviewEdits()}await e()}async _reloadPreview(){if(!this.previewPath)return;const e=await Ye(this.previewPath);e.ok&&(this.previewContent=e.content,this.previewLanguage=e.language,this.previewWritable=e.writable,this.previewPages=e.pages)}_pushToast(e,t,r){var o;const s=(o=this.shadowRoot)==null?void 0:o.querySelector("toast-stack");s==null||s.pushToast(e,t,r)}_popDetail(){m.popDetail()}_renderNotIndexedHint(e){return c`<div class=${e?"desktop-only not-indexed-hint":"not-indexed-hint"}>
      该文件未索引，无法预览。<br>请先执行 doclens index 后重试。
        ...
        <div class="initial-stack">
          <div class="hero-card">
            <welcome-pane heading="搜索你的文档" subheading="基于工作目录全文搜索关键词和正则表达式。试着搜: 「应急预案」「最近的项目周报」「数据库 schema」"></welcome-pane>
            <history-list
              title="历史会话"
              type="search"
...
确定要丢弃吗？`))return;const o=(t=this.shadowRoot)==null?void 0:t.querySelector("preview-pane");(r=o==null?void 0:o.discard)==null||r.call(o),this.previewDirty=!1}await e()}async _reloadPreview(){if(!this.previewPath)return;const e=await Ye(this.previewPath);e.ok&&(this.previewContent=e.content,this.previewLanguage=e.language,this.previewWritable=e.writable,this.previewPages=e.pages)}_pushToast(e,t,r){var o;const s=(o=this.shadowRoot)==null?void 0:o.querySelector("toast-stack");s==null||s.pushToast(e,t,r)}_renderNotIndexedHint(){return c`<div class="not-indexed-hint">
      该文件未索引，无法预览。<br>请先执行 doclens index 后重试。
        ...
        <div class="initial-stack">
          <div class="hero-card">
            <welcome-pane heading="和你的文档对话" subheading="AI 基于工作目录下的所有文档回答问题。试着问：「应急预案的处理要点是什么？」「总结最近的项目周报」"></welcome-pane>
            <history-list
              title="历史会话"
              type="chat"
              ?clearing=${this._clearing}
      ...
      `;const t=this.previewOpen,r=o=>c`<preview-pane
      ?noHeader=${o}
      path=${this.previewPath}
      language=${this.previewLanguage}
      content=${this.previewContent}
    ...
    :host {
      ...
      min-height: 0;
      background: var(--cortex-bg);
      /* chat initial 列比 search 略宽（760 vs 720） */
    ...
    /* 移动端：input-bar 不受 desktop max-width 限制（100% focus-main），
       padding 归零会让输入框贴屏边（除 activity-bar）。加 padding 12 留白 */
    @media (max-width: 1023px) {
      .input-bar { padding: var(--cortex-space-3); }
    }
    .focus-main {
      display: flex;
      flex: 1;
      ...
      <div class="layout">
        ...
        <main class="main">
          <div class="scroll-area">
            ${Ys.map(r=>{const s=yl.filter(i=>i.tab===r),o=[];for(const i of s){let a=o.find(l=>l.title===i.section);a||(a={title:i.section,fields:[]},o.push(a)),a.fields.push(i)}return c`
  ...
  `;ne([v()],X.prototype,"_activeTab",2);ne([v()],X.prototype,"_saving",2);ne([v()],X.prototype,"_error",2);ne([v()],X.prototype,"_toast",2);ne([v()],X.prototype,"_values",2);ne([v()],X.prototype,"_original",2);ne([v()],X.prototype,"_userEditedBaseUrl",2);ne([v()],X.prototype,"_exists",2);ne([v()],X.prototype,"_scope",2);ne([v()],X.prototype,"_fieldErrors",2);X=ne([E("settings-view")],X);const he=e=>`/api/files${e}`,pe={list:(e,t=200,r=0)=>F(he(`/list?path=${encodeURIComponent(e)}&limit=${t}&offset=${r}`)),stats:e=>F(he(`/stats?path=${encodeURIComponent(e)}`)),attrs:e=>F(he(`/attrs?path=${encodeURIComponent(e)}`)),mkdir:e=>F(he("/mkdir"),{method:"POST",json:{path:e}}),remove:e=>F(he(`?path=${encodeURIComponent(e)}`),{method:"DELETE"}),move:(e,t,r=!1)=>F(he("/move"),{method:"POST",json:{from_paths:e,dest_dir:t,overwrite:r}}),rename:(e,t)=>F(he("/rename"),{method:"POST",json:{path:e,new_name:t}}),upload:(e,t,r=!1)=>{const s=new FormData;return s.append("file",e),s.append("dest_dir",t),s.append("overwrite",String(r)),F(he("/upload"),{method:"POST",body:s})}};var Pl=Object.defineProperty,Al=Object.getOwnPropertyDescriptor,ge=(e,t,r,s)=>{for(var o=s>1?void 0:s?Al(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Pl(t,r,o),o};let ce=class extends k{constructor(){super(...arguments),this.depth=0,this.expanded=!1,this.selected=!1,this.readonly=!1,this.childEntries=[],this.loading=""}_onClick(){this.readonly?this.dispatchEvent(new CustomEvent("pick-dir",{detail:{path:this.entry.path},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("select-dir",{detail:{path:this.entry.path},bubbles:!0,composed:!0}))}_toggle(e){e.stopPropagation(),this.entry.has_child_dirs&&this.dispatchEvent(new CustomEvent("toggle",{detail:{path:this.entry.path},bubbles:!0,composed:!0}))}render(){return c`
    ...
    .row:hover { background: var(--cortex-surface-muted); cursor: pointer; }
    .row.selected { background: var(--cortex-primary-soft); color: var(--cortex-primary); }
    .arrow {
      width: 16px; height: 16px;
      display: inline-flex; align-items: center; justify-content: center;
      color: var(--cortex-text-muted); transition: transform 0.1s;
      font-size: 10px;
    }
  ...
  `;Fr=Dl([E("file-tree")],Fr);const Ol={pdf:{letter:"P",bg:"#DC2626",fg:"#FFFFFF"},doc:{letter:"D",bg:"#2563EB",fg:"#FFFFFF"},docx:{letter:"D",bg:"#2563EB",fg:"#FFFFFF"},xls:{letter:"X",bg:"#16A34A",fg:"#FFFFFF"},xlsx:{letter:"X",bg:"#16A34A",fg:"#FFFFFF"},csv:{letter:"C",bg:"#16A34A",fg:"#FFFFFF"},ppt:{letter:"S",bg:"#EA580C",fg:"#FFFFFF"},pptx:{letter:"S",bg:"#EA580C",fg:"#FFFFFF"},md:{letter:"M",bg:"#6366F1",fg:"#FFFFFF"},txt:{letter:"T",bg:"#6B7280",fg:"#FFFFFF"},html:{letter:"H",bg:"#E34F26",fg:"#FFFFFF"}};function Xo(e){if(!e)return"";const t=e.lastIndexOf(".");return t<=0||t===e.length-1?"":e.slice(t+1).toLowerCase()}function zl(e,t){if(t)return null;const r=Xo(e);return Ol[r]??null}function Rl(e){return e.is_dir?"文件夹":Xo(e.name)}var Il=Object.defineProperty,Ll=Object.getOwnPropertyDescriptor,pr=(e,t,r,s)=>{for(var o=s>1?void 0:s?Ll(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Il(t,r,o),o};let Ze=class extends k{constructor(){super(...arguments),this.selected=!1,this.active=!1}_fmtSize(e){return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/1024/1024).toFixed(1)} MB`}_fmtTime(e){if(!e)return"";try{return new Date(e).toLocaleString(void 0,{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"})}catch{return""}}_onRowClick(){this.dispatchEvent(new CustomEvent("activated",{detail:{path:this.entry.path,is_dir:this.entry.is_dir},bubbles:!0,composed:!0}))}_onCheckboxClick(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("checked",{detail:{path:this.entry.path,ctrl:e.ctrlKey||e.metaKey,shift:e.shiftKey},bubbles:!0,composed:!0}))}render(){const e=zl(this.entry.name,this.entry.is_dir);return c`
      <div
        ...
        <span class="cell-type">${Rl(this.entry)}</span>
      </div>
    `}};Ze.styles=_`
    :host { display: block; }
    .row {
    ...
    .row:has(input[type="checkbox"]:checked) { background: var(--cortex-primary-soft); }
    .checkbox { display: flex; align-items: center; justify-content: center; }
    .checkbox input[type="checkbox"] { accent-color: var(--cortex-primary); }
  ...
  `;pr([d({type:Object})],Ze.prototype,"entry",2);pr([d({type:Boolean})],Ze.prototype,"selected",2);pr([d({type:Boolean})],Ze.prototype,"active",2);Ze=pr([E("file-row")],Ze);var Ml=Object.defineProperty,Fl=Object.getOwnPropertyDescriptor,zt=(e,t,r,s)=>{for(var o=s>1?void 0:s?Fl(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Ml(t,r,o),o};const Ko=[28,28,240,80,140,70,80],Gs=[20,20,80,50,80,50,50],Zs=[60,60,800,200,300,150,200],Js=Ko.length,Qs="cortex.files.colWidths";let Ie=class extends k{constructor(){super(...arguments),this.activePath="",this.mobile=!1,this._colWidths=[...Ko],this._showMobileMenu=!1,this._makeColResizeHandler=e=>t=>{t.preventDefault(),t.stopPropagation();const r=t.clientX,s=this._colWidths[e];document.body.style.cursor="col-resize",document.body.style.userSelect="none";const o=a=>{const l=a.clientX-r,n=Math.max(Gs[e],Math.min(Zs[e],s+l)),h=[...this._colWidths];h[e]=n,this._colWidths=h},i=()=>{document.removeEventListener("mousemove",o),document.removeEventListener("mouseup",i),document.body.style.cursor="",document.body.style.userSelect="",localStorage.setItem(Qs,JSON.stringify(this._colWidths))};document.addEventListener("mousemove",o),document.addEventListener("mouseup",i)},this._onMobileBackClick=()=>{this._showMobileMenu=!1,this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))},this._onMobileMoreClick=e=>{e.stopPropagation(),this._showMobileMenu=!this._showMobileMenu},this._onDocClick=e=>{var o,i;if(!this._showMobileMenu)return;const t=e.composedPath(),r=(o=this.shadowRoot)==null?void 0:o.querySelector(".mobile-menu"),s=(i=this.shadowRoot)==null?void 0:i.querySelector(".mobile-more");r&&t.includes(r)||s&&t.includes(s)||(this._showMobileMenu=!1)},this._onMenuItemClick=e=>t=>{t.stopPropagation(),this._showMobileMenu=!1,this._action(e)}}connectedCallback(){super.connectedCallback(),this._unsubscribe=f.subscribe(()=>this.requestUpdate()),this._loadColWidths(),document.addEventListener("click",this._onDocClick,!0)}disconnectedCallback(){var e;(e=this._unsubscribe)==null||e.call(this),document.removeEventListener("click",this._onDocClick,!0),super.disconnectedCallback()}willUpdate(){for(let e=0;e<Js;e++)this.style.setProperty(`--col-${e+1}`,`${this._colWidths[e]}px`)}_loadColWidths(){const e=localStorage.getItem(Qs);if(e)try{const t=JSON.parse(e);Array.isArray(t)&&t.length===Js&&t.every(r=>typeof r=="number"&&Number.isFinite(r))&&(this._colWidths=t.map((r,s)=>Math.max(Gs[s],Math.min(Zs[s],r))))}catch{}}_action(e){this.dispatchEvent(new CustomEvent("action",{detail:{name:e},bubbles:!0,composed:!0}))}_onRowChecked(e){const{path:t,shift:r}=e.detail;m.selectEntry(t,{ctrl:!r,shift:r})}_onSelectAll(e){const t=e.target,{currentDir:r,treeCache:s,selectedPaths:o}=f.getState().files,i=s[r]||[];if(t.checked){const a=i.map(n=>n.path),l=Array.from(new Set([...o,...a]));m.setFilesState({selectedPaths:l})}else{const a=new Set(i.map(l=>l.path));m.setFilesState({selectedPaths:o.filter(l=>!a.has(l))})}}_goUp(){const{currentDir:e}=f.getState().files;if(e==="")return;const t=e.includes("/")?e.slice(0,e.lastIndexOf("/")):"";m.selectDir(t)}_renderMobileHeader(){const{currentDir:e,selectedPaths:t}=f.getState().files,r=t.length===1,s=t.length>=1,o=e===""?"/":`/${e}/`;return c`
    ...
    .breadcrumb .path { flex: 1; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--cortex-text); font-family: var(--cortex-font-mono); font-size: var(--cortex-fs-xs); }
    .up-btn {
      padding: 2px 8px;
      font-size: var(--cortex-fs-sm);
      border: 1px solid var(--cortex-border);
    ...
    .mobile-header .mobile-menu button.danger:hover:not(:disabled) { color: var(--cortex-danger); }
    .header-row {
      display: grid;
      grid-template-columns:
        var(--col-1, 28px)
  ...
  `;zt([d()],Ie.prototype,"activePath",2);zt([d({type:Boolean})],Ie.prototype,"mobile",2);zt([v()],Ie.prototype,"_colWidths",2);zt([v()],Ie.prototype,"_showMobileMenu",2);Ie=zt([E("file-list")],Ie);var Nl=Object.defineProperty,Wl=Object.getOwnPropertyDescriptor,cs=(e,t,r,s)=>{for(var o=s>1?void 0:s?Wl(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Nl(t,r,o),o};const Bl=/[\\/:*?"<>|]/,Hl=/^(con|prn|aux|nul|com[1-9]|lpt[1-9])$/i;let wt=class extends k{constructor(){super(...arguments),this._name="",this._err=""}get _parent(){return f.getState().files.currentDir}_validate(e){return e?e.startsWith(".")?"不能以点开头":Bl.test(e)?'含非法字符 / \\ : * ? " < > |':/\s/.test(e[0]||"")?"不能以空白开头":Hl.test(e)?"Windows 保留名":"":"名称不能为空"}_onInput(e){this._name=e.target.value,this._err=this._validate(this._name)}_submit(){if(this._err)return;const e=this._parent?`${this._parent}/${this._name}`:this._name;this.dispatchEvent(new CustomEvent("submit",{detail:{path:e},bubbles:!0,composed:!0}))}_cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){const e=!!this._err;return c`
      <div class="row">
  ...
  `;cs([v()],wt.prototype,"_name",2);cs([v()],wt.prototype,"_err",2);wt=cs([E("mkdir-dialog")],wt);var Ul=Object.defineProperty,jl=Object.getOwnPropertyDescriptor,fr=(e,t,r,s)=>{for(var o=s>1?void 0:s?jl(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Ul(t,r,o),o};const Vl=/[\\/:*?"<>|]/,ql=/^(con|prn|aux|nul|com[1-9]|lpt[1-9])$/i;let Je=class extends k{constructor(){super(...arguments),this.currentName="",this._name="",this._err=""}connectedCallback(){super.connectedCallback(),this._name=this.currentName,this._err=this._validate(this._name)}_validate(e){return e?e===this.currentName?"名称未变化":e.startsWith(".")?"不能以点开头":Vl.test(e)?'含非法字符 / \\ : * ? " < > |':ql.test(e)?"Windows 保留名":"":"名称不能为空"}_onInput(e){this._name=e.target.value,this._err=this._validate(this._name)}_submit(){this._err||this.dispatchEvent(new CustomEvent("submit",{detail:{newName:this._name},bubbles:!0,composed:!0}))}_cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){const e=!!this._err;return c`
    ...
    ${Ot}
      ...
      .err { color: var(--cortex-danger); font-size: var(--cortex-fs-xs); margin-top: var(--cortex-space-1); }
      .actions {
        display: flex; justify-content: flex-end;
        gap: var(--cortex-space-2);
        margin-top: var(--cortex-space-4);
  ...
  `;fr([d({type:String})],Je.prototype,"currentName",2);fr([v()],Je.prototype,"_name",2);fr([v()],Je.prototype,"_err",2);Je=fr([E("rename-dialog")],Je);var Xl=Object.defineProperty,Kl=Object.getOwnPropertyDescriptor,ds=(e,t,r,s)=>{for(var o=s>1?void 0:s?Kl(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Xl(t,r,o),o};let kt=class extends k{constructor(){super(...arguments),this._dest="",this._overwrite=!1}get _selectedCount(){return f.getState().files.selectedPaths.length}_onPickDir(e){this._dest=e.detail.path}_onToggle(e){e.stopPropagation()}_submit(){this._dest&&this.dispatchEvent(new CustomEvent("submit",{detail:{destDir:this._dest,overwrite:this._overwrite},bubbles:!0,composed:!0}))}_cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){const{treeCache:e,expandedPaths:t}=f.getState().files,r=(e[""]||[]).filter(o=>o.is_dir),s=new Set(t);return c`
  ...
  `;ds([v()],kt.prototype,"_dest",2);ds([v()],kt.prototype,"_overwrite",2);kt=ds([E("move-dialog")],kt);var Yl=Object.defineProperty,Gl=Object.getOwnPropertyDescriptor,br=(e,t,r,s)=>{for(var o=s>1?void 0:s?Gl(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Yl(t,r,o),o};let Qe=class extends k{constructor(){super(...arguments),this._phase="confirming",this._stats=null,this._confirmed=!1}get _selected(){return f.getState().files.selectedPaths}connectedCallback(){super.connectedCallback(),!this._stats&&this._selected.length>0&&(this._phase="loading-stats",this._loadStats())}async _loadStats(){const e=this._selected;let t=0,r=0,s=0;for(const o of e)try{const i=await pe.stats(o);t+=i.file_count,r+=i.dir_count,s+=i.total_size_bytes}catch{}t===0&&r===0&&(t=e.length),this._stats={file_count:t,dir_count:r,total_size_bytes:s},this._phase="confirming"}_fmtSize(e){return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/1024/1024).toFixed(1)} MB`}_delete(){this._confirmed&&(this._phase="deleting",this.dispatchEvent(new CustomEvent("submit",{detail:{paths:this._selected},bubbles:!0,composed:!0})))}_cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){const e=this._selected.length;return this._phase==="loading-stats"?c`<div class="spinner">统计中…</div>`:c`
    ...
    .warn {
      padding: var(--cortex-space-3);
      background: var(--cortex-warning-soft);
  ...
  `;us([d({type:String})],$t.prototype,"targetDir",2);us([v()],$t.prototype,"_active",2);$t=us([E("drop-zone")],$t);var Ql=Object.defineProperty,ec=Object.getOwnPropertyDescriptor,rt=(e,t,r,s)=>{for(var o=s>1?void 0:s?ec(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=(s?a(t,r,o):a(o))||o);return s&&o&&Ql(t,r,o),o};const tc=80,rc="按文件名搜索…";let me=class extends k{constructor(){super(...arguments),this._value="",this._isComposing=!1,this.disabled=!1,this.placeholder=rc,this.value="",this._timer=null,this._onInput=e=>{const t=e.target;if(this._value=t.value,this._value.trim()===""){this._emitClear();return}this._scheduleEmit()},this._onCompositionStart=()=>{this._isComposing=!0},this._onCompositionEnd=()=>{this._isComposing=!1,this._scheduleEmit()},this._onKeyDown=e=>{e.key==="Escape"&&(e.preventDefault(),this._emitClear())},this._onClearClick=()=>{var t;this._emitClear();const e=(t=this.shadowRoot)==null?void 0:t.querySelector("input");e==null||e.focus()}}connectedCallback(){super.connectedCallback(),this.value&&(this._value=this.value)}disconnectedCallback(){this._timer&&clearTimeout(this._timer),super.disconnectedCallback()}_emitSearch(){this.dispatchEvent(new CustomEvent("search",{detail:{query:this._value},bubbles:!0,composed:!0}))}_scheduleEmit(){this._timer&&clearTimeout(this._timer),this._timer=setTimeout(()=>{this._timer=null,this._isComposing||this._emitSearch()},tc)}_emitClear(){var t;this._timer&&(clearTimeout(this._timer),this._timer=null),this._value="";const e=(t=this.shadowRoot)==null?void 0:t.querySelector("input");e&&(e.value=""),this.dispatchEvent(new CustomEvent("clear",{bubbles:!0,composed:!0}))}render(){return c`
      <div class="box">
  ...
  `;rt([v()],me.prototype,"_value",2);rt([v()],me.prototype,"_isComposing",2);rt([d({type:Boolean})],me.prototype,"disabled",2);rt([d()],me.prototype,"placeholder",2);rt([d({type:String})],me.prototype,"value",2);me=rt([E("file-search-box")],me);var sc=Object.getOwnPropertyDescriptor,oc=(e,t,r,s)=>{for(var o=s>1?void 0:s?sc(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=a(o)||o);return o};const ic=100;function ac(e,t){if(!t)return e;const r=e.toLowerCase(),s=t.toLowerCase(),o=r.indexOf(s);return o===-1?e:[e.slice(0,o),c`<mark>${e.slice(o,o+s.length)}</mark>`,e.slice(o+s.length)]}function nc(e){const t=e.lastIndexOf("/");return t===-1?"":e.slice(0,t+1)}function lc(e){return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/1024/1024).toFixed(1)} MB`}function cc(e){if(!e)return"";const t=new Date(e).getTime();if(Number.isNaN(t))return"";const r=Date.now()-t,s=24*3600*1e3;return r<s?"今天":r<2*s?"昨天":r<7*s?`${Math.floor(r/s)} 天前`:r<30*s?`${Math.floor(r/(7*s))} 周前`:r<365*s?`${Math.floor(r/(30*s))} 个月前`:`${Math.floor(r/(365*s))} 年前`}let Nr=class extends k{constructor(){super(...arguments),this._onKeyDown=e=>{const{results:t,selectedPath:r}=this._state;if(t.length===0){e.key==="Escape"&&this.dispatchEvent(new CustomEvent("clear",{bubbles:!0,composed:!0}));return}const s=t.findIndex(o=>o.path===r);if(e.key==="ArrowDown"){e.preventDefault();const o=t[Math.min(t.length-1,s+1)];m.selectFilenameSearchResult(o.path),this.dispatchEvent(new CustomEvent("activated",{detail:{path:o.path},bubbles:!0,composed:!0}))}else if(e.key==="ArrowUp"){e.preventDefault();const o=t[Math.max(0,s-1)];m.selectFilenameSearchResult(o.path),this.dispatchEvent(new CustomEvent("activated",{detail:{path:o.path},bubbles:!0,composed:!0}))}else if(e.key==="Enter"){e.preventDefault();const o=t[s]??t[0];o&&this.dispatchEvent(new CustomEvent("activated",{detail:{path:o.path},bubbles:!0,composed:!0}))}else e.key==="Escape"&&this.dispatchEvent(new CustomEvent("clear",{bubbles:!0,composed:!0}))}}get _state(){return f.getState().files.filenameSearch}_onRowClick(e){m.selectFilenameSearchResult(e.path),this.dispatchEvent(new CustomEvent("activated",{detail:{path:e.path},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.tabIndex=0,this.addEventListener("keydown",this._onKeyDown),this._unsubscribe=f.subscribe(()=>this.requestUpdate())}disconnectedCallback(){var e;this.removeEventListener("keydown",this._onKeyDown),(e=this._unsubscribe)==null||e.call(this),super.disconnectedCallback()}render(){const{query:e,results:t,selectedPath:r,totalMatches:s}=this._state;return t.length===0?c`
        <div class="empty">
      ...
      <div class="rows">
        ${t.map(o=>{const i=nc(o.path),a=o.path===r;return c`
            <div
              class="row ${a?"active":""}"
            ...
            >
              <span class="name-cell">
                <span class="icon">📄</span>
                <span class="name">${ac(o.name,e)}</span>
                ${i?c`<span class="dir">${i}</span>`:""}
              </span>
              <span class="meta">${lc(o.size)} · ${cc(o.modifiedAt)}</span>
            </div>
          `})}
      </div>
      ${s>t.length?c`<div class="overflow-hint">共 ${s} 项，仅显示前 ${ic}，请补充关键字</div>`:""}
    `}};Nr.styles=_`
    :host {
      display: flex;
      flex-direction: column;
...
确定要丢弃吗？`))return;this._discardPreviewEdits()}await this._fetchPreview(e)}async _fetchPreview(e){const t=await Ye(e);t.ok?(this._previewError=null,this._previewPath=t.path,this._previewContent=t.content,this._previewLanguage=t.language,this._previewWritable=t.writable,this._previewPages=t.pages):t.notIndexed?(this._previewError="NOT_INDEXED",this._previewPath=e,this._previewContent="",this._previewWritable=!1,this._previewPages=null):this._showToast(t.message||"预览失败")}async _reloadPreview(){if(!this._previewPath)return;const e=await Ye(this._previewPath);e.ok&&(this._previewContent=e.content,this._previewLanguage=e.language,this._previewWritable=e.writable,this._previewPages=e.pages)}_discardPreviewEdits(){var t,r;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("preview-pane");(r=e==null?void 0:e.discard)==null||r.call(e),this._previewDirty=!1}_renderNotIndexedHint(){return c`<div class="preview-placeholder">
  ...
  `;Rt([d()],Le.prototype,"activeView",2);Rt([v()],Le.prototype,"_menuOpen",2);Rt([v()],Le.prototype,"_showSaveAndRevert",2);Rt([v()],Le.prototype,"_refreshing",2);Le=Rt([E("app-bar")],Le);var bc=Object.getOwnPropertyDescriptor,vc=(e,t,r,s)=>{for(var o=s>1?void 0:s?bc(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=a(o)||o);return o};let Wr=class extends k{constructor(){super(...arguments),this._abort=null}connectedCallback(){super.connectedCallback(),this._unsub=f.subscribe(()=>this.requestUpdate())}disconnectedCallback(){var e,t;(e=this._abort)==null||e.abort(),(t=this._unsub)==null||t.call(this),super.disconnectedCallback()}_pushToast(e,t="info",r=2500){var o;const s=(o=this.shadowRoot)==null?void 0:o.querySelector("toast-stack");s==null||s.pushToast(e,t,r)}_confirm(){m.startReindex(),this._runReindex()}_close(){var e;(e=this._abort)==null||e.abort(),m.closeReindex()}async _runReindex(){var e;this._abort=new AbortController;try{for await(const t of Ho("/api/reindex",{},this._abort.signal)){if(this._abort.signal.aborted)break;if(t.event==="progress"){const r=JSON.parse(t.data);m.setReindexProgress({current_file:r.current_file,indexed_count:r.indexed_count})}else if(t.event==="done"){const r=JSON.parse(t.data);r.success?(m.finishReindex({success:r.success,doc_count:r.doc_count,failed_count:r.failed_count}),this._pushToast(`索引重建完成：${r.doc_count} 文档`,"success",3e3)):m.failReindex(r.failed_count>0?`重建失败：${r.failed_count} 个文件失败`:"重建失败");break}else if(t.event==="error"){const r=JSON.parse(t.data);m.failReindex(r.detail||"重建失败");break}}}catch(t){(e=this._abort)!=null&&e.signal.aborted||m.failReindex(t.message||"重建失败")}}_renderBody(e){if(e.dialog==="confirm")return c`
    ...
    button.warn {
      background: var(--cortex-danger); color: #fff; border: none;
      border-radius: var(--cortex-radius-lg);
    }
    button.warn:hover { opacity: 0.9; background: var(--cortex-danger); }
    /* dialog 用 fixed 居中：reindex-dialog 作为 cortex-app（flex column + overflow:hidden）
       的最后一个 flex item，会被 .app-body(flex:1) 挤到视口底部之外。
       浏览器对 <dialog> 默认 position:absolute 无显式偏移时会停在"静态位置"
       （视口外），被 overflow:hidden 裁剪导致不可见。固定定位 + 居中可绕开
       父级 flex/overflow 上下文。 */
    dialog {
      position: fixed;
      top: 50%; left: 50%;
      ...
      box-shadow: var(--cortex-shadow-lg);
      min-width: 360px; max-width: 90vw; max-height: 90vh;
    }
    dialog::backdrop { background: var(--cortex-overlay-bg); }
    dialog > * { display: block; padding: var(--cortex-space-6); }
    @media (max-width: 1023px) {
      :host { min-width: 0; }
      dialog {
  ...
  `;Wr=vc([E("reindex-dialog")],Wr);async function mc(){const e=await fetch("/api/watch/status",{method:"GET"}),t=await e.json().catch(()=>null);if(!e.ok)throw new Error(`watch/status HTTP ${e.status}`);return t}async function gc(){const e=await fetch("/api/status",{method:"GET"}),t=await e.json().catch(()=>null);if(!e.ok)throw new Error(`status HTTP ${e.status}`);return t}const xc=5e3;let vt=null,Ut;async function Yo(){try{const e=await gc();m.setStatus(e)}catch{}}async function eo(){try{const t=(await mc()).watcher,r=(t==null?void 0:t.last_reindex_at)??null;Ut!==void 0&&r!==null&&r!==Ut&&(window.dispatchEvent(new CustomEvent("cortex:watch-reindexed",{detail:{doc_count:(t==null?void 0:t.last_doc_count)??null}})),Yo()),Ut=r,m.setWatcherStatus(t)}catch{}}function _c(){vt===null&&(Ut=void 0,Yo(),eo(),vt=window.setInterval(()=>{eo()},xc))}function yc(){vt!==null&&(window.clearInterval(vt),vt=null)}var wc=Object.getOwnPropertyDescriptor,kc=(e,t,r,s)=>{for(var o=s>1?void 0:s?wc(t,r):t,i=e.length-1,a;i>=0;i--)(a=e[i])&&(o=a(o)||o);return o};let Br=class extends k{connectedCallback(){super.connectedCallback(),Ls.init(),this._unsubscribe=f.subscribe(()=>this.requestUpdate()),_c()}disconnectedCallback(){var e;(e=this._unsubscribe)==null||e.call(this),yc(),super.disconnectedCallback()}_navigate(e){Ls.navigate(e.detail.view),e.detail.view==="settings"&&e.detail.scope&&m.setSettingsScope(e.detail.scope)}_renderView(){const e=f.getState().view;return e==="chat"?c`<chat-view></chat-view>`:e==="settings"?c`<settings-view></settings-view>`:e==="files"?c`<files-view></files-view>`:c`<search-view></search-view>`}render(){const e=f.getState().view;return c`
      <app-bar
        .activeView=${e}
