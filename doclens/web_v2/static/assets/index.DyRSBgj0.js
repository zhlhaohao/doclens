...
`;function _o(t){return!t.showTop&&!t.showBottom?null:h`
  ...
  `}var Rb=Object.defineProperty,Lb=Object.getOwnPropertyDescriptor,Dr=(t,e,r,i)=>{for(var s=i>1?void 0:i?Lb(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&Rb(e,r,s),s};let ea="",zl=0,ko=0;function os(t){if(!t)return 0;const e=ea.indexOf(t,zl);if(e===-1){const i=ea.indexOf(t);return i===-1?0:(ea.slice(0,i).match(/\n/g)??[]).length+1+ko}const r=(ea.slice(0,e).match(/\n/g)??[]).length+1;return zl=e+t.length,r+ko}function aa(t){return t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}const Bb=500;function kd(t){return t>0&&t<=Bb?`${t}px`:null}const Nb=/^[a-zA-Z][a-zA-Z0-9+.-]*:/;function Fb(t,e){if(!t||!e||e.startsWith("/")||e.startsWith("#")||Nb.test(e))return null;const r=e.match(/^([^?#]*)([?#].*)?$/),i=(r==null?void 0:r[1])??e,s=(r==null?void 0:r[2])??"";if(!i)return null;const a=t.split("/").slice(0,-1);for(const l of i.split("/"))if(!(l===""||l==="."))if(l===".."){if(a.length===0)return null;a.pop()}else a.push(l);return`/api/preview/raw?path=${a.map(encodeURIComponent).join("/")}${s}`}const zh={heading(t){const e=this.parser.parseInline(t.tokens),r=os(t.raw);return`<h${t.depth} data-source-line="${r}">${e}</h${t.depth}>
...
`);i.push({label:e[s].label,md:l,offset:a})}return i}render(){if(qb(),!this.content)return h`<div class="empty">无内容</div>`;if(this.pages&&this.pages.length>0){const e=this._splitByPages(this.content,this.pages);return h`
  ...
  `];Dr([y()],Gt.prototype,"content",2);Dr([y({type:Number})],Gt.prototype,"line",2);Dr([y()],Gt.prototype,"keyword",2);Dr([y({attribute:!1})],Gt.prototype,"pages",2);Dr([y({attribute:"doc-path"})],Gt.prototype,"docPath",2);Dr([z()],Gt.prototype,"_viewerSrc",2);Dr([z()],Gt.prototype,"_copied",2);Dr([y({type:Boolean})],Gt.prototype,"suppressLocate",2);Gt=Dr([K("md-viewer")],Gt);var jb=Object.defineProperty,Ub=Object.getOwnPropertyDescriptor,Vi=(t,e,r,i)=>{for(var s=i>1?void 0:i?Ub(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&jb(e,r,s),s};let Cr=class extends G{constructor(){super(...arguments),this.path="",this.originalContent="",this.mobile=!1,this._text="",this._dirty=!1,this._error=null,this._scrollJump=new gc(this,{behavior:"auto",onJumpTop:t=>this._jumpToEdge(t,0),onJumpBottom:t=>{const e=t;this._jumpToEdge(e,e.value.length)}}),this._onSaveClick=()=>{this._dirty&&this._emitSave()},this._onCancelClick=()=>{this.discard()}}willUpdate(t){t.has("originalContent")&&(this._text=this.originalContent,this._dirty=!1,this._error=null)}firstUpdated(){const t=this.shadowRoot.querySelector("textarea");t&&this._scrollJump.attach(t)}updated(){this._scrollJump.refresh()}get _textarea(){return this.shadowRoot.querySelector("textarea")}_jumpToEdge(t,e){t.focus(),t.setSelectionRange(e,e),t.scrollTop=e===0?0:t.scrollHeight-t.clientHeight}get _lines(){return this._text.split(`
...
`);const i=e.offsetHeight;return e.textContent="",i}topLine(){const t=this._textarea;if(!t)return 1;const e=t.scrollTop,r=this._lines.length;let i=1,s=r;for(;i<s;){const a=i+s+1>>1;this._heightBeforeLine(a)<=e?i=a:s=a-1}return i}scrollToLine(t){const e=this._textarea;e&&(e.scrollTop=this._heightBeforeLine(t))}_onInput(t){const e=t.target;this._text=e.value,this._error=null,this._updateDirty()}_onKeyDown(t){(t.ctrlKey||t.metaKey)&&t.key==="s"&&(t.preventDefault(),this._dirty&&this._emitSave())}_updateDirty(){const t=this._text!==this.originalContent;t!==this._dirty&&(this._dirty=t,this.dispatchEvent(new CustomEvent("dirty-change",{detail:{dirty:t}})))}_emitSave(){this.dispatchEvent(new CustomEvent("save",{detail:{content:this._text}}))}discard(){this._text=this.originalContent,this._dirty=!1,this._error=null,this._updateDirty(),this.dispatchEvent(new CustomEvent("cancel",{}))}setError(t){this._error=t}render(){return h`
  ...
  `];Vi([y()],Cr.prototype,"path",2);Vi([y()],Cr.prototype,"originalContent",2);Vi([y({type:Boolean})],Cr.prototype,"mobile",2);Vi([z()],Cr.prototype,"_text",2);Vi([z()],Cr.prototype,"_dirty",2);Vi([z()],Cr.prototype,"_error",2);Cr=Vi([K("md-editor")],Cr);class $h extends Error{constructor(e,r,i){super(r),this.code=e,this.status=i,this.name="PreviewSaveError"}}async function Wb(t,e){const r=await fetch(`/api/preview?path=${encodeURIComponent(t)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({content:e})});if(!r.ok){const i=await r.json().catch(()=>({code:"UNKNOWN",detail:r.statusText}));throw new $h(i.code??"UNKNOWN",i.detail??"保存失败",r.status)}return r.json()}class Th extends Error{constructor(e,r,i){super(r),this.code=e,this.status=i,this.name="PreviewUploadError"}}async function Vb(t){const e=new FormData;e.append("file",t);const r=await fetch("/api/preview/upload",{method:"POST",body:e});if(!r.ok){const i=await r.json().catch(()=>({code:"UNKNOWN",detail:r.statusText}));throw new Th(i.code??"UNKNOWN",i.detail??"上传失败",r.status)}return r.json()}const Gb=[".md",".pdf",".docx",".xlsx",".xlsm",".xltx",".xltm",".csv",".mhtml",".mht",".pst",".png",".jpg",".jpeg",".webp",".gif",".bmp",".tiff",".tif"];function Xb(t){const e=t.toLowerCase();return e.includes("#")&&e.split("#")[0].endsWith(".pst")?!0:Gb.some(r=>e.endsWith(r))}const Kb=[".png",".jpg",".jpeg",".webp"];function zd(t){const e=t.toLowerCase();return Kb.some(r=>e.endsWith(r))}async function gs(t){const e=new URLSearchParams({path:t});try{const r=await fetch(`/api/preview?${e}`);if(r.ok){const a=await r.json();return{ok:!0,path:a.path,content:a.content,language:a.language,writable:a.writable??!1,pages:a.pages??null,lineMap:a.line_map??null,attachments:a.attachments??null}}const i=await r.json().catch(()=>({code:"UNKNOWN",detail:""}));return{ok:!1,notIndexed:i.code==="NOT_INDEXED",message:i.detail||i.code||`HTTP ${r.status}`}}catch(r){return{ok:!1,notIndexed:!1,message:r.message||"网络错误"}}}async function Yb(t,e=0,r=50){const i=new URLSearchParams({path:t,offset:String(e),limit:String(r)});try{const s=await fetch(`/api/pst/emails?${i}`);if(s.ok){const o=await s.json();return{ok:!0,path:o.path,total:o.total,offset:o.offset,limit:o.limit,emails:o.emails??[]}}const a=await s.json().catch(()=>({code:"UNKNOWN",detail:""}));return{ok:!1,notIndexed:a.code==="NOT_INDEXED",message:a.detail||a.code||`HTTP ${s.status}`}}catch(s){return{ok:!1,notIndexed:!1,message:s.message||"网络错误"}}}function Jr(t){return t.toLowerCase().endsWith(".pst")&&!t.includes("#")}function Li(t){const e=t.toLowerCase();return e.includes("#")&&e.split("#")[0].endsWith(".pst")}const Ch="cortex.files.previewScroll",Zb=200;function Eh(){let t;try{t=JSON.parse(localStorage.getItem(Ch)??"{}")}catch{return{}}if(typeof t!="object"||t===null||Array.isArray(t))return{};const e={};for(const[r,i]of Object.entries(t))typeof i=="number"&&Number.isFinite(i)&&i>=1&&(e[r]=Math.floor(i));return e}function Jb(t){if(!t)return null;const e=Eh()[t];return e===void 0?null:e}function Qb(t,e){if(!t||!Number.isFinite(e))return;const r=Eh();delete r[t],e>1&&(r[t]=Math.floor(e));const i=Object.keys(r);for(;i.length>Zb;){const s=i.shift();delete r[s]}try{localStorage.setItem(Ch,JSON.stringify(r))}catch{}}var e2=Object.defineProperty,t2=Object.getOwnPropertyDescriptor,Oe=(t,e,r,i)=>{for(var s=i>1?void 0:i?t2(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&e2(e,r,s),s};let Ce=class extends G{constructor(){super(...arguments),this.path="",this.language="text",this.content="",this.highlights=[],this.loading=!1,this.line=null,this.keyword="",this.writable=!1,this.noHeader=!1,this.mobile=!1,this.pages=null,this.attachments=null,this.showBack=!1,this.backLabel="返回",this.enableReparse=!1,this.rememberScroll=!1,this._mode="preview",this._content="",this._showMobileMenu=!1,this._showHighlightBar=!1,this._highlightInput="",this._anchorLine=1,this._suppressLocate=!1,this._skipRestoreOnce=!1,this._scrollJump=new gc(this,{behavior:"smooth"}),this._scrollBoundViewer=null,this._pendingScrollPath="",this._onViewerScroll=()=>{this._pendingScrollPath=this.path,window.clearTimeout(this._scrollSaveTimer),this._scrollSaveTimer=window.setTimeout(()=>this._flushScrollMemory(),300)},this._onMobileBackClick=()=>{this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))},this._onMobileMoreClick=t=>{t.stopPropagation(),this._showMobileMenu=!this._showMobileMenu},this._onDocClick=t=>{var s,a;if(!this._showMobileMenu)return;const e=t.composedPath(),r=(s=this.shadowRoot)==null?void 0:s.querySelector(".mobile-menu"),i=(a=this.shadowRoot)==null?void 0:a.querySelector(".mobile-more");r&&e.includes(r)||i&&e.includes(i)||(this._showMobileMenu=!1)},this._onEditorCancel=()=>{this._captureEditorAnchor(),this._mode="preview"},this._onEditorDirty=t=>{this.dispatchEvent(new CustomEvent("dirty-change",{detail:{dirty:t.detail.dirty}}))},this._onDownloadClick=()=>{if(!this.path)return;const t=`/api/preview/download?path=${encodeURIComponent(this.path)}`,e=document.createElement("a");e.href=t,e.rel="noopener",document.body.appendChild(e),e.click(),document.body.removeChild(e)},this._onReparseClick=()=>{this.path&&this.dispatchEvent(new CustomEvent("reparse",{detail:{path:this.path},bubbles:!0,composed:!0}))},this._onUploadClick=()=>{var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector('input[type="file"]');t==null||t.click()},this._onHighlightToggle=async()=>{var t;if(this._showHighlightBar=!this._showHighlightBar,this._showHighlightBar){await this.updateComplete;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".highlight-bar input");e==null||e.focus()}},this._onHighlightInput=t=>{this._highlightInput=t.target.value,this._clearHighlightDebounce(),this._highlightInput.trim()&&(this._highlightDebounce=window.setTimeout(()=>{this._highlightDebounce=void 0,this._jumpToFirstHit()},300))},this._onHighlightKeydown=t=>{t.key==="Enter"?(this._clearHighlightDebounce(),this._jumpToFirstHit()):t.key==="Escape"&&this._onHighlightClear()},this._onHighlightClear=()=>{this._clearHighlightDebounce(),this._highlightInput="",this._showHighlightBar=!1}}willUpdate(t){t.has("path")&&(this._highlightInput="",this._showHighlightBar=!1,this._clearHighlightDebounce(),this._flushScrollMemory()),t.has("content")&&(this._content=this.content,this._mode="preview",this._skipRestoreOnce=!0,this._suppressLocate=!1,this._anchorLine=1)}async updated(t){var i;(i=super.updated)==null||i.call(this,t);const e=this.shadowRoot.querySelector(".body");e?this._scrollJump.attach(e):this._scrollJump.detach();const r=this.shadowRoot.querySelector("md-viewer");if(this.rememberScroll&&r&&this._mode==="preview"?this._scrollBoundViewer!==r&&(this._detachScrollMemory(),r.addEventListener("scroll",this._onViewerScroll,{passive:!0}),this._scrollBoundViewer=r):this._scrollBoundViewer&&this._detachScrollMemory(),this.rememberScroll&&t.has("path")){const s=Jb(this.path);if(s!==null&&s>1&&this.language==="markdown"&&r){const a=this.path;if(await r.updateComplete,this.path!==a)return;r.scrollToSourceLine(s,"auto")}}if(t.has("_mode")){if(this._mode==="edit"){const s=this.shadowRoot.querySelector("md-editor");s&&(await s.updateComplete,s.scrollToLine(this._anchorLine));return}if(this._skipRestoreOnce){this._skipRestoreOnce=!1;return}r&&(await r.updateComplete,r.scrollToSourceLine(this._anchorLine,"auto")),this._suppressLocate=!1}}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick,!0)}disconnectedCallback(){document.removeEventListener("click",this._onDocClick,!0),this._clearHighlightDebounce(),this._detachScrollMemory(),super.disconnectedCallback()}_flushScrollMemory(){window.clearTimeout(this._scrollSaveTimer),this._scrollSaveTimer=void 0;const t=this._scrollBoundViewer,e=this._pendingScrollPath;this._pendingScrollPath="",!(!t||!e)&&Qb(e,t.topSourceLine())}_detachScrollMemory(){this._scrollBoundViewer&&this._scrollBoundViewer.removeEventListener("scroll",this._onViewerScroll),this._flushScrollMemory(),this._scrollBoundViewer=null}_basename(t){if(!t)return"";const e=t.lastIndexOf("/");return e>=0?t.slice(e+1):t}get _isPst(){return Li(this.path)||Jr(this.path)}_renderMobileHeader(){return h`
    ...
    `}enterEdit(){const t=this.shadowRoot.querySelector("md-viewer");t&&(this._anchorLine=t.topSourceLine()),this._mode="edit"}_captureEditorAnchor(){const t=this.shadowRoot.querySelector("md-editor");t&&(this._anchorLine=t.topLine()),this._suppressLocate=!0}async _onEditorSave(t){const e=this.shadowRoot.querySelector("md-editor");this._captureEditorAnchor();try{await Wb(this.path,t.detail.content),this._content=t.detail.content,this._mode="preview",this.dispatchEvent(new CustomEvent("saved",{detail:{content:t.detail.content}}))}catch(r){const i=r instanceof $h?`${r.code} ${r.message}`:r.message??"保存失败";e==null||e.setError(i),this.dispatchEvent(new CustomEvent("save-failed",{detail:{message:i}}))}}discard(){const t=this.shadowRoot.querySelector("md-editor");t==null||t.discard(),this._mode="preview"}_renderDownloadBtn(){return this._isPst?null:h`<button class="download-btn" @click=${this._onDownloadClick}><doclens-icon name="download"></doclens-icon><span class="btn-label">下载</span></button>`}_renderReparseBtn(){return!this.enableReparse||this._isPst||!zd(this.path)?null:h`<button class="download-btn" @click=${this._onReparseClick}><doclens-icon name="refresh-cw"></doclens-icon><span class="btn-label">重新解析</span></button>`}_renderBackBtn(){return this.showBack?h`<button class="back-btn" @click=${this._onMobileBackClick}><doclens-icon name="arrow-left"></doclens-icon><span class="btn-label">${this.backLabel}</span></button>`:null}async _onFileChange(t){var s;const e=t.target,r=(s=e.files)==null?void 0:s[0];if(e.value="",!(!r||!window.confirm(`即将上传 '${r.name}' 覆盖原文件，是否继续？`)))try{const a=await Vb(r);this.dispatchEvent(new CustomEvent("upload-success",{detail:{path:a.path}}))}catch(a){const o=a instanceof Th?`${a.code} ${a.message}`:a.message??"上传失败";this.dispatchEvent(new CustomEvent("upload-failed",{detail:{message:o}}))}}_renderUploadBtn(){return this._isPst?null:h`<button class="upload-btn" @click=${this._onUploadClick}><doclens-icon name="upload"></doclens-icon><span class="btn-label">上传</span></button>`}_renderHighlightBtn(){return h`<button
...
`);return h`
  ...
  `];Oe([y()],Ce.prototype,"path",2);Oe([y()],Ce.prototype,"language",2);Oe([y()],Ce.prototype,"content",2);Oe([y({attribute:!1})],Ce.prototype,"highlights",2);Oe([y({type:Boolean})],Ce.prototype,"loading",2);Oe([y({type:Number})],Ce.prototype,"line",2);Oe([y()],Ce.prototype,"keyword",2);Oe([y({type:Boolean})],Ce.prototype,"writable",2);Oe([y({type:Boolean})],Ce.prototype,"noHeader",2);Oe([y({type:Boolean})],Ce.prototype,"mobile",2);Oe([y({attribute:!1})],Ce.prototype,"pages",2);Oe([y({attribute:!1})],Ce.prototype,"attachments",2);Oe([y({type:Boolean})],Ce.prototype,"showBack",2);Oe([y()],Ce.prototype,"backLabel",2);Oe([y({type:Boolean})],Ce.prototype,"enableReparse",2);Oe([y({type:Boolean})],Ce.prototype,"rememberScroll",2);Oe([z()],Ce.prototype,"_mode",2);Oe([z()],Ce.prototype,"_content",2);Oe([z()],Ce.prototype,"_showMobileMenu",2);Oe([z()],Ce.prototype,"_showHighlightBar",2);Oe([z()],Ce.prototype,"_highlightInput",2);Ce=Oe([K("preview-pane")],Ce);const r2="modulepreload",i2=function(t){return"/"+t},$d={},s2=function(e,r,i){let s=Promise.resolve();if(r&&r.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(r.map(c=>{if(c=i2(c),c in $d)return;$d[c]=!0;const p=c.endsWith(".css"),f=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${f}`))return;const g=document.createElement("link");if(g.rel=p?"stylesheet":r2,p||(g.as="script"),g.crossOrigin="",g.href=c,l&&g.setAttribute("nonce",l),document.head.appendChild(g),p)return new Promise((w,k)=>{g.addEventListener("load",w),g.addEventListener("error",()=>k(new Error(`Unable to preload CSS for ${c}`)))})}))}function a(o){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=o,window.dispatchEvent(l),!l.defaultPrevented)throw o}return s.then(o=>{for(const l of o||[])l.status==="rejected"&&a(l.reason);return e().catch(a)})},a2=1e4;async function o2(t){const e=new AbortController,r=setTimeout(()=>e.abort(),a2);try{return await de("/api/ask/respond",{method:"POST",json:t,signal:e.signal})}finally{clearTimeout(r)}}function Ah(t){try{const e=JSON.parse(t);if(!Array.isArray(e==null?void 0:e.questions))return null;const r=e.questions;return r.length===0?null:r.every(s=>typeof(s==null?void 0:s.question)=="string"&&typeof(s==null?void 0:s.header)=="string"&&Array.isArray(s==null?void 0:s.options)&&s.options.length>=2&&s.options.every(a=>typeof(a==null?void 0:a.label)=="string"))?r:null}catch{return null}}function Mh(t){const e=t.match(/^\((?:Recommended|推荐)\)\s*/);return e?[t.slice(e[0].length),!0]:t.endsWith("（推荐）")?[t.slice(0,-4),!0]:t.endsWith("(推荐)")?[t.slice(0,-4),!0]:[t,!1]}const n2=Object.freeze(Object.defineProperty({__proto__:null,parseAskQuestions:Ah,respondAsk:o2,splitRecommended:Mh},Symbol.toStringTag,{value:"Module"}));var l2=Object.defineProperty,c2=Object.getOwnPropertyDescriptor,li=(t,e,r,i)=>{for(var s=i>1?void 0:i?c2(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&l2(e,r,s),s};let ar=class extends G{constructor(){super(...arguments),this.ask=null,this.resolvedAnswers=null,this._selected=[],this._others=[],this._status="pending",this._answers=[],this._submitting=!1}willUpdate(t){t.has("ask")&&this.ask&&(this._selected=this.ask.questions.map(()=>[]),this._others=this.ask.questions.map(()=>null),this._status="pending",this._answers=[]),t.has("resolvedAnswers")&&this.resolvedAnswers&&(this._status="answered",this._answers=this.resolvedAnswers)}get _canSubmit(){return this.ask?this.ask.questions.every((t,e)=>{var a;const r=((a=this._selected[e])==null?void 0:a.length)??0,i=(this._others[e]??"").trim(),s=this._others[e]!==null&&i.length>0;return r>0||s}):!1}_toggle(t,e,r){const i=[...this._selected],s=i[t]??[];i[t]=r?s.includes(e)?s.filter(a=>a!==e):[...s,e]:s.includes(e)?[]:[e],this._selected=i}_onOtherInput(t,e){const r=[...this._others];r[t]=e,this._others=r}async _submit(){if(!this.ask||!this._canSubmit||this._submitting)return;this._submitting=!0;const t=this.ask.questions.map((r,i)=>({question:r.question,selected:this._selected[i]??[],other:(this._others[i]??"").trim()||null}));let e=!1;try{const{respondAsk:r}=await s2(async()=>{const{respondAsk:s}=await Promise.resolve().then(()=>n2);return{respondAsk:s}},void 0),{submitted:i}=await r({request_id:this.ask.requestId,answers:t});this._status=i?"answered":"expired",this._answers=t,e=!0}catch(r){console.warn("[ask-card] respond failed:",r),this._status="expired",this._answers=t,e=!0}finally{this._submitting=!1,e&&this._dispatchDone()}}_dispatchDone(){var t;this.dispatchEvent(new CustomEvent("ask-done",{detail:{requestId:((t=this.ask)==null?void 0:t.requestId)??""},bubbles:!0,composed:!0}))}_renderQuestion(t,e){const r=this._selected[e]??[],i=this._others[e]??null;return h`
      <div class="q">
        <p class="q-title">
  ...
  `];Cs([y({reflect:!0})],si.prototype,"role",2);Cs([y({attribute:!1})],si.prototype,"message",2);Cs([y()],si.prototype,"error",2);Cs([y({attribute:!1})],si.prototype,"modelName",2);Cs([z()],si.prototype,"_copied",2);si=Cs([K("chat-message")],si);var p2=Object.defineProperty,f2=Object.getOwnPropertyDescriptor,Sa=(t,e,r,i)=>{for(var s=i>1?void 0:i?f2(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&p2(e,r,s),s};const m2={search:"search",read_document:"file",grep:"search"},v2={search:"正在搜索",read_document:"正在读取",grep:"正在检索"};function g2(t){const e=[`思考过程（${t.length} 步）`];return t.forEach((r,i)=>{e.push(""),e.push(`[${i+1}] ${r.name}`),Object.keys(r.input).length&&(e.push("参数："),e.push(JSON.stringify(r.input,null,2))),r.output!=null&&r.output!==""?(e.push("结果："),e.push(r.output)):e.push("结果：（无输出）")}),e.join(`
`)}let Bi=class extends G{constructor(){super(...arguments),this.steps=[],this._expanded=!1,this._fullResultIds=new Set,this._copied=!1}willUpdate(t){if(t.has("steps")){const r=(t.get("steps")??[]).some(s=>s.status==="running"),i=this.steps.some(s=>s.status==="running");!r&&i?this._expanded=!0:r&&!i&&(this._expanded=!1)}}_toggle(){this._expanded=!this._expanded}_toggleResult(t){const e=new Set(this._fullResultIds);e.has(t)?e.delete(t):e.add(t),this._fullResultIds=e}async _onCopy(t){t.stopPropagation();const e=g2(this.steps);try{await navigator.clipboard.writeText(e),this._copied=!0,setTimeout(()=>{this._copied=!1},2e3)}catch{try{const i=document.createElement("textarea");i.value=e,i.style.position="fixed",i.style.opacity="0",document.body.appendChild(i),i.select(),document.execCommand("copy"),document.body.removeChild(i),this._copied=!0,setTimeout(()=>{this._copied=!1},2e3)}catch(i){console.warn("copy failed:",i)}}}_renderArgs(t){return Object.entries(t).map(([e,r])=>`${e}: ${typeof r=="string"?r:JSON.stringify(r)}`).join(`
`)}_renderStep(t){const e=t.status==="running",r=t.status==="error",i=m2[t.name]??"settings",s=this._fullResultIds.has(t.tool_use_id),a=(t.output??"").split(`
...
`):t.output??"",c=t.output!=null&&t.output!=="";return h`
      <div class="step ${e?"running":""} ${r?"error":""}">
        <div class="head">
          ...
          <span class="name">${t.name}</span>
          ${e?h`<span class="running-text">${v2[t.name]??"正在调用"}...</span>`:null}
          <span class="meta">
  ...
  `;Sa([y({attribute:!1})],Bi.prototype,"steps",2);Sa([z()],Bi.prototype,"_expanded",2);Sa([z()],Bi.prototype,"_fullResultIds",2);Sa([z()],Bi.prototype,"_copied",2);Bi=Sa([K("chat-tool-trace")],Bi);var b2=Object.defineProperty,x2=Object.getOwnPropertyDescriptor,xc=(t,e,r,i)=>{for(var s=i>1?void 0:i?x2(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&b2(e,r,s),s};let fa=class extends G{constructor(){super(...arguments),this.messages=[],this.modelName=null,this._scrollRafPending=!1}updated(){this._scrollRafPending||(this._scrollRafPending=!0,requestAnimationFrame(()=>{this._scrollRafPending=!1,this.scrollTop=this.scrollHeight}))}render(){return this.messages.length===0?h`<div class="empty">开始与 Doclens 对话</div>`:h`
  ...
  `;za([y({type:Number})],Ni.prototype,"total",2);za([y({type:Number})],Ni.prototype,"offset",2);za([y({type:Number})],Ni.prototype,"limit",2);za([y({type:Boolean})],Ni.prototype,"disabled",2);Ni=za([K("pagination-bar")],Ni);var S2=Object.defineProperty,z2=Object.getOwnPropertyDescriptor,ci=(t,e,r,i)=>{for(var s=i>1?void 0:i?z2(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&S2(e,r,s),s};const Ed=new Map;let or=class extends G{constructor(){super(...arguments),this.pstPath="",this.showBack=!1,this._emails=[],this._total=0,this._offset=0,this._loading=!1,this._error=null,this._limit=50,this._onPageChange=t=>{this._offset=(t.detail.page-1)*this._limit,Ed.set(this.pstPath,this._offset),this._load()},this._onBackClick=()=>{this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}}willUpdate(t){t.has("pstPath")&&(this._offset=Ed.get(this.pstPath)??0,this._load())}async _load(){if(!this.pstPath)return;this._loading=!0,this._error=null;const t=await Yb(this.pstPath,this._offset,this._limit);t.ok&&t.path!==this.pstPath||(t.ok?(this._emails=t.emails,this._total=t.total):(this._emails=[],this._total=0,this._error=t.notIndexed?"该 PST 尚未索引，请先执行 doclens index。":t.message||"加载失败"),this._loading=!1)}_onRowClick(t){this.dispatchEvent(new CustomEvent("open-email",{detail:{path:`${this.pstPath}#${t.entry_id}`},bubbles:!0,composed:!0}))}_basename(t){const e=t.lastIndexOf("/");return e>=0?t.slice(e+1):t}render(){return this._loading&&this._emails.length===0?h`<div class="state">加载中...</div>`:this._error?h`<div class="state error">${this._error}</div>`:h`
      <div class="header">
  ...
  `;ci([y()],or.prototype,"pstPath",2);ci([y({type:Boolean})],or.prototype,"showBack",2);ci([z()],or.prototype,"_emails",2);ci([z()],or.prototype,"_total",2);ci([z()],or.prototype,"_offset",2);ci([z()],or.prototype,"_loading",2);ci([z()],or.prototype,"_error",2);or=ci([K("pst-email-list")],or);var $2=Object.defineProperty,T2=Object.getOwnPropertyDescriptor,Ih=(t,e,r,i)=>{for(var s=i>1?void 0:i?T2(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&$2(e,r,s),s};let So=class extends G{constructor(){super(...arguments),this._toasts=[],this._nextId=1,this._timers=new Map}pushToast(t,e="info",r=2500){const i=this._nextId++;if(this._toasts=[...this._toasts,{id:i,message:t,level:e,duration:r}],r>0){const s=window.setTimeout(()=>this.dismiss(i),r);this._timers.set(i,s)}}dismiss(t){const e=this._timers.get(t);e!==void 0&&(window.clearTimeout(e),this._timers.delete(t)),this._toasts=this._toasts.filter(r=>r.id!==t)}disconnectedCallback(){super.disconnectedCallback();for(const t of this._timers.values())window.clearTimeout(t);this._timers.clear()}render(){return h`
...
确定要丢弃吗？`))return;const s=(e=this.shadowRoot)==null?void 0:e.querySelector("preview-pane");(r=s==null?void 0:s.discard)==null||r.call(s),this.previewDirty=!1}await t()}async _reloadPreview(){if(!this.previewPath)return;const t=await gs(this.previewPath);t.ok&&(this.previewContent=t.content,this.previewLanguage=t.language,this.previewWritable=t.writable,this.previewPages=t.pages,this.previewAttachments=t.attachments)}_pushToast(t,e,r){var s;const i=(s=this.shadowRoot)==null?void 0:s.querySelector("toast-stack");i==null||i.pushToast(t,e,r)}_renderNotIndexedHint(){return h`<div class="not-indexed-hint">
      ...
      <div class="form">
        ...
        <div>
          ...
          <select class="select" .value=${e.protocol} @change=${i=>this._setField("protocol",i.target.value)}>
            ${G2.map(i=>h`<option value=${i.value} ?selected=${i.value===e.protocol}>${i.label}</option>`)}
          </select>
        </div>
        <div class="full">
  ...
  `;mr([y()],Rt.prototype,"activeSearch",2);mr([z()],Rt.prototype,"_presets",2);mr([z()],Rt.prototype,"_loading",2);mr([z()],Rt.prototype,"_editing",2);mr([z()],Rt.prototype,"_busy",2);mr([z()],Rt.prototype,"_error",2);mr([z()],Rt.prototype,"_toast",2);mr([z()],Rt.prototype,"_confirmDeleteId",2);mr([z()],Rt.prototype,"_formError",2);Rt=mr([K("search-presets-section")],Rt);var Z2=Object.defineProperty,J2=Object.getOwnPropertyDescriptor,vr=(t,e,r,i)=>{for(var s=i>1?void 0:i?J2(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&Z2(e,r,s),s};const Md=["ai","search","network"],Q2={ai:"sparkles",search:"search",network:"globe"},e4=h`
...
`;let Lt=class extends G{constructor(){super(...arguments),this._activeTab="ai",this._saving=!1,this._error=null,this._toast=null,this._values={},this._original={},this._exists=!0,this._scope="global",this._fieldErrors={},this._loadGen=0,this._onRevertRequest=()=>{this._revert()}}connectedCallback(){super.connectedCallback();const t=T.getState();this._scope=t.settings.scope,this._unsubscribe=T.subscribe(()=>this._onStoreChange()),window.addEventListener("cortex:revert-settings",this._onRevertRequest),this._load()}disconnectedCallback(){var t;(t=this._unsubscribe)==null||t.call(this),this._toastTimer!==void 0&&(window.clearTimeout(this._toastTimer),this._toastTimer=void 0),this._loadGen+=1,window.removeEventListener("cortex:revert-settings",this._onRevertRequest),super.disconnectedCallback()}_onStoreChange(){const t=T.getState();t.settings.scope!==this._scope&&(this._scope=t.settings.scope,this._load())}async _load(){const t=++this._loadGen;this._error=null;try{const e=await N2(this._scope);if(t!==this._loadGen||!this.isConnected)return;this._values={...e.values},this._original={...e.values},this._exists=e.exists,this._fieldErrors={},C.loadSettings(this._values,e.exists)}catch(e){if(t!==this._loadGen||!this.isConnected)return;this._error=`加载失败: ${e.message}`}}get _dirtyFields(){const t=new Set([...Object.keys(this._original),...Object.keys(this._values)]),e=[];for(const r of t)(this._original[r]??"")!==(this._values[r]??"")&&e.push(r);return e}get _dirty(){return this._dirtyFields.length>0}_updateValues(t){this._values={...this._values,...t};for(const[e,r]of Object.entries(t))C.updateSetting(e,r)}_onInput(t,e){this._updateValues({[t]:e})}_isMobile(){return typeof window.matchMedia=="function"&&window.matchMedia("(max-width: 1023px)").matches}_pushToast(t,e="info",r=2500){var s;const i=(s=this.shadowRoot)==null?void 0:s.querySelector("toast-stack");i==null||i.pushToast(t,e,r)}_extractFieldErrors(t){if(t instanceof zo){const e=t.body,r={};for(const i of(e==null?void 0:e.fields)??[])r[i.field]=i.error;return r}return{}}_close(){zr.navigate(zr.lastMain())}async _refreshSystemStatus(){try{const t=await cu();C.setStatus(t)}catch{}}_revert(){this._values={...this._original},C.revertSettings()}async _save(){var t;if(!(!this._dirty||this._saving)){this._saving=!0,this._error=null,this._fieldErrors={};try{const e=await F2(this._scope,this._values);if(!this.isConnected)return;this._original={...this._values},C.loadSettings(this._values,!0),this._refreshSystemStatus();const r=e.needs_restart?"已保存。重启 doclens gui 后 AI 配置生效。":"已保存。下次查询立即生效。";this._isMobile()?this._pushToast(r,"success",4e3):this._toast=r}catch(e){let r;if(e instanceof zo){const i=e.body,s=(t=i==null?void 0:i.fields)==null?void 0:t.map(a=>a.field).join(", ");r=s?`保存失败（${s}）`:`保存失败 (HTTP ${e.status})`}else e instanceof Error?r=`保存失败: ${e.message}`:r="保存失败: 未知错误";this._isMobile()?(this._pushToast(r,"error",5e3),this._fieldErrors=this._extractFieldErrors(e)):this._error=r}finally{this._saving=!1}}}_renderField(t){const e=this._values[t.envVar]??"";return h`
    ...
    `}_renderDesc(t){if(t.tab!=="search"||!t.hint)return N;const e=t.hint.replace(/。$/,""),r=t.min!=null&&t.max!=null?` · ${t.min}–${t.max}`:"";return h`<div class="desc">${e}${r}</div>`}_renderInput(t,e){const r=t.mono?"mono":"",i=s=>this._onInput(t.envVar,s.target.value);switch(t.component){case"text":return h`
        ...
        `;case"switch":{const s=e==="",a=s?(L2[t.envVar]??"true")==="true":e==="true",o=l=>this._onInput(t.envVar,l.target.checked?"true":"false");return h`
          <label class="switch">
            <input
              type="checkbox"
              .checked=${a}
        ...
        <aside class="sidebar">
          <nav class="tab-strip" role="tablist">
            ${Md.map(r=>h`
              ...
              ><doclens-icon name=${Q2[r]}></doclens-icon>${R2[r]}</button>
            `)}
          </nav>
        </aside>
        <main class="main">
          <div class="scroll-area">
            ${Md.map(r=>{const i=B2.filter(a=>a.tab===r),s=[];for(const a of i){const o=a.section??"";let l=s.find(c=>c.title===o);l||(l={title:o,fields:[]},s.push(l)),l.fields.push(a)}return h`
  ...
  `;$l=a4([K("file-tree")],$l);const o4={pdf:{letter:"P",bg:"#E41E3F",fg:"#FFFFFF"},doc:{letter:"D",bg:"#0064E0",fg:"#FFFFFF"},docx:{letter:"D",bg:"#0064E0",fg:"#FFFFFF"},xls:{letter:"X",bg:"#31A24C",fg:"#FFFFFF"},xlsx:{letter:"X",bg:"#31A24C",fg:"#FFFFFF"},csv:{letter:"C",bg:"#31A24C",fg:"#FFFFFF"},ppt:{letter:"S",bg:"#EA580C",fg:"#FFFFFF"},pptx:{letter:"S",bg:"#EA580C",fg:"#FFFFFF"},md:{letter:"M",bg:"#A121CE",fg:"#FFFFFF"},txt:{letter:"T",bg:"#5D6C7B",fg:"#FFFFFF"},html:{letter:"H",bg:"#E34F26",fg:"#FFFFFF"},mhtml:{letter:"W",bg:"#0D9488",fg:"#FFFFFF"},mht:{letter:"W",bg:"#0D9488",fg:"#FFFFFF"},png:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},jpg:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},jpeg:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},webp:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},gif:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},bmp:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},tiff:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},tif:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"}};function n4(t){if(!t)return"";const e=t.lastIndexOf(".");return e<=0||e===t.length-1?"":t.slice(e+1).toLowerCase()}function l4(t,e){if(e)return null;const r=n4(t);return o4[r]??null}var c4=Object.defineProperty,d4=Object.getOwnPropertyDescriptor,Vo=(t,e,r,i)=>{for(var s=i>1?void 0:i?d4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&c4(e,r,s),s};let bs=class extends G{constructor(){super(...arguments),this.selected=!1,this.active=!1}_fmtSize(t){return t<1024?`${t} B`:t<1024*1024?`${(t/1024).toFixed(1)} KB`:`${(t/1024/1024).toFixed(1)} MB`}_fmtTime(t){if(!t)return"";try{return new Date(t).toLocaleString(void 0,{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"})}catch{return""}}_onRowClick(){this.dispatchEvent(new CustomEvent("activated",{detail:{path:this.entry.path,is_dir:this.entry.is_dir},bubbles:!0,composed:!0}))}_onCheckboxClick(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("checked",{detail:{path:this.entry.path,ctrl:t.ctrlKey||t.metaKey,shift:t.shiftKey},bubbles:!0,composed:!0}))}render(){const t=l4(this.entry.name,this.entry.is_dir);return h`
      <div
  ...
  `;Vo([y({type:Object})],bs.prototype,"entry",2);Vo([y({type:Boolean})],bs.prototype,"selected",2);Vo([y({type:Boolean})],bs.prototype,"active",2);bs=Vo([K("file-row")],bs);var u4=Object.defineProperty,h4=Object.getOwnPropertyDescriptor,$a=(t,e,r,i)=>{for(var s=i>1?void 0:i?h4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&u4(e,r,s),s};const Fh=[28,28,240,80,140],Pd=[20,20,80,50,80],Dd=[60,60,800,200,300],Id=Fh.length,Od="cortex.files.colWidths";let Fi=class extends G{constructor(){super(...arguments),this.activePath="",this.mobile=!1,this._colWidths=[...Fh],this._showMobileMenu=!1,this._makeColResizeHandler=t=>e=>{e.preventDefault(),e.stopPropagation();const r=e.clientX,i=this._colWidths[t];document.body.style.cursor="col-resize",document.body.style.userSelect="none";const s=o=>{const l=o.clientX-r,c=Math.max(Pd[t],Math.min(Dd[t],i+l)),p=[...this._colWidths];p[t]=c,this._colWidths=p},a=()=>{document.removeEventListener("mousemove",s),document.removeEventListener("mouseup",a),document.body.style.cursor="",document.body.style.userSelect="",localStorage.setItem(Od,JSON.stringify(this._colWidths))};document.addEventListener("mousemove",s),document.addEventListener("mouseup",a)},this._onMobileBackClick=()=>{this._showMobileMenu=!1,this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))},this._onMobileMoreClick=t=>{t.stopPropagation(),this._showMobileMenu=!this._showMobileMenu},this._onDocClick=t=>{var s,a;if(!this._showMobileMenu)return;const e=t.composedPath(),r=(s=this.shadowRoot)==null?void 0:s.querySelector(".mobile-menu"),i=(a=this.shadowRoot)==null?void 0:a.querySelector(".mobile-more");r&&e.includes(r)||i&&e.includes(i)||(this._showMobileMenu=!1)},this._onMenuItemClick=t=>e=>{e.stopPropagation(),this._showMobileMenu=!1,this._action(t)}}connectedCallback(){super.connectedCallback(),this._unsubscribe=T.subscribe(()=>this.requestUpdate()),this._loadColWidths(),document.addEventListener("click",this._onDocClick,!0)}disconnectedCallback(){var t;(t=this._unsubscribe)==null||t.call(this),document.removeEventListener("click",this._onDocClick,!0),super.disconnectedCallback()}willUpdate(){for(let t=0;t<Id;t++)this.style.setProperty(`--col-${t+1}`,`${this._colWidths[t]}px`)}_loadColWidths(){const t=localStorage.getItem(Od);if(t)try{const e=JSON.parse(t);Array.isArray(e)&&e.length===Id&&e.every(r=>typeof r=="number"&&Number.isFinite(r))&&(this._colWidths=e.map((r,i)=>Math.max(Pd[i],Math.min(Dd[i],r))))}catch{}}_action(t){this.dispatchEvent(new CustomEvent("action",{detail:{name:t},bubbles:!0,composed:!0}))}_onRowChecked(t){const{path:e,shift:r}=t.detail;C.selectEntry(e,{ctrl:!r,shift:r})}_onSelectAll(t){const e=t.target,{currentDir:r,treeCache:i,selectedPaths:s}=T.getState().files,a=i[r]||[];if(e.checked){const o=a.map(c=>c.path),l=Array.from(new Set([...s,...o]));C.setFilesState({selectedPaths:l})}else{const o=new Set(a.map(l=>l.path));C.setFilesState({selectedPaths:s.filter(l=>!o.has(l))})}}_goUp(){const{currentDir:t}=T.getState().files;if(t==="")return;const e=t.includes("/")?t.slice(0,t.lastIndexOf("/")):"";C.selectDir(e)}_renderMobileHeader(){const{currentDir:t,selectedPaths:e}=T.getState().files,r=e.length===1,i=e.length>=1,s=t===""?"/":`/${t}/`;return h`
      <div class="mobile-header">
        <button
          class="mobile-back"
          type="button"
  ...
  `;Go([y({type:String})],xs.prototype,"currentName",2);Go([z()],xs.prototype,"_name",2);Go([z()],xs.prototype,"_err",2);xs=Go([K("rename-dialog")],xs);class _c extends Error{constructor(e,r,i){super(r),this.code=e,this.status=i,this.name="ReparseError"}}async function w4(){return(await de("/api/vision/prompt")).prompt}async function _4(t,e){try{return await de("/api/vision/reparse",{method:"POST",json:{path:t,prompt:e}})}catch(r){throw r instanceof At?new _c(r.code,r.message,r.status):r}}async function k4(t,e){try{return await de("/api/vision/note",{method:"POST",json:{path:t,markdown:e}})}catch(r){throw r instanceof At?new _c(r.code,r.message,r.status):r}}var S4=Object.defineProperty,z4=Object.getOwnPropertyDescriptor,ui=(t,e,r,i)=>{for(var s=i>1?void 0:i?z4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&S4(e,r,s),s};let lr=class extends G{constructor(){super(...arguments),this.path="",this._mode="ai",this._defaultPrompt="",this._prompt="",this._promptLoading=!0,this._loading=!1,this._err=""}async connectedCallback(){super.connectedCallback();try{this._defaultPrompt=await w4(),this._mode==="ai"&&(this._prompt=this._defaultPrompt)}catch{this._err="加载默认提示词失败，请手动输入"}this._promptLoading=!1}_switchMode(t){this._loading||t===this._mode||(this._mode=t,this._err="",this._prompt=t==="ai"?this._defaultPrompt:"")}_clear(){this._loading||(this._prompt="",this._err="")}_onInput(t){this._prompt=t.target.value,this._err&&(this._err="")}async _submit(){if(!(this._loading||this._promptLoading)){if(!this._prompt.trim()){this._err=this._mode==="ai"?"提示词不能为空":"备注不能为空";return}this._err="",this._loading=!0;try{this._mode==="ai"?await _4(this.path,this._prompt):await k4(this.path,this._prompt),this.dispatchEvent(new CustomEvent("done",{bubbles:!0,composed:!0}))}catch(t){const e=t instanceof _c?`[${t.code}] `:"";this._err=`${e}${t.message??"操作失败"}`}finally{this._loading=!1}}}_cancel(){this._loading||this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){const t=this._mode==="ai",e=!this._loading&&!this._promptLoading&&!!this._prompt.trim(),r=!!this._err,i=this._loading?t?"解析中...":"保存中...":t?"重新解析":"保存备注";return h`
      <div class="mode-tabs">
...
说明文字…），将覆盖 AI 解析结果`}
  ...
  `;Xo([z()],ys.prototype,"_phase",2);Xo([z()],ys.prototype,"_stats",2);Xo([z()],ys.prototype,"_confirmed",2);ys=Xo([K("delete-dialog")],ys);async function A4(){return(await de("/api/skills")).skills??[]}var M4=Object.defineProperty,P4=Object.getOwnPropertyDescriptor,Ta=(t,e,r,i)=>{for(var s=i>1?void 0:i?P4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&M4(e,r,s),s};let Hi=class extends G{constructor(){super(...arguments),this._skills=[],this._loading=!0,this._error=null,this._isMobile=!1,this._onMqlChange=t=>{this._isMobile=t.matches}}connectedCallback(){super.connectedCallback(),this._mql=window.matchMedia("(max-width: 1023px)"),this._isMobile=this._mql.matches,this._mql.addEventListener("change",this._onMqlChange),this._load()}disconnectedCallback(){var t;(t=this._mql)==null||t.removeEventListener("change",this._onMqlChange),super.disconnectedCallback()}async _load(){this._loading=!0,this._error=null;try{this._skills=await A4()}catch(t){this._error=(t==null?void 0:t.message)||"技能列表加载失败"}finally{this._loading=!1}}_onPick(t){this.dispatchEvent(new CustomEvent("pick",{detail:{skill:t},bubbles:!0,composed:!0}))}_onItemKeydown(t,e){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),this._onPick(e))}_cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}_renderBody(){return this._loading?h`<div class="empty">加载中…</div>`:this._error?h`<div class="err">${this._error}</div>`:this._skills.length===0?h`<div class="empty">暂无可用技能</div>`:this._isMobile?h`<ul class="list">
  ...
  `;Ta([z()],Hi.prototype,"_skills",2);Ta([z()],Hi.prototype,"_loading",2);Ta([z()],Hi.prototype,"_error",2);Ta([z()],Hi.prototype,"_isMobile",2);Hi=Ta([K("skill-toolbox-dialog")],Hi);var D4=Object.defineProperty,I4=Object.getOwnPropertyDescriptor,Ko=(t,e,r,i)=>{for(var s=i>1?void 0:i?I4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&D4(e,r,s),s};let ws=class extends G{constructor(){super(...arguments),this.skill=null,this.filePaths=[],this._prompt=""}_submit(){this.dispatchEvent(new CustomEvent("submit",{detail:{prompt:this._prompt.trim()},bubbles:!0,composed:!0}))}_cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){const t=this.skill;return h`
      <h3>
  ...
  `;Sc([y({type:String})],ga.prototype,"targetDir",2);Sc([z()],ga.prototype,"_active",2);ga=Sc([K("drop-zone")],ga);var L4=Object.defineProperty,B4=Object.getOwnPropertyDescriptor,As=(t,e,r,i)=>{for(var s=i>1?void 0:i?B4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&L4(e,r,s),s};const N4=80,F4="按文件名搜索…";let ai=class extends G{constructor(){super(...arguments),this._value="",this._isComposing=!1,this.disabled=!1,this.placeholder=F4,this.value="",this._timer=null,this._onInput=t=>{const e=t.target;if(this._value=e.value,this._value.trim()===""){this._emitClear();return}this._scheduleEmit()},this._onCompositionStart=()=>{this._isComposing=!0},this._onCompositionEnd=()=>{this._isComposing=!1,this._scheduleEmit()},this._onKeyDown=t=>{t.key==="Escape"&&(t.preventDefault(),this._emitClear())},this._onClearClick=()=>{var e;this._emitClear();const t=(e=this.shadowRoot)==null?void 0:e.querySelector("input");t==null||t.focus()}}connectedCallback(){super.connectedCallback(),this.value&&(this._value=this.value)}disconnectedCallback(){this._timer&&clearTimeout(this._timer),super.disconnectedCallback()}_emitSearch(){this.dispatchEvent(new CustomEvent("search",{detail:{query:this._value},bubbles:!0,composed:!0}))}_scheduleEmit(){this._timer&&clearTimeout(this._timer),this._timer=setTimeout(()=>{this._timer=null,this._isComposing||this._emitSearch()},N4)}_emitClear(){var e;this._timer&&(clearTimeout(this._timer),this._timer=null),this._value="";const t=(e=this.shadowRoot)==null?void 0:e.querySelector("input");t&&(t.value=""),this.dispatchEvent(new CustomEvent("clear",{bubbles:!0,composed:!0}))}render(){return h`
      <div class="box">
  ...
  `;As([z()],ai.prototype,"_value",2);As([z()],ai.prototype,"_isComposing",2);As([y({type:Boolean})],ai.prototype,"disabled",2);As([y()],ai.prototype,"placeholder",2);As([y({type:String})],ai.prototype,"value",2);ai=As([K("file-search-box")],ai);var H4=Object.getOwnPropertyDescriptor,q4=(t,e,r,i)=>{for(var s=i>1?void 0:i?H4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=o(s)||s);return s};const j4=100;function U4(t,e){if(!e)return t;const r=t.toLowerCase(),i=e.toLowerCase(),s=r.indexOf(i);return s===-1?t:[t.slice(0,s),h`<mark>${t.slice(s,s+i.length)}</mark>`,t.slice(s+i.length)]}function W4(t){const e=t.lastIndexOf("/");return e===-1?"":t.slice(0,e+1)}function V4(t){return t<1024?`${t} B`:t<1024*1024?`${(t/1024).toFixed(1)} KB`:`${(t/1024/1024).toFixed(1)} MB`}function G4(t){if(!t)return"";const e=new Date(t).getTime();if(Number.isNaN(e))return"";const r=Date.now()-e,i=24*3600*1e3;return r<i?"今天":r<2*i?"昨天":r<7*i?`${Math.floor(r/i)} 天前`:r<30*i?`${Math.floor(r/(7*i))} 周前`:r<365*i?`${Math.floor(r/(30*i))} 个月前`:`${Math.floor(r/(365*i))} 年前`}let Tl=class extends G{constructor(){super(...arguments),this._onKeyDown=t=>{const{results:e,selectedPath:r}=this._state;if(e.length===0){t.key==="Escape"&&this.dispatchEvent(new CustomEvent("clear",{bubbles:!0,composed:!0}));return}const i=e.findIndex(s=>s.path===r);if(t.key==="ArrowDown"){t.preventDefault();const s=e[Math.min(e.length-1,i+1)];C.selectFilenameSearchResult(s.path),this.dispatchEvent(new CustomEvent("activated",{detail:{path:s.path},bubbles:!0,composed:!0}))}else if(t.key==="ArrowUp"){t.preventDefault();const s=e[Math.max(0,i-1)];C.selectFilenameSearchResult(s.path),this.dispatchEvent(new CustomEvent("activated",{detail:{path:s.path},bubbles:!0,composed:!0}))}else if(t.key==="Enter"){t.preventDefault();const s=e[i]??e[0];s&&this.dispatchEvent(new CustomEvent("activated",{detail:{path:s.path},bubbles:!0,composed:!0}))}else t.key==="Escape"&&this.dispatchEvent(new CustomEvent("clear",{bubbles:!0,composed:!0}))}}get _state(){return T.getState().files.filenameSearch}_onRowClick(t){C.selectFilenameSearchResult(t.path),this.dispatchEvent(new CustomEvent("activated",{detail:{path:t.path},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.tabIndex=0,this.addEventListener("keydown",this._onKeyDown),this._unsubscribe=T.subscribe(()=>this.requestUpdate())}disconnectedCallback(){var t;this.removeEventListener("keydown",this._onKeyDown),(t=this._unsubscribe)==null||t.call(this),super.disconnectedCallback()}render(){const{query:t,results:e,selectedPath:r,totalMatches:i}=this._state;return e.length===0?h`
      ...
      <div class="rows">
        ${e.map(s=>{const a=W4(s.path),o=s.path===r;return h`
            <div
              class="row ${o?"active":""}"
            ...
            >
              <span class="name-cell">
                ...
                <span class="name">${U4(s.name,t)}</span>
                ${a?h`<span class="dir">${a}</span>`:""}
              </span>
              <span class="meta">${V4(s.size)} · ${G4(s.modifiedAt)}</span>
            </div>
          `})}
      </div>
      ${i>e.length?h`<div class="overflow-hint">共 ${i} 项，仅显示前 ${j4}，请补充关键字</div>`:""}
    `}};Tl.styles=j`
    :host {
      display: flex;
      flex-direction: column;
...
确定要丢弃吗？`))return;this._discardPreviewEdits()}await this._fetchPreview(t)}async _fetchPreview(t){if(Jr(t)){this._previewError=null,this._previewPath=t,this._previewContent="",this._previewWritable=!1,this._previewPages=null,this._previewAttachments=null;return}const e=await gs(t);e.ok?(this._previewError=null,this._previewPath=e.path,this._previewContent=e.content,this._previewLanguage=e.language,this._previewWritable=e.writable,this._previewPages=e.pages,this._previewAttachments=e.attachments):e.notIndexed?(this._previewError="NOT_INDEXED",this._previewPath=t,this._previewContent="",this._previewWritable=!1,this._previewPages=null,this._previewAttachments=null):this._showToast(e.message||"预览失败")}async _reloadPreview(){if(!this._previewPath)return;const t=await gs(this._previewPath);t.ok&&(this._previewContent=t.content,this._previewLanguage=t.language,this._previewWritable=t.writable,this._previewPages=t.pages,this._previewAttachments=t.attachments)}_discardPreviewEdits(){var e,r;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("preview-pane");(r=t==null?void 0:t.discard)==null||r.call(t),this._previewDirty=!1}_renderNotIndexedHint(){return h`<div class="preview-placeholder">
  ...
  `;dt([z()],te.prototype,"_dialog",2);dt([z()],te.prototype,"_reparsePath",2);dt([z()],te.prototype,"_pickedSkill",2);dt([z()],te.prototype,"_toast",2);dt([z()],te.prototype,"_previewPath",2);dt([z()],te.prototype,"_previewContent",2);dt([z()],te.prototype,"_previewLanguage",2);dt([z()],te.prototype,"_previewWritable",2);dt([z()],te.prototype,"_previewPages",2);dt([z()],te.prototype,"_previewAttachments",2);dt([z()],te.prototype,"_previewError",2);dt([z()],te.prototype,"_previewDirty",2);dt([z()],te.prototype,"_treePaneWidth",2);dt([z()],te.prototype,"_previewPaneWidth",2);te=dt([K("files-view")],te);const qr=t=>`/api/diary${t}`,jr={today:()=>de(qr("/today")),entry:t=>de(qr(`/entry?date=${encodeURIComponent(t)}`)),calendar:t=>de(qr(`/calendar?month=${encodeURIComponent(t)}`)),addText:t=>de(qr("/fragments"),{method:"POST",json:{text:t}}),uploadPhoto:(t,e)=>{const r=new FormData;return r.append("file",t),r.append("caption",e),de(qr("/photos"),{method:"POST",body:r})},removeFragment:(t,e)=>de(qr(`/fragments/${encodeURIComponent(e)}?date=${encodeURIComponent(t)}`),{method:"DELETE"}),editFragment:(t,e,r)=>de(qr(`/fragments/${encodeURIComponent(e)}?date=${encodeURIComponent(t)}`),{method:"PUT",json:{text:r}}),setCity:(t,e)=>de(qr(`/city?date=${encodeURIComponent(t)}&city=${encodeURIComponent(e)}`),{method:"POST"})};var Y4=Object.defineProperty,Z4=Object.getOwnPropertyDescriptor,hi=(t,e,r,i)=>{for(var s=i>1?void 0:i?Z4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&Y4(e,r,s),s};const J4=["一","二","三","四","五","六","日"];function Kr(t){const[e,r,i]=t.split("-").map(Number);return new Date(e,r-1,i)}function Hh(t){const e=String(t.getMonth()+1).padStart(2,"0"),r=String(t.getDate()).padStart(2,"0");return`${t.getFullYear()}-${e}-${r}`}function ta(t){return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}`}function Ld(t,e){const r=Kr(t);return r.setDate(r.getDate()+e),Hh(r)}function Q4(t,e){const r=Kr(`${t}-01`);return r.setMonth(r.getMonth()+e),ta(r)}const ex=["星期一","星期二","星期三","星期四","星期五","星期六","星期日"];function tx(t){return ex[(Kr(t).getDay()+6)%7]}let cr=class extends G{constructor(){super(...arguments),this.month="",this.dates=[],this.selected="",this.today="",this._view="days",this._pickerYear=0,this._yearStart=0}_shiftMonth(t){this.dispatchEvent(new CustomEvent("month-change",{detail:{month:Q4(this.month,t)},bubbles:!0,composed:!0}))}_select(t){this.dispatchEvent(new CustomEvent("select-date",{detail:{date:t},bubbles:!0,composed:!0}))}_dispatchMonth(t){this.dispatchEvent(new CustomEvent("month-change",{detail:{month:t},bubbles:!0,composed:!0}))}_currentYear(){return Number(this.month.split("-")[0])||new Date().getFullYear()}_titleClick(){if(this._view==="days")this._pickerYear=this._currentYear(),this._view="months";else if(this._view==="months"){const t=this._pickerYear;this._yearStart=t-t%12,this._view="years"}else this._view="days"}_shiftPickerYear(t){this._pickerYear+=t}_shiftYearRange(t){this._yearStart+=t*12}_pickYear(t){this._pickerYear=t,this._view="months"}_pickMonth(t){const e=String(t).padStart(2,"0");this._dispatchMonth(`${this._pickerYear}-${e}`),this._view="days"}_cells(){const t=Kr(`${this.month}-01`),e=new Date(t.getFullYear(),t.getMonth()+1,0).getDate(),r=(t.getDay()+6)%7,i=[];for(let s=0;s<r;s++)i.push(null);for(let s=1;s<=e;s++)i.push({date:`${this.month}-${String(s).padStart(2,"0")}`,day:s,other:!1});return i}render(){return h`
    ...
    `}_renderDays(){const t=new Set(this.dates);return h`
      <div class="grid">
        ${J4.map(e=>h`<span class="wd">${e}</span>`)}
  ...
  `;hi([y()],cr.prototype,"month",2);hi([y({attribute:!1})],cr.prototype,"dates",2);hi([y()],cr.prototype,"selected",2);hi([y()],cr.prototype,"today",2);hi([z()],cr.prototype,"_view",2);hi([z()],cr.prototype,"_pickerYear",2);hi([z()],cr.prototype,"_yearStart",2);cr=hi([K("diary-calendar")],cr);class Pi extends Error{constructor(e,r){super(r),this.name="JsbridgePhotoError",this.code=e}}const ki="dbg1";function Bd(){const t=/NexBox\/(\d+(?:\.\d+)*)/.exec(navigator.userAgent),e=typeof window<"u"&&!!window.Android,r=typeof window<"u"&&!!window.jsbridge,i=r&&typeof window.jsbridge.takePhoto=="function",s=r&&typeof window.jsbridge.pickPhotos=="function",a=e&&!!i&&!!s;return[`[${ki}] UA:${t?`NexBox/${t[1]}`:"无NexBox标识"}`,`Android注入:${e?"有":"无"}`,`jsbridge.js:${r?"已加载":"未加载"}`,`takePhoto:${i?"✓":"✗"} pickPhotos:${s?"✓":"✗"}`,`判定→${a?"走jsbridge":"降级input"}`].join(" | ")}function rx(){return typeof window<"u"&&!!window.Android&&!!window.jsbridge&&typeof window.jsbridge.takePhoto=="function"&&typeof window.jsbridge.pickPhotos=="function"}function qh(t,e){const r=atob(t.base64),i=new Uint8Array(r.length);for(let a=0;a<r.length;a++)i[a]=r.charCodeAt(a);const s=t.mimeType==="image/jpeg"?"jpg":t.mimeType.split("/")[1]||"jpg";return new File([i],`${e}_${Date.now()}.${s}`,{type:t.mimeType})}function ix(t){switch(t){case 2:return"相机权限被拒，请在系统设置中开启后重试";case 3:return"未找到可用的相机或相册应用";default:return"拍照失败，请重试"}}function Nd(t){switch(t){case 3:return"未找到可用的相册应用";case 5:return"照片处理失败，请重试";default:return"选图失败，请重试"}}function sx(t){return"error"in t||typeof t.base64!="string"?null:t}const jh=15e3;function ax(){return new Promise((t,e)=>{let r=!1;const i=window.setTimeout(()=>{r||(r=!0,e(new Pi(-1,"原生15秒无回调：App 内可能未注册 takePhoto 插件（需 Android 仓库 2026-08-20 后的构建）")))},jh),s=a=>o=>{r||(r=!0,window.clearTimeout(i),a(o))};window.jsbridge.takePhoto({success:s(a=>{const o=a;if(typeof o.base64!="string"||!o.base64){e(new Pi(o.code??-1,"拍照失败，请重试"));return}t(qh(o,"photo"))}),fail:s(a=>{const o=a;e(new Pi(o.code??-1,ix(o.code??-1)))}),cancel:s(()=>t(null))})})}function ox(){return new Promise((t,e)=>{let r=!1;const i=window.setTimeout(()=>{r||(r=!0,e(new Pi(-1,"原生15秒无回调：App 内可能未注册 pickPhotos 插件（需 Android 仓库 2026-08-20 后的构建）")))},jh),s=a=>o=>{r||(r=!0,window.clearTimeout(i),a(o))};window.jsbridge.pickPhotos({maxCount:1,success:s(a=>{var c;const o=a,l=(c=o.photos)!=null&&c[0]?sx(o.photos[0]):null;if(!l){e(new Pi(5,Nd(5)));return}t(qh(l,"gallery"))}),fail:s(a=>{const o=a;e(new Pi(o.code??-1,Nd(o.code??-1)))}),cancel:s(()=>t(null))})})}var nx=Object.defineProperty,lx=Object.getOwnPropertyDescriptor,gr=(t,e,r,i)=>{for(var s=i>1?void 0:i?lx(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&nx(e,r,s),s};let Bt=class extends G{constructor(){super(...arguments),this.entry=null,this.submitting=!1,this.city="",this._pendingFile=null,this._pendingPreviewUrl="",this._confirmingFid="",this._editingFid="",this._editText="",this._viewerSrc="",this._dbgShown=!1}connectedCallback(){super.connectedCallback(),this._dbgShown||(this._dbgShown=!0,this.updateComplete.then(()=>this._debugToast(Bd(),"info",6e3)))}_debugToast(t,e="info",r=4e3){}_onSubmitText(t){this.dispatchEvent(new CustomEvent("submit-text",{detail:{value:t.detail.value},bubbles:!0,composed:!0}));const e=t.target;e.value=""}_onCityTag(){this.dispatchEvent(new CustomEvent("city-change",{bubbles:!0,composed:!0}))}_pickPhoto(t){if(rx()){this._debugToast(`[${ki}] 点${t?"拍照":"相册"}→调jsbridge ${t?"takePhoto":"pickPhotos"}…`),this._toastCalledJsbridge(t),this._pickPhotoViaJsbridge(t);return}this._debugToast(`[${ki}] 点${t?"拍照":"相册"}→降级input：${Bd()}`,"error",6e3);const e=this.renderRoot.querySelector(t?"input[data-capture]":"input[data-gallery]");e==null||e.click()}async _pickPhotoViaJsbridge(t){try{const e=await(t?ax():ox());e?(this._debugToast(`[${ki}] 原生回调success：${e.name} ${(e.size/1024).toFixed(0)}KB`,"success"),this._setPendingFile(e)):this._debugToast(`[${ki}] 原生回调cancel（用户取消）`)}catch(e){const r=e instanceof Pi?`[${ki}] 原生回调fail code=${e.code}：${e.message}`:"拍照失败，请重试";this._debugToast(r,"error",6e3),this.dispatchEvent(new CustomEvent("photo-error",{detail:{message:r},bubbles:!0,composed:!0}))}}_toastCalledJsbridge(t){this._debugToast(`[${ki}] messageSend已发出(${t?"takePhoto":"pickPhotos"})，等原生回调（15s超时）…`,"info",5e3)}_setPendingFile(t){this._pendingPreviewUrl&&URL.revokeObjectURL(this._pendingPreviewUrl),this._pendingFile=t,this._pendingPreviewUrl=URL.createObjectURL(t)}_onFileChange(t){var i;const e=t.target,r=(i=e.files)==null?void 0:i[0];e.value="",r&&this._setPendingFile(r)}_cancelPending(){this._pendingPreviewUrl&&URL.revokeObjectURL(this._pendingPreviewUrl),this._pendingFile=null,this._pendingPreviewUrl=""}_confirmPending(){var r;if(!this._pendingFile)return;const t=((r=this.renderRoot.querySelector(".caption"))==null?void 0:r.value.trim())??"",e=this._pendingFile;this._cancelPending(),this.dispatchEvent(new CustomEvent("upload-photo",{detail:{file:e,caption:t},bubbles:!0,composed:!0}))}_onDelete(t){if(this._confirmingFid!==t){this._confirmingFid=t;return}this._confirmingFid="",this.dispatchEvent(new CustomEvent("delete-fragment",{detail:{fid:t},bubbles:!0,composed:!0}))}_onEdit(t,e){this._confirmingFid="",this._editingFid=t,this._editText=e}_onCancelEdit(){this._editingFid="",this._editText=""}_onSaveEdit(t){const e=this._editText;this.dispatchEvent(new CustomEvent("edit-fragment",{detail:{fid:t,text:e},bubbles:!0,composed:!0})),this._editingFid="",this._editText=""}_renderFragment(t){const e=this._confirmingFid===t.fid,r=this._editingFid===t.fid;return h`
      <li class="frag">
  ...
  `;gr([y({attribute:!1})],Bt.prototype,"entry",2);gr([y({type:Boolean})],Bt.prototype,"submitting",2);gr([y()],Bt.prototype,"city",2);gr([z()],Bt.prototype,"_pendingFile",2);gr([z()],Bt.prototype,"_pendingPreviewUrl",2);gr([z()],Bt.prototype,"_confirmingFid",2);gr([z()],Bt.prototype,"_editingFid",2);gr([z()],Bt.prototype,"_editText",2);gr([z()],Bt.prototype,"_viewerSrc",2);Bt=gr([K("diary-record-panel")],Bt);var cx=Object.defineProperty,dx=Object.getOwnPropertyDescriptor,pi=(t,e,r,i)=>{for(var s=i>1?void 0:i?dx(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&cx(e,r,s),s};let dr=class extends G{constructor(){super(...arguments),this.date="",this.today="",this.entry=null,this.loading=!1,this.calendarOpen=!1,this.calendarMonth="",this.calendarDates=[]}_nav(t){this.dispatchEvent(new CustomEvent("navigate-day",{detail:{delta:t},bubbles:!0,composed:!0}))}_toggleCalendar(){this.dispatchEvent(new CustomEvent("toggle-calendar",{bubbles:!0,composed:!0}))}_renderBody(){var t;if(this.loading)return h`<div class="content loading">加载中…</div>`;if(!this.entry||this.entry.state!=="summarized"){const e=((t=this.entry)==null?void 0:t.state)==="raw"?"这一天的日记尚未整理成文":"这一天没有日记";return h`<div class="empty">${e}</div>`}return h`<md-viewer .content=${this.entry.content}></md-viewer>`}render(){const t=this.date===this.today;return h`
      <div class="nav-row">
        ...
        <button class="date-btn" @click=${this._toggleCalendar}>
          ...
          ${this.date.slice(5)} ${tx(this.date).replace("星期","周")}${t?"（今天）":""}
        </button>
  ...
  `;pi([y()],dr.prototype,"date",2);pi([y()],dr.prototype,"today",2);pi([y({attribute:!1})],dr.prototype,"entry",2);pi([y({type:Boolean})],dr.prototype,"loading",2);pi([y({type:Boolean})],dr.prototype,"calendarOpen",2);pi([y()],dr.prototype,"calendarMonth",2);pi([y({attribute:!1})],dr.prototype,"calendarDates",2);dr=pi([K("diary-review-panel")],dr);var ux=Object.getOwnPropertyDescriptor,hx=(t,e,r,i)=>{for(var s=i>1?void 0:i?ux(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=o(s)||s);return s};const px=["广州","深圳","珠海","东莞","佛山","中山"];let Cl=class extends G{_pick(t){this.dispatchEvent(new CustomEvent("submit",{detail:{city:t},bubbles:!0,composed:!0}))}_cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){return h`
      <div class="title">选择你的城市（用于日记天气）</div>
      <div class="grid">
        ${px.map(t=>h`<button class="city" @click=${()=>this._pick(t)}>${t}</button>`)}
      </div>
      <div class="actions">
  ...
  `;Cl=hx([K("city-dialog")],Cl);var fx=Object.defineProperty,mx=Object.getOwnPropertyDescriptor,Uh=(t,e,r,i)=>{for(var s=i>1?void 0:i?mx(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&fx(e,r,s),s};let $o=class extends G{constructor(){super(...arguments),this._initialized=!1,this._pendingSubmit=null}connectedCallback(){super.connectedCallback(),this._unsubscribe=T.subscribe(()=>this.requestUpdate()),this._initialized||(this._initialized=!0,this._init())}updated(t){var r;super.updated(t);const e=(r=this.shadowRoot)==null?void 0:r.querySelector("dialog");e&&!e.open&&e.showModal()}disconnectedCallback(){var t;(t=this._unsubscribe)==null||t.call(this),super.disconnectedCallback()}get _diary(){return T.getState().diary}_localToday(){return Hh(new Date)}async _init(){await this._loadToday();const t=this._diary.today||this._localToday(),e=Ld(t,-1);C.setDiaryState({reviewDate:e}),await Promise.all([this._loadReview(e),this._loadCalendar(ta(Kr(e)))])}async _loadToday(){C.setDiaryState({recordLoading:!0,error:null});try{const t=await jr.today();C.setDiaryState({today:t.today,todayEntry:t.entry,recordLoading:!1})}catch(t){C.setDiaryState({recordLoading:!1,today:this._localToday(),error:t instanceof At?t.message:"加载今日记录失败"})}}async _loadReview(t){C.setDiaryState({reviewLoading:!0,error:null});try{const e=await jr.entry(t);C.setDiaryState({reviewEntry:e,reviewLoading:!1})}catch(e){C.setDiaryState({reviewEntry:null,reviewLoading:!1,error:e instanceof At?e.message:"加载日记失败"})}}async _loadCalendar(t){try{const e=await jr.calendar(t);C.setDiaryState({calendarMonth:t,calendarDates:e.dates})}catch{C.setDiaryState({calendarMonth:t,calendarDates:[]})}}_onPhotoError(t){C.setDiaryState({error:t.detail.message})}async _onSubmitText(t){var e;if(!this._diary.submitting){if(!((e=this._diary.todayEntry)!=null&&e.city)){this._pendingSubmit={type:"text",value:t.detail.value},C.setDiaryState({cityDialogOpen:!0});return}this._submitText(t.detail.value)}}async _onUploadPhoto(t){var e;if(!this._diary.submitting){if(!((e=this._diary.todayEntry)!=null&&e.city)){this._pendingSubmit={type:"photo",file:t.detail.file,caption:t.detail.caption},C.setDiaryState({cityDialogOpen:!0});return}this._uploadPhoto(t.detail.file,t.detail.caption)}}async _submitText(t){C.setDiaryState({submitting:!0,error:null});try{await jr.addText(t),await this._loadToday()}catch(e){C.setDiaryState({error:e instanceof At?e.message:"记录失败，请重试"})}finally{C.setDiaryState({submitting:!1})}}async _uploadPhoto(t,e){C.setDiaryState({submitting:!0,error:null});try{await jr.uploadPhoto(t,e),await this._loadToday()}catch(r){C.setDiaryState({error:r instanceof At?r.message:"照片上传失败，请重试"})}finally{C.setDiaryState({submitting:!1})}}async _onDeleteFragment(t){const e=this._diary.today||this._localToday();C.setDiaryState({error:null});try{await jr.removeFragment(e,t.detail.fid),await this._loadToday()}catch(r){C.setDiaryState({error:r instanceof At?r.message:"删除失败，请重试"})}}async _onEditFragment(t){const e=this._diary.today||this._localToday();C.setDiaryState({submitting:!0,error:null});try{await jr.editFragment(e,t.detail.fid,t.detail.text),await this._loadToday()}catch(r){C.setDiaryState({error:r instanceof At?r.message:"保存失败，请重试"})}finally{C.setDiaryState({submitting:!1})}}async _onNavigateDay(t){const e=Ld(this._diary.reviewDate,t.detail.delta);C.setDiaryState({reviewDate:e,calendarOpen:!1}),await this._loadReview(e);const r=ta(Kr(e));r!==this._diary.calendarMonth&&this._loadCalendar(r)}_onToggleCalendar(){const t=!this._diary.calendarOpen;C.setDiaryState({calendarOpen:t}),t&&this._loadCalendar(ta(Kr(this._diary.reviewDate)))}async _onSelectDate(t){const e=t.detail.date;C.setDiaryState({reviewDate:e,calendarOpen:!1}),await this._loadReview(e)}_onMonthChange(t){this._loadCalendar(t.detail.month)}_switchTab(t){if(C.setDiaryState({tab:t,calendarOpen:!1}),t==="record")this._loadToday();else{const e=this._diary.reviewDate;this._loadReview(e),this._loadCalendar(ta(Kr(e)))}}async _onCitySubmit(t){const e=t.detail.city,r=this._diary.today||this._localToday();C.setDiaryState({cityDialogOpen:!1});const i=this._pendingSubmit;this._pendingSubmit=null,(i==null?void 0:i.type)==="text"?await this._submitText(i.value):(i==null?void 0:i.type)==="photo"&&i.file&&await this._uploadPhoto(i.file,i.caption);try{const s=await jr.setCity(r,e);C.setDiaryState({todayEntry:s})}catch{}}_onCityCancel(){C.setDiaryState({cityDialogOpen:!1}),localStorage.setItem("doclens.diary.citySelected","true")}render(){var e;const t=this._diary;return h`
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    dialog::backdrop { background: rgba(0, 0, 0, 0.3); }
    dialog > * { display: block; padding: var(--cortex-space-6); }
  `;Uh([z()],$o.prototype,"_pendingSubmit",2);$o=Uh([K("diary-view")],$o);function vx(){return typeof window.matchMedia=="function"&&window.matchMedia("(pointer: coarse)").matches}var gx=Object.getOwnPropertyDescriptor,bx=(t,e,r,i)=>{for(var s=i>1?void 0:i?gx(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=o(s)||s);return s};let El=class extends G{_emit(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}render(){return h`
      <div class="grid">
  ...
  `;El=bx([K("pin-pad")],El);var xx=Object.defineProperty,yx=Object.getOwnPropertyDescriptor,Yo=(t,e,r,i)=>{for(var s=i>1?void 0:i?yx(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&xx(e,r,s),s};const wi=6;let _s=class extends G{constructor(){super(...arguments),this._pin="",this._error="",this._submitting=!1,this._coarse=vx()}async _submit(){if(!(this._pin.length!==wi||this._submitting)){this._submitting=!0,this._error="";try{await N1(this._pin),C.setAuthState({authenticated:!0}),zr.navigate("search")}catch(t){this._pin="",this._error=t instanceof At?t.message:"网络错误，请重试"}finally{this._submitting=!1}}}_onDigit(t){this._pin.length>=wi||(this._error="",this._pin+=t.detail,this._pin.length===wi&&this._submit())}_onBackspace(){this._error="",this._pin=this._pin.slice(0,-1)}_onInput(t){const e=t.target;this._pin=e.value.replace(/\D/g,"").slice(0,wi),e.value=this._pin,this._error=""}_onKeydown(t){t.key==="Enter"&&this._submit()}_renderCoarse(){return h`
  ...
  `;Al=Tx([K("reindex-dialog")],Al);const Cx=3e3;let Yr=null,ds=!0,oa=null;function Fd(t){try{return JSON.parse(t||"{}")}catch{return null}}function Ex(t){C.setWatcherStatus(t.watcher??null),C.setWatchRecentChanges(t.recent_changes??[]),C.setSyncStatus(t.sync??null)}function Ax(t){window.dispatchEvent(new CustomEvent("cortex:watch-reindexed",{detail:{doc_count:t.doc_count??null,failed_count:t.failed_count??0}}))}function Mx(t){return new Promise(e=>{oa=window.setTimeout(()=>{oa=null,e()},t)})}async function Px(){for(;!ds;){try{const t=Yr==null?void 0:Yr.signal;if(!t)return;for await(const e of Wl("/api/watch/events",{},t)){if(ds)break;if(e.event==="status"){const r=Fd(e.data);r&&Ex(r)}else if(e.event==="reindexed"){const r=Fd(e.data);r&&Ax(r)}}}catch{}if(ds)return;await Mx(Cx)}}function Dx(){ds&&(ds=!1,Yr=new AbortController,Px())}function Ix(){ds=!0,oa!==null&&(window.clearTimeout(oa),oa=null),Yr==null||Yr.abort(),Yr=null}var Ox=Object.defineProperty,Rx=Object.getOwnPropertyDescriptor,Vh=(t,e,r,i)=>{for(var s=i>1?void 0:i?Rx(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&Ox(e,r,s),s};let Co=class extends G{constructor(){super(...arguments),this._mainStarted=!1,this._mountedViews=new Set}willUpdate(){const t=T.getState().view;t!=="login"&&!this._mountedViews.has(t)&&(this._mountedViews=new Set(this._mountedViews).add(t))}connectedCallback(){super.connectedCallback(),zr.init(),this._unsubscribe=T.subscribe(()=>this.requestUpdate()),p0(()=>{T.getState().view!=="login"&&(C.setAuthState({authenticated:!1}),zr.navigate("login"))}),this._unsubAuth=T.subscribeSelector(t=>t.auth.authenticated,t=>{t&&this._startMain()}),this._probeAuth()}async _probeAuth(){try{const t=await du();if(C.setAuthState({required:t.required,authenticated:t.authenticated,hasPassword:t.has_password}),t.required&&!t.authenticated){zr.navigate("login");return}}catch{C.setAuthState({required:!1,authenticated:!0})}this._startMain()}_startMain(){this._mainStarted||(this._mainStarted=!0,Dx(),this._loadStatus())}async _loadStatus(){try{const t=await cu();C.setStatus(t),t.sync!==void 0&&C.setSyncStatus(t.sync??null)}catch{}}disconnectedCallback(){var t,e;(t=this._unsubscribe)==null||t.call(this),(e=this._unsubAuth)==null||e.call(this),p0(null),Ix(),super.disconnectedCallback()}_navigate(t){zr.navigate(t.detail.view),t.detail.view==="settings"&&t.detail.scope&&C.setSettingsScope(t.detail.scope)}_renderView(){const t=T.getState().view;return h`
