...
`,fa=class{constructor(t,...e){this.slotNames=[],this.handleSlotChange=r=>{const i=r.target;(this.slotNames.includes("[default]")&&!i.name||i.name&&this.slotNames.includes(i.name))&&this.host.requestUpdate()},(this.host=t).addController(this),this.slotNames=e}hasDefaultSlot(){return[...this.host.childNodes].some(t=>{if(t.nodeType===t.TEXT_NODE&&t.textContent.trim()!=="")return!0;if(t.nodeType===t.ELEMENT_NODE){const e=t;if(e.tagName.toLowerCase()==="sl-visually-hidden")return!1;if(!e.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(t){return this.host.querySelector(`:scope > [slot="${t}"]`)!==null}test(t){return t==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(t)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}},qn="";function Kc(t){qn=t}function Ep(t=""){if(!qn){const e=[...document.getElementsByTagName("script")],r=e.find(i=>i.hasAttribute("data-shoelace"));if(r)Kc(r.getAttribute("data-shoelace"));else{const i=e.find(a=>/shoelace(\.min)?\.js($|\?)/.test(a.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(a.src));let s="";i&&(s=i.getAttribute("src")),Kc(s.split("/").slice(0,-1).join("/"))}}return qn.replace(/\/$/,"")+(t?`/${t.replace(/^\//,"")}`:"")}var Ap={name:"default",resolver:t=>Ep(`assets/icons/${t}.svg`)},Mp=Ap,Yc={caret:`
  ...
  `},Pp={name:"system",resolver:t=>t in Yc?`data:image/svg+xml,${encodeURIComponent(Yc[t])}`:""},Dp=Pp,Op=[Mp,Dp],Un=[];function Rp(t){Un.push(t)}function Ip(t){Un=Un.filter(e=>e!==t)}function Zc(t){return Op.find(e=>e.name===t)}var Lp=U`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Bp=(t,e)=>(t==null?void 0:t._$litType$)!==void 0,Np=t=>t.strings===void 0,Fp={},Hp=(t,e=Fp)=>t._$AH=e;var Fs=Symbol(),La=Symbol(),hn,pn=new Map,Bt=class extends at{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(t,e){var r;let i;if(e!=null&&e.spriteSheet)return this.svg=p`<svg part="svg">
        <use part="use" href="${t}"></use>
      </svg>`,this.svg;try{if(i=await fetch(t,{mode:"cors"}),!i.ok)return i.status===410?Fs:La}catch{return La}try{const s=document.createElement("div");s.innerHTML=await i.text();const a=s.firstElementChild;if(((r=a==null?void 0:a.tagName)==null?void 0:r.toLowerCase())!=="svg")return Fs;hn||(hn=new DOMParser);const l=hn.parseFromString(a.outerHTML,"text/html").body.querySelector("svg");return l?(l.part.add("svg"),document.adoptNode(l)):Fs}catch{return Fs}}connectedCallback(){super.connectedCallback(),Rp(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),Ip(this)}getIconSource(){const t=Zc(this.library);return this.name&&t?{url:t.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var t;const{url:e,fromLibrary:r}=this.getIconSource(),i=r?Zc(this.library):void 0;if(!e){this.svg=null;return}let s=pn.get(e);if(s||(s=this.resolveIcon(e,i),pn.set(e,s)),!this.initialRender)return;const a=await s;if(a===La&&pn.delete(e),e===this.getIconSource().url){if(Bp(a)){if(this.svg=a,i){await this.updateComplete;const o=this.shadowRoot.querySelector("[part='svg']");typeof i.mutator=="function"&&o&&i.mutator(o)}return}switch(a){case La:case Fs:this.svg=null,this.emit("sl-error");break;default:this.svg=a.cloneNode(!0),(t=i==null?void 0:i.mutator)==null||t.call(i,this.svg),this.emit("sl-load")}}}render(){return this.svg}};Bt.styles=[Gt,Lp];E([$()],Bt.prototype,"svg",2);E([w({reflect:!0})],Bt.prototype,"name",2);E([w()],Bt.prototype,"src",2);E([w()],Bt.prototype,"label",2);E([w({reflect:!0})],Bt.prototype,"library",2);E([ot("label")],Bt.prototype,"handleLabelChange",1);E([ot(["name","src","library"])],Bt.prototype,"setIcon",1);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ur={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},Ol=t=>(...e)=>({_$litDirective$:t,values:e});let Rl=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,r,i){this._$Ct=e,this._$AM=r,this._$Ci=i}_$AS(e,r){return this.update(e,r)}update(e,r){return this.render(...r)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pt=Ol(class extends Rl{constructor(t){var e;if(super(t),t.type!==Ur.ATTRIBUTE||t.name!=="class"||((e=t.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){var i,s;if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in e)e[a]&&!((i=this.nt)!=null&&i.has(a))&&this.st.add(a);return this.render(e)}const r=t.element.classList;for(const a of this.st)a in e||(r.remove(a),this.st.delete(a));for(const a in e){const o=!!e[a];o===this.st.has(a)||(s=this.nt)!=null&&s.has(a)||(o?(r.add(a),this.st.add(a)):(r.remove(a),this.st.delete(a)))}return At}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Gd=Symbol.for(""),qp=t=>{if((t==null?void 0:t.r)===Gd)return t==null?void 0:t._$litStatic$},to=(t,...e)=>({_$litStatic$:e.reduce((r,i,s)=>r+(a=>{if(a._$litStatic$!==void 0)return a._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${a}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(i)+t[s+1],t[0]),r:Gd}),Jc=new Map,Up=t=>(e,...r)=>{const i=r.length;let s,a;const o=[],l=[];let c,h=0,f=!1;for(;h<i;){for(c=e[h];h<i&&(a=r[h],(s=qp(a))!==void 0);)c+=s+e[++h],f=!0;h!==i&&l.push(a),o.push(c),h++}if(h===i&&o.push(e[i]),f){const b=o.join("$$lit$$");(e=Jc.get(b))===void 0&&(o.raw=o,Jc.set(b,e=o)),r=l}return t(e,...r)},Za=Up(p);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const he=t=>t??F;var xe=class extends at{constructor(){super(...arguments),this.formControlController=new Vd(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new fa(this,"[default]","prefix","suffix"),this.localize=new Li(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Dl}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(t){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(t)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(t){this.isButton()&&(this.button.setCustomValidity(t),this.formControlController.updateValidity())}render(){const t=this.isLink(),e=t?to`a`:to`button`;return Za`
      <${e}
        part="base"
...
`,Wp=(t="value")=>(e,r)=>{const i=e.constructor,s=i.prototype.attributeChangedCallback;i.prototype.attributeChangedCallback=function(a,o,l){var c;const h=i.getPropertyOptions(t),f=typeof h.attribute=="string"?h.attribute:t;if(a===f){const b=h.converter||os,k=(typeof b=="function"?b:(c=b==null?void 0:b.fromAttribute)!=null?c:os.fromAttribute)(l,h.type);this[t]!==k&&(this[r]=k)}s.call(this,a,o,l)}},Vp=U`
...
`,Je=class extends at{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}click(){this.button.click()}focus(t){this.button.focus(t)}blur(){this.button.blur()}render(){const t=!!this.href,e=t?to`a`:to`button`;return Za`
      <${e}
        part="base"
...
`,kt=class yi extends at{constructor(){super(...arguments),this.hasSlotController=new fa(this,"icon","suffix"),this.localize=new Li(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"sl-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var e;(e=this.countdownAnimation)==null||e.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var e;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(e=this.countdownAnimation)==null||e.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:e}=this,r="100%",i="0";this.countdownAnimation=e.animate([{width:r},{width:i}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await is(this.base),this.base.hidden=!1;const{keyframes:e,options:r}=_i(this,"alert.show",{dir:this.localize.dir()});await ki(this.base,e,r),this.emit("sl-after-show")}else{Yd(this),this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await is(this.base);const{keyframes:e,options:r}=_i(this,"alert.hide",{dir:this.localize.dir()});await ki(this.base,e,r),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,ro(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,ro(this,"sl-after-hide")}async toast(){return new Promise(e=>{this.handleCountdownChange(),yi.toastStack.parentElement===null&&document.body.append(yi.toastStack),yi.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{yi.toastStack.removeChild(this),e(),yi.toastStack.querySelector("sl-alert")===null&&yi.toastStack.remove()},{once:!0})})}render(){return p`
  ...
  `;iu([w()],ao.prototype,"active",2);ao=iu([Z("activity-bar")],ao);var $1=Object.defineProperty,T1=Object.getOwnPropertyDescriptor,su=(t,e,r,i)=>{for(var s=i>1?void 0:i?T1(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&$1(e,r,s),s};let oo=class extends G{constructor(){super(...arguments),this.active="search",this._items=[{id:"search",icon:"search",label:"搜索"},{id:"chat",icon:"message-circle",label:"对话"},{id:"diary",icon:"book-open",label:"日记"},{id:"files",icon:"folder",label:"文件"}]}_select(t){this.dispatchEvent(new CustomEvent("navigate",{detail:{view:t},bubbles:!0,composed:!0}))}render(){return p`
      ${this._items.map(t=>p`
        <button
  ...
  `;su([w()],oo.prototype,"active",2);oo=su([Z("tab-bar")],oo);var C1=Object.defineProperty,E1=Object.getOwnPropertyDescriptor,Cr=(t,e,r,i)=>{for(var s=i>1?void 0:i?E1(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&C1(e,r,s),s};let Wt=class extends G{constructor(){super(...arguments),this.variant="compact",this.heading="Doclens",this.subheading="",this.suffix="",this.heroIcon="",this.modes=[],this.examples=[],this.workdir=""}render(){return this.variant==="onboarding"?this._renderOnboarding():this._renderCompact()}_renderCompact(){return p`
      <h1 class="title">
  ...
  `;ma([w()],Ai.prototype,"title",2);ma([w({attribute:!1})],Ai.prototype,"sessions",2);ma([w()],Ai.prototype,"type",2);ma([w({type:Boolean})],Ai.prototype,"clearing",2);Ai=ma([Z("history-list")],Ai);var O1=Object.defineProperty,R1=Object.getOwnPropertyDescriptor,au=(t,e,r,i)=>{for(var s=i>1?void 0:i?R1(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&O1(e,r,s),s};let no=class extends G{constructor(){super(...arguments),this.session=null}_select(){this.session&&this.dispatchEvent(new CustomEvent("select",{detail:{session:this.session},bubbles:!0,composed:!0}))}render(){if(!this.session)return null;const t=[];return this.session.type==="chat"&&t.push(String(this.session.message_count)),t.push(new Date(this.session.updated_at).toLocaleDateString()),p`
      <div class="name">
        ${this.session.mode==="grep"?p`<span class="mode-tag" title="正则 grep">grep</span>`:null}
        ${this.session.title}
      </div>
      <div class="meta">${t.join(" · ")}</div>
    `}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._select)}disconnectedCallback(){this.removeEventListener("click",this._select),super.disconnectedCallback()}};no.styles=U`
    :host {
      display: flex;
      align-items: center;
      justify-content: space-between;
  ...
  `;au([w({attribute:!1})],no.prototype,"session",2);no=au([Z("history-item")],no);var I1=Object.defineProperty,L1=Object.getOwnPropertyDescriptor,St=(t,e,r,i)=>{for(var s=i>1?void 0:i?L1(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&I1(e,r,s),s};let st=class extends G{constructor(){super(...arguments),this.value="",this.placeholder="",this.buttonLabel="搜索",this.buttonIcon="",this.iconAfter=!1,this.multiline=!1,this.disabled=!1,this.streaming=!1,this.mode="keyword",this.modes=null,this._menuOpen=!1,this._onDocClick=()=>{this._menuOpen=!1,document.removeEventListener("click",this._onDocClick)}}focus(){var t;(t=this.inputEl)==null||t.focus()}updated(t){var e;(e=super.updated)==null||e.call(this,t),(t.has("value")||t.has("multiline"))&&this._autoResize()}_autoResize(){const t=this.renderRoot.querySelector("textarea");t&&(t.style.height="auto",t.style.height=`${t.scrollHeight}px`)}get trimmed(){return this.value.trim()}_onInput(t){const e=t.target;this.value=e.value,this.dispatchEvent(new CustomEvent("input-change",{detail:{value:this.value}}));const r=this.renderRoot.querySelector("button");r&&(r.disabled=!this.trimmed||this.disabled),this._autoResize()}_onKeydown(t){t.key==="Enter"&&(t.shiftKey&&this.multiline||(t.preventDefault(),this._submit()))}_submit(){this.streaming||!this.trimmed||this.disabled||this.dispatchEvent(new CustomEvent("submit",{detail:{value:this.trimmed}}))}_emitStop(){this.dispatchEvent(new CustomEvent("stop"))}get _hasModes(){return!!this.modes&&this.mode in this.modes}_toggleMenu(t){t.stopPropagation(),this._menuOpen=!this._menuOpen,this._menuOpen&&document.addEventListener("click",this._onDocClick)}_selectMode(t){this._menuOpen=!1,document.removeEventListener("click",this._onDocClick),this.dispatchEvent(new CustomEvent("mode-change",{detail:{mode:t}}))}_renderButton(){if(this.streaming)return p`
...
`):[],a={type:"table",raw:Ir(e[0],`
`),header:[],align:[],rows:[]};if(r.length===i.length){for(let l of i)this.rules.other.tableAlignRight.test(l)?a.align.push("right"):this.rules.other.tableAlignCenter.test(l)?a.align.push("center"):this.rules.other.tableAlignLeft.test(l)?a.align.push("left"):a.align.push(null);for(let l=0;l<r.length;l++)a.header.push({text:r[l],tokens:this.lexer.inline(r[l]),header:!0,align:a.align[l]});for(let l of s)a.rows.push(u0(l,a.header.length).map((c,h)=>({text:c,tokens:this.lexer.inline(c),header:!1,align:a.align[h]})));return a}}lheading(t){let e=this.rules.block.lheading.exec(t);if(e){let r=e[1].trim();return{type:"heading",raw:Ir(e[0],`
...
`)?"":`
`)+c.raw,f.text+=`
`+c.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=f.text):r.push(c);continue}if(e){this.infiniteLoopError(e.charCodeAt(0));break}}return this.state.top=!0,r}inline(e,r=[]){return this.inlineQueue.push({src:e,tokens:r}),r}inlineTokens(e,r=[]){var h,f,b,y,k;this.tokenizer.lexer=this;let i=e,s=null;if(this.tokens.links){let z=Object.keys(this.tokens.links);if(z.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(i))!==null;)z.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(i=i.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(i))!==null;)i=i.slice(0,s.index)+"++"+i.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let a;for(;(s=this.tokenizer.rules.inline.blockSkip.exec(i))!==null;)a=s[2]?s[2].length:0,i=i.slice(0,s.index+a)+"["+"a".repeat(s[0].length-a-2)+"]"+i.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);i=((f=(h=this.options.hooks)==null?void 0:h.emStrongMask)==null?void 0:f.call({lexer:this},i))??i;let o=!1,l="",c=1/0;for(;e;){if(e.length<c)c=e.length;else{this.infiniteLoopError(e.charCodeAt(0));break}o||(l=""),o=!1;let z;if((y=(b=this.options.extensions)==null?void 0:b.inline)!=null&&y.some(M=>(z=M.call({lexer:this},e,r))?(e=e.substring(z.raw.length),r.push(z),!0):!1))continue;if(z=this.tokenizer.escape(e)){e=e.substring(z.raw.length),r.push(z);continue}if(z=this.tokenizer.tag(e)){e=e.substring(z.raw.length),r.push(z);continue}if(z=this.tokenizer.link(e)){e=e.substring(z.raw.length),r.push(z);continue}if(z=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(z.raw.length);let M=r.at(-1);z.type==="text"&&(M==null?void 0:M.type)==="text"?(M.raw+=z.raw,M.text+=z.text):r.push(z);continue}if(z=this.tokenizer.emStrong(e,i,l)){e=e.substring(z.raw.length),r.push(z);continue}if(z=this.tokenizer.codespan(e)){e=e.substring(z.raw.length),r.push(z);continue}if(z=this.tokenizer.br(e)){e=e.substring(z.raw.length),r.push(z);continue}if(z=this.tokenizer.del(e,i,l)){e=e.substring(z.raw.length),r.push(z);continue}if(z=this.tokenizer.autolink(e)){e=e.substring(z.raw.length),r.push(z);continue}if(!this.state.inLink&&(z=this.tokenizer.url(e))){e=e.substring(z.raw.length),r.push(z);continue}let O=e;if((k=this.options.extensions)!=null&&k.startInline){let M=1/0,N=e.slice(1),j;this.options.extensions.startInline.forEach(J=>{j=J.call({lexer:this},N),typeof j=="number"&&j>=0&&(M=Math.min(M,j))}),M<1/0&&M>=0&&(O=e.substring(0,M+1))}if(z=this.tokenizer.inlineText(O)){e=e.substring(z.raw.length),z.raw.slice(-1)!=="_"&&(l=z.raw.slice(-1)),o=!0;let M=r.at(-1);(M==null?void 0:M.type)==="text"?(M.raw+=z.raw,M.text+=z.text):r.push(z);continue}if(e){this.infiniteLoopError(e.charCodeAt(0));break}}return r}infiniteLoopError(e){let r="Infinite loop on byte: "+e;if(this.options.silent)console.error(r);else throw new Error(r)}},uo=class{constructor(t){we(this,"options");we(this,"parser");this.options=t||Ni}space(t){return""}code({text:t,lang:e,escaped:r}){var a;let i=(a=(e||"").match(Ye.notSpaceStart))==null?void 0:a[0],s=t.replace(Ye.endingNewline,"")+`
...
`+Ae),Ft&&(Ae=Da(Ae)),re&&Ca?Tt(Ae):Ae},e.setConfig=function(){let B=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};tn(B),Ps=!0,yr=_e,wr=ge},e.clearConfig=function(){Gi=null,Ps=!1,yr=null,wr=null,re=le,ne=""},e.isValidAttribute=function(B,v,S){Gi||tn({});const P=Ee(B),W=Ee(v);return Dc(P,W,S)},e.addHook=function(B,v){typeof v=="function"&&je(be,B)&&Zi(be[B],v)},e.removeHook=function(B,v){if(je(be,B)){if(v!==void 0){const S=Of(be[B],v);return S===-1?void 0:Rf(be[B],S,1)[0]}return v0(be[B])}},e.removeHooks=function(B){je(be,B)&&(be[B]=[])},e.removeAllHooks=function(){be=C0()},e}var sm=gu();function ho(t){return sm.sanitize(t,{ADD_ATTR:["loading","target"]})}var am=Object.defineProperty,om=Object.getOwnPropertyDescriptor,Xl=(t,e,r,i)=>{for(var s=i>1?void 0:i?om(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&am(e,r,s),s};let sa=class extends G{constructor(){super(...arguments),this.result=null,this.active=!1}_select(){this.result&&this.dispatchEvent(new CustomEvent("select",{detail:{result:this.result},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._select)}disconnectedCallback(){this.removeEventListener("click",this._select),super.disconnectedCallback()}_renderSnippet(){var r;const t=((r=this.result)==null?void 0:r.snippet)??"";if(!t)return null;const e=ho(de.parse(t,{async:!1}));return p`<div class="snippet" .innerHTML=${e}></div>`}render(){if(!this.result)return null;const t=Math.round(this.result.score*100);return p`
  ...
  `;Xl([w({attribute:!1})],sa.prototype,"result",2);Xl([w({type:Boolean,reflect:!0})],sa.prototype,"active",2);sa=Xl([Z("result-card")],sa);var nm=Object.defineProperty,lm=Object.getOwnPropertyDescriptor,Co=(t,e,r,i)=>{for(var s=i>1?void 0:i?lm(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&nm(e,r,s),s};let ls=class extends G{constructor(){super(...arguments),this.results=[],this.activeResult=null,this.loading=!1}render(){return p`
      <div class="list-pane">
  ...
  `;Co([w({attribute:!1})],ls.prototype,"results",2);Co([w({attribute:!1})],ls.prototype,"activeResult",2);Co([w({type:Boolean})],ls.prototype,"loading",2);ls=Co([Z("search-results")],ls);class R extends Error{constructor(e,r){var i="KaTeX parse error: "+e,s,a,o=r&&r.loc;if(o&&o.start<=o.end){var l=o.lexer.input;s=o.start,a=o.end,s===l.length?i+=" at end of input: ":i+=" at position "+(s+1)+": ";var c=l.slice(s,a).replace(/[^]/g,"$&̲"),h;s>15?h="…"+l.slice(s-15,s):h=l.slice(0,s);var f;a+15<l.length?f=l.slice(a,a+15)+"…":f=l.slice(a),i+=h+c+f}super(i),this.name="ParseError",this.position=void 0,this.length=void 0,this.rawMessage=void 0,Object.setPrototypeOf(this,R.prototype),this.position=s,s!=null&&a!=null&&(this.length=a-s),this.rawMessage=e}}var cm=/([A-Z])/g,dm=t=>t.replace(cm,"-$1").toLowerCase(),um={"&":"&amp;",">":"&gt;","<":"&lt;",'"':"&quot;","'":"&#x27;"},hm=/[&><"']/g,Ze=t=>String(t).replace(hm,e=>um[e]),Ja=t=>t.type==="ordgroup"||t.type==="color"?t.body.length===1?Ja(t.body[0]):t:t.type==="font"?Ja(t.body):t,pm=new Set(["mathord","textord","atom"]),Er=t=>pm.has(Ja(t).type),fm=t=>{var e=/^[\x00-\x20]*([^\\/#?]*?)(:|&#0*58|&#x0*3a|&colon)/i.exec(t);return e?e[2]!==":"||!/^[a-zA-Z][a-zA-Z0-9+\-.]*$/.test(e[1])?null:e[1].toLowerCase():"_relative"},Jn={displayMode:{type:"boolean",description:"Render math in display mode, which puts the math in display style (so \\int and \\sum are large, for example), and centers the math on the page on its own line.",cli:"-d, --display-mode"},output:{type:{enum:["htmlAndMathml","html","mathml"]},description:"Determines the markup language of the output.",cli:"-F, --format <type>"},leqno:{type:"boolean",description:"Render display math in leqno style (left-justified tags)."},fleqn:{type:"boolean",description:"Render display math flush left."},throwOnError:{type:"boolean",default:!0,cli:"-t, --no-throw-on-error",cliDescription:"Render errors (in the color given by --error-color) instead of throwing a ParseError exception when encountering an error."},errorColor:{type:"string",default:"#cc0000",cli:"-c, --error-color <color>",cliDescription:"A color string given in the format 'rgb' or 'rrggbb' (no #). This option determines the color of errors rendered by the -t option.",cliProcessor:t=>"#"+t},macros:{type:"object",cli:"-m, --macro <def>",cliDescription:"Define custom macro of the form '\\foo:expansion' (use multiple -m arguments for multiple macros).",cliDefault:[],cliProcessor:(t,e)=>(e.push(t),e)},minRuleThickness:{type:"number",description:"Specifies a minimum thickness, in ems, for fraction lines, `\\sqrt` top lines, `{array}` vertical lines, `\\hline`, `\\hdashline`, `\\underline`, `\\overline`, and the borders of `\\fbox`, `\\boxed`, and `\\fcolorbox`.",processor:t=>Math.max(0,t),cli:"--min-rule-thickness <size>",cliProcessor:parseFloat},colorIsTextColor:{type:"boolean",description:"Makes \\color behave like LaTeX's 2-argument \\textcolor, instead of LaTeX's one-argument \\color mode change.",cli:"-b, --color-is-text-color"},strict:{type:[{enum:["warn","ignore","error"]},"boolean","function"],description:"Turn on strict / LaTeX faithfulness mode, which throws an error if the input uses features that are not supported by LaTeX.",cli:"-S, --strict",cliDefault:!1},trust:{type:["boolean","function"],description:"Trust the input, enabling all HTML features such as \\url.",cli:"-T, --trust"},maxSize:{type:"number",default:1/0,description:"If non-zero, all user-specified sizes, e.g. in \\rule{500em}{500em}, will be capped to maxSize ems. Otherwise, elements and spaces can be arbitrarily large",processor:t=>Math.max(0,t),cli:"-s, --max-size <n>",cliProcessor:parseInt},maxExpand:{type:"number",default:1e3,description:"Limit the number of macro expansions to the specified number, to prevent e.g. infinite macro loops. If set to Infinity, the macro expander will try to fully expand as in LaTeX.",processor:t=>Math.max(0,t),cli:"-e, --max-expand <n>",cliProcessor:t=>t==="Infinity"?1/0:parseInt(t)},globalGroup:{type:"boolean",cli:!1}};function mm(t){if(typeof t!="string")return t.enum[0];switch(t){case"boolean":return!1;case"string":return"";case"number":return 0;case"object":return{};default:throw new Error("Unexpected schema type; settings must declare an explicit default.")}}function vm(t){if(t.default!==void 0)return t.default;var e=Array.isArray(t.type)?t.type[0]:t.type;return mm(e)}function bm(t,e,r,i){var s=r[e];t[e]=s!==void 0?i.processor?i.processor(s):s:vm(i)}class Kl{constructor(e){e===void 0&&(e={}),this.displayMode=void 0,this.output=void 0,this.leqno=void 0,this.fleqn=void 0,this.throwOnError=void 0,this.errorColor=void 0,this.macros=void 0,this.minRuleThickness=void 0,this.colorIsTextColor=void 0,this.strict=void 0,this.trust=void 0,this.maxSize=void 0,this.maxExpand=void 0,this.globalGroup=void 0,e=e||{};for(var r of Object.keys(Jn)){var i=Jn[r];i&&bm(this,r,e,i)}}reportNonstrict(e,r,i){var s=this.strict;if(typeof s=="function"&&(s=s(e,r,i)),!(!s||s==="ignore")){if(s===!0||s==="error")throw new R("LaTeX-incompatible input and strict mode is set to 'error': "+(r+" ["+e+"]"),i);s==="warn"?typeof console<"u"&&console.warn("LaTeX-incompatible input and strict mode is set to 'warn': "+(r+" ["+e+"]")):typeof console<"u"&&console.warn("LaTeX-incompatible input and strict mode is set to "+("unrecognized '"+s+"': "+r+" ["+e+"]"))}}useStrictBehavior(e,r,i){var s=this.strict;if(typeof s=="function")try{s=s(e,r,i)}catch{s="error"}return!s||s==="ignore"?!1:s===!0||s==="error"?!0:s==="warn"?(typeof console<"u"&&console.warn("LaTeX-incompatible input and strict mode is set to 'warn': "+(r+" ["+e+"]")),!1):(typeof console<"u"&&console.warn("LaTeX-incompatible input and strict mode is set to "+("unrecognized '"+s+"': "+r+" ["+e+"]")),!1)}isTrusted(e){if("url"in e&&e.url&&!e.protocol){var r=fm(e.url);if(r==null)return!1;e.protocol=r}var i=typeof this.trust=="function"?this.trust(e):this.trust;return!!i}}class Br{constructor(e,r,i){this.id=void 0,this.size=void 0,this.cramped=void 0,this.id=e,this.size=r,this.cramped=i}sup(){return ir[gm[this.id]]}sub(){return ir[xm[this.id]]}fracNum(){return ir[ym[this.id]]}fracDen(){return ir[wm[this.id]]}cramp(){return ir[_m[this.id]]}text(){return ir[km[this.id]]}isTight(){return this.size>=2}}var Yl=0,po=1,ss=2,zr=3,aa=4,Mt=5,cs=6,it=7,ir=[new Br(Yl,0,!1),new Br(po,0,!0),new Br(ss,1,!1),new Br(zr,1,!0),new Br(aa,2,!1),new Br(Mt,2,!0),new Br(cs,3,!1),new Br(it,3,!0)],gm=[aa,Mt,aa,Mt,cs,it,cs,it],xm=[Mt,Mt,Mt,Mt,it,it,it,it],ym=[ss,zr,aa,Mt,cs,it,cs,it],wm=[zr,zr,Mt,Mt,it,it,it,it],_m=[po,po,zr,zr,Mt,Mt,it,it],km=[Yl,po,ss,zr,ss,zr,ss,zr],ie={DISPLAY:ir[Yl],TEXT:ir[ss],SCRIPT:ir[aa],SCRIPTSCRIPT:ir[cs]},Qn=[{name:"latin",blocks:[[256,591],[768,879]]},{name:"cyrillic",blocks:[[1024,1279]]},{name:"armenian",blocks:[[1328,1423]]},{name:"brahmic",blocks:[[2304,4255]]},{name:"georgian",blocks:[[4256,4351]]},{name:"cjk",blocks:[[12288,12543],[19968,40879],[65280,65376]]},{name:"hangul",blocks:[[44032,55215]]}];function Sm(t){for(var e=0;e<Qn.length;e++)for(var r=Qn[e],i=0;i<r.blocks.length;i++){var s=r.blocks[i];if(t>=s[0]&&t<=s[1])return r.name}return null}var Qa=[];Qn.forEach(t=>t.blocks.forEach(e=>Qa.push(...e)));function xu(t){for(var e=0;e<Qa.length;e+=2)if(t>=Qa[e]&&t<=Qa[e+1])return!0;return!1}var Fe=t=>t+" "+t,Ji=80,zm=function(e,r){return"M95,"+(622+e+r)+`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class bl extends Rl{constructor(e){if(super(e),this.it=F,e.type!==Ur.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===F||e==null)return this._t=void 0,this.it=e;if(e===At)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const r=[e];return r.raw=r,this._t={_$litType$:this.constructor.resultType,strings:r,values:[]}}}bl.directiveName="unsafeHTML",bl.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var fg=Object.defineProperty,mg=Object.getOwnPropertyDescriptor,hh=(t,e,r,i)=>{for(var s=i>1?void 0:i?mg(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&fg(e,r,s),s};const vg={search:zb,folder:$b,"folder-open":Tb,file:Cb,"message-circle":Eb,upload:Ab,download:Mb,"folder-plus":Pb,pencil:Db,"arrow-right":Ob,"trash-2":Rb,save:Ib,x:Lb,"arrow-left":Fb,"arrow-up":Hb,"arrow-up-to-line":qb,"arrow-down-to-line":Ub,"more-horizontal":jb,"more-vertical":Wb,"chevron-down":Vb,"chevron-right":Gb,"refresh-cw":Xb,"refresh-ccw":Kb,"alert-triangle":Yb,check:Zb,clipboard:Jb,brain:Qb,settings:eg,globe:tg,scale:rg,"book-open":ig,"rotate-ccw":sg,sparkles:ag,regex:og,camera:ng,image:lg,calendar:cg,"chevron-left":dg,"maximize-2":Bb,copy:Nb,square:ug,user:hg,"log-out":pg};let vo=class extends G{constructor(){super(...arguments),this.name=""}render(){const t=vg[this.name];return t?p`${uh(t)}`:null}};vo.styles=U`
    :host {
      display: inline-flex;
      align-items: center;
      justify-content: center;
...
`;function bo(t){return!t.showTop&&!t.showBottom?null:p`
  ...
  `}var bg=Object.defineProperty,gg=Object.getOwnPropertyDescriptor,Pr=(t,e,r,i)=>{for(var s=i>1?void 0:i?gg(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&bg(e,r,s),s};let Ks="",xl=0,go=0;function ts(t){if(!t)return 0;const e=Ks.indexOf(t,xl);if(e===-1){const i=Ks.indexOf(t);return i===-1?0:(Ks.slice(0,i).match(/\n/g)??[]).length+1+go}const r=(Ks.slice(0,e).match(/\n/g)??[]).length+1;return xl=e+t.length,r+go}function ea(t){return t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}const xg=500;function md(t){return t>0&&t<=xg?`${t}px`:null}const yg=/^[a-zA-Z][a-zA-Z0-9+.-]*:/;function wg(t,e){if(!t||!e||e.startsWith("/")||e.startsWith("#")||yg.test(e))return null;const r=e.match(/^([^?#]*)([?#].*)?$/),i=(r==null?void 0:r[1])??e,s=(r==null?void 0:r[2])??"";if(!i)return null;const a=t.split("/").slice(0,-1);for(const l of i.split("/"))if(!(l===""||l==="."))if(l===".."){if(a.length===0)return null;a.pop()}else a.push(l);return`/api/preview/raw?path=${a.map(encodeURIComponent).join("/")}${s}`}const ph={heading(t){const e=this.parser.parseInline(t.tokens),r=ts(t.raw);return`<h${t.depth} data-source-line="${r}">${e}</h${t.depth}>
`},paragraph(t){const e=this.parser.parseInline(t.tokens);return`<p data-source-line="${ts(t.raw)}">${e}</p>
`},code(t){const e=ts(t.raw),r=ea(t.text),i=t.lang?` class="language-${ea(t.lang)}"`:"";return`<pre data-source-line="${e}"><button class="copy-btn" title="复制代码">复制</button><code${i}>${r}</code></pre>
...
`};const _g={name:"singleLineDisplayMath",level:"block",start(t){return t.indexOf("$$")},tokenizer(t){const e=/^\$\$([^\n]+?)\$\$\s*(?:\n|$)/.exec(t);if(e)return{type:"singleLineDisplayMath",raw:e[0],text:e[1].trim()}},renderer(t){const e=ts(t.raw),r=dh.renderToString(t.text.replace(/\$/g,""),{displayMode:!0,throwOnError:!1});return`<div data-source-line="${e}">${r}</div>
...
`);i.push({label:e[s].label,md:l,offset:a})}return i}render(){if(kg(),!this.content)return p`<div class="empty">无内容</div>`;if(this.pages&&this.pages.length>0){const e=this._splitByPages(this.content,this.pages);return p`
        <div class="md-body md-body-paged">
          ...
          ${e.map(r=>{go=r.offset;const i=ho(de.parse(r.md,{async:!1}));return p`
        ...
        <div class="scroll-jump-anchor">${bo(this._scrollJump)}</div>
        ${this._viewerSrc?p`<image-viewer .src=${this._viewerSrc} @close=${()=>this._viewerSrc=""}></image-viewer>`:null}
      `}go=0;const t=ho(de.parse(this.content,{async:!1}));return p`
      <div class="md-body">
        <div class="copy-bar-top">${this._renderCopyBtn()}</div>
        <div .innerHTML=${t}></div>
      </div>
...
`);return p`
  ...
  `;Ss([w({reflect:!0})],ii.prototype,"role",2);Ss([w({attribute:!1})],ii.prototype,"message",2);Ss([w()],ii.prototype,"error",2);Ss([w({attribute:!1})],ii.prototype,"modelName",2);Ss([$()],ii.prototype,"_copied",2);ii=Ss([Z("chat-message")],ii);var Ig=Object.defineProperty,Lg=Object.getOwnPropertyDescriptor,xa=(t,e,r,i)=>{for(var s=i>1?void 0:i?Lg(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&Ig(e,r,s),s};const Bg={search:"search",read_document:"file",grep:"search"},Ng={search:"正在搜索",read_document:"正在读取",grep:"正在检索"};function Fg(t){const e=[`思考过程（${t.length} 步）`];return t.forEach((r,i)=>{e.push(""),e.push(`[${i+1}] ${r.name}`),Object.keys(r.input).length&&(e.push("参数："),e.push(JSON.stringify(r.input,null,2))),r.output!=null&&r.output!==""?(e.push("结果："),e.push(r.output)):e.push("结果：（无输出）")}),e.join(`
...
`):t.output??"",c=t.output!=null&&t.output!=="";return p`
  ...
  `;ni([w()],ar.prototype,"pstPath",2);ni([w({type:Boolean})],ar.prototype,"showBack",2);ni([$()],ar.prototype,"_emails",2);ni([$()],ar.prototype,"_total",2);ni([$()],ar.prototype,"_offset",2);ni([$()],ar.prototype,"_loading",2);ni([$()],ar.prototype,"_error",2);ar=ni([Z("pst-email-list")],ar);var Kg=Object.defineProperty,Yg=Object.getOwnPropertyDescriptor,gh=(t,e,r,i)=>{for(var s=i>1?void 0:i?Yg(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&Kg(e,r,s),s};let xo=class extends G{constructor(){super(...arguments),this._toasts=[],this._nextId=1,this._timers=new Map}pushToast(t,e="info",r=2500){const i=this._nextId++;if(this._toasts=[...this._toasts,{id:i,message:t,level:e,duration:r}],r>0){const s=window.setTimeout(()=>this.dismiss(i),r);this._timers.set(i,s)}}dismiss(t){const e=this._timers.get(t);e!==void 0&&(window.clearTimeout(e),this._timers.delete(t)),this._toasts=this._toasts.filter(r=>r.id!==t)}disconnectedCallback(){super.disconnectedCallback();for(const t of this._timers.values())window.clearTimeout(t);this._timers.clear()}render(){return p`
...
确定要丢弃吗？`))return;const s=(e=this.shadowRoot)==null?void 0:e.querySelector("preview-pane");(r=s==null?void 0:s.discard)==null||r.call(s),this.previewDirty=!1}await t()}async _reloadPreview(){if(!this.previewPath)return;const t=await hs(this.previewPath);t.ok&&(this.previewContent=t.content,this.previewLanguage=t.language,this.previewWritable=t.writable,this.previewPages=t.pages,this.previewAttachments=t.attachments)}_pushToast(t,e,r){var s;const i=(s=this.shadowRoot)==null?void 0:s.querySelector("toast-stack");i==null||i.pushToast(t,e,r)}_renderNotIndexedHint(){return p`<div class="not-indexed-hint">
  ...
  `;fr([w()],Rt.prototype,"activeSearch",2);fr([$()],Rt.prototype,"_presets",2);fr([$()],Rt.prototype,"_loading",2);fr([$()],Rt.prototype,"_editing",2);fr([$()],Rt.prototype,"_busy",2);fr([$()],Rt.prototype,"_error",2);fr([$()],Rt.prototype,"_toast",2);fr([$()],Rt.prototype,"_confirmDeleteId",2);fr([$()],Rt.prototype,"_formError",2);Rt=fr([Z("search-presets-section")],Rt);var x2=Object.defineProperty,y2=Object.getOwnPropertyDescriptor,mr=(t,e,r,i)=>{for(var s=i>1?void 0:i?y2(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&x2(e,r,s),s};const kd=["ai","search","network"],w2={ai:"sparkles",search:"search",network:"globe"},_2=p`
...
`;let It=class extends G{constructor(){super(...arguments),this._activeTab="ai",this._saving=!1,this._error=null,this._toast=null,this._values={},this._original={},this._exists=!0,this._scope="global",this._fieldErrors={},this._loadGen=0,this._onRevertRequest=()=>{this._revert()}}connectedCallback(){super.connectedCallback();const t=T.getState();this._scope=t.settings.scope,this._unsubscribe=T.subscribe(()=>this._onStoreChange()),window.addEventListener("cortex:revert-settings",this._onRevertRequest),this._load()}disconnectedCallback(){var t;(t=this._unsubscribe)==null||t.call(this),this._toastTimer!==void 0&&(window.clearTimeout(this._toastTimer),this._toastTimer=void 0),this._loadGen+=1,window.removeEventListener("cortex:revert-settings",this._onRevertRequest),super.disconnectedCallback()}_onStoreChange(){const t=T.getState();t.settings.scope!==this._scope&&(this._scope=t.settings.scope,this._load())}async _load(){const t=++this._loadGen;this._error=null;try{const e=await l2(this._scope);if(t!==this._loadGen||!this.isConnected)return;this._values={...e.values},this._original={...e.values},this._exists=e.exists,this._fieldErrors={},C.loadSettings(this._values,e.exists)}catch(e){if(t!==this._loadGen||!this.isConnected)return;this._error=`加载失败: ${e.message}`}}get _dirtyFields(){const t=new Set([...Object.keys(this._original),...Object.keys(this._values)]),e=[];for(const r of t)(this._original[r]??"")!==(this._values[r]??"")&&e.push(r);return e}get _dirty(){return this._dirtyFields.length>0}_updateValues(t){this._values={...this._values,...t};for(const[e,r]of Object.entries(t))C.updateSetting(e,r)}_onInput(t,e){this._updateValues({[t]:e})}_isMobile(){return typeof window.matchMedia=="function"&&window.matchMedia("(max-width: 1023px)").matches}_pushToast(t,e="info",r=2500){var s;const i=(s=this.shadowRoot)==null?void 0:s.querySelector("toast-stack");i==null||i.pushToast(t,e,r)}_extractFieldErrors(t){if(t instanceof yo){const e=t.body,r={};for(const i of(e==null?void 0:e.fields)??[])r[i.field]=i.error;return r}return{}}_close(){Sr.navigate(Sr.lastMain())}async _refreshSystemStatus(){try{const t=await eu();C.setStatus(t)}catch{}}_revert(){this._values={...this._original},C.revertSettings()}async _save(){var t;if(!(!this._dirty||this._saving)){this._saving=!0,this._error=null,this._fieldErrors={};try{const e=await c2(this._scope,this._values);if(!this.isConnected)return;this._original={...this._values},C.loadSettings(this._values,!0),this._refreshSystemStatus();const r=e.needs_restart?"已保存。重启 doclens gui 后 AI 配置生效。":"已保存。下次查询立即生效。";this._isMobile()?this._pushToast(r,"success",4e3):this._toast=r}catch(e){let r;if(e instanceof yo){const i=e.body,s=(t=i==null?void 0:i.fields)==null?void 0:t.map(a=>a.field).join(", ");r=s?`保存失败（${s}）`:`保存失败 (HTTP ${e.status})`}else e instanceof Error?r=`保存失败: ${e.message}`:r="保存失败: 未知错误";this._isMobile()?(this._pushToast(r,"error",5e3),this._fieldErrors=this._extractFieldErrors(e)):this._error=r}finally{this._saving=!1}}}_renderField(t){const e=this._values[t.envVar]??"";return p`
  ...
  `;Fo([w({type:Object})],ps.prototype,"entry",2);Fo([w({type:Boolean})],ps.prototype,"selected",2);Fo([w({type:Boolean})],ps.prototype,"active",2);ps=Fo([Z("file-row")],ps);var D2=Object.defineProperty,O2=Object.getOwnPropertyDescriptor,_a=(t,e,r,i)=>{for(var s=i>1?void 0:i?O2(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&D2(e,r,s),s};const Sh=[28,28,240,80,140],Sd=[20,20,80,50,80],zd=[60,60,800,200,300],$d=Sh.length,Td="cortex.files.colWidths";let Ii=class extends G{constructor(){super(...arguments),this.activePath="",this.mobile=!1,this._colWidths=[...Sh],this._showMobileMenu=!1,this._makeColResizeHandler=t=>e=>{e.preventDefault(),e.stopPropagation();const r=e.clientX,i=this._colWidths[t];document.body.style.cursor="col-resize",document.body.style.userSelect="none";const s=o=>{const l=o.clientX-r,c=Math.max(Sd[t],Math.min(zd[t],i+l)),h=[...this._colWidths];h[t]=c,this._colWidths=h},a=()=>{document.removeEventListener("mousemove",s),document.removeEventListener("mouseup",a),document.body.style.cursor="",document.body.style.userSelect="",localStorage.setItem(Td,JSON.stringify(this._colWidths))};document.addEventListener("mousemove",s),document.addEventListener("mouseup",a)},this._onMobileBackClick=()=>{this._showMobileMenu=!1,this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))},this._onMobileMoreClick=t=>{t.stopPropagation(),this._showMobileMenu=!this._showMobileMenu},this._onDocClick=t=>{var s,a;if(!this._showMobileMenu)return;const e=t.composedPath(),r=(s=this.shadowRoot)==null?void 0:s.querySelector(".mobile-menu"),i=(a=this.shadowRoot)==null?void 0:a.querySelector(".mobile-more");r&&e.includes(r)||i&&e.includes(i)||(this._showMobileMenu=!1)},this._onMenuItemClick=t=>e=>{e.stopPropagation(),this._showMobileMenu=!1,this._action(t)}}connectedCallback(){super.connectedCallback(),this._unsubscribe=T.subscribe(()=>this.requestUpdate()),this._loadColWidths(),document.addEventListener("click",this._onDocClick,!0)}disconnectedCallback(){var t;(t=this._unsubscribe)==null||t.call(this),document.removeEventListener("click",this._onDocClick,!0),super.disconnectedCallback()}willUpdate(){for(let t=0;t<$d;t++)this.style.setProperty(`--col-${t+1}`,`${this._colWidths[t]}px`)}_loadColWidths(){const t=localStorage.getItem(Td);if(t)try{const e=JSON.parse(t);Array.isArray(e)&&e.length===$d&&e.every(r=>typeof r=="number"&&Number.isFinite(r))&&(this._colWidths=e.map((r,i)=>Math.max(Sd[i],Math.min(zd[i],r))))}catch{}}_action(t){this.dispatchEvent(new CustomEvent("action",{detail:{name:t},bubbles:!0,composed:!0}))}_onRowChecked(t){const{path:e,shift:r}=t.detail;C.selectEntry(e,{ctrl:!r,shift:r})}_onSelectAll(t){const e=t.target,{currentDir:r,treeCache:i,selectedPaths:s}=T.getState().files,a=i[r]||[];if(e.checked){const o=a.map(c=>c.path),l=Array.from(new Set([...s,...o]));C.setFilesState({selectedPaths:l})}else{const o=new Set(a.map(l=>l.path));C.setFilesState({selectedPaths:s.filter(l=>!o.has(l))})}}_goUp(){const{currentDir:t}=T.getState().files;if(t==="")return;const e=t.includes("/")?t.slice(0,t.lastIndexOf("/")):"";C.selectDir(e)}_renderMobileHeader(){const{currentDir:t,selectedPaths:e}=T.getState().files,r=e.length===1,i=e.length>=1,s=t===""?"/":`/${t}/`;return p`
      <div class="mobile-header">
        <button
          class="mobile-back"
          type="button"
...
说明文字…），将覆盖 AI 解析结果`}
  ...
  `;qo([$()],ms.prototype,"_phase",2);qo([$()],ms.prototype,"_stats",2);qo([$()],ms.prototype,"_confirmed",2);ms=qo([Z("delete-dialog")],ms);async function J2(){return(await pe("/api/skills")).skills??[]}var Q2=Object.defineProperty,e4=Object.getOwnPropertyDescriptor,Uo=(t,e,r,i)=>{for(var s=i>1?void 0:i?e4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&Q2(e,r,s),s};let vs=class extends G{constructor(){super(...arguments),this._skills=[],this._loading=!0,this._error=null}connectedCallback(){super.connectedCallback(),this._load()}async _load(){this._loading=!0,this._error=null;try{this._skills=await J2()}catch(t){this._error=(t==null?void 0:t.message)||"技能列表加载失败"}finally{this._loading=!1}}_onPick(t){this.dispatchEvent(new CustomEvent("pick",{detail:{skill:t},bubbles:!0,composed:!0}))}_cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){return p`
      <h3>选择技能</h3>
      <div class="hint">将对选中的文件执行所选技能</div>
      ${this._loading?p`<div class="empty">加载中…</div>`:this._error?p`<div class="err">${this._error}</div>`:this._skills.length===0?p`<div class="empty">暂无可用技能</div>`:p`<div class="grid" role="listbox">
  ...
  `;Uo([$()],vs.prototype,"_skills",2);Uo([$()],vs.prototype,"_loading",2);Uo([$()],vs.prototype,"_error",2);vs=Uo([Z("skill-toolbox-dialog")],vs);var t4=Object.defineProperty,r4=Object.getOwnPropertyDescriptor,jo=(t,e,r,i)=>{for(var s=i>1?void 0:i?r4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&t4(e,r,s),s};let bs=class extends G{constructor(){super(...arguments),this.skill=null,this.filePaths=[],this._prompt=""}_submit(){this.dispatchEvent(new CustomEvent("submit",{detail:{prompt:this._prompt.trim()},bubbles:!0,composed:!0}))}_cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){const t=this.skill;return p`
      <h3>
...
确定要丢弃吗？`))return;this._discardPreviewEdits()}await this._fetchPreview(t)}async _fetchPreview(t){if(Zr(t)){this._previewError=null,this._previewPath=t,this._previewContent="",this._previewWritable=!1,this._previewPages=null,this._previewAttachments=null;return}const e=await hs(t);e.ok?(this._previewError=null,this._previewPath=e.path,this._previewContent=e.content,this._previewLanguage=e.language,this._previewWritable=e.writable,this._previewPages=e.pages,this._previewAttachments=e.attachments):e.notIndexed?(this._previewError="NOT_INDEXED",this._previewPath=t,this._previewContent="",this._previewWritable=!1,this._previewPages=null,this._previewAttachments=null):this._showToast(e.message||"预览失败")}async _reloadPreview(){if(!this._previewPath)return;const t=await hs(this._previewPath);t.ok&&(this._previewContent=t.content,this._previewLanguage=t.language,this._previewWritable=t.writable,this._previewPages=t.pages,this._previewAttachments=t.attachments)}_discardPreviewEdits(){var e,r;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("preview-pane");(r=t==null?void 0:t.discard)==null||r.call(t),this._previewDirty=!1}_renderNotIndexedHint(){return p`<div class="preview-placeholder">
  ...
  `;_l=E4([Z("city-dialog")],_l);var M4=Object.defineProperty,P4=Object.getOwnPropertyDescriptor,$h=(t,e,r,i)=>{for(var s=i>1?void 0:i?P4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&M4(e,r,s),s};let wo=class extends G{constructor(){super(...arguments),this._initialized=!1,this._pendingSubmit=null}connectedCallback(){super.connectedCallback(),this._unsubscribe=T.subscribe(()=>this.requestUpdate()),this._initialized||(this._initialized=!0,this._init())}updated(t){var r;super.updated(t);const e=(r=this.shadowRoot)==null?void 0:r.querySelector("dialog");e&&!e.open&&e.showModal()}disconnectedCallback(){var t;(t=this._unsubscribe)==null||t.call(this),super.disconnectedCallback()}get _diary(){return T.getState().diary}_localToday(){return zh(new Date)}async _init(){await this._loadToday();const t=this._diary.today||this._localToday(),e=Ed(t,-1);C.setDiaryState({reviewDate:e}),await Promise.all([this._loadReview(e),this._loadCalendar(Ys(Xr(e)))])}async _loadToday(){C.setDiaryState({recordLoading:!0,error:null});try{const t=await qr.today();C.setDiaryState({today:t.today,todayEntry:t.entry,recordLoading:!1})}catch(t){C.setDiaryState({recordLoading:!1,today:this._localToday(),error:t instanceof Et?t.message:"加载今日记录失败"})}}async _loadReview(t){C.setDiaryState({reviewLoading:!0,error:null});try{const e=await qr.entry(t);C.setDiaryState({reviewEntry:e,reviewLoading:!1})}catch(e){C.setDiaryState({reviewEntry:null,reviewLoading:!1,error:e instanceof Et?e.message:"加载日记失败"})}}async _loadCalendar(t){try{const e=await qr.calendar(t);C.setDiaryState({calendarMonth:t,calendarDates:e.dates})}catch{C.setDiaryState({calendarMonth:t,calendarDates:[]})}}async _onSubmitText(t){var e;if(!this._diary.submitting){if(!((e=this._diary.todayEntry)!=null&&e.city)){this._pendingSubmit={type:"text",value:t.detail.value},C.setDiaryState({cityDialogOpen:!0});return}this._submitText(t.detail.value)}}async _onUploadPhoto(t){var e;if(!this._diary.submitting){if(!((e=this._diary.todayEntry)!=null&&e.city)){this._pendingSubmit={type:"photo",file:t.detail.file,caption:t.detail.caption},C.setDiaryState({cityDialogOpen:!0});return}this._uploadPhoto(t.detail.file,t.detail.caption)}}async _submitText(t){C.setDiaryState({submitting:!0,error:null});try{await qr.addText(t),await this._loadToday()}catch(e){C.setDiaryState({error:e instanceof Et?e.message:"记录失败，请重试"})}finally{C.setDiaryState({submitting:!1})}}async _uploadPhoto(t,e){C.setDiaryState({submitting:!0,error:null});try{await qr.uploadPhoto(t,e),await this._loadToday()}catch(r){C.setDiaryState({error:r instanceof Et?r.message:"照片上传失败，请重试"})}finally{C.setDiaryState({submitting:!1})}}async _onDeleteFragment(t){const e=this._diary.today||this._localToday();C.setDiaryState({error:null});try{await qr.removeFragment(e,t.detail.fid),await this._loadToday()}catch(r){C.setDiaryState({error:r instanceof Et?r.message:"删除失败，请重试"})}}async _onEditFragment(t){const e=this._diary.today||this._localToday();C.setDiaryState({submitting:!0,error:null});try{await qr.editFragment(e,t.detail.fid,t.detail.text),await this._loadToday()}catch(r){C.setDiaryState({error:r instanceof Et?r.message:"保存失败，请重试"})}finally{C.setDiaryState({submitting:!1})}}async _onNavigateDay(t){const e=Ed(this._diary.reviewDate,t.detail.delta);C.setDiaryState({reviewDate:e,calendarOpen:!1}),await this._loadReview(e);const r=Ys(Xr(e));r!==this._diary.calendarMonth&&this._loadCalendar(r)}_onToggleCalendar(){const t=!this._diary.calendarOpen;C.setDiaryState({calendarOpen:t}),t&&this._loadCalendar(Ys(Xr(this._diary.reviewDate)))}async _onSelectDate(t){const e=t.detail.date;C.setDiaryState({reviewDate:e,calendarOpen:!1}),await this._loadReview(e)}_onMonthChange(t){this._loadCalendar(t.detail.month)}_switchTab(t){if(C.setDiaryState({tab:t,calendarOpen:!1}),t==="record")this._loadToday();else{const e=this._diary.reviewDate;this._loadReview(e),this._loadCalendar(Ys(Xr(e)))}}async _onCitySubmit(t){const e=t.detail.city,r=this._diary.today||this._localToday();C.setDiaryState({cityDialogOpen:!1});const i=this._pendingSubmit;this._pendingSubmit=null,(i==null?void 0:i.type)==="text"?await this._submitText(i.value):(i==null?void 0:i.type)==="photo"&&i.file&&await this._uploadPhoto(i.file,i.caption);try{const s=await qr.setCity(r,e);C.setDiaryState({todayEntry:s})}catch{}}_onCityCancel(){C.setDiaryState({cityDialogOpen:!1}),localStorage.setItem("doclens.diary.citySelected","true")}render(){var e;const t=this._diary;return p`
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    dialog::backdrop { background: rgba(0, 0, 0, 0.3); }
    dialog > * { display: block; padding: var(--cortex-space-6); }
  `;$h([$()],wo.prototype,"_pendingSubmit",2);wo=$h([Z("diary-view")],wo);function D4(){return typeof window.matchMedia=="function"&&window.matchMedia("(pointer: coarse)").matches}var O4=Object.getOwnPropertyDescriptor,R4=(t,e,r,i)=>{for(var s=i>1?void 0:i?O4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=o(s)||s);return s};let kl=class extends G{_emit(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}render(){return p`
      <div class="grid">
  ...
  `;kl=R4([Z("pin-pad")],kl);var I4=Object.defineProperty,L4=Object.getOwnPropertyDescriptor,Wo=(t,e,r,i)=>{for(var s=i>1?void 0:i?L4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&I4(e,r,s),s};const xi=6;let gs=class extends G{constructor(){super(...arguments),this._pin="",this._error="",this._submitting=!1,this._coarse=D4()}async _submit(){if(!(this._pin.length!==xi||this._submitting)){this._submitting=!0,this._error="";try{await w1(this._pin),C.setAuthState({authenticated:!0}),Sr.navigate("search")}catch(t){this._pin="",this._error=t instanceof Et?t.message:"网络错误，请重试"}finally{this._submitting=!1}}}_onDigit(t){this._pin.length>=xi||(this._error="",this._pin+=t.detail,this._pin.length===xi&&this._submit())}_onBackspace(){this._error="",this._pin=this._pin.slice(0,-1)}_onInput(t){const e=t.target;this._pin=e.value.replace(/\D/g,"").slice(0,xi),e.value=this._pin,this._error=""}_onKeydown(t){t.key==="Enter"&&this._submit()}_renderCoarse(){return p`
  ...
  `;Sl=j4([Z("reindex-dialog")],Sl);const W4=3e3;let Kr=null,as=!0,ta=null;function Ad(t){try{return JSON.parse(t||"{}")}catch{return null}}function V4(t){C.setWatcherStatus(t.watcher??null),C.setWatchRecentChanges(t.recent_changes??[]),C.setSyncStatus(t.sync??null)}function G4(t){window.dispatchEvent(new CustomEvent("cortex:watch-reindexed",{detail:{doc_count:t.doc_count??null,failed_count:t.failed_count??0}}))}function X4(t){return new Promise(e=>{ta=window.setTimeout(()=>{ta=null,e()},t)})}async function K4(){for(;!as;){try{const t=Kr==null?void 0:Kr.signal;if(!t)return;for await(const e of Bl("/api/watch/events",{},t)){if(as)break;if(e.event==="status"){const r=Ad(e.data);r&&V4(r)}else if(e.event==="reindexed"){const r=Ad(e.data);r&&G4(r)}}}catch{}if(as)return;await X4(W4)}}function Y4(){as&&(as=!1,Kr=new AbortController,K4())}function Z4(){as=!0,ta!==null&&(window.clearTimeout(ta),ta=null),Kr==null||Kr.abort(),Kr=null}var J4=Object.defineProperty,Q4=Object.getOwnPropertyDescriptor,Ch=(t,e,r,i)=>{for(var s=i>1?void 0:i?Q4(e,r):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(s=(i?o(e,r,s):o(s))||s);return i&&s&&J4(e,r,s),s};let ko=class extends G{constructor(){super(...arguments),this._mainStarted=!1,this._mountedViews=new Set}willUpdate(){const t=T.getState().view;t!=="login"&&!this._mountedViews.has(t)&&(this._mountedViews=new Set(this._mountedViews).add(t))}connectedCallback(){super.connectedCallback(),Sr.init(),this._unsubscribe=T.subscribe(()=>this.requestUpdate()),o0(()=>{T.getState().view!=="login"&&(C.setAuthState({authenticated:!1}),Sr.navigate("login"))}),this._unsubAuth=T.subscribeSelector(t=>t.auth.authenticated,t=>{t&&this._startMain()}),this._probeAuth()}async _probeAuth(){try{const t=await tu();if(C.setAuthState({required:t.required,authenticated:t.authenticated,hasPassword:t.has_password}),t.required&&!t.authenticated){Sr.navigate("login");return}}catch{C.setAuthState({required:!1,authenticated:!0})}this._startMain()}_startMain(){this._mainStarted||(this._mainStarted=!0,Y4(),this._loadStatus())}async _loadStatus(){try{const t=await eu();C.setStatus(t),t.sync!==void 0&&C.setSyncStatus(t.sync??null)}catch{}}disconnectedCallback(){var t,e;(t=this._unsubscribe)==null||t.call(this),(e=this._unsubAuth)==null||e.call(this),o0(null),Z4(),super.disconnectedCallback()}_navigate(t){Sr.navigate(t.detail.view),t.detail.view==="settings"&&t.detail.scope&&C.setSettingsScope(t.detail.scope)}_renderView(){const t=T.getState().view;return p`
  ...
  `;Ch([$()],ko.prototype,"_mountedViews",2);ko=Ch([Z("cortex-app")],ko);
