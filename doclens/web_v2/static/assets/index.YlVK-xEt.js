...
`);return c`
  ...
  `;rr([d({reflect:!0})],qe.prototype,"role",2);rr([d({attribute:!1})],qe.prototype,"message",2);rr([d()],qe.prototype,"error",2);qe=rr([P("chat-message")],qe);var Rn=Object.defineProperty,Ln=Object.getOwnPropertyDescriptor,Pi=(e,t,r,i)=>{for(var s=i>1?void 0:i?Ln(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&Rn(t,r,s),s};let Yt=class extends ${constructor(){super(...arguments),this.messages=[]}updated(){this.scrollTop=this.scrollHeight}render(){return this.messages.length===0?c`<div class="empty">开始与 Cortex 对话</div>`:c`
