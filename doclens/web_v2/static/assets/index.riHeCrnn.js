...
`;var Xg=Object.defineProperty,Kg=Object.getOwnPropertyDescriptor,Ih=(e,t,r,i)=>{for(var s=i>1?void 0:i?Kg(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&Xg(t,r,s),s};const Yg={search:eg,folder:tg,"folder-open":rg,file:ig,"message-circle":sg,upload:ag,download:og,"folder-plus":ng,pencil:lg,"arrow-right":cg,"trash-2":dg,save:ug,x:hg,"arrow-left":mg,"arrow-up":vg,"arrow-up-to-line":bg,"arrow-down-to-line":gg,"more-horizontal":xg,"more-vertical":yg,"chevron-down":wg,"chevron-right":_g,"refresh-cw":kg,"refresh-ccw":Sg,"alert-triangle":$g,check:zg,clipboard:Tg,brain:Cg,settings:Ag,globe:Eg,scale:Mg,"book-open":Pg,"rotate-ccw":Dg,sparkles:Ig,regex:Og,camera:Rg,image:Lg,calendar:Bg,"chevron-left":Ng,"maximize-2":pg,copy:fg,square:Fg,user:Hg,"log-out":qg,highlighter:jg,send:Ug,"list-tree":Wg,plus:Vg,minus:Gg};let _o=class extends V{constructor(){super(...arguments),this.name=""}render(){const e=Yg[this.name];return e?u`${Dh(e)}`:null}};_o.styles=j`
    :host {
      display: inline-flex;
      align-items: center;
      justify-content: center;
...
`;function ko(e){return!e.showTop&&!e.showBottom?null:u`
  ...
  `}var Zg=Object.defineProperty,Jg=Object.getOwnPropertyDescriptor,mr=(e,t,r,i)=>{for(var s=i>1?void 0:i?Jg(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&Zg(t,r,s),s};let ta="",zl=0,So=0;function os(e){if(!e)return 0;const t=ta.indexOf(e,zl);if(t===-1){const i=ta.indexOf(e);return i===-1?0:(ta.slice(0,i).match(/\n/g)??[]).length+1+So}const r=(ta.slice(0,t).match(/\n/g)??[]).length+1;return zl=t+e.length,r+So}function oa(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const Qg=500;function Ad(e){return e>0&&e<=Qg?`${e}px`:null}const e2=/^[a-zA-Z][a-zA-Z0-9+.-]*:/;function t2(e,t){if(!e||!t||t.startsWith("/")||t.startsWith("#")||e2.test(t))return null;const r=t.match(/^([^?#]*)([?#].*)?$/),i=(r==null?void 0:r[1])??t,s=(r==null?void 0:r[2])??"";if(!i)return null;const a=e.split("/").slice(0,-1);for(const n of i.split("/"))if(!(n===""||n==="."))if(n===".."){if(a.length===0)return null;a.pop()}else a.push(n);return`/api/preview/raw?path=${a.map(encodeURIComponent).join("/")}${s}`}const Oh={heading(e){const t=this.parser.parseInline(e.tokens),r=os(e.raw);return`<h${e.depth} data-source-line="${r}">${t}</h${e.depth}>
...
`);i.push({label:t[s].label,md:n,offset:a})}return i}render(){if(i2(),!this.content)return u`<div class="empty">无内容</div>`;if(this.pages&&this.pages.length>0){const t=this._splitByPages(this.content,this.pages);return u`
  ...
  `];mr([y()],Ot.prototype,"content",2);mr([y({type:Number})],Ot.prototype,"line",2);mr([y()],Ot.prototype,"keyword",2);mr([y({attribute:!1})],Ot.prototype,"pages",2);mr([y({attribute:"doc-path"})],Ot.prototype,"docPath",2);mr([y({attribute:"font-scale",type:Number})],Ot.prototype,"fontScale",2);mr([S()],Ot.prototype,"_viewerSrc",2);mr([S()],Ot.prototype,"_copied",2);mr([y({type:Boolean})],Ot.prototype,"suppressLocate",2);Ot=mr([K("md-viewer")],Ot);var s2=Object.defineProperty,a2=Object.getOwnPropertyDescriptor,Vi=(e,t,r,i)=>{for(var s=i>1?void 0:i?a2(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&s2(t,r,s),s};let Ar=class extends V{constructor(){super(...arguments),this.path="",this.originalContent="",this.mobile=!1,this._text="",this._dirty=!1,this._error=null,this._scrollJump=new wc(this,{behavior:"auto",onJumpTop:e=>this._jumpToEdge(e,0),onJumpBottom:e=>{const t=e;this._jumpToEdge(t,t.value.length)}}),this._onSaveClick=()=>{this._dirty&&this._emitSave()},this._onCancelClick=()=>{this.discard()}}willUpdate(e){e.has("originalContent")&&(this._text=this.originalContent,this._dirty=!1,this._error=null)}firstUpdated(){const e=this.shadowRoot.querySelector("textarea");e&&this._scrollJump.attach(e)}updated(){this._scrollJump.refresh()}get _textarea(){return this.shadowRoot.querySelector("textarea")}_jumpToEdge(e,t){e.focus(),e.setSelectionRange(t,t),e.scrollTop=t===0?0:e.scrollHeight-e.clientHeight}get _lines(){return this._text.split(`
...
`);const i=t.offsetHeight;return t.textContent="",i}topLine(){const e=this._textarea;if(!e)return 1;const t=e.scrollTop,r=this._lines.length;let i=1,s=r;for(;i<s;){const a=i+s+1>>1;this._heightBeforeLine(a)<=t?i=a:s=a-1}return i}scrollToLine(e){const t=this._textarea;t&&(t.scrollTop=this._heightBeforeLine(e))}_onInput(e){const t=e.target;this._text=t.value,this._error=null,this._updateDirty()}_onKeyDown(e){(e.ctrlKey||e.metaKey)&&e.key==="s"&&(e.preventDefault(),this._dirty&&this._emitSave())}_updateDirty(){const e=this._text!==this.originalContent;e!==this._dirty&&(this._dirty=e,this.dispatchEvent(new CustomEvent("dirty-change",{detail:{dirty:e}})))}_emitSave(){this.dispatchEvent(new CustomEvent("save",{detail:{content:this._text}}))}discard(){this._text=this.originalContent,this._dirty=!1,this._error=null,this._updateDirty(),this.dispatchEvent(new CustomEvent("cancel",{}))}setError(e){this._error=e}render(){return u`
  ...
  `;kc([y({attribute:!1})],ma.prototype,"items",2);kc([y({type:Number})],ma.prototype,"currentLine",2);ma=kc([K("toc-drawer")],ma);class Lh extends Error{constructor(t,r,i){super(r),this.code=t,this.status=i,this.name="PreviewSaveError"}}async function c2(e,t){const r=await fetch(`/api/preview?path=${encodeURIComponent(e)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({content:t})});if(!r.ok){const i=await r.json().catch(()=>({code:"UNKNOWN",detail:r.statusText}));throw new Lh(i.code??"UNKNOWN",i.detail??"保存失败",r.status)}return r.json()}class Bh extends Error{constructor(t,r,i){super(r),this.code=t,this.status=i,this.name="PreviewUploadError"}}async function d2(e){const t=new FormData;t.append("file",e);const r=await fetch("/api/preview/upload",{method:"POST",body:t});if(!r.ok){const i=await r.json().catch(()=>({code:"UNKNOWN",detail:r.statusText}));throw new Bh(i.code??"UNKNOWN",i.detail??"上传失败",r.status)}return r.json()}const u2=[".md",".pdf",".docx",".xlsx",".xlsm",".xltx",".xltm",".csv",".mhtml",".mht",".pst",".png",".jpg",".jpeg",".webp",".gif",".bmp",".tiff",".tif"];function h2(e){const t=e.toLowerCase();return t.includes("#")&&t.split("#")[0].endsWith(".pst")?!0:u2.some(r=>t.endsWith(r))}const p2=[".png",".jpg",".jpeg",".webp"];function Pd(e){const t=e.toLowerCase();return p2.some(r=>t.endsWith(r))}async function bs(e){const t=new URLSearchParams({path:e});try{const r=await fetch(`/api/preview?${t}`);if(r.ok){const a=await r.json();return{ok:!0,path:a.path,content:a.content,language:a.language,writable:a.writable??!1,pages:a.pages??null,lineMap:a.line_map??null,attachments:a.attachments??null}}const i=await r.json().catch(()=>({code:"UNKNOWN",detail:""}));return{ok:!1,notIndexed:i.code==="NOT_INDEXED",message:i.detail||i.code||`HTTP ${r.status}`}}catch(r){return{ok:!1,notIndexed:!1,message:r.message||"网络错误"}}}async function f2(e,t=0,r=50){const i=new URLSearchParams({path:e,offset:String(t),limit:String(r)});try{const s=await fetch(`/api/pst/emails?${i}`);if(s.ok){const o=await s.json();return{ok:!0,path:o.path,total:o.total,offset:o.offset,limit:o.limit,emails:o.emails??[]}}const a=await s.json().catch(()=>({code:"UNKNOWN",detail:""}));return{ok:!1,notIndexed:a.code==="NOT_INDEXED",message:a.detail||a.code||`HTTP ${s.status}`}}catch(s){return{ok:!1,notIndexed:!1,message:s.message||"网络错误"}}}function Jr(e){return e.toLowerCase().endsWith(".pst")&&!e.includes("#")}function Bi(e){const t=e.toLowerCase();return t.includes("#")&&t.split("#")[0].endsWith(".pst")}const Nh="cortex.files.previewScroll",m2=200;function Fh(){let e;try{e=JSON.parse(localStorage.getItem(Nh)??"{}")}catch{return{}}if(typeof e!="object"||e===null||Array.isArray(e))return{};const t={};for(const[r,i]of Object.entries(e))typeof i=="number"&&Number.isFinite(i)&&i>=1&&(t[r]=Math.floor(i));return t}function v2(e){if(!e)return null;const t=Fh()[e];return t===void 0?null:t}function b2(e,t){if(!e||!Number.isFinite(t))return;const r=Fh();delete r[e],t>1&&(r[e]=Math.floor(t));const i=Object.keys(r);for(;i.length>m2;){const s=i.shift();delete r[s]}try{localStorage.setItem(Nh,JSON.stringify(r))}catch{}}class Di extends Error{constructor(t,r){super(r),this.name="JsbridgePhotoError",this.code=t}}class Dd extends Error{constructor(t,r){super(r),this.name="JsbridgeUploadError",this.code=t}}class Tl extends Error{constructor(t,r,i=!1){super(r),this.name="JsbridgeDownloadError",this.code=t,this.unauthorized=i}}const Si="dbg1";function Id(){const e=/NexBox\/(\d+(?:\.\d+)*)/.exec(navigator.userAgent),t=typeof window<"u"&&!!window.Android,r=typeof window<"u"&&!!window.jsbridge,i=r&&typeof window.jsbridge.takePhoto=="function",s=r&&typeof window.jsbridge.pickPhotos=="function",a=t&&!!i&&!!s;return[`[${Si}] UA:${e?`NexBox/${e[1]}`:"无NexBox标识"}`,`Android注入:${t?"有":"无"}`,`jsbridge.js:${r?"已加载":"未加载"}`,`takePhoto:${i?"✓":"✗"} pickPhotos:${s?"✓":"✗"}`,`判定→${a?"走jsbridge":"降级input"}`].join(" | ")}function g2(){return typeof window<"u"&&!!window.Android&&!!window.jsbridge&&typeof window.jsbridge.takePhoto=="function"&&typeof window.jsbridge.pickPhotos=="function"}function x2(){return typeof window<"u"&&!!window.Android&&!!window.jsbridge&&typeof window.jsbridge.pickAndUploadFiles=="function"}function y2(){return typeof window<"u"&&!!window.Android&&!!window.jsbridge&&typeof window.jsbridge.downloadFile=="function"}function Hh(e,t){const r=atob(e.base64),i=new Uint8Array(r.length);for(let a=0;a<r.length;a++)i[a]=r.charCodeAt(a);const s=e.mimeType==="image/jpeg"?"jpg":e.mimeType.split("/")[1]||"jpg";return new File([i],`${t}_${Date.now()}.${s}`,{type:e.mimeType})}function w2(e){switch(e){case 2:return"相机权限被拒，请在系统设置中开启后重试";case 3:return"未找到可用的相机或相册应用";default:return"拍照失败，请重试"}}function Od(e){switch(e){case 3:return"未找到可用的相册应用";case 5:return"照片处理失败，请重试";default:return"选图失败，请重试"}}function _2(e){return"error"in e||typeof e.base64!="string"?null:e}const qh=15e3;function k2(){return new Promise((e,t)=>{let r=!1;const i=window.setTimeout(()=>{r||(r=!0,t(new Di(-1,"原生15秒无回调：App 内可能未注册 takePhoto 插件（需 Android 仓库 2026-08-20 后的构建）")))},qh),s=a=>o=>{r||(r=!0,window.clearTimeout(i),a(o))};window.jsbridge.takePhoto({success:s(a=>{const o=a;if(typeof o.base64!="string"||!o.base64){t(new Di(o.code??-1,"拍照失败，请重试"));return}e(Hh(o,"photo"))}),fail:s(a=>{const o=a;t(new Di(o.code??-1,w2(o.code??-1)))}),cancel:s(()=>e(null))})})}function S2(){return new Promise((e,t)=>{let r=!1;const i=window.setTimeout(()=>{r||(r=!0,t(new Di(-1,"原生15秒无回调：App 内可能未注册 pickPhotos 插件（需 Android 仓库 2026-08-20 后的构建）")))},qh),s=a=>o=>{r||(r=!0,window.clearTimeout(i),a(o))};window.jsbridge.pickPhotos({maxCount:1,success:s(a=>{var c;const o=a,n=(c=o.photos)!=null&&c[0]?_2(o.photos[0]):null;if(!n){t(new Di(5,Od(5)));return}e(Hh(n,"gallery"))}),fail:s(a=>{const o=a;t(new Di(o.code??-1,Od(o.code??-1)))}),cancel:s(()=>e(null))})})}const $2=10*60*1e3;function z2(e){switch(e){case 1:return"上传参数缺失（uploadUrl），请更新 App 后重试";case 3:return"未找到可用的文件选择器";case 7:return"已有上传在进行中";default:return"上传失败，请重试"}}function T2(e){return new Promise((t,r)=>{let i=!1;const s=window.setTimeout(()=>{i||(i=!0,r(new Dd(-1,"原生10分钟无回调：App 内可能未注册 pickAndUploadFiles 插件（需 Android 侧按 upload_bridge.md 实现后的构建）")))},$2),a=o=>n=>{i||(i=!0,window.clearTimeout(s),o(n))};window.jsbridge.pickAndUploadFiles({uploadUrl:e.uploadUrl,destDir:e.destDir,overwrite:e.overwrite??!1,maxCount:e.maxCount,success:a(o=>t(o)),fail:a(o=>{const n=o;r(new Dd(n.code??-1,z2(n.code??-1)))}),cancel:a(()=>t(null))})})}const C2=10*60*1e3;function A2(e){return e.includes("UNAUTHORIZED")?"登录已过期，请重新登录":e.includes("FILE_NOT_FOUND")?"文件不存在（可能已被删除）":e.includes("NETWORK_ERROR")?"网络错误，请检查连接":e.includes("WRITE_FAILED")?"保存失败（存储空间不足？）":"下载失败，请重试"}function E2(e){return new Promise((t,r)=>{let i=!1;const s=window.setTimeout(()=>{i||(i=!0,r(new Tl(-1,"原生10分钟无回调：App 内可能未注册 downloadFile 插件（需 Android 侧按 download_bridge.md 实现后的构建）")))},C2),a=o=>n=>{i||(i=!0,window.clearTimeout(s),o(n))};window.jsbridge.downloadFile({downloadUrl:e.downloadUrl,fileName:e.fileName,success:a(o=>t(o)),fail:a(o=>{const n=o;r(new Tl(n.code??-1,A2(n.detail||""),n.unauthorized===!0))})})})}const jh="cortex.files.mdFontScalePct",Cl=60,Al=200,Rd=10,Ld=100;function M2(){const e=localStorage.getItem(jh);if(e===null||e.trim()==="")return Ld;const t=Number(e);return Number.isFinite(t)?Sc(t):Ld}function P2(e){if(Number.isFinite(e))try{localStorage.setItem(jh,String(Sc(e)))}catch{}}function Sc(e){return Math.min(Al,Math.max(Cl,e))}function D2(e){return Sc(e)/100}var I2=Object.defineProperty,O2=Object.getOwnPropertyDescriptor,ze=(e,t,r,i)=>{for(var s=i>1?void 0:i?O2(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&I2(t,r,s),s};let xe=class extends V{constructor(){super(...arguments),this.path="",this.language="text",this.content="",this.highlights=[],this.loading=!1,this.line=null,this.keyword="",this.writable=!1,this.noHeader=!1,this.mobile=!1,this.pages=null,this.attachments=null,this.showBack=!1,this.backLabel="返回",this.enableReparse=!1,this.rememberScroll=!1,this._mode="preview",this._content="",this._showMobileMenu=!1,this._downloading=!1,this._fontScalePct=M2(),this._showHighlightBar=!1,this._highlightInput="",this._showToc=!1,this._tocItems=[],this._tocCurrentLine=1,this._anchorLine=1,this._suppressLocate=!1,this._skipRestoreOnce=!1,this._scrollJump=new wc(this,{behavior:"smooth"}),this._scrollBoundViewer=null,this._pendingScrollPath="",this._onViewerScroll=()=>{this._pendingScrollPath=this.path,window.clearTimeout(this._scrollSaveTimer),this._scrollSaveTimer=window.setTimeout(()=>this._flushScrollMemory(),300)},this._onMobileBackClick=()=>{this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))},this._onMobileMoreClick=e=>{e.stopPropagation(),this._showMobileMenu=!this._showMobileMenu},this._onDocClick=e=>{var s,a;if(!this._showMobileMenu)return;const t=e.composedPath(),r=(s=this.shadowRoot)==null?void 0:s.querySelector(".mobile-menu"),i=(a=this.shadowRoot)==null?void 0:a.querySelector(".mobile-more");r&&t.includes(r)||i&&t.includes(i)||(this._showMobileMenu=!1)},this._onEditorCancel=()=>{this._captureEditorAnchor(),this._mode="preview"},this._onEditorDirty=e=>{this.dispatchEvent(new CustomEvent("dirty-change",{detail:{dirty:e.detail.dirty}}))},this._onDownloadClick=()=>{if(!this.path||this._downloading)return;const e=`/api/preview/download?path=${encodeURIComponent(this.path)}`;if(y2()){this._downloadViaJsbridge(e);return}const t=document.createElement("a");t.href=e,t.rel="noopener",document.body.appendChild(t),t.click(),document.body.removeChild(t)},this._onReparseClick=()=>{this.path&&this.dispatchEvent(new CustomEvent("reparse",{detail:{path:this.path},bubbles:!0,composed:!0}))},this._onUploadClick=()=>{var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector('input[type="file"]');e==null||e.click()},this._onHighlightToggle=async()=>{var e;if(this._showHighlightBar=!this._showHighlightBar,this._showHighlightBar){await this.updateComplete;const t=(e=this.shadowRoot)==null?void 0:e.querySelector(".highlight-bar input");t==null||t.focus()}},this._onHighlightInput=e=>{this._highlightInput=e.target.value,this._clearHighlightDebounce(),this._highlightInput.trim()&&(this._highlightDebounce=window.setTimeout(()=>{this._highlightDebounce=void 0,this._jumpToFirstHit()},300))},this._onHighlightKeydown=e=>{e.key==="Enter"?(this._clearHighlightDebounce(),this._jumpToFirstHit()):e.key==="Escape"&&this._onHighlightClear()},this._onHighlightClear=()=>{this._clearHighlightDebounce(),this._highlightInput="",this._showHighlightBar=!1},this._onTocToggle=()=>{if(!this._showToc){const e=this.shadowRoot.querySelector("md-viewer");this._tocCurrentLine=(e==null?void 0:e.topSourceLine())??1}this._showToc=!this._showToc},this._onTocClose=()=>{this._showToc=!1},this._onTocJump=e=>{this._showToc=!1;const t=this.shadowRoot.querySelector("md-viewer");t==null||t.jumpToSourceLine(e.detail.line,"smooth")}}willUpdate(e){e.has("path")&&(this._highlightInput="",this._showHighlightBar=!1,this._clearHighlightDebounce(),this._showToc=!1,this._flushScrollMemory()),e.has("content")&&(this._content=this.content,this._tocItems=Md(this._content),this._showToc=!1,this._mode="preview",this._skipRestoreOnce=!0,this._suppressLocate=!1,this._anchorLine=1)}async updated(e){var i;(i=super.updated)==null||i.call(this,e);const t=this.shadowRoot.querySelector(".body");t?this._scrollJump.attach(t):this._scrollJump.detach();const r=this.shadowRoot.querySelector("md-viewer");if(this.rememberScroll&&r&&this._mode==="preview"?this._scrollBoundViewer!==r&&(this._detachScrollMemory(),r.addEventListener("scroll",this._onViewerScroll,{passive:!0}),this._scrollBoundViewer=r):this._scrollBoundViewer&&this._detachScrollMemory(),this.rememberScroll&&e.has("path")){const s=v2(this.path);if(s!==null&&s>1&&this.language==="markdown"&&r){const a=this.path;if(await r.updateComplete,this.path!==a)return;r.scrollToSourceLine(s,"auto")}}if(e.has("_mode")){if(this._mode==="edit"){const s=this.shadowRoot.querySelector("md-editor");s&&(await s.updateComplete,s.scrollToLine(this._anchorLine));return}if(this._skipRestoreOnce){this._skipRestoreOnce=!1;return}r&&(await r.updateComplete,r.scrollToSourceLine(this._anchorLine,"auto")),this._suppressLocate=!1}}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick,!0)}disconnectedCallback(){document.removeEventListener("click",this._onDocClick,!0),this._clearHighlightDebounce(),this._detachScrollMemory(),super.disconnectedCallback()}_flushScrollMemory(){window.clearTimeout(this._scrollSaveTimer),this._scrollSaveTimer=void 0;const e=this._scrollBoundViewer,t=this._pendingScrollPath;this._pendingScrollPath="",!(!e||!t)&&b2(t,e.topSourceLine())}_detachScrollMemory(){this._scrollBoundViewer&&this._scrollBoundViewer.removeEventListener("scroll",this._onViewerScroll),this._flushScrollMemory(),this._scrollBoundViewer=null}_renderFontScaleStepper(){const e=this._fontScalePct<=Cl,t=this._fontScalePct>=Al;return u`
    ...
    `}_bumpFontScale(e){const t=Math.min(Al,Math.max(Cl,this._fontScalePct+e));t!==this._fontScalePct&&(this._fontScalePct=t,P2(t))}_basename(e){if(!e)return"";const t=e.lastIndexOf("/");return t>=0?e.slice(t+1):e}get _isPst(){return Bi(this.path)||Jr(this.path)}_renderMobileHeader(){return u`
...
`);return u`
  ...
  `];ze([y()],xe.prototype,"path",2);ze([y()],xe.prototype,"language",2);ze([y()],xe.prototype,"content",2);ze([y({attribute:!1})],xe.prototype,"highlights",2);ze([y({type:Boolean})],xe.prototype,"loading",2);ze([y({type:Number})],xe.prototype,"line",2);ze([y()],xe.prototype,"keyword",2);ze([y({type:Boolean})],xe.prototype,"writable",2);ze([y({type:Boolean})],xe.prototype,"noHeader",2);ze([y({type:Boolean})],xe.prototype,"mobile",2);ze([y({attribute:!1})],xe.prototype,"pages",2);ze([y({attribute:!1})],xe.prototype,"attachments",2);ze([y({type:Boolean})],xe.prototype,"showBack",2);ze([y()],xe.prototype,"backLabel",2);ze([y({type:Boolean})],xe.prototype,"enableReparse",2);ze([y({type:Boolean})],xe.prototype,"rememberScroll",2);ze([S()],xe.prototype,"_mode",2);ze([S()],xe.prototype,"_content",2);ze([S()],xe.prototype,"_showMobileMenu",2);ze([S()],xe.prototype,"_downloading",2);ze([S()],xe.prototype,"_fontScalePct",2);ze([S()],xe.prototype,"_showHighlightBar",2);ze([S()],xe.prototype,"_highlightInput",2);ze([S()],xe.prototype,"_showToc",2);ze([S()],xe.prototype,"_tocItems",2);ze([S()],xe.prototype,"_tocCurrentLine",2);xe=ze([K("preview-pane")],xe);const R2="modulepreload",L2=function(e){return"/"+e},Bd={},B2=function(t,r,i){let s=Promise.resolve();if(r&&r.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),n=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(r.map(c=>{if(c=L2(c),c in Bd)return;Bd[c]=!0;const p=c.endsWith(".css"),f=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${f}`))return;const b=document.createElement("link");if(b.rel=p?"stylesheet":R2,p||(b.as="script"),b.crossOrigin="",b.href=c,n&&b.setAttribute("nonce",n),document.head.appendChild(b),p)return new Promise((w,k)=>{b.addEventListener("load",w),b.addEventListener("error",()=>k(new Error(`Unable to preload CSS for ${c}`)))})}))}function a(o){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=o,window.dispatchEvent(n),!n.defaultPrevented)throw o}return s.then(o=>{for(const n of o||[])n.status==="rejected"&&a(n.reason);return t().catch(a)})},N2=1e4;async function F2(e){const t=new AbortController,r=setTimeout(()=>t.abort(),N2);try{return await ue("/api/ask/respond",{method:"POST",json:e,signal:t.signal})}finally{clearTimeout(r)}}function Uh(e){try{const t=JSON.parse(e);if(!Array.isArray(t==null?void 0:t.questions))return null;const r=t.questions;return r.length===0?null:r.every(s=>typeof(s==null?void 0:s.question)=="string"&&typeof(s==null?void 0:s.header)=="string"&&Array.isArray(s==null?void 0:s.options)&&s.options.length>=2&&s.options.every(a=>typeof(a==null?void 0:a.label)=="string"))?r:null}catch{return null}}function Wh(e){const t=e.match(/^\((?:Recommended|推荐)\)\s*/);return t?[e.slice(t[0].length),!0]:e.endsWith("（推荐）")?[e.slice(0,-4),!0]:e.endsWith("(推荐)")?[e.slice(0,-4),!0]:[e,!1]}const H2=Object.freeze(Object.defineProperty({__proto__:null,parseAskQuestions:Uh,respondAsk:F2,splitRecommended:Wh},Symbol.toStringTag,{value:"Module"}));var q2=Object.defineProperty,j2=Object.getOwnPropertyDescriptor,ci=(e,t,r,i)=>{for(var s=i>1?void 0:i?j2(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&q2(t,r,s),s};let or=class extends V{constructor(){super(...arguments),this.ask=null,this.resolvedAnswers=null,this._selected=[],this._others=[],this._status="pending",this._answers=[],this._submitting=!1}willUpdate(e){e.has("ask")&&this.ask&&(this._selected=this.ask.questions.map(()=>[]),this._others=this.ask.questions.map(()=>null),this._status="pending",this._answers=[]),e.has("resolvedAnswers")&&this.resolvedAnswers&&(this._status="answered",this._answers=this.resolvedAnswers)}get _canSubmit(){return this.ask?this.ask.questions.every((e,t)=>{var a;const r=((a=this._selected[t])==null?void 0:a.length)??0,i=(this._others[t]??"").trim(),s=this._others[t]!==null&&i.length>0;return r>0||s}):!1}_toggle(e,t,r){const i=[...this._selected],s=i[e]??[];i[e]=r?s.includes(t)?s.filter(a=>a!==t):[...s,t]:s.includes(t)?[]:[t],this._selected=i}_onOtherInput(e,t){const r=[...this._others];r[e]=t,this._others=r}async _submit(){if(!this.ask||!this._canSubmit||this._submitting)return;this._submitting=!0;const e=this.ask.questions.map((r,i)=>({question:r.question,selected:this._selected[i]??[],other:(this._others[i]??"").trim()||null}));let t=!1;try{const{respondAsk:r}=await B2(async()=>{const{respondAsk:s}=await Promise.resolve().then(()=>H2);return{respondAsk:s}},void 0),{submitted:i}=await r({request_id:this.ask.requestId,answers:e});this._status=i?"answered":"expired",this._answers=e,t=!0}catch(r){console.warn("[ask-card] respond failed:",r),this._status="expired",this._answers=e,t=!0}finally{this._submitting=!1,t&&this._dispatchDone()}}_dispatchDone(){var e;this.dispatchEvent(new CustomEvent("ask-done",{detail:{requestId:((e=this.ask)==null?void 0:e.requestId)??""},bubbles:!0,composed:!0}))}_renderQuestion(e,t){const r=this._selected[t]??[],i=this._others[t]??null;return u`
      <div class="q">
        <p class="q-title">
  ...
  `];Cs([y({reflect:!0})],si.prototype,"role",2);Cs([y({attribute:!1})],si.prototype,"message",2);Cs([y()],si.prototype,"error",2);Cs([y({attribute:!1})],si.prototype,"modelName",2);Cs([S()],si.prototype,"_copied",2);si=Cs([K("chat-message")],si);var G2=Object.defineProperty,X2=Object.getOwnPropertyDescriptor,za=(e,t,r,i)=>{for(var s=i>1?void 0:i?X2(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&G2(t,r,s),s};const K2={search:"search",read_document:"file",grep:"search"},Y2={search:"正在搜索",read_document:"正在读取",grep:"正在检索"};function Z2(e){const t=[`思考过程（${e.length} 步）`];return e.forEach((r,i)=>{t.push(""),t.push(`[${i+1}] ${r.name}`),Object.keys(r.input).length&&(t.push("参数："),t.push(JSON.stringify(r.input,null,2))),r.output!=null&&r.output!==""?(t.push("结果："),t.push(r.output)):t.push("结果：（无输出）")}),t.join(`
`)}let Ni=class extends V{constructor(){super(...arguments),this.steps=[],this._expanded=!1,this._fullResultIds=new Set,this._copied=!1}willUpdate(e){if(e.has("steps")){const r=(e.get("steps")??[]).some(s=>s.status==="running"),i=this.steps.some(s=>s.status==="running");!r&&i?this._expanded=!0:r&&!i&&(this._expanded=!1)}}_toggle(){this._expanded=!this._expanded}_toggleResult(e){const t=new Set(this._fullResultIds);t.has(e)?t.delete(e):t.add(e),this._fullResultIds=t}async _onCopy(e){e.stopPropagation();const t=Z2(this.steps);try{await navigator.clipboard.writeText(t),this._copied=!0,setTimeout(()=>{this._copied=!1},2e3)}catch{try{const i=document.createElement("textarea");i.value=t,i.style.position="fixed",i.style.opacity="0",document.body.appendChild(i),i.select(),document.execCommand("copy"),document.body.removeChild(i),this._copied=!0,setTimeout(()=>{this._copied=!1},2e3)}catch(i){console.warn("copy failed:",i)}}}_renderArgs(e){return Object.entries(e).map(([t,r])=>`${t}: ${typeof r=="string"?r:JSON.stringify(r)}`).join(`
`)}_renderStep(e){const t=e.status==="running",r=e.status==="error",i=K2[e.name]??"settings",s=this._fullResultIds.has(e.tool_use_id),a=(e.output??"").split(`
...
`):e.output??"",c=e.output!=null&&e.output!=="";return u`
      <div class="step ${t?"running":""} ${r?"error":""}">
        <div class="head">
          ...
          <span class="name">${e.name}</span>
          ${t?u`<span class="running-text">${Y2[e.name]??"正在调用"}...</span>`:null}
          <span class="meta">
  ...
  `;za([y({attribute:!1})],Ni.prototype,"steps",2);za([S()],Ni.prototype,"_expanded",2);za([S()],Ni.prototype,"_fullResultIds",2);za([S()],Ni.prototype,"_copied",2);Ni=za([K("chat-tool-trace")],Ni);var J2=Object.defineProperty,Q2=Object.getOwnPropertyDescriptor,$c=(e,t,r,i)=>{for(var s=i>1?void 0:i?Q2(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&J2(t,r,s),s};let va=class extends V{constructor(){super(...arguments),this.messages=[],this.modelName=null,this._scrollRafPending=!1}updated(){this._scrollRafPending||(this._scrollRafPending=!0,requestAnimationFrame(()=>{this._scrollRafPending=!1,this.scrollTop=this.scrollHeight}))}render(){return this.messages.length===0?u`<div class="empty">开始与 Doclens 对话</div>`:u`
...
确定要丢弃吗？`))return;const s=(t=this.shadowRoot)==null?void 0:t.querySelector("preview-pane");(r=s==null?void 0:s.discard)==null||r.call(s),this.previewDirty=!1}await e()}async _reloadPreview(){if(!this.previewPath)return;const e=await bs(this.previewPath);e.ok&&(this.previewContent=e.content,this.previewLanguage=e.language,this.previewWritable=e.writable,this.previewPages=e.pages,this.previewAttachments=e.attachments)}_pushToast(e,t,r){var s;const i=(s=this.shadowRoot)==null?void 0:s.querySelector("toast-stack");i==null||i.pushToast(e,t,r)}_renderNotIndexedHint(){return u`<div class="not-indexed-hint">
      ...
      <div class="form">
        ...
        <div>
          ...
          <select class="select" .value=${t.protocol} @change=${i=>this._setField("protocol",i.target.value)}>
            ${Tx.map(i=>u`<option value=${i.value} ?selected=${i.value===t.protocol}>${i.label}</option>`)}
          </select>
        </div>
        <div class="full">
  ...
  `;br([y()],Lt.prototype,"activeSearch",2);br([S()],Lt.prototype,"_presets",2);br([S()],Lt.prototype,"_loading",2);br([S()],Lt.prototype,"_editing",2);br([S()],Lt.prototype,"_busy",2);br([S()],Lt.prototype,"_error",2);br([S()],Lt.prototype,"_toast",2);br([S()],Lt.prototype,"_confirmDeleteId",2);br([S()],Lt.prototype,"_formError",2);Lt=br([K("search-presets-section")],Lt);var Mx=Object.defineProperty,Px=Object.getOwnPropertyDescriptor,gr=(e,t,r,i)=>{for(var s=i>1?void 0:i?Px(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&Mx(t,r,s),s};const jd=["ai","search","network"],Dx={ai:"sparkles",search:"search",network:"globe"},Ix=u`
...
`;let Bt=class extends V{constructor(){super(...arguments),this._activeTab="ai",this._saving=!1,this._error=null,this._toast=null,this._values={},this._original={},this._exists=!0,this._scope="global",this._fieldErrors={},this._loadGen=0,this._onRevertRequest=()=>{this._revert()}}connectedCallback(){super.connectedCallback();const e=T.getState();this._scope=e.settings.scope,this._unsubscribe=T.subscribe(()=>this._onStoreChange()),window.addEventListener("cortex:revert-settings",this._onRevertRequest),this._load()}disconnectedCallback(){var e;(e=this._unsubscribe)==null||e.call(this),this._toastTimer!==void 0&&(window.clearTimeout(this._toastTimer),this._toastTimer=void 0),this._loadGen+=1,window.removeEventListener("cortex:revert-settings",this._onRevertRequest),super.disconnectedCallback()}_onStoreChange(){const e=T.getState();e.settings.scope!==this._scope&&(this._scope=e.settings.scope,this._load())}async _load(){const e=++this._loadGen;this._error=null;try{const t=await xx(this._scope);if(e!==this._loadGen||!this.isConnected)return;this._values={...t.values},this._original={...t.values},this._exists=t.exists,this._fieldErrors={},C.loadSettings(this._values,t.exists)}catch(t){if(e!==this._loadGen||!this.isConnected)return;this._error=`加载失败: ${t.message}`}}get _dirtyFields(){const e=new Set([...Object.keys(this._original),...Object.keys(this._values)]),t=[];for(const r of e)(this._original[r]??"")!==(this._values[r]??"")&&t.push(r);return t}get _dirty(){return this._dirtyFields.length>0}_updateValues(e){this._values={...this._values,...e};for(const[t,r]of Object.entries(e))C.updateSetting(t,r)}_onInput(e,t){this._updateValues({[e]:t})}_isMobile(){return typeof window.matchMedia=="function"&&window.matchMedia("(max-width: 1023px)").matches}_pushToast(e,t="info",r=2500){var s;const i=(s=this.shadowRoot)==null?void 0:s.querySelector("toast-stack");i==null||i.pushToast(e,t,r)}_extractFieldErrors(e){if(e instanceof zo){const t=e.body,r={};for(const i of(t==null?void 0:t.fields)??[])r[i.field]=i.error;return r}return{}}_close(){Gt.navigate(Gt.lastMain())}async _refreshSystemStatus(){try{const e=await xu();C.setStatus(e)}catch{}}_revert(){this._values={...this._original},C.revertSettings()}async _save(){var e;if(!(!this._dirty||this._saving)){this._saving=!0,this._error=null,this._fieldErrors={};try{const t=await yx(this._scope,this._values);if(!this.isConnected)return;this._original={...this._values},C.loadSettings(this._values,!0),this._refreshSystemStatus();const r=t.needs_restart?"已保存。重启 doclens gui 后 AI 配置生效。":"已保存。下次查询立即生效。";this._isMobile()?this._pushToast(r,"success",4e3):this._toast=r}catch(t){let r;if(t instanceof zo){const i=t.body,s=(e=i==null?void 0:i.fields)==null?void 0:e.map(a=>a.field).join(", ");r=s?`保存失败（${s}）`:`保存失败 (HTTP ${t.status})`}else t instanceof Error?r=`保存失败: ${t.message}`:r="保存失败: 未知错误";this._isMobile()?(this._pushToast(r,"error",5e3),this._fieldErrors=this._extractFieldErrors(t)):this._error=r}finally{this._saving=!1}}}_renderField(e){const t=this._values[e.envVar]??"";return u`
    ...
    `}_renderDesc(e){if(e.tab!=="search"||!e.hint)return N;const t=e.hint.replace(/。$/,""),r=e.min!=null&&e.max!=null?` · ${e.min}–${e.max}`:"";return u`<div class="desc">${t}${r}</div>`}_renderInput(e,t){const r=e.mono?"mono":"",i=s=>this._onInput(e.envVar,s.target.value);switch(e.component){case"text":return u`
        ...
        `;case"switch":{const s=t==="",a=s?(bx[e.envVar]??"true")==="true":t==="true",o=n=>this._onInput(e.envVar,n.target.checked?"true":"false");return u`
          <label class="switch">
            <input
              type="checkbox"
              .checked=${a}
  ...
  `;El=Nx([K("file-tree")],El);const Fx={pdf:{letter:"P",bg:"#E41E3F",fg:"#FFFFFF"},doc:{letter:"D",bg:"#0064E0",fg:"#FFFFFF"},docx:{letter:"D",bg:"#0064E0",fg:"#FFFFFF"},xls:{letter:"X",bg:"#31A24C",fg:"#FFFFFF"},xlsx:{letter:"X",bg:"#31A24C",fg:"#FFFFFF"},csv:{letter:"C",bg:"#31A24C",fg:"#FFFFFF"},ppt:{letter:"S",bg:"#EA580C",fg:"#FFFFFF"},pptx:{letter:"S",bg:"#EA580C",fg:"#FFFFFF"},md:{letter:"M",bg:"#A121CE",fg:"#FFFFFF"},txt:{letter:"T",bg:"#5D6C7B",fg:"#FFFFFF"},html:{letter:"H",bg:"#E34F26",fg:"#FFFFFF"},mhtml:{letter:"W",bg:"#0D9488",fg:"#FFFFFF"},mht:{letter:"W",bg:"#0D9488",fg:"#FFFFFF"},png:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},jpg:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},jpeg:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},webp:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},gif:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},bmp:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},tiff:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"},tif:{letter:"I",bg:"#7C3AED",fg:"#FFFFFF"}};function Hx(e){if(!e)return"";const t=e.lastIndexOf(".");return t<=0||t===e.length-1?"":e.slice(t+1).toLowerCase()}function qx(e,t){if(t)return null;const r=Hx(e);return Fx[r]??null}var jx=Object.defineProperty,Ux=Object.getOwnPropertyDescriptor,Go=(e,t,r,i)=>{for(var s=i>1?void 0:i?Ux(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&jx(t,r,s),s};let gs=class extends V{constructor(){super(...arguments),this.selected=!1,this.active=!1}_fmtSize(e){return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/1024/1024).toFixed(1)} MB`}_fmtTime(e){if(!e)return"";try{return new Date(e).toLocaleString(void 0,{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"})}catch{return""}}_onRowClick(){this.dispatchEvent(new CustomEvent("activated",{detail:{path:this.entry.path,is_dir:this.entry.is_dir},bubbles:!0,composed:!0}))}_onCheckboxClick(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("checked",{detail:{path:this.entry.path,ctrl:e.ctrlKey||e.metaKey,shift:e.shiftKey},bubbles:!0,composed:!0}))}render(){const e=qx(this.entry.name,this.entry.is_dir);return u`
      <div
  ...
  `;Go([y({type:Object})],gs.prototype,"entry",2);Go([y({type:Boolean})],gs.prototype,"selected",2);Go([y({type:Boolean})],gs.prototype,"active",2);gs=Go([K("file-row")],gs);var Wx=Object.defineProperty,Vx=Object.getOwnPropertyDescriptor,Es=(e,t,r,i)=>{for(var s=i>1?void 0:i?Vx(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&Wx(t,r,s),s};const ep=[28,28,240,80,140],Ud=[20,20,80,50,80],Wd=[60,60,800,200,300],Vd=ep.length,Gd="cortex.files.colWidths";let ai=class extends V{constructor(){super(...arguments),this.activePath="",this.mobile=!1,this.uploading=!1,this._colWidths=[...ep],this._showMobileMenu=!1,this._makeColResizeHandler=e=>t=>{t.preventDefault(),t.stopPropagation();const r=t.clientX,i=this._colWidths[e];document.body.style.cursor="col-resize",document.body.style.userSelect="none";const s=o=>{const n=o.clientX-r,c=Math.max(Ud[e],Math.min(Wd[e],i+n)),p=[...this._colWidths];p[e]=c,this._colWidths=p},a=()=>{document.removeEventListener("mousemove",s),document.removeEventListener("mouseup",a),document.body.style.cursor="",document.body.style.userSelect="",localStorage.setItem(Gd,JSON.stringify(this._colWidths))};document.addEventListener("mousemove",s),document.addEventListener("mouseup",a)},this._onMobileBackClick=()=>{this._showMobileMenu=!1,this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))},this._onMobileMoreClick=e=>{e.stopPropagation(),this._showMobileMenu=!this._showMobileMenu},this._onDocClick=e=>{var s,a;if(!this._showMobileMenu)return;const t=e.composedPath(),r=(s=this.shadowRoot)==null?void 0:s.querySelector(".mobile-menu"),i=(a=this.shadowRoot)==null?void 0:a.querySelector(".mobile-more");r&&t.includes(r)||i&&t.includes(i)||(this._showMobileMenu=!1)},this._onMenuItemClick=e=>t=>{t.stopPropagation(),this._showMobileMenu=!1,this._action(e)}}connectedCallback(){super.connectedCallback(),this._unsubscribe=T.subscribe(()=>this.requestUpdate()),this._loadColWidths(),document.addEventListener("click",this._onDocClick,!0)}disconnectedCallback(){var e;(e=this._unsubscribe)==null||e.call(this),document.removeEventListener("click",this._onDocClick,!0),super.disconnectedCallback()}willUpdate(){for(let e=0;e<Vd;e++)this.style.setProperty(`--col-${e+1}`,`${this._colWidths[e]}px`)}_loadColWidths(){const e=localStorage.getItem(Gd);if(e)try{const t=JSON.parse(e);Array.isArray(t)&&t.length===Vd&&t.every(r=>typeof r=="number"&&Number.isFinite(r))&&(this._colWidths=t.map((r,i)=>Math.max(Ud[i],Math.min(Wd[i],r))))}catch{}}_action(e){this.dispatchEvent(new CustomEvent("action",{detail:{name:e},bubbles:!0,composed:!0}))}_onRowChecked(e){const{path:t,shift:r}=e.detail;C.selectEntry(t,{ctrl:!r,shift:r})}_onSelectAll(e){const t=e.target,{currentDir:r,treeCache:i,selectedPaths:s}=T.getState().files,a=i[r]||[];if(t.checked){const o=a.map(c=>c.path),n=Array.from(new Set([...s,...o]));C.setFilesState({selectedPaths:n})}else{const o=new Set(a.map(n=>n.path));C.setFilesState({selectedPaths:s.filter(n=>!o.has(n))})}}_goUp(){const{currentDir:e}=T.getState().files;if(e==="")return;const t=e.includes("/")?e.slice(0,e.lastIndexOf("/")):"";C.selectDir(t)}_renderMobileHeader(){const{currentDir:e,selectedPaths:t}=T.getState().files,r=t.length===1,i=t.length>=1,s=e===""?"/":`/${e}/`;return u`
      <div class="mobile-header">
        <button
          class="mobile-back"
          type="button"
  ...
  `;Xo([y({type:String})],xs.prototype,"currentName",2);Xo([S()],xs.prototype,"_name",2);Xo([S()],xs.prototype,"_err",2);xs=Xo([K("rename-dialog")],xs);class Cc extends Error{constructor(t,r,i){super(r),this.code=t,this.status=i,this.name="ReparseError"}}async function t4(){return(await ue("/api/vision/prompt")).prompt}async function r4(e,t){try{return await ue("/api/vision/reparse",{method:"POST",json:{path:e,prompt:t}})}catch(r){throw r instanceof Et?new Cc(r.code,r.message,r.status):r}}async function i4(e,t){try{return await ue("/api/vision/note",{method:"POST",json:{path:e,markdown:t}})}catch(r){throw r instanceof Et?new Cc(r.code,r.message,r.status):r}}var s4=Object.defineProperty,a4=Object.getOwnPropertyDescriptor,hi=(e,t,r,i)=>{for(var s=i>1?void 0:i?a4(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&s4(t,r,s),s};let cr=class extends V{constructor(){super(...arguments),this.path="",this._mode="ai",this._defaultPrompt="",this._prompt="",this._promptLoading=!0,this._loading=!1,this._err=""}async connectedCallback(){super.connectedCallback();try{this._defaultPrompt=await t4(),this._mode==="ai"&&(this._prompt=this._defaultPrompt)}catch{this._err="加载默认提示词失败，请手动输入"}this._promptLoading=!1}_switchMode(e){this._loading||e===this._mode||(this._mode=e,this._err="",this._prompt=e==="ai"?this._defaultPrompt:"")}_clear(){this._loading||(this._prompt="",this._err="")}_onInput(e){this._prompt=e.target.value,this._err&&(this._err="")}async _submit(){if(!(this._loading||this._promptLoading)){if(!this._prompt.trim()){this._err=this._mode==="ai"?"提示词不能为空":"备注不能为空";return}this._err="",this._loading=!0;try{this._mode==="ai"?await r4(this.path,this._prompt):await i4(this.path,this._prompt),this.dispatchEvent(new CustomEvent("done",{bubbles:!0,composed:!0}))}catch(e){const t=e instanceof Cc?`[${e.code}] `:"";this._err=`${t}${e.message??"操作失败"}`}finally{this._loading=!1}}}_cancel(){this._loading||this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){const e=this._mode==="ai",t=!this._loading&&!this._promptLoading&&!!this._prompt.trim(),r=!!this._err,i=this._loading?e?"解析中...":"保存中...":e?"重新解析":"保存备注";return u`
      <div class="mode-tabs">
...
说明文字…），将覆盖 AI 解析结果`}
  ...
  `;Ko([S()],ys.prototype,"_phase",2);Ko([S()],ys.prototype,"_stats",2);Ko([S()],ys.prototype,"_confirmed",2);ys=Ko([K("delete-dialog")],ys);async function d4(){return(await ue("/api/skills")).skills??[]}var u4=Object.defineProperty,h4=Object.getOwnPropertyDescriptor,Ca=(e,t,r,i)=>{for(var s=i>1?void 0:i?h4(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&u4(t,r,s),s};let Hi=class extends V{constructor(){super(...arguments),this._skills=[],this._loading=!0,this._error=null,this._isMobile=!1,this._onMqlChange=e=>{this._isMobile=e.matches}}connectedCallback(){super.connectedCallback(),this._mql=window.matchMedia("(max-width: 1023px)"),this._isMobile=this._mql.matches,this._mql.addEventListener("change",this._onMqlChange),this._load()}disconnectedCallback(){var e;(e=this._mql)==null||e.removeEventListener("change",this._onMqlChange),super.disconnectedCallback()}async _load(){this._loading=!0,this._error=null;try{this._skills=await d4()}catch(e){this._error=(e==null?void 0:e.message)||"技能列表加载失败"}finally{this._loading=!1}}_onPick(e){this.dispatchEvent(new CustomEvent("pick",{detail:{skill:e},bubbles:!0,composed:!0}))}_onItemKeydown(e,t){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._onPick(t))}_cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}_renderBody(){return this._loading?u`<div class="empty">加载中…</div>`:this._error?u`<div class="err">${this._error}</div>`:this._skills.length===0?u`<div class="empty">暂无可用技能</div>`:this._isMobile?u`<ul class="list">
  ...
  `;Ca([S()],Hi.prototype,"_skills",2);Ca([S()],Hi.prototype,"_loading",2);Ca([S()],Hi.prototype,"_error",2);Ca([S()],Hi.prototype,"_isMobile",2);Hi=Ca([K("skill-toolbox-dialog")],Hi);var p4=Object.defineProperty,f4=Object.getOwnPropertyDescriptor,Yo=(e,t,r,i)=>{for(var s=i>1?void 0:i?f4(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&p4(t,r,s),s};let ws=class extends V{constructor(){super(...arguments),this.skill=null,this.filePaths=[],this._prompt=""}_submit(){this.dispatchEvent(new CustomEvent("submit",{detail:{prompt:this._prompt.trim()},bubbles:!0,composed:!0}))}_cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){const e=this.skill;return u`
      <h3>
  ...
  `;Ec([y({type:String})],xa.prototype,"targetDir",2);Ec([S()],xa.prototype,"_active",2);xa=Ec([K("drop-zone")],xa);var b4=Object.defineProperty,g4=Object.getOwnPropertyDescriptor,Ms=(e,t,r,i)=>{for(var s=i>1?void 0:i?g4(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&b4(t,r,s),s};const x4=80,y4="按文件名搜索…";let oi=class extends V{constructor(){super(...arguments),this._value="",this._isComposing=!1,this.disabled=!1,this.placeholder=y4,this.value="",this._timer=null,this._onInput=e=>{const t=e.target;if(this._value=t.value,this._value.trim()===""){this._emitClear();return}this._scheduleEmit()},this._onCompositionStart=()=>{this._isComposing=!0},this._onCompositionEnd=()=>{this._isComposing=!1,this._scheduleEmit()},this._onKeyDown=e=>{e.key==="Escape"&&(e.preventDefault(),this._emitClear())},this._onClearClick=()=>{var t;this._emitClear();const e=(t=this.shadowRoot)==null?void 0:t.querySelector("input");e==null||e.focus()}}connectedCallback(){super.connectedCallback(),this.value&&(this._value=this.value)}disconnectedCallback(){this._timer&&clearTimeout(this._timer),super.disconnectedCallback()}_emitSearch(){this.dispatchEvent(new CustomEvent("search",{detail:{query:this._value},bubbles:!0,composed:!0}))}_scheduleEmit(){this._timer&&clearTimeout(this._timer),this._timer=setTimeout(()=>{this._timer=null,this._isComposing||this._emitSearch()},x4)}_emitClear(){var t;this._timer&&(clearTimeout(this._timer),this._timer=null),this._value="";const e=(t=this.shadowRoot)==null?void 0:t.querySelector("input");e&&(e.value=""),this.dispatchEvent(new CustomEvent("clear",{bubbles:!0,composed:!0}))}render(){return u`
      <div class="box">
  ...
  `;Ms([S()],oi.prototype,"_value",2);Ms([S()],oi.prototype,"_isComposing",2);Ms([y({type:Boolean})],oi.prototype,"disabled",2);Ms([y()],oi.prototype,"placeholder",2);Ms([y({type:String})],oi.prototype,"value",2);oi=Ms([K("file-search-box")],oi);var w4=Object.getOwnPropertyDescriptor,_4=(e,t,r,i)=>{for(var s=i>1?void 0:i?w4(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=o(s)||s);return s};const k4=100;function S4(e,t){if(!t)return e;const r=e.toLowerCase(),i=t.toLowerCase(),s=r.indexOf(i);return s===-1?e:[e.slice(0,s),u`<mark>${e.slice(s,s+i.length)}</mark>`,e.slice(s+i.length)]}function $4(e){const t=e.lastIndexOf("/");return t===-1?"":e.slice(0,t+1)}function z4(e){return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/1024/1024).toFixed(1)} MB`}function T4(e){if(!e)return"";const t=new Date(e).getTime();if(Number.isNaN(t))return"";const r=Date.now()-t,i=24*3600*1e3;return r<i?"今天":r<2*i?"昨天":r<7*i?`${Math.floor(r/i)} 天前`:r<30*i?`${Math.floor(r/(7*i))} 周前`:r<365*i?`${Math.floor(r/(30*i))} 个月前`:`${Math.floor(r/(365*i))} 年前`}let Ml=class extends V{constructor(){super(...arguments),this._onKeyDown=e=>{const{results:t,selectedPath:r}=this._state;if(t.length===0){e.key==="Escape"&&this.dispatchEvent(new CustomEvent("clear",{bubbles:!0,composed:!0}));return}const i=t.findIndex(s=>s.path===r);if(e.key==="ArrowDown"){e.preventDefault();const s=t[Math.min(t.length-1,i+1)];C.selectFilenameSearchResult(s.path),this.dispatchEvent(new CustomEvent("activated",{detail:{path:s.path},bubbles:!0,composed:!0}))}else if(e.key==="ArrowUp"){e.preventDefault();const s=t[Math.max(0,i-1)];C.selectFilenameSearchResult(s.path),this.dispatchEvent(new CustomEvent("activated",{detail:{path:s.path},bubbles:!0,composed:!0}))}else if(e.key==="Enter"){e.preventDefault();const s=t[i]??t[0];s&&this.dispatchEvent(new CustomEvent("activated",{detail:{path:s.path},bubbles:!0,composed:!0}))}else e.key==="Escape"&&this.dispatchEvent(new CustomEvent("clear",{bubbles:!0,composed:!0}))}}get _state(){return T.getState().files.filenameSearch}_onRowClick(e){C.selectFilenameSearchResult(e.path),this.dispatchEvent(new CustomEvent("activated",{detail:{path:e.path},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.tabIndex=0,this.addEventListener("keydown",this._onKeyDown),this._unsubscribe=T.subscribe(()=>this.requestUpdate())}disconnectedCallback(){var e;this.removeEventListener("keydown",this._onKeyDown),(e=this._unsubscribe)==null||e.call(this),super.disconnectedCallback()}render(){const{query:e,results:t,selectedPath:r,totalMatches:i}=this._state;return t.length===0?u`
      ...
      <div class="rows">
        ${t.map(s=>{const a=$4(s.path),o=s.path===r;return u`
            <div
              class="row ${o?"active":""}"
            ...
            >
              <span class="name-cell">
                ...
                <span class="name">${S4(s.name,e)}</span>
      ...
      ${i>t.length?u`<div class="overflow-hint">共 ${i} 项，仅显示前 ${k4}，请补充关键字</div>`:""}
    `}};Ml.styles=j`
    :host {
      display: flex;
      flex-direction: column;
...
确定要丢弃吗？`))return;this._discardPreviewEdits()}await this._fetchPreview(e)}async _fetchPreview(e){if(Jr(e)){this._previewError=null,this._previewPath=e,this._previewContent="",this._previewWritable=!1,this._previewPages=null,this._previewAttachments=null;return}const t=await bs(e);t.ok?(this._previewError=null,this._previewPath=t.path,this._previewContent=t.content,this._previewLanguage=t.language,this._previewWritable=t.writable,this._previewPages=t.pages,this._previewAttachments=t.attachments):t.notIndexed?(this._previewError="NOT_INDEXED",this._previewPath=e,this._previewContent="",this._previewWritable=!1,this._previewPages=null,this._previewAttachments=null):this._showToast(t.message||"预览失败")}async _reloadPreview(){if(!this._previewPath)return;const e=await bs(this._previewPath);e.ok&&(this._previewContent=e.content,this._previewLanguage=e.language,this._previewWritable=e.writable,this._previewPages=e.pages,this._previewAttachments=e.attachments)}_discardPreviewEdits(){var t,r;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("preview-pane");(r=e==null?void 0:e.discard)==null||r.call(e),this._previewDirty=!1}_renderNotIndexedHint(){return u`<div class="preview-placeholder">
  ...
  `;et([S()],ee.prototype,"_dialog",2);et([S()],ee.prototype,"_reparsePath",2);et([S()],ee.prototype,"_pickedSkill",2);et([S()],ee.prototype,"_toast",2);et([S()],ee.prototype,"_previewPath",2);et([S()],ee.prototype,"_previewContent",2);et([S()],ee.prototype,"_previewLanguage",2);et([S()],ee.prototype,"_previewWritable",2);et([S()],ee.prototype,"_previewPages",2);et([S()],ee.prototype,"_previewAttachments",2);et([S()],ee.prototype,"_previewError",2);et([S()],ee.prototype,"_previewDirty",2);et([S()],ee.prototype,"_treePaneWidth",2);et([S()],ee.prototype,"_previewPaneWidth",2);et([S()],ee.prototype,"_uploading",2);ee=et([K("files-view")],ee);const qr=e=>`/api/diary${e}`,jr={today:()=>ue(qr("/today")),entry:e=>ue(qr(`/entry?date=${encodeURIComponent(e)}`)),calendar:e=>ue(qr(`/calendar?month=${encodeURIComponent(e)}`)),addText:e=>ue(qr("/fragments"),{method:"POST",json:{text:e}}),uploadPhoto:(e,t)=>{const r=new FormData;return r.append("file",e),r.append("caption",t),ue(qr("/photos"),{method:"POST",body:r})},removeFragment:(e,t)=>ue(qr(`/fragments/${encodeURIComponent(t)}?date=${encodeURIComponent(e)}`),{method:"DELETE"}),editFragment:(e,t,r)=>ue(qr(`/fragments/${encodeURIComponent(t)}?date=${encodeURIComponent(e)}`),{method:"PUT",json:{text:r}}),setCity:(e,t)=>ue(qr(`/city?date=${encodeURIComponent(e)}&city=${encodeURIComponent(t)}`),{method:"POST"})};var E4=Object.defineProperty,M4=Object.getOwnPropertyDescriptor,pi=(e,t,r,i)=>{for(var s=i>1?void 0:i?M4(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&E4(t,r,s),s};const P4=["一","二","三","四","五","六","日"];function Kr(e){const[t,r,i]=e.split("-").map(Number);return new Date(t,r-1,i)}function tp(e){const t=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${e.getFullYear()}-${t}-${r}`}function ra(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`}function Kd(e,t){const r=Kr(e);return r.setDate(r.getDate()+t),tp(r)}function D4(e,t){const r=Kr(`${e}-01`);return r.setMonth(r.getMonth()+t),ra(r)}const I4=["星期一","星期二","星期三","星期四","星期五","星期六","星期日"];function O4(e){return I4[(Kr(e).getDay()+6)%7]}let dr=class extends V{constructor(){super(...arguments),this.month="",this.dates=[],this.selected="",this.today="",this._view="days",this._pickerYear=0,this._yearStart=0}_shiftMonth(e){this.dispatchEvent(new CustomEvent("month-change",{detail:{month:D4(this.month,e)},bubbles:!0,composed:!0}))}_select(e){this.dispatchEvent(new CustomEvent("select-date",{detail:{date:e},bubbles:!0,composed:!0}))}_dispatchMonth(e){this.dispatchEvent(new CustomEvent("month-change",{detail:{month:e},bubbles:!0,composed:!0}))}_currentYear(){return Number(this.month.split("-")[0])||new Date().getFullYear()}_titleClick(){if(this._view==="days")this._pickerYear=this._currentYear(),this._view="months";else if(this._view==="months"){const e=this._pickerYear;this._yearStart=e-e%12,this._view="years"}else this._view="days"}_shiftPickerYear(e){this._pickerYear+=e}_shiftYearRange(e){this._yearStart+=e*12}_pickYear(e){this._pickerYear=e,this._view="months"}_pickMonth(e){const t=String(e).padStart(2,"0");this._dispatchMonth(`${this._pickerYear}-${t}`),this._view="days"}_cells(){const e=Kr(`${this.month}-01`),t=new Date(e.getFullYear(),e.getMonth()+1,0).getDate(),r=(e.getDay()+6)%7,i=[];for(let s=0;s<r;s++)i.push(null);for(let s=1;s<=t;s++)i.push({date:`${this.month}-${String(s).padStart(2,"0")}`,day:s,other:!1});return i}render(){return u`
    ...
    `}_renderDays(){const e=new Set(this.dates);return u`
      <div class="grid">
        ${P4.map(t=>u`<span class="wd">${t}</span>`)}
  ...
  `;xr([y({attribute:!1})],Nt.prototype,"entry",2);xr([y({type:Boolean})],Nt.prototype,"submitting",2);xr([y()],Nt.prototype,"city",2);xr([S()],Nt.prototype,"_pendingFile",2);xr([S()],Nt.prototype,"_pendingPreviewUrl",2);xr([S()],Nt.prototype,"_confirmingFid",2);xr([S()],Nt.prototype,"_editingFid",2);xr([S()],Nt.prototype,"_editText",2);xr([S()],Nt.prototype,"_viewerSrc",2);Nt=xr([K("diary-record-panel")],Nt);var B4=Object.defineProperty,N4=Object.getOwnPropertyDescriptor,fi=(e,t,r,i)=>{for(var s=i>1?void 0:i?N4(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&B4(t,r,s),s};let ur=class extends V{constructor(){super(...arguments),this.date="",this.today="",this.entry=null,this.loading=!1,this.calendarOpen=!1,this.calendarMonth="",this.calendarDates=[]}_nav(e){this.dispatchEvent(new CustomEvent("navigate-day",{detail:{delta:e},bubbles:!0,composed:!0}))}_toggleCalendar(){this.dispatchEvent(new CustomEvent("toggle-calendar",{bubbles:!0,composed:!0}))}_renderBody(){var e;if(this.loading)return u`<div class="content loading">加载中…</div>`;if(!this.entry||this.entry.state!=="summarized"){const t=((e=this.entry)==null?void 0:e.state)==="raw"?"这一天的日记尚未整理成文":"这一天没有日记";return u`<div class="empty">${t}</div>`}return u`<md-viewer .content=${this.entry.content}></md-viewer>`}render(){const e=this.date===this.today;return u`
      <div class="nav-row">
        ...
        <button class="date-btn" @click=${this._toggleCalendar}>
          ...
          ${this.date.slice(5)} ${O4(this.date).replace("星期","周")}${e?"（今天）":""}
        </button>
  ...
  `;fi([y()],ur.prototype,"date",2);fi([y()],ur.prototype,"today",2);fi([y({attribute:!1})],ur.prototype,"entry",2);fi([y({type:Boolean})],ur.prototype,"loading",2);fi([y({type:Boolean})],ur.prototype,"calendarOpen",2);fi([y()],ur.prototype,"calendarMonth",2);fi([y({attribute:!1})],ur.prototype,"calendarDates",2);ur=fi([K("diary-review-panel")],ur);var F4=Object.getOwnPropertyDescriptor,H4=(e,t,r,i)=>{for(var s=i>1?void 0:i?F4(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=o(s)||s);return s};const q4=["广州","深圳","珠海","东莞","佛山","中山"];let Pl=class extends V{_pick(e){this.dispatchEvent(new CustomEvent("submit",{detail:{city:e},bubbles:!0,composed:!0}))}_cancel(){this.dispatchEvent(new CustomEvent("cancel",{bubbles:!0,composed:!0}))}render(){return u`
      <div class="title">选择你的城市（用于日记天气）</div>
      <div class="grid">
        ${q4.map(e=>u`<button class="city" @click=${()=>this._pick(e)}>${e}</button>`)}
      </div>
      <div class="actions">
  ...
  `;Pl=H4([K("city-dialog")],Pl);var j4=Object.defineProperty,U4=Object.getOwnPropertyDescriptor,rp=(e,t,r,i)=>{for(var s=i>1?void 0:i?U4(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&j4(t,r,s),s};let To=class extends V{constructor(){super(...arguments),this._initialized=!1,this._pendingSubmit=null}connectedCallback(){super.connectedCallback(),this._unsubscribe=T.subscribe(()=>this.requestUpdate()),this._initialized||(this._initialized=!0,this._init())}updated(e){var r;super.updated(e);const t=(r=this.shadowRoot)==null?void 0:r.querySelector("dialog");t&&!t.open&&t.showModal()}disconnectedCallback(){var e;(e=this._unsubscribe)==null||e.call(this),super.disconnectedCallback()}get _diary(){return T.getState().diary}_localToday(){return tp(new Date)}async _init(){await this._loadToday();const e=this._diary.today||this._localToday(),t=Kd(e,-1);C.setDiaryState({reviewDate:t}),await Promise.all([this._loadReview(t),this._loadCalendar(ra(Kr(t)))])}async _loadToday(){C.setDiaryState({recordLoading:!0,error:null});try{const e=await jr.today();C.setDiaryState({today:e.today,todayEntry:e.entry,recordLoading:!1})}catch(e){C.setDiaryState({recordLoading:!1,today:this._localToday(),error:e instanceof Et?e.message:"加载今日记录失败"})}}async _loadReview(e){C.setDiaryState({reviewLoading:!0,error:null});try{const t=await jr.entry(e);C.setDiaryState({reviewEntry:t,reviewLoading:!1})}catch(t){C.setDiaryState({reviewEntry:null,reviewLoading:!1,error:t instanceof Et?t.message:"加载日记失败"})}}async _loadCalendar(e){try{const t=await jr.calendar(e);C.setDiaryState({calendarMonth:e,calendarDates:t.dates})}catch{C.setDiaryState({calendarMonth:e,calendarDates:[]})}}_onPhotoError(e){C.setDiaryState({error:e.detail.message})}async _onSubmitText(e){var t;if(!this._diary.submitting){if(!((t=this._diary.todayEntry)!=null&&t.city)){this._pendingSubmit={type:"text",value:e.detail.value},C.setDiaryState({cityDialogOpen:!0});return}this._submitText(e.detail.value)}}async _onUploadPhoto(e){var t;if(!this._diary.submitting){if(!((t=this._diary.todayEntry)!=null&&t.city)){this._pendingSubmit={type:"photo",file:e.detail.file,caption:e.detail.caption},C.setDiaryState({cityDialogOpen:!0});return}this._uploadPhoto(e.detail.file,e.detail.caption)}}async _submitText(e){C.setDiaryState({submitting:!0,error:null});try{await jr.addText(e),await this._loadToday()}catch(t){C.setDiaryState({error:t instanceof Et?t.message:"记录失败，请重试"})}finally{C.setDiaryState({submitting:!1})}}async _uploadPhoto(e,t){C.setDiaryState({submitting:!0,error:null});try{await jr.uploadPhoto(e,t),await this._loadToday()}catch(r){C.setDiaryState({error:r instanceof Et?r.message:"照片上传失败，请重试"})}finally{C.setDiaryState({submitting:!1})}}async _onDeleteFragment(e){const t=this._diary.today||this._localToday();C.setDiaryState({error:null});try{await jr.removeFragment(t,e.detail.fid),await this._loadToday()}catch(r){C.setDiaryState({error:r instanceof Et?r.message:"删除失败，请重试"})}}async _onEditFragment(e){const t=this._diary.today||this._localToday();C.setDiaryState({submitting:!0,error:null});try{await jr.editFragment(t,e.detail.fid,e.detail.text),await this._loadToday()}catch(r){C.setDiaryState({error:r instanceof Et?r.message:"保存失败，请重试"})}finally{C.setDiaryState({submitting:!1})}}async _onNavigateDay(e){const t=Kd(this._diary.reviewDate,e.detail.delta);C.setDiaryState({reviewDate:t,calendarOpen:!1}),await this._loadReview(t);const r=ra(Kr(t));r!==this._diary.calendarMonth&&this._loadCalendar(r)}_onToggleCalendar(){const e=!this._diary.calendarOpen;C.setDiaryState({calendarOpen:e}),e&&this._loadCalendar(ra(Kr(this._diary.reviewDate)))}async _onSelectDate(e){const t=e.detail.date;C.setDiaryState({reviewDate:t,calendarOpen:!1}),await this._loadReview(t)}_onMonthChange(e){this._loadCalendar(e.detail.month)}_switchTab(e){if(C.setDiaryState({tab:e,calendarOpen:!1}),e==="record")this._loadToday();else{const t=this._diary.reviewDate;this._loadReview(t),this._loadCalendar(ra(Kr(t)))}}async _onCitySubmit(e){const t=e.detail.city,r=this._diary.today||this._localToday();C.setDiaryState({cityDialogOpen:!1});const i=this._pendingSubmit;this._pendingSubmit=null,(i==null?void 0:i.type)==="text"?await this._submitText(i.value):(i==null?void 0:i.type)==="photo"&&i.file&&await this._uploadPhoto(i.file,i.caption);try{const s=await jr.setCity(r,t);C.setDiaryState({todayEntry:s})}catch{}}_onCityCancel(){C.setDiaryState({cityDialogOpen:!1}),localStorage.setItem("doclens.diary.citySelected","true")}render(){var t;const e=this._diary;return u`
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    dialog::backdrop { background: rgba(0, 0, 0, 0.3); }
    dialog > * { display: block; padding: var(--cortex-space-6); }
  `;rp([S()],To.prototype,"_pendingSubmit",2);To=rp([K("diary-view")],To);function W4(){return typeof window.matchMedia=="function"&&window.matchMedia("(pointer: coarse)").matches}var V4=Object.getOwnPropertyDescriptor,G4=(e,t,r,i)=>{for(var s=i>1?void 0:i?V4(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=o(s)||s);return s};let Dl=class extends V{_emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}render(){return u`
      <div class="grid">
  ...
  `;Dl=G4([K("pin-pad")],Dl);var X4=Object.defineProperty,K4=Object.getOwnPropertyDescriptor,Zo=(e,t,r,i)=>{for(var s=i>1?void 0:i?K4(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&X4(t,r,s),s};const _i=6;let _s=class extends V{constructor(){super(...arguments),this._pin="",this._error="",this._submitting=!1,this._coarse=W4()}async _submit(){if(!(this._pin.length!==_i||this._submitting)){this._submitting=!0,this._error="";try{await Jf(this._pin),C.setAuthState({authenticated:!0}),Gt.navigate("search")}catch(e){this._pin="",this._error=e instanceof Et?e.message:"网络错误，请重试"}finally{this._submitting=!1}}}_onDigit(e){this._pin.length>=_i||(this._error="",this._pin+=e.detail,this._pin.length===_i&&this._submit())}_onBackspace(){this._error="",this._pin=this._pin.slice(0,-1)}_onInput(e){const t=e.target;this._pin=t.value.replace(/\D/g,"").slice(0,_i),t.value=this._pin,this._error=""}_onKeydown(e){e.key==="Enter"&&this._submit()}_renderCoarse(){return u`
  ...
  `;Il=r3([K("reindex-dialog")],Il);const i3=3e3;let Yr=null,ds=!0,na=null;function Yd(e){try{return JSON.parse(e||"{}")}catch{return null}}function s3(e){C.setWatcherStatus(e.watcher??null),C.setWatchRecentChanges(e.recent_changes??[]),C.setSyncStatus(e.sync??null)}function a3(e){window.dispatchEvent(new CustomEvent("cortex:watch-reindexed",{detail:{doc_count:e.doc_count??null,failed_count:e.failed_count??0}}))}function o3(e){return new Promise(t=>{na=window.setTimeout(()=>{na=null,t()},e)})}async function n3(){for(;!ds;){try{const e=Yr==null?void 0:Yr.signal;if(!e)return;for await(const t of Kl("/api/watch/events",{},e)){if(ds)break;if(t.event==="status"){const r=Yd(t.data);r&&s3(r)}else if(t.event==="reindexed"){const r=Yd(t.data);r&&a3(r)}}}catch{}if(ds)return;await o3(i3)}}function l3(){ds&&(ds=!1,Yr=new AbortController,n3())}function c3(){ds=!0,na!==null&&(window.clearTimeout(na),na=null),Yr==null||Yr.abort(),Yr=null}var d3=Object.defineProperty,u3=Object.getOwnPropertyDescriptor,sp=(e,t,r,i)=>{for(var s=i>1?void 0:i?u3(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&d3(t,r,s),s};let Ao=class extends V{constructor(){super(...arguments),this._mainStarted=!1,this._mountedViews=new Set}willUpdate(){const e=T.getState().view;e!=="login"&&!this._mountedViews.has(e)&&(this._mountedViews=new Set(this._mountedViews).add(e))}connectedCallback(){super.connectedCallback(),Gt.init(),this._unsubscribe=T.subscribe(()=>this.requestUpdate()),x0(()=>{T.getState().view!=="login"&&(C.setAuthState({authenticated:!1}),Gt.navigate("login"))}),this._unsubAuth=T.subscribeSelector(e=>e.auth.authenticated,e=>{e&&this._startMain()}),this._probeAuth()}async _probeAuth(){try{const e=await yu();if(C.setAuthState({required:e.required,authenticated:e.authenticated,hasPassword:e.has_password}),e.required&&!e.authenticated){Gt.navigate("login");return}}catch{C.setAuthState({required:!1,authenticated:!0})}this._startMain()}_startMain(){this._mainStarted||(this._mainStarted=!0,l3(),this._loadStatus())}async _loadStatus(){try{const e=await xu();C.setStatus(e),e.sync!==void 0&&C.setSyncStatus(e.sync??null)}catch{}}disconnectedCallback(){var e,t;(e=this._unsubscribe)==null||e.call(this),(t=this._unsubAuth)==null||t.call(this),x0(null),c3(),super.disconnectedCallback()}_navigate(e){Gt.navigate(e.detail.view),e.detail.view==="settings"&&e.detail.scope&&C.setSettingsScope(e.detail.scope)}_renderView(){const e=T.getState().view;return u`
