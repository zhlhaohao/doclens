 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const zo=(e,t)=>(e==null?void 0:e._$litType$)!==void 0,Oo=e=>e.strings===void 0,Io={},Ro=(e,t=Io)=>e._$AH=t;var ot=Symbol(),zt=Symbol(),vr,gr=new Map,J=class extends W{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var r;let i;if(t!=null&&t.spriteSheet)return this.svg=c`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,this.svg;try{if(i=await fetch(e,{mode:"cors"}),!i.ok)return i.status===410?ot:zt}catch{return zt}try{const s=document.createElement("div");s.innerHTML=await i.text();const o=s.firstElementChild;if(((r=o==null?void 0:o.tagName)==null?void 0:r.toLowerCase())!=="svg")return ot;vr||(vr=new DOMParser);const l=vr.parseFromString(o.outerHTML,"text/html").body.querySelector("svg");return l?(l.part.add("svg"),document.adoptNode(l)):ot}catch{return ot}}connectedCallback(){super.connectedCallback(),Ao(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),To(this)}getIconSource(){const e=_s(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;const{url:t,fromLibrary:r}=this.getIconSource(),i=r?_s(this.library):void 0;if(!t){this.svg=null;return}let s=gr.get(t);if(s||(s=this.resolveIcon(t,i),gr.set(t,s)),!this.initialRender)return;const o=await s;if(o===zt&&gr.delete(t),t===this.getIconSource().url){if(zo(o)){if(this.svg=o,i){await this.updateComplete;const a=this.shadowRoot.querySelector("[part='svg']");typeof i.mutator=="function"&&a&&i.mutator(a)}return}switch(o){case zt:case ot:this.svg=null,this.emit("sl-error");break;default:this.svg=o.cloneNode(!0),(e=i==null?void 0:i.mutator)==null||e.call(i,this.svg),this.emit("sl-load")}}}render(){return this.svg}};J.styles=[ie,Do];p([m()],J.prototype,"svg",2);p([d({reflect:!0})],J.prototype,"name",2);p([d()],J.prototype,"src",2);p([d()],J.prototype,"label",2);p([d({reflect:!0})],J.prototype,"library",2);p([H("label")],J.prototype,"handleLabelChange",1);p([H(["name","src","library"])],J.prototype,"setIcon",1);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,K=class we extends W{constructor(){super(...arguments),this.hasSlotController=new $t(this,"icon","suffix"),this.localize=new Re(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"sl-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var t;(t=this.countdownAnimation)==null||t.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var t;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(t=this.countdownAnimation)==null||t.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:t}=this,r="100%",i="0";this.countdownAnimation=t.animate([{width:r},{width:i}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await Be(this.base),this.base.hidden=!1;const{keyframes:t,options:r}=$e(this,"alert.show",{dir:this.localize.dir()});await Se(this.base,t,r),this.emit("sl-after-show")}else{hi(this),this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await Be(this.base);const{keyframes:t,options:r}=$e(this,"alert.hide",{dir:this.localize.dir()});await Se(this.base,t,r),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,Wt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Wt(this,"sl-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),we.toastStack.parentElement===null&&document.body.append(we.toastStack),we.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{we.toastStack.removeChild(this),t(),we.toastStack.querySelector("sl-alert")===null&&we.toastStack.remove()},{once:!0})})}render(){return c`
  ...
  `;bi([d()],jt.prototype,"active",2);jt=bi([A("tab-bar")],jt);var _a=Object.defineProperty,ya=Object.getOwnPropertyDescriptor,jr=(e,t,r,i)=>{for(var s=i>1?void 0:i?ya(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&_a(t,r,s),s};let mt=class extends ${constructor(){super(...arguments),this.heading="Doclens",this.subheading=""}render(){return c`
  ...
  `;jr([d()],mt.prototype,"heading",2);jr([d()],mt.prototype,"subheading",2);mt=jr([A("welcome-pane")],mt);var wa=Object.defineProperty,ka=Object.getOwnPropertyDescriptor,Ze=(e,t,r,i)=>{for(var s=i>1?void 0:i?ka(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&wa(t,r,s),s};let me=class extends ${constructor(){super(...arguments),this.backLabel="返回",this.title="",this.meta="",this.actions=[],this._menuOpen=!1,this._onDocClick=e=>{if(!this._menuOpen)return;e.composedPath().includes(this)||(this._menuOpen=!1)}}_back(){this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}_onMoreClick(e){e.stopPropagation(),this._menuOpen=!this._menuOpen}_onItemClick(e){e.disabled||(this._menuOpen=!1,e.onClick())}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick)}disconnectedCallback(){document.removeEventListener("click",this._onDocClick),super.disconnectedCallback()}render(){return c`
...
]`).replace("lheading",xi).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Ua=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,ja=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,yi=/^( {2,}|\\)\n(?!\s*$)/,qa=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Qe=/[\p{P}\p{S}]/u,rr=/[\s\p{P}\p{S}]/u,Zr=/[^\s\p{P}\p{S}]/u,Va=P(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,rr).getRegex(),wi=/(?!~)[\p{P}\p{S}]/u,Xa=/(?!~)[\s\p{P}\p{S}]/u,Ka=/(?:[^\s\p{P}\p{S}]|~)/u,Ya=P(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Ta?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),ki=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,Ga=P(ki,"u").replace(/punct/g,Qe).getRegex(),Za=P(ki,"u").replace(/punct/g,wi).getRegex(),$i="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Qa=P($i,"gu").replace(/notPunctSpace/g,Zr).replace(/punctSpace/g,rr).replace(/punct/g,Qe).getRegex(),Ja=P($i,"gu").replace(/notPunctSpace/g,Ka).replace(/punctSpace/g,Xa).replace(/punct/g,wi).getRegex(),en=P("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Zr).replace(/punctSpace/g,rr).replace(/punct/g,Qe).getRegex(),tn=P(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,Qe).getRegex(),rn="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",sn=P(rn,"gu").replace(/notPunctSpace/g,Zr).replace(/punctSpace/g,rr).replace(/punct/g,Qe).getRegex(),on=P(/\\(punct)/,"gu").replace(/punct/g,Qe).getRegex(),an=P(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),nn=P(Yr).replace("(?:-->|$)","-->").getRegex(),ln=P("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",nn).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Vt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,cn=P(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",Vt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Si=P(/^!?\[(label)\]\[(ref)\]/).replace("label",Vt).replace("ref",Kr).getRegex(),Ei=P(/^!?\[(ref)\](?:\[\])?/).replace("ref",Kr).getRegex(),dn=P("reflink|nolink(?!\\()","g").replace("reflink",Si).replace("nolink",Ei).getRegex(),Ds=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Qr={_backpedal:Ee,anyPunctuation:on,autolink:an,blockSkip:Ya,br:yi,code:ja,del:Ee,delLDelim:Ee,delRDelim:Ee,emStrongLDelim:Ga,emStrongRDelimAst:Qa,emStrongRDelimUnd:en,escape:Ua,link:cn,nolink:Ei,punctuation:Va,reflink:Si,reflinkSearch:dn,tag:ln,text:qa,url:Ee},hn={...Qr,link:P(/^!?\[(label)\]\((.*?)\)/).replace("label",Vt).getRegex(),reflink:P(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Vt).getRegex()},Cr={...Qr,emStrongRDelimAst:Ja,emStrongLDelim:Za,delLDelim:tn,delRDelim:sn,url:P(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Ds).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:P(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Ds).getRegex()},un={...Cr,br:P(yi).replace("{2,}","*").getRegex(),text:P(Cr.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Ot={normal:Gr,gfm:Ha,pedantic:Ba},nt={normal:Qr,gfm:Cr,breaks:un,pedantic:hn},pn={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},zs=e=>pn[e];function ne(e,t){if(t){if(F.escapeTest.test(e))return e.replace(F.escapeReplace,zs)}else if(F.escapeTestNoEncode.test(e))return e.replace(F.escapeReplaceNoEncode,zs);return e}function Os(e){try{e=encodeURI(e).replace(F.percentDecode,"%")}catch{return null}return e}function Is(e,t){var o;let r=e.replace(F.findPipe,(a,l,n)=>{let u=!1,h=l;for(;--h>=0&&n[h]==="\\";)u=!u;return u?"|":" |"}),i=r.split(F.splitPipe),s=0;if(i[0].trim()||i.shift(),i.length>0&&!((o=i.at(-1))!=null&&o.trim())&&i.pop(),t)if(i.length>t)i.splice(t);else for(;i.length<t;)i.push("");for(;s<i.length;s++)i[s]=i[s].trim().replace(F.slashPipe,"|");return i}function he(e,t,r){let i=e.length;if(i===0)return"";let s=0;for(;s<i&&e.charAt(i-s-1)===t;)s++;return e.slice(0,i-s)}function Rs(e){let t=e.split(`
...
Please report this to https://github.com/markedjs/marked.`,e){let i="<p>An error occurred:</p><pre>"+ne(r.message+"",!0)+"</pre>";return t?Promise.resolve(i):i}if(t)return Promise.reject(r);throw r}}},De=new vn;function T(e,t){return De.parse(e,t)}T.options=T.setOptions=function(e){return De.setOptions(e),T.defaults=De.defaults,vi(T.defaults),T};T.getDefaults=qr;T.defaults=Me;T.use=function(...e){return De.use(...e),T.defaults=De.defaults,vi(T.defaults),T};T.walkTokens=function(e,t){return De.walkTokens(e,t)};T.parseInline=De.parseInline;T.Parser=re;T.parser=re.parse;T.Renderer=Kt;T.TextRenderer=Jr;T.Lexer=te;T.lexer=te.lex;T.Tokenizer=Xt;T.Hooks=ct;T.parse=T;T.options;T.setOptions;T.use;T.walkTokens;T.parseInline;re.parse;te.lex;var gn=Object.defineProperty,xn=Object.getOwnPropertyDescriptor,es=(e,t,r,i)=>{for(var s=i>1?void 0:i?xn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&gn(t,r,s),s};let vt=class extends ${constructor(){super(...arguments),this.result=null,this.active=!1}_select(){this.result&&this.dispatchEvent(new CustomEvent("select",{detail:{result:this.result},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this._select)}disconnectedCallback(){this.removeEventListener("click",this._select),super.disconnectedCallback()}_renderSnippet(){var r;const e=((r=this.result)==null?void 0:r.snippet)??"";if(!e)return null;const t=T.parse(e,{async:!1});return c`<div class="snippet" .innerHTML=${t}></div>`}render(){if(!this.result)return null;const e=Math.round(this.result.score*100);return c`
  ...
  `;es([d({attribute:!1})],vt.prototype,"result",2);es([d({type:Boolean,reflect:!0})],vt.prototype,"active",2);vt=es([A("result-card")],vt);var _n=Object.defineProperty,yn=Object.getOwnPropertyDescriptor,sr=(e,t,r,i)=>{for(var s=i>1?void 0:i?yn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&_n(t,r,s),s};let qe=class extends ${constructor(){super(...arguments),this.results=[],this.activeResult=null,this.loading=!1}render(){return c`
      <div class="list-pane">
  ...
  `;sr([d({attribute:!1})],qe.prototype,"results",2);sr([d({attribute:!1})],qe.prototype,"activeResult",2);sr([d({type:Boolean})],qe.prototype,"loading",2);qe=sr([A("search-results")],qe);var wn=Object.defineProperty,kn=Object.getOwnPropertyDescriptor,Ct=(e,t,r,i)=>{for(var s=i>1?void 0:i?kn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&wn(t,r,s),s};let dt="",Tr=0,Yt=0;function lt(e){if(!e)return 0;const t=dt.indexOf(e,Tr);if(t===-1){const i=dt.indexOf(e);return i===-1?0:(dt.slice(0,i).match(/\n/g)??[]).length+1+Yt}const r=(dt.slice(0,t).match(/\n/g)??[]).length+1;return Tr=t+e.length,r+Yt}function Ms(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}const $n={heading(e){const t=this.parser.parseInline(e.tokens),r=lt(e.raw);return`<h${e.depth} data-source-line="${r}">${t}</h${e.depth}>
...
`);return c`
  ...
  `;ir([d({reflect:!0})],Ve.prototype,"role",2);ir([d({attribute:!1})],Ve.prototype,"message",2);ir([d()],Ve.prototype,"error",2);Ve=ir([A("chat-message")],Ve);var Ln=Object.defineProperty,Mn=Object.getOwnPropertyDescriptor,Ai=(e,t,r,i)=>{for(var s=i>1?void 0:i?Mn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&Ln(t,r,s),s};let Gt=class extends ${constructor(){super(...arguments),this.messages=[]}updated(){this.scrollTop=this.scrollHeight}render(){return this.messages.length===0?c`<div class="empty">开始与 Doclens 对话</div>`:c`
