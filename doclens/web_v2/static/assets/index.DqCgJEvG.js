...
`);i.push({label:t[s].label,md:n,offset:a})}return i}render(){if(r2(),!this.content)return u`<div class="empty">无内容</div>`;if(this.pages&&this.pages.length>0){const t=this._splitByPages(this.content,this.pages);return u`
  ...
  `];mr([y()],Ot.prototype,"content",2);mr([y({type:Number})],Ot.prototype,"line",2);mr([y()],Ot.prototype,"keyword",2);mr([y({attribute:!1})],Ot.prototype,"pages",2);mr([y({attribute:"doc-path"})],Ot.prototype,"docPath",2);mr([y({attribute:"font-scale",type:Number})],Ot.prototype,"fontScale",2);mr([S()],Ot.prototype,"_viewerSrc",2);mr([S()],Ot.prototype,"_copied",2);mr([y({type:Boolean})],Ot.prototype,"suppressLocate",2);Ot=mr([K("md-viewer")],Ot);var i2=Object.defineProperty,s2=Object.getOwnPropertyDescriptor,Gi=(e,t,r,i)=>{for(var s=i>1?void 0:i?s2(t,r):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(s=(i?o(t,r,s):o(s))||s);return i&&s&&i2(t,r,s),s};let Ar=class extends V{constructor(){super(...arguments),this.path="",this.originalContent="",this.mobile=!1,this._text="",this._dirty=!1,this._error=null,this._scrollJump=new wc(this,{behavior:"auto",onJumpTop:e=>this._jumpToEdge(e,0),onJumpBottom:e=>{const t=e;this._jumpToEdge(t,t.value.length)}}),this._onSaveClick=()=>{this._dirty&&this._emitSave()},this._onCancelClick=()=>{this.discard()}}willUpdate(e){e.has("originalContent")&&(this._text=this.originalContent,this._dirty=!1,this._error=null)}firstUpdated(){const e=this.shadowRoot.querySelector("textarea");e&&this._scrollJump.attach(e)}updated(){this._scrollJump.refresh()}get _textarea(){return this.shadowRoot.querySelector("textarea")}_jumpToEdge(e,t){e.focus(),e.setSelectionRange(t,t),e.scrollTop=t===0?0:e.scrollHeight-e.clientHeight}get _lines(){return this._text.split(`
