...
`;function lt(e,t){const r=Ui({waitUntilFirstUpdate:!1},t);return(i,s)=>{const{update:a}=i,o=Array.isArray(e)?e:[e];i.update=function(n){o.forEach(c=>{const p=c;if(n.has(p)){const f=n.get(p),b=this[p];f!==b&&(!r.waitUntilFirstUpdate||this.hasUpdated)&&this[s](f,b)}}),a.call(this,n)}}}/**
 * @license
