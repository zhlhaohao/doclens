...
`,Mo=(e="value")=>(t,r)=>{const i=t.constructor,s=i.prototype.attributeChangedCallback;i.prototype.attributeChangedCallback=function(o,a,l){var n;const u=i.getPropertyOptions(e),h=typeof u.attribute=="string"?u.attribute:e;if(o===h){const b=u.converter||He,S=(typeof b=="function"?b:(n=b==null?void 0:b.fromAttribute)!=null?n:He.fromAttribute)(l,u.type);this[e]!==S&&(this[r]=S)}s.call(this,o,a,l)}},No=_`
...
`,q=class _e extends N{constructor(){super(...arguments),this.hasSlotController=new kt(this,"icon","suffix"),this.localize=new Oe(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"sl-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var t;(t=this.countdownAnimation)==null||t.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var t;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(t=this.countdownAnimation)==null||t.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:t}=this,r="100%",i="0";this.countdownAnimation=t.animate([{width:r},{width:i}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await Ne(this.base),this.base.hidden=!1;const{keyframes:t,options:r}=we(this,"alert.show",{dir:this.localize.dir()});await ke(this.base,t,r),this.emit("sl-after-show")}else{di(this),this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await Ne(this.base);const{keyframes:t,options:r}=we(this,"alert.hide",{dir:this.localize.dir()});await ke(this.base,t,r),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,Nt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Nt(this,"sl-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),_e.toastStack.parentElement===null&&document.body.append(_e.toastStack),_e.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{_e.toastStack.removeChild(this),t(),_e.toastStack.querySelector("sl-alert")===null&&_e.toastStack.remove()},{once:!0})})}render(){return c`
  ...
  `;Ur([d()],bt.prototype,"heading",2);Ur([d()],bt.prototype,"subheading",2);bt=Ur([P("welcome-pane")],bt);var ya=Object.defineProperty,wa=Object.getOwnPropertyDescriptor,Ge=(e,t,r,i)=>{for(var s=i>1?void 0:i?wa(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&ya(t,r,s),s};let ue=class extends ${constructor(){super(...arguments),this.backLabel="返回",this.title="",this.meta="",this.actions=[],this._menuOpen=!1,this._onDocClick=e=>{if(!this._menuOpen)return;e.composedPath().includes(this)||(this._menuOpen=!1)}}_back(){this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}_onMoreClick(e){e.stopPropagation(),this._menuOpen=!this._menuOpen}_onItemClick(e){e.disabled||(this._menuOpen=!1,e.onClick())}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick)}disconnectedCallback(){document.removeEventListener("click",this._onDocClick),super.disconnectedCallback()}render(){return c`
  ...
  `;Ge([d()],ue.prototype,"backLabel",2);Ge([d()],ue.prototype,"title",2);Ge([d()],ue.prototype,"meta",2);Ge([d({attribute:!1})],ue.prototype,"actions",2);Ge([g()],ue.prototype,"_menuOpen",2);ue=Ge([P("focus-header")],ue);var ka=Object.defineProperty,$a=Object.getOwnPropertyDescriptor,$t=(e,t,r,i)=>{for(var s=i>1?void 0:i?$a(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&ka(t,r,s),s};let Pe=class extends ${constructor(){super(...arguments),this.title="历史会话",this.sessions=[],this.clearing=!1}_onClear(){this.clearing||this.dispatchEvent(new CustomEvent("clear",{bubbles:!0,composed:!0}))}render(){const e=this.sessions.length>0;return c`
      <div class="header">
        <div class="title">${this.title}</div>
        ${e?c`
          <button
...
⚠️ ${s.detail}`},m.setChatState({messages:o})}await Bn(r,[{kind:"message_user",payload:JSON.stringify({content:t})},{kind:"message_ai",payload:JSON.stringify({content:i})}],f.getState().chat.messages.length),this._loadHistory()}catch(i){m.setError(`对话失败: ${i.message}`)}finally{m.setChatState({streaming:!1})}}_backToInitial(){m.setChatState({state:"initial",currentSession:null,messages:[]}),this._loadHistory()}async _loadSession(e){m.setChatState({state:"focus",currentSession:e,messages:[]});try{const t=await fetch(`/api/sessions/${e.id}`);if(t.ok){const i=((await t.json()).items||[]).map(s=>{const o=JSON.parse(s.payload);return{role:s.kind==="message_user"?"user":"assistant",content:o.content}});m.setChatState({messages:i})}}catch(t){console.warn("load session failed",t)}}_onHistorySelect(e){this._loadSession(e.detail.session)}render(){var t;const e=this.viewState;return e.state==="initial"?c`
  ...
  `;ae([g()],G.prototype,"_activeTab",2);ae([g()],G.prototype,"_saving",2);ae([g()],G.prototype,"_error",2);ae([g()],G.prototype,"_toast",2);ae([g()],G.prototype,"_values",2);ae([g()],G.prototype,"_original",2);ae([g()],G.prototype,"_exists",2);ae([g()],G.prototype,"_scope",2);ae([g()],G.prototype,"_fieldErrors",2);G=ae([P("settings-view")],G);const le=e=>`/api/files${e}`,ce={list:(e,t=200,r=0)=>M(le(`/list?path=${encodeURIComponent(e)}&limit=${t}&offset=${r}`)),stats:e=>M(le(`/stats?path=${encodeURIComponent(e)}`)),attrs:e=>M(le(`/attrs?path=${encodeURIComponent(e)}`)),mkdir:e=>M(le("/mkdir"),{method:"POST",json:{path:e}}),remove:e=>M(le(`?path=${encodeURIComponent(e)}`),{method:"DELETE"}),move:(e,t,r=!1)=>M(le("/move"),{method:"POST",json:{from_paths:e,dest_dir:t,overwrite:r}}),rename:(e,t)=>M(le("/rename"),{method:"POST",json:{path:e,new_name:t}}),upload:(e,t,r=!1)=>{const i=new FormData;return i.append("file",e),i.append("dest_dir",t),i.append("overwrite",String(r)),M(le("/upload"),{method:"POST",body:i})}};var ol=Object.defineProperty,al=Object.getOwnPropertyDescriptor,ve=(e,t,r,i)=>{for(var s=i>1?void 0:i?al(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(s=(i?a(t,r,s):a(s))||s);return i&&s&&ol(t,r,s),s};let oe=class extends ${constructor(){super(...arguments),this.depth=0,this.expanded=!1,this.selected=!1,this.readonly=!1,this.childEntries=[],this.loading=""}_onClick(){this.readonly?this.dispatchEvent(new CustomEvent("pick-dir",{detail:{path:this.entry.path},bubbles:!0,composed:!0})):this.dispatchEvent(new CustomEvent("select-dir",{detail:{path:this.entry.path},bubbles:!0,composed:!0}))}_toggle(e){e.stopPropagation(),this.entry.has_child_dirs&&this.dispatchEvent(new CustomEvent("toggle",{detail:{path:this.entry.path},bubbles:!0,composed:!0}))}render(){return c`
