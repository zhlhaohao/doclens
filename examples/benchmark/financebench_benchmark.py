...
async def main():
    ...
    parser.add_argument("--index-dir", type=str, default=os.path.join(_script_dir, "indexes", "financebench"), help="Index directory")
    parser.add_argument("--pdf-dir", type=str, default=os.path.join(_script_dir, "data", "financebench_pdfs"), help="Directory for downloaded PDFs")
