 ...
 */const $s=Symbol.for(""),Ki=e=>{if((e==null?void 0:e.r)===$s)return e==null?void 0:e._$litStatic$},ye=(e,...t)=>({_$litStatic$:t.reduce((r,s,i)=>r+(o=>{if(o._$litStatic$!==void 0)return o._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${o}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(s)+e[i+1],e[0]),r:$s}),qr=new Map,Xi=e=>(t,...r)=>{const s=r.length;let i,o;const a=[],l=[];let n,h=0,d=!1;for(;h<s;){for(n=t[h];h<s&&(o=r[h],(i=Ki(o))!==void 0);)n+=i+t[++h],d=!0;h!==s&&l.push(o),a.push(n),h++}if(h===s&&a.push(t[s]),d){const f=a.join("$$lit$$");(t=qr.get(f))===void 0&&(a.raw=a,qr.set(f,t=a)),r=l}return e(t,...r)},ve=Xi(p);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
