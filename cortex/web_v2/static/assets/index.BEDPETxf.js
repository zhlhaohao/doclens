...
`;function D(e,t){const r=kt({waitUntilFirstUpdate:!1},t);return(s,i)=>{const{update:o}=s,a=Array.isArray(e)?e:[e];s.update=function(l){a.forEach(n=>{const h=n;if(l.has(h)){const d=l.get(h),f=this[h];d!==f&&(!r.waitUntilFirstUpdate||this.hasUpdated)&&this[i](d,f)}}),o.call(this,l)}}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ji=(e,t)=>(e==null?void 0:e._$litType$)!==void 0,Ui=e=>e.strings===void 0,qi={},Wi=(e,t=qi)=>e._$AH=t;var Ut=Symbol(),he=Symbol(),We,Ke=new Map,q=class extends L{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var r;let s;if(t!=null&&t.spriteSheet)return this.svg=p`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`,this.svg;try{if(s=await fetch(e,{mode:"cors"}),!s.ok)return s.status===410?Ut:he}catch{return he}try{const i=document.createElement("div");i.innerHTML=await s.text();const o=i.firstElementChild;if(((r=o==null?void 0:o.tagName)==null?void 0:r.toLowerCase())!=="svg")return Ut;We||(We=new DOMParser);const l=We.parseFromString(o.outerHTML,"text/html").body.querySelector("svg");return l?(l.part.add("svg"),document.adoptNode(l)):Ut}catch{return Ut}}connectedCallback(){super.connectedCallback(),Fi(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),Mi(this)}getIconSource(){const e=Ur(this.library);return this.name&&e?{url:e.resolver(this.name),fromLibrary:!0}:{url:this.src,fromLibrary:!1}}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;const{url:t,fromLibrary:r}=this.getIconSource(),s=r?Ur(this.library):void 0;if(!t){this.svg=null;return}let i=Ke.get(t);if(i||(i=this.resolveIcon(t,s),Ke.set(t,i)),!this.initialRender)return;const o=await i;if(o===he&&Ke.delete(t),t===this.getIconSource().url){if(ji(o)){if(this.svg=o,s){await this.updateComplete;const a=this.shadowRoot.querySelector("[part='svg']");typeof s.mutator=="function"&&a&&s.mutator(a)}return}switch(o){case he:case Ut:this.svg=null,this.emit("sl-error");break;default:this.svg=o.cloneNode(!0),(e=s==null?void 0:s.mutator)==null||e.call(s,this.svg),this.emit("sl-load")}}}render(){return this.svg}};q.styles=[Y,Vi];u([v()],q.prototype,"svg",2);u([c({reflect:!0})],q.prototype,"name",2);u([c()],q.prototype,"src",2);u([c()],q.prototype,"label",2);u([c({reflect:!0})],q.prototype,"library",2);u([D("label")],q.prototype,"handleLabelChange",1);u([D(["name","src","library"])],q.prototype,"setIcon",1);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const U=_s(class extends ks{constructor(e){var t;if(super(e),e.type!==ut.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var s,i;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in t)t[o]&&!((s=this.nt)!=null&&s.has(o))&&this.st.add(o);return this.render(t)}const r=e.element.classList;for(const o of this.st)o in t||(r.remove(o),this.st.delete(o));for(const o in t){const a=!!t[o];a===this.st.has(o)||(i=this.nt)!=null&&i.has(o)||(a?(r.add(o),this.st.add(o)):(r.remove(o),this.st.delete(o)))}return Z}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $s=Symbol.for(""),Ki=e=>{if((e==null?void 0:e.r)===$s)return e==null?void 0:e._$litStatic$},ye=(e,...t)=>({_$litStatic$:t.reduce((r,s,i)=>r+(o=>{if(o._$litStatic$!==void 0)return o._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${o}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(s)+e[i+1],e[0]),r:$s}),qr=new Map,Xi=e=>(t,...r)=>{const s=r.length;let i,o;const a=[],l=[];let n,h=0,d=!1;for(;h<s;){for(n=t[h];h<s&&(o=r[h],(i=Ki(o))!==void 0);)n+=i+t[++h],d=!0;h!==s&&l.push(o),a.push(n),h++}if(h===s&&a.push(t[s]),d){const f=a.join("$$lit$$");(t=qr.get(f))===void 0&&(a.raw=a,qr.set(f,t=a)),r=l}return e(t,...r)},me=Xi(p);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,Ss=class extends L{constructor(){super(...arguments),this.hasSlotController=new ae(this,"footer","header","image")}render(){return p`
      <div
        part="base"
...
`,I=class extends L{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){const e=!!this.href,t=e?ye`a`:ye`button`;return me`
    ...
    `}};I.styles=[Y,eo];I.dependencies={"sl-icon":q};u([H(".icon-button")],I.prototype,"button",2);u([v()],I.prototype,"hasFocus",2);u([c()],I.prototype,"name",2);u([c()],I.prototype,"library",2);u([c()],I.prototype,"src",2);u([c()],I.prototype,"href",2);u([c()],I.prototype,"target",2);u([c()],I.prototype,"download",2);u([c()],I.prototype,"label",2);u([c({type:Boolean,reflect:!0})],I.prototype,"disabled",2);var ro=0,J=class extends L{constructor(){super(...arguments),this.localize=new _t(this),this.attrId=++ro,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("sl-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,p`
      <div
        part="base"
...
`,V=class ht extends L{constructor(){super(...arguments),this.hasSlotController=new ae(this,"icon","suffix"),this.localize=new _t(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"sl-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var t;(t=this.countdownAnimation)==null||t.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var t;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(t=this.countdownAnimation)==null||t.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:t}=this,r="100%",s="0";this.countdownAnimation=t.animate([{width:r},{width:s}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await At(this.base),this.base.hidden=!1;const{keyframes:t,options:r}=ft(this,"alert.show",{dir:this.localize.dir()});await bt(this.base,t,r),this.emit("sl-after-show")}else{Es(this),this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await At(this.base);const{keyframes:t,options:r}=ft(this,"alert.hide",{dir:this.localize.dir()});await bt(this.base,t,r),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,xe(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,xe(this,"sl-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),ht.toastStack.parentElement===null&&document.body.append(ht.toastStack),ht.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{ht.toastStack.removeChild(this),t(),ht.toastStack.querySelector("sl-alert")===null&&ht.toastStack.remove()},{once:!0})})}render(){return p`
    ...
    `}};V.styles=[Y,xo];V.dependencies={"sl-icon-button":I};u([H('[part~="base"]')],V.prototype,"base",2);u([H(".alert__countdown-elapsed")],V.prototype,"countdownElement",2);u([c({type:Boolean,reflect:!0})],V.prototype,"open",2);u([c({type:Boolean,reflect:!0})],V.prototype,"closable",2);u([c({reflect:!0})],V.prototype,"variant",2);u([c({type:Number})],V.prototype,"duration",2);u([c({type:String,reflect:!0})],V.prototype,"countdown",2);u([v()],V.prototype,"remainingTime",2);u([D("open",{waitUntilFirstUpdate:!0})],V.prototype,"handleOpenChange",1);u([D("duration")],V.prototype,"handleDurationChange",1);var wo=V;F("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});F("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});wo.define("sl-alert");function _o(e,t){const r=new Set([...Object.keys(e),...Object.keys(t)]);for(const s of r)if((e[s]??"")!==(t[s]??""))return!0;return!1}const ko={view:"search",search:{state:"initial",currentSession:null,query:"",results:[],total:0,source:"fts"},chat:{state:"initial",currentSession:null,messages:[],streaming:!1},detailStack:[],pendingSession:null,status:null,error:null,settings:{scope:"local",values:{},original:{},dirty:!1,exists:!0,saving:!1,error:null}};class $o{constructor(){this.state=ko,this.listeners=new Set}getState(){return this.state}setState(t){this.state={...this.state,...t},this.listeners.forEach(r=>r(this.state))}subscribe(t){return this.listeners.add(t),()=>this.listeners.delete(t)}subscribeSelector(t,r){let s=t(this.state);return this.subscribe(i=>{const o=t(i);o!==s&&(s=o,r(o))})}}const m=new $o,A={setView(e){m.setState({view:e})},setSearchState(e){const t=m.getState().search;m.setState({search:{...t,...e}})},setChatState(e){const t=m.getState().chat;m.setState({chat:{...t,...e}})},pushDetail(e){const t=m.getState().detailStack;m.setState({detailStack:[...t,e]})},popDetail(){const e=m.getState().detailStack;e.length!==0&&m.setState({detailStack:e.slice(0,-1)})},setError(e){m.setState({error:e})},setPendingSession(e){m.setState({pendingSession:e})},setSettingsScope(e){const t=m.getState().settings;m.setState({settings:{...t,scope:e}})},loadSettings(e,t){const r=m.getState().settings;m.setState({settings:{...r,values:{...e},original:{...e},exists:t,dirty:!1,error:null}})},updateSetting(e,t){const r=m.getState().settings,s={...r.values,[e]:t},i=_o(r.original,s);m.setState({settings:{...r,values:s,dirty:i}})},revertSettings(){const e=m.getState().settings,t={...e.original};m.setState({settings:{...e,values:t,dirty:!1}})},setSettingsSaving(e){const t=m.getState().settings;m.setState({settings:{...t,saving:e}})},setSettingsError(e){const t=m.getState().settings;m.setState({settings:{...t,error:e}})}};var So=Object.defineProperty,Co=Object.getOwnPropertyDescriptor,Ts=(e,t,r,s)=>{for(var i=s>1?void 0:s?Co(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(i=(s?a(t,r,i):a(i))||i);return s&&i&&So(t,r,i),i};let we=class extends T{constructor(){super(...arguments),this.active="search",this._items=[{id:"search",icon:"🔍",label:"搜索"},{id:"chat",icon:"💬",label:"对话"},{id:"history",icon:"🕘",label:"历史"}]}_select(e){this.dispatchEvent(new CustomEvent("navigate",{detail:{view:e},bubbles:!0,composed:!0}))}render(){return p`
      ${this._items.map(e=>p`
        <button
  ...
  `;Ts([c()],we.prototype,"active",2);we=Ts([P("activity-bar")],we);var Eo=Object.defineProperty,Ao=Object.getOwnPropertyDescriptor,zs=(e,t,r,s)=>{for(var i=s>1?void 0:s?Ao(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(i=(s?a(t,r,i):a(i))||i);return s&&i&&Eo(t,r,i),i};let _e=class extends T{constructor(){super(...arguments),this.active="search",this._items=[{id:"search",icon:"🔍",label:"搜索"},{id:"chat",icon:"💬",label:"对话"},{id:"history",icon:"🕘",label:"历史"}]}_select(e){this.dispatchEvent(new CustomEvent("navigate",{detail:{view:e},bubbles:!0,composed:!0}))}render(){return p`
      ${this._items.map(e=>p`
        <button
  ...
  `;zs([c()],_e.prototype,"active",2);_e=zs([P("tab-bar")],_e);var To=Object.defineProperty,zo=Object.getOwnPropertyDescriptor,br=(e,t,r,s)=>{for(var i=s>1?void 0:s?zo(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(i=(s?a(t,r,i):a(i))||i);return s&&i&&To(t,r,i),i};let ee=class extends T{constructor(){super(...arguments),this.heading="Cortex",this.subheading=""}render(){return p`
  ...
  `;br([c()],ee.prototype,"heading",2);br([c()],ee.prototype,"subheading",2);ee=br([P("welcome-pane")],ee);var Po=Object.defineProperty,Oo=Object.getOwnPropertyDescriptor,Dt=(e,t,r,s)=>{for(var i=s>1?void 0:s?Oo(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(i=(s?a(t,r,i):a(i))||i);return s&&i&&Po(t,r,i),i};let at=class extends T{constructor(){super(...arguments),this.backLabel="返回",this.title="",this.meta="",this.actions=[],this._menuOpen=!1,this._onDocClick=e=>{if(!this._menuOpen)return;e.composedPath().includes(this)||(this._menuOpen=!1)}}_back(){this.dispatchEvent(new CustomEvent("back",{bubbles:!0,composed:!0}))}_onMoreClick(e){e.stopPropagation(),this._menuOpen=!this._menuOpen}_onItemClick(e){e.disabled||(this._menuOpen=!1,e.onClick())}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick)}disconnectedCallback(){document.removeEventListener("click",this._onDocClick),super.disconnectedCallback()}render(){return p`
  ...
  `;Dt([c()],at.prototype,"backLabel",2);Dt([c()],at.prototype,"title",2);Dt([c()],at.prototype,"meta",2);Dt([c({attribute:!1})],at.prototype,"actions",2);Dt([v()],at.prototype,"_menuOpen",2);at=Dt([P("focus-header")],at);var Ro=Object.defineProperty,Io=Object.getOwnPropertyDescriptor,ne=(e,t,r,s)=>{for(var i=s>1?void 0:s?Io(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(i=(s?a(t,r,i):a(i))||i);return s&&i&&Ro(t,r,i),i};let xt=class extends T{constructor(){super(...arguments),this.title="历史会话",this.sessions=[],this.clearing=!1}_onSelect(e){this.dispatchEvent(new CustomEvent("select",{detail:e.detail,bubbles:!0,composed:!0}))}_onClear(){this.clearing||this.dispatchEvent(new CustomEvent("clear",{bubbles:!0,composed:!0}))}render(){const e=this.sessions.length>0;return p`
      <div class="header">
        <div class="title">${this.title}</div>
        ${e?p`
          <button
  ...
  `;ne([c()],xt.prototype,"title",2);ne([c({attribute:!1})],xt.prototype,"sessions",2);ne([c()],xt.prototype,"type",2);ne([c({type:Boolean})],xt.prototype,"clearing",2);xt=ne([P("history-list")],xt);var Lo=Object.defineProperty,Do=Object.getOwnPropertyDescriptor,Ps=(e,t,r,s)=>{for(var i=s>1?void 0:s?Do(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(i=(s?a(t,r,i):a(i))||i);return s&&i&&Lo(t,r,i),i};let ke=class extends T{constructor(){super(...arguments),this.session=null}_select(){this.session&&this.dispatchEvent(new CustomEvent("select",{detail:{session:this.session},bubbles:!0,composed:!0}))}render(){return this.session?p`
  ...
  `;Ps([c({attribute:!1})],ke.prototype,"session",2);ke=Ps([P("history-item")],ke);var Bo=Object.defineProperty,No=Object.getOwnPropertyDescriptor,lt=(e,t,r,s)=>{for(var i=s>1?void 0:s?No(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(i=(s?a(t,r,i):a(i))||i);return s&&i&&Bo(t,r,i),i};let et=class extends T{constructor(){super(...arguments),this.value="",this.placeholder="",this.buttonLabel="搜索",this.buttonIcon="",this.multiline=!1,this.disabled=!1}focus(){var e;(e=this.inputEl)==null||e.focus()}get trimmed(){return this.value.trim()}_onInput(e){const t=e.target;this.value=t.value,this.dispatchEvent(new CustomEvent("input-change",{detail:{value:this.value}}));const r=this.renderRoot.querySelector("button");r&&(r.disabled=!this.trimmed||this.disabled)}_onKeydown(e){e.key==="Enter"&&(e.ctrlKey||e.metaKey)&&(e.preventDefault(),this._submit()),e.key==="Enter"&&!this.multiline&&!e.shiftKey&&(e.preventDefault(),this._submit())}_submit(){!this.trimmed||this.disabled||this.dispatchEvent(new CustomEvent("submit",{detail:{value:this.trimmed}}))}render(){const e=this.multiline?p`<textarea rows="1" .value=${this.value} placeholder=${this.placeholder}
...
`,e=e.substring(g.length+1),n=!0),!n){let j=this.rules.other.nextBulletRegex(b),z=this.rules.other.hrRegex(b),de=this.rules.other.fencesBeginRegex(b),ct=this.rules.other.headingBeginRegex(b),Ne=this.rules.other.htmlBeginRegex(b),Xs=this.rules.other.blockquoteBeginRegex(b);for(;e;){let He=e.split(`
`,1)[0],Ht;if(g=He,this.options.pedantic?(g=g.replace(this.rules.other.listReplaceNesting,"  "),Ht=g):Ht=g.replace(this.rules.other.tabCharGlobal,"    "),de.test(g)||ct.test(g)||Ne.test(g)||Xs.test(g)||j.test(g)||z.test(g))break;if(Ht.search(this.rules.other.nonSpaceChar)>=b||!g.trim())d+=`
...
`}};let as=!1;function Ra(){as||(as=!0,S.use({hooks:{preprocess(e){return Gt=e,sr=0,e}},renderer:Oa}))}let Ot=class extends T{constructor(){super(...arguments),this.content="",this.line=null,this.keyword=""}updated(e){var t;(t=super.updated)==null||t.call(this,e),(e.has("content")||e.has("keyword"))&&this._highlightKeyword(),(e.has("line")||e.has("content"))&&this._locateAndHighlight()}_locateAndHighlight(){if(this.line===null||this.line===void 0)return;const e=Array.from(this.shadowRoot.querySelectorAll("[data-source-line]"));if(e.length===0)return;const t=e.reduce((s,i)=>{const o=Number(i.getAttribute("data-source-line"));return o<=this.line&&(!s||o>Number(s.getAttribute("data-source-line")))?i:s},null);if(!t)return;const r=this.getBoundingClientRect();if(r.height>0){const s=t.getBoundingClientRect(),i=s.top-r.top+this.scrollTop;this.scrollTo({top:i-r.height/2+s.height/2,behavior:"smooth"})}t.classList.remove("highlight-flash"),t.offsetWidth,t.classList.add("highlight-flash")}_highlightKeyword(){var a,l;const e=(a=this.shadowRoot)==null?void 0:a.querySelector(".md-body");if(!e)return;const t=(this.keyword??"").split(/\s+/).filter(n=>n.length>0);if(t.length===0)return;const r=new RegExp(t.map(n=>this._escapeRegExp(n)).join("|"),"gi"),s=document.createTreeWalker(e,NodeFilter.SHOW_TEXT,{acceptNode(n){const h=n.parentElement;if(!h)return NodeFilter.FILTER_REJECT;const d=h.tagName;return d==="SCRIPT"||d==="STYLE"||d==="MARK"?NodeFilter.FILTER_REJECT:r.test(n.nodeValue??"")?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_REJECT}}),i=[];let o;for(;o=s.nextNode();)i.push(o);for(const n of i){r.lastIndex=0;const h=n.nodeValue??"",d=document.createDocumentFragment();let f=0,g;for(;(g=r.exec(h))!==null;){g.index>f&&d.appendChild(document.createTextNode(h.slice(f,g.index)));const w=document.createElement("mark");w.textContent=g[0],w.className="keyword-hit",d.appendChild(w),f=g.index+g[0].length,g[0].length===0&&r.lastIndex++}f<h.length&&d.appendChild(document.createTextNode(h.slice(f))),(l=n.parentNode)==null||l.replaceChild(d,n)}}_escapeRegExp(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}render(){if(Ra(),!this.content)return p`<div class="empty">无内容</div>`;const e=S.parse(this.content,{async:!1});return p`<div class="md-body" .innerHTML=${e}></div>`}};Ot.styles=$`
  ...
  `;Nt([c()],nt.prototype,"path",2);Nt([c()],nt.prototype,"originalContent",2);Nt([v()],nt.prototype,"_text",2);Nt([v()],nt.prototype,"_dirty",2);Nt([v()],nt.prototype,"_error",2);nt=Nt([P("md-editor")],nt);class Vs extends Error{constructor(t,r,s){super(r),this.code=t,this.status=s,this.name="PreviewSaveError"}}async function Da(e,t){const r=await fetch(`/api/preview?path=${encodeURIComponent(e)}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({content:t})});if(!r.ok){const s=await r.json().catch(()=>({code:"UNKNOWN",detail:r.statusText}));throw new Vs(s.code??"UNKNOWN",s.detail??"保存失败",r.status)}return r.json()}var Ba=Object.defineProperty,Na=Object.getOwnPropertyDescriptor,W=(e,t,r,s)=>{for(var i=s>1?void 0:s?Na(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(i=(s?a(t,r,i):a(i))||i);return s&&i&&Ba(t,r,i),i};let B=class extends T{constructor(){super(...arguments),this.path="",this.language="text",this.content="",this.highlights=[],this.loading=!1,this.line=null,this.keyword="",this.writable=!1,this.noHeader=!1,this._mode="preview",this._content="",this._onEditorCancel=()=>{this._mode="preview"},this._onEditorDirty=e=>{this.dispatchEvent(new CustomEvent("dirty-change",{detail:{dirty:e.detail.dirty}}))}}willUpdate(e){e.has("content")&&(this._content=this.content,this._mode="preview")}enterEdit(){this._mode="edit"}async _onEditorSave(e){const t=this.shadowRoot.querySelector("md-editor");try{await Da(this.path,e.detail.content),this._content=e.detail.content,this._mode="preview",this.dispatchEvent(new CustomEvent("saved",{detail:{content:e.detail.content}}))}catch(r){const s=r instanceof Vs?`${r.code} ${r.message}`:r.message??"保存失败";t==null||t.setError(s),this.dispatchEvent(new CustomEvent("save-failed",{detail:{message:s}}))}}discard(){const e=this.shadowRoot.querySelector("md-editor");e==null||e.discard(),this._mode="preview"}render(){if(this.loading)return p`<div class="empty">加载中...</div>`;if(!this._content&&!this.content)return p`<div class="empty">点击左侧结果查看预览</div>`;if(this.language==="markdown"&&this._mode==="edit")return p`
...
`);return p`
  ...
  `;W([c()],B.prototype,"path",2);W([c()],B.prototype,"language",2);W([c()],B.prototype,"content",2);W([c({attribute:!1})],B.prototype,"highlights",2);W([c({type:Boolean})],B.prototype,"loading",2);W([c({type:Number})],B.prototype,"line",2);W([c()],B.prototype,"keyword",2);W([c({type:Boolean})],B.prototype,"writable",2);W([c({type:Boolean})],B.prototype,"noHeader",2);W([v()],B.prototype,"_mode",2);W([v()],B.prototype,"_content",2);B=W([P("preview-pane")],B);var Ha=Object.defineProperty,Fa=Object.getOwnPropertyDescriptor,Le=(e,t,r,s)=>{for(var i=s>1?void 0:s?Fa(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(i=(s?a(t,r,i):a(i))||i);return s&&i&&Ha(t,r,i),i};let Rt=class extends T{constructor(){super(...arguments),this.role="user",this.message=null,this.error=null}render(){return this.message?p`
  ...
  `;Le([c({reflect:!0})],Rt.prototype,"role",2);Le([c({attribute:!1})],Rt.prototype,"message",2);Le([c()],Rt.prototype,"error",2);Rt=Le([P("chat-message")],Rt);var Ma=Object.defineProperty,Va=Object.getOwnPropertyDescriptor,js=(e,t,r,s)=>{for(var i=s>1?void 0:s?Va(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(i=(s?a(t,r,i):a(i))||i);return s&&i&&Ma(t,r,i),i};let Ee=class extends T{constructor(){super(...arguments),this.messages=[]}updated(){this.scrollTop=this.scrollHeight}render(){return this.messages.length===0?p`<div class="empty">开始与 Cortex 对话</div>`:p`
...
⚠️ ${i.detail}`},A.setChatState({messages:o})}await Ws(r,[{kind:"message_user",payload:JSON.stringify({content:t})},{kind:"message_ai",payload:JSON.stringify({content:s})}],m.getState().chat.messages.length),this._loadHistory()}catch(s){A.setError(`对话失败: ${s.message}`)}finally{A.setChatState({streaming:!1})}}_backToInitial(){A.setChatState({state:"initial",currentSession:null,messages:[]}),this._loadHistory()}async _loadSession(e){A.setChatState({state:"focus",currentSession:e,messages:[]});try{const t=await fetch(`/api/sessions/${e.id}`);if(t.ok){const s=((await t.json()).items||[]).map(i=>{const o=JSON.parse(i.payload);return{role:i.kind==="message_user"?"user":"assistant",content:o.content}});A.setChatState({messages:s})}}catch(t){console.warn("load session failed",t)}}_onHistorySelect(e){this._loadSession(e.detail.session)}render(){var t;const e=this.viewState;return e.state==="initial"?p`
  ...
  `;De([v()],It.prototype,"draft",2);De([v()],It.prototype,"historySessions",2);De([v()],It.prototype,"_clearing",2);It=De([P("chat-view")],It);var tn=Object.defineProperty,en=Object.getOwnPropertyDescriptor,Be=(e,t,r,s)=>{for(var i=s>1?void 0:s?en(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(i=(s?a(t,r,i):a(i))||i);return s&&i&&tn(t,r,i),i};let Lt=class extends T{constructor(){super(...arguments),this.sessions=[],this.loading=!0,this._clearing=!1}connectedCallback(){super.connectedCallback(),this._load()}async _load(){this.loading=!0;try{const{sessions:e}=await Cr({limit:100});this.sessions=e}catch(e){console.warn("load history failed",e)}finally{this.loading=!1}}_onSelect(e){const t=e.detail.session;A.setPendingSession(t),A.setView(t.type==="search"?"search":"chat")}async _onClear(){this._clearing=!0,this.requestUpdate();try{await Er(),await this._load()}catch(e){console.warn("clear sessions failed",e)}finally{this._clearing=!1,this.requestUpdate()}}render(){return p`
  ...
  `;rt([v()],Q.prototype,"_activeTab",2);rt([v()],Q.prototype,"_saving",2);rt([v()],Q.prototype,"_error",2);rt([v()],Q.prototype,"_toast",2);rt([v()],Q.prototype,"_values",2);rt([v()],Q.prototype,"_original",2);rt([v()],Q.prototype,"_exists",2);rt([v()],Q.prototype,"_scope",2);Q=rt([P("settings-view")],Q);var dn=Object.defineProperty,un=Object.getOwnPropertyDescriptor,Ar=(e,t,r,s)=>{for(var i=s>1?void 0:s?un(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(i=(s?a(t,r,i):a(i))||i);return s&&i&&dn(t,r,i),i};let ie=class extends T{constructor(){super(...arguments),this.activeView="search",this._menuOpen=!1,this._onDocClick=e=>{if(!this._menuOpen)return;e.composedPath().includes(this)||(this._menuOpen=!1)}}_onAvatarClick(e){e.stopPropagation(),this._menuOpen=!this._menuOpen}_onScopeSelect(e){this._menuOpen=!1,this.dispatchEvent(new CustomEvent("navigate",{detail:{view:"settings",scope:e},bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick)}disconnectedCallback(){document.removeEventListener("click",this._onDocClick),super.disconnectedCallback()}render(){return p`
      <div class="brand">
  ...
  `;Ar([c()],ie.prototype,"activeView",2);Ar([v()],ie.prototype,"_menuOpen",2);ie=Ar([P("app-bar")],ie);var hn=Object.getOwnPropertyDescriptor,pn=(e,t,r,s)=>{for(var i=s>1?void 0:s?hn(t,r):t,o=e.length-1,a;o>=0;o--)(a=e[o])&&(i=a(i)||i);return i};let ir=class extends T{connectedCallback(){super.connectedCallback(),this._unsubscribe=m.subscribe(()=>this.requestUpdate())}disconnectedCallback(){var e;(e=this._unsubscribe)==null||e.call(this),super.disconnectedCallback()}_navigate(e){A.setView(e.detail.view),e.detail.view==="settings"&&e.detail.scope&&A.setSettingsScope(e.detail.scope)}_renderView(){const e=m.getState().view;return e==="search"?p`<search-view></search-view>`:e==="chat"?p`<chat-view></chat-view>`:e==="settings"?p`<settings-view></settings-view>`:p`<history-view></history-view>`}render(){const e=m.getState().view;return p`
      <app-bar
        .activeView=${e}
